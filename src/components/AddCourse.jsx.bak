          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
            ...
            {showDevTools && (
              <div className="grid md:grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  <div className="text-gray-400 mb-1">API Payload Preview</div>
                  <pre className="bg-black p-3 rounded-lg text-yellow-400 overflow-x-auto">
                    {JSON.stringify(
                      {
                        ...formData,
                        topics: formData.topics.map((t, i) => ({
                          ...t,
                          sequence: i + 1,
                        })),
                      },
                ...
                <div className="bg-gray-800 p-3 rounded-lg">
                  <div className="text-gray-400">Topics Count</div>
                ...
                <div className="bg-gray-800 p-3 rounded-lg">
                  <div className="text-gray-400">Courses Loaded</div>
