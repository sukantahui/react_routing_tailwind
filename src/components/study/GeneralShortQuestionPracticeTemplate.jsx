// GeneralPurposeShortQuestionPracticeTemplate.jsx
...
export default function GeneralShortQuestionPracticeTemplate({ data }) {
                        ...
                        <div class="question-card">
                            ...
                            <div class="answer-section">
                                ...
                                ` : `
                                    ...
                                    ${q.explanation ? `<div style="margin-top:0.4rem;"><strong>💡 Explanation:</strong><br/>${escapeHtml(q.explanation)}</div>` : ""}
                                `}
                            </div>
                        </div>
                    `).join("")}
                ...
                {started &&
                    sessionQ.map((q, index) => (
                        ...
                        >
                            ...
                            {q.code && (
                                <div className="mb-3">
                                    <pre className="bg-slate-950 p-3 rounded-lg overflow-x-auto text-sm text-slate-200 border border-slate-700">
                                        <code>{q.code}</code>
                                    </pre>
                                </div>
                            )}
                                    ...
                                    {q.code ? (
                                        <>
                                            <div>
                                                ...
                                                <pre className="bg-slate-950 p-2 rounded-lg text-slate-200 text-sm">{q.output || "(No output shown)"}</pre>
                                            </div>
                                            <p className="text-slate-300 text-sm leading-relaxed"><b>Explanation:</b> {q.explanation}</p>
                                        </>
                                    ) : (
                                        <>
                                            <p className="text-slate-200 text-sm leading-relaxed"><b>Answer:</b> {q.answer}</p>
                                            {q.explanation && (
                                                <p className="text-slate-300 text-sm leading-relaxed mt-2"><b>Explanation:</b> {q.explanation}</p>
                                            )}
                                        </>
                                    )}
                                </div>
