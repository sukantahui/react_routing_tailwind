...
export default function PlainTextPrint({ content = "", filename = "study_note.txt" }) {
  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      printWindow.document.write("<html><head><title>" + filename + "</title><style>body { font-family: monospace; padding: 20px; white-space: pre-wrap; word-break: break-all; font-size: 12px; }</style></head><body>" + content.replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</body></html>");
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>{copied ? "Copied!" : "Copy ASCII Note"}</span>
          </button>
