...
/**
 * Topic8 – MySQL Native JSON Data Type vs Relational 1NF: When JSON Violates 1NF and When It Is Justified
 * Module: 006_002_first-normal-form-1nf
 *
 * @component
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-teal-500/30 selection:text-teal-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">
            MySQL Native JSON Data Type vs Relational 1NF: When JSON Violates 1NF and When It Is Justified
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master First Normal Form (1NF). Learn the atomicity principle, how to eliminate multivalued attributes and repeating columns, composite attribute decomposition, and exceptions in modern databases.
          </p>
        </header>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800 overflow-hidden shadow-2xl">
            ...
            <div className="flex border-b border-slate-800 bg-slate-950/60 overflow-x-auto">
              ...
              &gt;
                <span>🚫</span>
                <span>NON-ATOMIC CSV ARRAY</span>
              </button>
                  ...
                  <table className="w-full text-left text-xs font-mono">
                    <thead className="bg-slate-900 border-b border-slate-800 text-slate-300">
                      <tr>
                        ...
                        <th className="p-3">hobby (Atomic)</th>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <PlainTextPrint
            content={noteText}
            title="MySQL Native JSON Data Type vs Relational 1NF: When JSON Violates 1NF and When It Is Justified"
            stampEnabled={true}
            showDownload={true}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <FAQTemplate
            title="MySQL Native JSON Data Type vs Relational 1NF: When JSON Violates 1NF and When It Is Justified – Practice Questions"
            questions={questions}
        ...
        <footer className="max-w-5xl mx-auto pt-8 border-t border-slate-800 text-center text-xs text-slate-400">
          <span>
            Topic 8 · MySQL Native JSON Data Type vs Relational 1NF: When JSON Violates 1NF and When It Is Justified · RDBMS MySQL Masterclass · Coder & AccoTax Barrackpore
          </span>
        </footer>
      </div>
    </>
