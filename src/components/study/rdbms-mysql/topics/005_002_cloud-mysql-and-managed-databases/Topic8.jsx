...
/**
 * Topic8 – Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis)
 * Module: 005_002_cloud-mysql-and-managed-databases
 *
 * @component
 * @returns {JSX.Element} Interactive educational workbench for Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis).
 */
const Topic8 = () => {
  ...
  const conceptsData = {
    concept1: {
      ...
      title: "1. Architectural Principles of Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis)",
      badge: "Cloud Architecture",
      badgeColor: "emerald",
      sqlSnippet: `-- ☁️ CLOUD DATABASE INFRASTRUCTURE PATTERN (TOPIC 8):
...
-- Storage Engine: InnoDB with Cloud-optimized volume striping (gp3 / io2)`,
      explanation: "Comprehensive architectural framework for Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis), detailing enterprise deployment models, cloud automation, and high availability.",
    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <header className="max-w-6xl mx-auto mb-10 text-center sm:text-left border-b border-slate-800 pb-8">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight leading-tight">
          Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis)
        </h1>
        <p className="mt-4 text-base sm:text-lg text-slate-400 max-w-4xl leading-relaxed">
          Scaling high-throughput architectures: vertical instance class resizing (db.m6g), read replica routing with ProxySQL, and caching frequently queried hot keys in Redis.
        </p>
      </header>
      ...
      <main className="max-w-6xl mx-auto space-y-16">
        ...
        <section id="printable-note" className="space-y-6">
          ...
          <PlainTextPrint
            title="Topic 8: Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis)"
            content={noteText}
          />
        ...
        <section id="faq-section" className="space-y-6">
          ...
          <FAQTemplate
            title="Vertical Scaling (Compute/Memory resizing) vs Horizontal Scaling (Read Replicas, Caching with Redis) FAQs"
            questions={questions}
          />
        </section>
      </main>
