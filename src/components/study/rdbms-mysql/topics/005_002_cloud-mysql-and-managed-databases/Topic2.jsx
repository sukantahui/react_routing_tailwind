...
/**
 * Topic2 – AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages
 * Module: 005_002_cloud-mysql-and-managed-databases
 *
 * @component
 * @returns {JSX.Element} Interactive educational workbench for AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages.
 */
const Topic2 = () => {
  ...
  const conceptsData = {
    concept1: {
      ...
      title: "1. Architectural Principles of AWS Aurora MySQL",
      badge: "Cloud Architecture",
      badgeColor: "emerald",
      sqlSnippet: `-- ☁️ CLOUD DATABASE INFRASTRUCTURE PATTERN (TOPIC 2):
...
-- Storage Engine: InnoDB with Cloud-optimized volume striping (gp3 / io2)`,
      explanation: "Comprehensive architectural framework for AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages, detailing enterprise deployment models, cloud automation, and high availability.",
    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <header className="max-w-6xl mx-auto mb-10 text-center sm:text-left border-b border-slate-800 pb-8">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
          AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages
        </h1>
        <p className="mt-4 text-base sm:text-lg text-slate-400 max-w-4xl leading-relaxed">
          Deep dive into Amazon Aurora: distributed 6-way storage across 3 AZs, 15 millisecond read replicas, lock-free parallel query engine, and Aurora Serverless v2.
        </p>
      </header>
      ...
      <main className="max-w-6xl mx-auto space-y-16">
        ...
        <section id="printable-note" className="space-y-6">
          ...
          <PlainTextPrint
            title="Topic 2: AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages"
            content={noteText}
          />
        ...
        <section id="faq-section" className="space-y-6">
          ...
          <FAQTemplate
            title="AWS Aurora MySQL: Cloud-Native Shared Storage Architecture and Performance Advantages FAQs"
            questions={questions}
          />
        </section>
      </main>
