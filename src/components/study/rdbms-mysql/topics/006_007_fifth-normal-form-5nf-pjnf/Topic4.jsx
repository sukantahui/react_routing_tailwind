...
/**
 * Topic4 – The Classic 3-Way Relationship Example: Supplier-Part-Project (SPJ) Cyclic Constraint
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-teal-500/30 selection:text-teal-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">
            The Classic 3-Way Relationship Example: Supplier-Part-Project (SPJ) Cyclic Constraint
          </h1>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <PlainTextPrint
            content={noteText}
            title="The Classic 3-Way Relationship Example: Supplier-Part-Project (SPJ) Cyclic Constraint"
            stampEnabled={true}
            showDownload={true}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <FAQTemplate
            title="The Classic 3-Way Relationship Example: Supplier-Part-Project (SPJ) Cyclic Constraint – Practice Questions"
            questions={questions}
        ...
        <footer className="max-w-5xl mx-auto pt-8 border-t border-slate-800 text-center text-xs text-slate-400">
          <span>
            Topic 4 · The Classic 3-Way Relationship Example: Supplier-Part-Project (SPJ) Cyclic Constraint · RDBMS MySQL Masterclass · Coder & AccoTax Barrackpore
          </span>
        </footer>
      </div>
    </>
