...
/**
 * Topic7 – Bernstein's 3NF Synthesis Algorithm: Creating 3NF Schemas from Minimal Functional Dependency Sets
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-teal-500/30 selection:text-teal-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">
            Bernstein's 3NF Synthesis Algorithm: Creating 3NF Schemas from Minimal Functional Dependency Sets
          </h1>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800 overflow-hidden shadow-2xl">
            ...
            <div className="flex border-b border-slate-800 bg-slate-950/60 overflow-x-auto">
              ...
              >
                <span>🔍</span>
                <span>BERNSTEIN'S SYNTHESIS</span>
              </button>
                  ...
                  <table className="w-full text-left text-xs font-mono">
                    <thead className="bg-slate-900 border-b border-slate-800 text-slate-300">
                      <tr>
                        ...
                        <th className="p-3">salary_inr</th>
                        <th className="p-3">dept_id (Non-Key)</th>
                        <th className="p-3">dept_name</th>
                        <th className="p-3">location (Transitive)</th>
                      </tr>
                    </thead>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <PlainTextPrint
            content={noteText}
            title="Bernstein's 3NF Synthesis Algorithm: Creating 3NF Schemas from Minimal Functional Dependency Sets"
            stampEnabled={true}
            showDownload={true}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <FAQTemplate
            title="Bernstein's 3NF Synthesis Algorithm: Creating 3NF Schemas from Minimal Functional Dependency Sets – Practice Questions"
            questions={questions}
        ...
        <footer className="max-w-5xl mx-auto pt-8 border-t border-slate-800 text-center text-xs text-slate-400">
          <span>
            Topic 7 · Bernstein's 3NF Synthesis Algorithm: Creating 3NF Schemas from Minimal Functional Dependency Sets · RDBMS MySQL Masterclass · Coder & AccoTax Barrackpore
          </span>
        </footer>
      </div>
    </>
