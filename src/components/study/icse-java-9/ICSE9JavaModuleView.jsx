...
import roadmapData from "./icse-java-ix-roadmap.json";

export default function ICSE9JavaModuleView() {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="sticky top-0 z-30 border-b border-slate-800 bg-slate-950/90 backdrop-blur-xl">
        <div className="max-w-4xl mx-auto p-4 flex justify-between items-center">
          ...
          {/* CENTER: TITLE */}
          <div className="text-center">
            <p className="text-[11px] uppercase text-slate-500 flex items-center justify-center gap-1">
