  ...
  const warfareProfiles = [
    {
      ...
      simResult: 'State-sponsored LNK worm attempts PLC frequency alteration (1410 Hz) &rarr; Optical data diode blocks return command -&gt; Mechanical governor locks speed -> Zero damage.',
    },
    {
