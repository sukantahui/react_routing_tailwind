  ...
  const terrorProfiles = [
    {
      ...
      simResult: 'Rogue PLC command sets chlorine to 11,000 PPM &rarr; Hardwired optical sensor detects threshold breach -&gt; Mechanical dump valve trips in 0.4s -> 0 Liters Contaminated.',
    },
    {
