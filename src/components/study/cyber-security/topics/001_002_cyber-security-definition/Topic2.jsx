  ...
  const importanceProfiles = [
    {
      ...
      simResult: 'Fraud detection engine analyzes transaction velocity &rarr; Flags suspicious ₹1,50,000 overseas card swipe -&gt; Blocks fraud in 35ms -> Funds protected.',
    },
    {
