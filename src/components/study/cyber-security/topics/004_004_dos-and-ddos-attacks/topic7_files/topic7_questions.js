...
add_hook('InvoicePaid', 1, function($vars) {
  ...
  },
  {
    ...
    explanation: "Let $C_{\\text{attacker}}$ represent the attacker's costs (e.g. ₹2,000 for a booter subscription). Let $C_{\\text{defender}}$ represent the victim's total costs: cloud scrubbing contract (₹10,00,000/year), downtime losses (4 hours at ₹8,00,000/hour = ₹32,00,000), and forensic response (₹8,00,000), totaling $C_{\\text{defender}} = ₹50,00,000$. The Economic Cost Asymmetry Ratio is: $A_{\\text{economic}} = \\frac{50,00,000}{2,000} = 2,500\\times$. For Ransom DoS demanding a ₹25,00,000 ransom, expected attacker ROI is: $\\text{ROI} = \\frac{25,00,000 - 2,000}{2,000} \\times 100\\% = 124,900\\%$. Deploying always-on Anycast cloud scrubbing eliminates downtime losses, driving attacker ROI to $-100\\%$.",
