...
const Topic0 = () => {
  ...
  // Studio 1: 4-Tier Governance Pyramid Data
  const docTiers = {
    tier1_policies: {
      key: "tier1_policies",
      name: "Tier 1: Policies (Strategic Intent)",
      authority: "Mandatory for 100% of Employees (Board of Directors & CEO Signed)",
      questionAnswered: "Answers 'WHY' security is essential and 'WHAT' executive intent dictates.",
  ...
  const lifecycleStages = {
    stage1_drafting: {
      ...
      description: "Author drafts document using standardized template, assigning unique Document ID (e.g. POL-SEC-01), title, semantic version (v1.0), and classification banner.",
  ...
  const localScenarios = [
    ...
    },
    {
      ...
      title: "Healthcare Clinical Data Governance & Privacy",
      budget: "₹8,20,000",
    ...
    },
    {
      ...
      title: "Governance Hierarchy & Document Simulation Laboratory",
      budget: "₹4,50,000",
      ...
      resolution:
        "The team developed an interactive 4-Tier Governance Hierarchy Builder and Document Control Lifecycle Simulator in React, training 215+ BCA cyber security students on authoring ISO 27001 artifacts.",
      metrics: {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans antialiased pb-16">
      ...
      <header className="bg-gradient-to-r from-gray-900 via-slate-900 to-indigo-950 border-b border-gray-800 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-950/80 text-indigo-300 border border-indigo-700/50">
            ...
            Course Module 3: Information Security Management • Module 003_003 • Topic 0 of 14
          </div>
          <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-white">
            Hierarchy of Security Governance: Policies, Standards, Guidelines, Procedures
          </h1>
          <p className="text-sm sm:text-base text-gray-300 max-w-3xl leading-relaxed">
            Architect an auditable security governance foundation: master the 4-tier hierarchy (Policies, Standards, Procedures, Guidelines), 
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-12">
        ...
        {/* SECTION 1: Interactive 4-Tier Security Governance Pyramid */}
        <section className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>📐</span> Studio 1: 4-Tier Security Governance Pyramid
            </h2>
            <p className="text-xs sm:text-sm text-gray-400 mt-1">
              Select a governance tier to inspect its operational authority, core questions answered (Why vs What vs How), sample artifacts, and external auditor verification expectations.
            </p>
          </div>
          ...
          <div className="bg-gray-950 rounded-2xl border border-gray-800 p-6 space-y-6 shadow-2xl">
            ...
            <div className="bg-gray-900 p-4 rounded-xl border border-gray-800 space-y-2 font-mono text-xs">
              ...
              <div className="p-3 bg-gray-950 rounded-lg border border-gray-800 text-gray-300 space-y-1">
                <div><span className="text-indigo-400 font-bold">Document ID:</span> POL-SEC-01 (Enterprise Information Security Policy)</div>
                <div><span className="text-indigo-400 font-bold">Version:</span> v3.2 (Approved by CISO Sukanta Hui on 2026-08-23)</div>
        ...
        <section className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">
              Visualizing the 4-Tier Security Governance Pyramid and the Clause 7.5 Document Control Lifecycle Flow.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-4">
              <h3 className="text-sm font-bold text-indigo-400 flex items-center gap-2">
                <span>🔄</span> Diagram A: The 4-Tier Security Governance Pyramid
              </h3>
              ...
              <p className="text-xs text-gray-400 text-center">
                Figure 0.1: The 4-tier security governance hierarchy pyramid (ISO/IEC 27001).
              </p>
            </div>
            ...
            <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-4">
              ...
              <div className="bg-gray-900/90 rounded-xl p-4 border border-gray-800 overflow-x-auto flex justify-center">
                <svg viewBox="0 0 500 320" className="w-full max-w-lg h-auto text-xs" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <line x1="155" y1="47" x2="185" y2="47" stroke="#06b6d4" strokeWidth="1.5" markerEnd="url(#arrowCyan60)" />
                  ...
                  <line x1="315" y1="47" x2="345" y2="47" stroke="#6366f1" strokeWidth="1.5" markerEnd="url(#arrowIndigo60)" />
                  ...
                  <line x1="265" y1="127" x2="230" y2="127" stroke="#f59e0b" strokeWidth="1.5" markerEnd="url(#arrowGold60)" />
                  ...
                  <defs>
                    <marker id="arrowCyan60" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                      <path d="M 0 0 L 10 5 L 0 10 z" fill="#06b6d4" />
                    </marker>
                    <marker id="arrowIndigo60" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                      <path d="M 0 0 L 10 5 L 0 10 z" fill="#6366f1" />
                    </marker>
                    <marker id="arrowGold60" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <p className="text-xs text-gray-400 text-center">
                Figure 0.2: The Document Control Lifecycle workflow under ISO/IEC 27001 Clause 7.5.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>🏢</span> Section 4: Security Governance Scenarios (West Bengal)
            </h2>
            <p className="text-xs sm:text-sm text-gray-400 mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="bg-gray-900 p-4 rounded-xl border border-emerald-900/30 space-y-2">
                <h4 className="font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1.5">
                  <span>🛡</span> Applied Governance Solution
                </h4>
        ...
        <section className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">
              Guidelines for Enterprise Governance Architects and CISOs structuring 4-tier security suites.
            </p>
          </div>
        ...
        <section className="space-y-6">
          <div className="border-b border-gray-800 pb-4">
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-1">
              Synthesize 4-tier governance hierarchies and Clause 7.5 document control workflows before reviewing the comprehensive practice questions.
            </p>
          </div>
          ...
          <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 text-xs text-gray-300">
              <div className="flex items-center gap-2 p-2.5 bg-gray-900 rounded-lg border border-gray-800">
                ...
                <span>4-Tier Hierarchy: Policies (Tier 1), Standards (2), Procedures (3), Guidelines (4).</span>
              </div>
              <div className="flex items-center gap-2 p-2.5 bg-gray-900 rounded-lg border border-gray-800">
                <span className="text-emerald-400">✔</span>
              ...
              <div className="flex items-center gap-2 p-2.5 bg-gray-900 rounded-lg border border-gray-800">
                <span className="text-emerald-400">✔</span>
                <span>Documented governance suite proves Reasonable Security Practices under IT Act Sec 43A.</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <FAQTemplate
            title="Hierarchy of Security Governance FAQs"
            subtitle="30 Moderate to Expert Practice Questions &amp; Governance Hierarchy Deep Dives"
            questions={questions}
          />
        </section>
        ...
        <section className="space-y-4">
          <PlainTextPrint
            content={noteText}
            title="Hierarchy of Security Governance: Policies, Standards, Guidelines, Procedures (Printable Study Guide)"
            stampEnabled={true}
            showDownload={true}
        ...
        <section className="pt-4">
          <Teacher
            note="Teacher's Note: Welcome to Module 003_003: Security Policies, Risk Assessment & Mitigation! The 4-tier security governance hierarchy is the constitutional bedrock of enterprise risk management. Always remember: author strategic Policies (Tier 1) signed by executive leadership under Clause 5.2, define measurable Technical Standards (Tier 2) with exact ciphers and parameters, write numbered chronological SOPs (Tier 3) for operational execution, and publish helpful Guidelines (Tier 4). Enforce rigorous document control under Clause 7.5 to guarantee 100% audit success and total statutory Safe Harbor under Section 43A of the Indian IT Act 2000 and Section 8 of the Indian DPDP Act 2023!"
          />
        </section>
