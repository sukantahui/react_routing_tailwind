    ...
    <div className="space-y-8 text-slate-200 leading-relaxed font-sans">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold tracking-wide uppercase">
          <span>📘</span> TallyPrime Master Series · Topic 5
        </div>
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight leading-snug">
          Common TDS Sections: 194C (Contractors - 1%/2%, Single ₹30k / Aggregate ₹1 Lakh), 194J (Professional/Technical Fees - 2%/10%, ₹30k), 194I (Rent - Land/Building 10%, Plant/Machinery 2%, ₹2.4 Lakhs), 194H (Commission - 5%, ₹15k), 194Q (Purchase of Goods - 0.1%, ₹50 Lakhs)
        </h1>
      ...
      <section className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-4">
        ...
        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
          Understanding <strong>Common TDS Sections: 194C (Contractors - 1%/2%, Single ₹30k / Aggregate ₹1 Lakh), 194J (Professional/Technical Fees - 2%/10%, ₹30k), 194I (Rent - Land/Building 10%, Plant/Machinery 2%, ₹2.4 Lakhs), 194H (Commission - 5%, ₹15k), 194Q (Purchase of Goods - 0.1%, ₹50 Lakhs)</strong> is essential for maintaining accurate business books, ensuring statutory tax compliance, and operating TallyPrime efficiently.
        </p>
