...
import project1Data from "./project1_files/project1_data.json";
import questionsEn from "./project1_files/project1_questions";
import questionsBn from "./project1_files/project1_questions_bn";
import noteTextEn from "./project1_files/project1_note.txt?raw";
import noteTextBn from "./project1_files/project1_note_bn.txt?raw";
import txTextEn from "./project1_files/project1_tx.txt?raw";
import txTextBn from "./project1_files/project1_tx_bn.txt?raw";
import qpTextEn from "./project1_files/project1_qp.txt?raw";
import qpTextBn from "./project1_files/project1_qp_bn.txt?raw";
...
export default function Project1() {
  ...
  const transactionsList = project1Data?.transactions || [];
  ...
  const handleTriggerPrintA4 = () => {
    triggerA4CommercePrint({
      projectTitle: isBengali ? "প্রজেক্ট ১: বাণিজ্যিক হিসাববিজ্ঞান অনুশীলন প্রশ্নপত্র" : "Project 1: Commercial Accounting Assignment Question Paper",
  ...
  const handleEvaluateSolution = () => {
    ...
    setTimeout(() => {
      ...
      setEvaluationResult({
        ...
        remarksEn: "Outstanding performance! All 30 commercial business transactions of M/s Apex Global Traders have been correctly journalized, posted to general ledgers, balanced with c/d and b/d mechanics, and reconciled in the Trial Balance with 100% precision!",
        remarksBn: "চমৎকার পারফরম্যান্স! M/s Apex Global Traders-এর ৩০টি ব্যবসায়িক লেনদেন সঠিকভাবে জাবেদাভুক্ত, খতিয়ানে পোস্টিং, c/d ও b/d মেকানিক্স দ্বারা সমতাভুক্ত এবং ট্রায়াল ব্যালেন্সে ১০০% নিখুঁতভাবে মিলিয়ে দেওয়া হয়েছে!"
      });
    }, 1500);
  };
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>🏆</span>
            <span>TallyPrime Master Series · Module 1.3 · Project 1</span>
          </div>
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 tracking-tight leading-tight">
            {isBengali ? "প্রজেক্ট ১: ৩০টি ব্যবসায়িক বাস্তব লেনদেনের খতিয়ান পোস্টিং ও জের অডিট ক্যাপস্টোন" : "Project 1: Complete 30-Transaction Commercial Accounting & Ledger Balancing Audit"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            {isBengali ? "M/s Apex Global Traders-এর (এপ্রিল ২০২৬) ৩০টি বাস্তব বাণিজ্যিক লেনদেনের জাবেদা, খতিয়ান পোস্টিং, ব্যালেন্সিং ও সিএনএটি স্যারের লাইভ ইভালুয়েশন।" : "Comprehensive real-world case study for M/s Apex Global Traders (April 2026). Record, post to ledgers, balance T-accounts, and submit for Mr. CNAT's live evaluation."}
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16 rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-slate-900/95 to-slate-900/80 p-6 md:p-8 shadow-2xl space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
            <div>
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">
                M/s Apex Global Traders (Proprietorship)
              </h2>
              <p className="text-xs text-slate-400">
                {isBengali ? "বাণিজ্যিক হিসাব খাতা ও অডিট কেস স্টাডি (এপ্রিল ২০২৬)" : "Commercial Books of Accounts Case Study (Financial Period: April 2026)"}
              </p>
            </div>
            ...
            <div className="text-right font-mono text-xs text-emerald-400 font-bold bg-slate-950 px-4 py-2 rounded-xl border border-slate-800">
              {isBengali ? "মোট লেনদেন: ৩০টি বাণিজ্যিক কেস" : "Total Scope: 30 Business Transactions"}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-mono pt-2">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-300">
              ...
              Debit/Credit Rules, Voucher Key Mapping &amp; Balance c/d mechanics.
            </div>
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-300">
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              ...
              <span>{isBengali ? "৩০টি ব্যবসায়িক লেনদেনের অ্যাসাইনমেন্ট ও কাজ" : "30 Commercial Business Transactions Problem Set"}</span>
            </h2>
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 md:p-8 space-y-6 shadow-2xl">
            ...
            <div className="pt-2">
              <PlainTextPrint
                content={qpText}
                filename={isBengali ? "Project1_Question_Paper_bn.txt" : "Project1_Question_Paper.txt"}
            ...
            <div className="pt-2">
              <PlainTextPrint
                content={txText}
                filename={isBengali ? "project1_30_transactions_hints_bn.txt" : "project1_30_transactions_hints.txt"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16">
          <JournalLedgerViewer data={project1Data} isBengali={isBengali} />
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-16 rounded-2xl border border-teal-500/40 bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/40 p-6 md:p-8 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
            <div>
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">
                {isBengali ? "সিএনএটি স্যারের (Mr. CNAT) মূল্যায়ন ও অডিট যাচাইকরণ" : "Submit Solution for CNAT Sir's Evaluation & Certification"}
              </h2>
              <p className="text-xs text-slate-400">
            ...
            >
              {isAuditing ? (
                ...
                <>
                  <span>📝</span>
                  <span>{isBengali ? "সিএনএটি স্যারের কাছে মূল্যায়ন জমা দিন" : "Submit Solution to CNAT Sir for Evaluation"}</span>
                </>
              )}
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/30 border border-emerald-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-emerald-300">
                  {isBengali ? "Teacher's Desk: প্রজেক্ট ১ নির্দেশনা" : "Teacher's Desk: Project 1 Capstone Guidance"}
                </h2>
                <p className="text-xs text-slate-400 font-mono">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <p>
                  {isBengali
                    ? "এই ৩০টি লেনদেন হলো সম্পূর্ণ ডাবল-এন্ট্রি খতিয়ানের ভিত্তি! প্রতি লেনদেন জাবেদাভুক্ত করুন, সঠিক খতিয়ানে ডেবিট/ক্রেডিট দিন এবং মাস শেষে Balance c/d বের করে ১লা মে-তে b/d আকারে নিয়ে আসুন!"
                    : "These 30 commercial transactions form the complete backbone of double-entry ledger posting! Journalize each entry, post to respective T-accounts, balance c/d at month-end, and carry forward b/d on 1st May!"}
                </p>
              </div>
            </div>
          </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            filename={isBengali ? "project1_study_note_bn.txt" : "project1_study_note.txt"}
            hidePreview={true}
            showDownload={true}
          />
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={isBengali ? "Project 1 মূল্যায়ন ও অনুশীলন প্রশ্নাবলী" : "Project 1 Assessment & Diagnostic Practice"}
            questions={questions}
          />
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto">
          <Teacher
            note={
              isBengali
                ? "প্রজেক্ট ১-এর ৩০টি ব্যবসায়িক লেনদেন নিখুঁতভাবে সমাধান করলেই খতিয়ান পোস্টিং ও জের মেলানোর পূর্ণাঙ্গ দক্ষতা তৈরি হবে!"
                : "Solving all 30 commercial transactions in Project 1 guarantees complete double-entry ledger posting and balancing mastery!"
            }
          />
        </section>
