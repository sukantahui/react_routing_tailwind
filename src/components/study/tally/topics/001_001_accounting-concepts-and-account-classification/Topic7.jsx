      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 tracking-tight leading-tight">
            The Golden Rules of Accounting: Debit the Receiver / Credit the Giver; Debit What Comes In / Credit What Goes Out; Debit All Expenses & Losses / Credit All Incomes & Gains
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Mastering the fundamental rules governing every journal voucher entry.
          </p>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/30 border border-emerald-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <p>The Golden Rules dictate whether to Debit or Credit an account based on whether it is Personal, Real, or Nominal.</p>
              </div>
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <div className="space-y-3 text-xs sm:text-sm font-sans border-l-2 border-emerald-500/40 pl-4 py-1">
                  <div>
                    <p><strong className="text-emerald-400">Moumi (Lab Student):</strong> <em>"Sir, when we receive ₹10,000 cash from customer Rohit, which rule applies to Cash and which to Rohit?"</em></p>
                  </div>
                  <div>
                    <p><strong className="text-sky-300">CNAT Sir:</strong> <em>"Cash is a Real Account: Cash comes in &rarr; DEBIT Cash! Rohit is a Personal Account: Rohit is the giver &rarr; CREDIT Rohit! Entry: Debit Cash ₹10,000 / Credit Rohit ₹10,000!"</em></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>📌</span> The Three Golden Rules of Bookkeeping
            </h2>
              ...
              <table className="w-full text-xs sm:text-sm text-left border-collapse border border-slate-800">
                ...
                <tbody className="divide-y divide-slate-800 text-slate-300">
                    ...
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Personal Account Rule</td>
                      <td className="p-3 border border-slate-800">DEBIT the Receiver | CREDIT the Giver</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Example: Paid ₹5,000 to Supplier HP Ltd (Debit HP Ltd)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Real Account Rule</td>
                      <td className="p-3 border border-slate-800">DEBIT what Comes In | CREDIT what Goes Out</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Example: Purchased Machinery ₹50,000 Cash (Debit Machinery, Credit Cash)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Nominal Account Rule</td>
                      <td className="p-3 border border-slate-800">DEBIT all Expenses & Losses | CREDIT all Incomes & Gains</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Example: Paid Office Rent ₹12,000 (Debit Rent Expense, Credit Bank)</td>
                    </tr>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              In TallyPrime voucher entry screens, pressing F12 allows you to display 'Use Cr/Dr instead of To/By during voucher entry' for easy Golden Rule entry.
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint content={noteText} filename="topic7_study_note.txt" />
        </section>
