      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 tracking-tight leading-tight">
            Step-by-Step Transaction Analysis Logic: Identifying Accounts Affected and Determining Debit vs Credit
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            A systematic 4-step algorithm for analyzing any commercial transaction.
          </p>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/30 border border-emerald-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <p>To record any transaction correctly: 1. Identify the 2 or more accounts affected. 2. Classify each account type. 3. Apply Golden/Modern rules. 4. Verify Debit total equals Credit total.</p>
              </div>
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <div className="space-y-3 text-xs sm:text-sm font-sans border-l-2 border-emerald-500/40 pl-4 py-1">
                  <div>
                    <p><strong className="text-emerald-400">Soudip (Lab Student):</strong> <em>"Sir, what is the exact step-by-step process when analyzing 'Paid Electricity Bill ₹3,500 by HDFC NetBanking'?"</em></p>
                  </div>
                  <div>
                    <p><strong className="text-sky-300">CNAT Sir:</strong> <em>"Step 1: Accounts affected are Electricity Expense & HDFC Bank. Step 2: Electricity is Nominal, HDFC Bank is Personal/Real. Step 3: Debit Electricity Expense (Expense), Credit HDFC Bank (Giver/Bank goes down). Step 4: Dr ₹3,500 = Cr ₹3,500!"</em></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>📌</span> The 4-Step Transaction Analysis Algorithm
            </h2>
              ...
              <table className="w-full text-xs sm:text-sm text-left border-collapse border border-slate-800">
                ...
                <tbody className="divide-y divide-slate-800 text-slate-300">
                    ...
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Step 1: Identify Accounts</td>
                      <td className="p-3 border border-slate-800">Find which two ledgers are impacted by the source document (Invoice/Receipt).</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">e.g. Sales A/c and Customer A/c</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Step 2: Classify Account Nature</td>
                      <td className="p-3 border border-slate-800">Determine whether accounts are Real, Personal, Nominal OR Asset, Expense, Liability.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">e.g. Customer = Personal (Asset), Sales = Nominal (Income)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Step 3: Apply Polarity Rule</td>
                      <td className="p-3 border border-slate-800">Determine whether accounts are increasing or decreasing and apply Dr/Cr rule.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Debit Customer (Receiver/Asset +), Credit Sales (Income +)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Step 4: Record & Verify</td>
                      <td className="p-3 border border-slate-800">Pass voucher in TallyPrime and verify that total Debit equals total Credit.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Ctrl+A to save voucher in Tally</td>
                    </tr>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              TallyPrime automatically blocks saving a voucher if the total Debit amount does not equal the total Credit amount.
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint content={noteText} filename="topic9_study_note.txt" />
        </section>
