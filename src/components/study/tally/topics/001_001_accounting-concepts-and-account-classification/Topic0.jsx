      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            The complete gateway into commercial financial accounting, double-entry principles, and business communication.
          </p>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/30 border border-emerald-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <p>Accounting systematically records, classifies, summarizes, and reports financial transactions to answer: How much do we earn? How much do we spend? How much do we own? How much do we owe?</p>
              </div>
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <div className="space-y-3 text-xs sm:text-sm font-sans border-l-2 border-emerald-500/40 pl-4 py-1">
                  <div>
                    <p><strong className="text-emerald-400">Sohini (Lab Student):</strong> <em>"Sir, as a non-accounting student, why is accounting called the language of business?"</em></p>
                  </div>
                  <div>
                    <p><strong className="text-sky-300">CNAT Sir:</strong> <em>"Just as we use English or Bengali to communicate thoughts, business owners use accounting statements (P&L and Balance Sheet) to communicate financial health to banks, tax authorities, and investors!"</em></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>📌</span> The Language of Business & 4 Key Financial Questions
            </h2>
              ...
              <table className="w-full text-xs sm:text-sm text-left border-collapse border border-slate-800">
                ...
                <tbody className="divide-y divide-slate-800 text-slate-300">
                    ...
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">1. Systematic Recording</td>
                      <td className="p-3 border border-slate-800">Recording every cash/bank/credit transaction in Journal vouchers immediately upon occurrence.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Gateway of Tally &gt; Vouchers (F5, F6, F7, F8, F9)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">2. Classifying Ledger Balances</td>
                      <td className="p-3 border border-slate-800">Grouping transactions of similar nature into individual Ledgers (Cash, Sales, Rent, Sundry Debtors).</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Gateway of Tally &gt; Chart of Accounts / Display &gt; Account Books</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">3. Summarizing Financial Position</td>
                      <td className="p-3 border border-slate-800">Compiling Trial Balance, Trading Account, Profit & Loss Statement, and Balance Sheet.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Gateway of Tally &gt; Display More Reports &gt; Trial Balance / P&L / Balance Sheet</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">4. Interpreting & Reporting</td>
                      <td className="p-3 border border-slate-800">Analyzing financial ratios, tax liabilities (GST, TDS), working capital, and cash flows.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Gateway of Tally &gt; Ratio Analysis / Cash Flow / Dashboard</td>
                    </tr>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              When operating TallyPrime, every entry you pass automatically updates the Journal, Ledger, Trial Balance, P&L, and Balance Sheet in real-time.
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint content={noteText} filename="topic0_study_note.txt" />
        </section>
