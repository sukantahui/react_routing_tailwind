      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 tracking-tight leading-tight">
            Revenue, Income, Expenses, Capital Expenditure vs Revenue Expenditure, Purchases, Sales, Gains, and Losses
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Distinguishing operational income and expenditure from long-term capital investments.
          </p>
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-emerald-950/30 border border-emerald-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed text-sm sm:text-base">
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <p>Revenue is gross inflow from operations. Expenses are costs incurred to generate revenue. Capital expenditure creates long-term assets, while Revenue expenditure is written off in P&L.</p>
              </div>
              ...
              <div className="bg-slate-950/70 border border-slate-800 rounded-xl p-5 space-y-3">
                ...
                <div className="space-y-3 text-xs sm:text-sm font-sans border-l-2 border-emerald-500/40 pl-4 py-1">
                  <div>
                    <p><strong className="text-emerald-400">Soudip (Lab Student):</strong> <em>"Sir, if we spend ₹2,00,000 to purchase a new delivery van, is it a Revenue Expense or Capital Expenditure?"</em></p>
                  </div>
                  <div>
                    <p><strong className="text-sky-300">CNAT Sir:</strong> <em>"It is Capital Expenditure! A delivery van provides business benefits over 5-10 years and is listed on the Balance Sheet as an Asset, whereas van petrol is a Revenue Expense written off in P&L!"</em></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
              <span>📌</span> Income Statement Components & Expenditure Classification
            </h2>
              ...
              <table className="w-full text-xs sm:text-sm text-left border-collapse border border-slate-800">
                ...
                <tbody className="divide-y divide-slate-800 text-slate-300">
                    ...
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Capital Expenditure (CapEx)</td>
                      <td className="p-3 border border-slate-800">Acquiring or extending fixed assets. Benefit lasts multiple years. Recorded in Balance Sheet.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Debit Asset A/c (e.g. Delivery Van A/c)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Revenue Expenditure (OpEx)</td>
                      <td className="p-3 border border-slate-800">Day-to-day operational cost. Benefit consumed within 12 months. Recorded in P&L.</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Debit Expense A/c (e.g. Fuel Expense A/c)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Direct Expenses</td>
                      <td className="p-3 border border-slate-800">Manufacturing or purchasing costs directly tied to goods sold (Freight, Factory Wages).</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Grouped under 'Direct Expenses' (Trading A/c)</td>
                    </tr>
                  
                    <tr className="hover:bg-slate-900/50">
                      <td className="p-3 border border-slate-800 font-bold text-emerald-300">Indirect Expenses</td>
                      <td className="p-3 border border-slate-800">Administrative, selling, and general overheads (Office Rent, Staff Salary, Audit Fees).</td>
                      <td className="p-3 border border-slate-800 font-mono text-sky-300">Grouped under 'Indirect Expenses' (P&L A/c)</td>
                    </tr>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              In TallyPrime, selecting 'Direct Expenses' places the cost in Trading Account, while 'Indirect Expenses' places it in Profit & Loss Account.
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint content={noteText} filename="topic4_study_note.txt" />
        </section>
