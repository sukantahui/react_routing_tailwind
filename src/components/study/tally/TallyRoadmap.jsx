...
export default class TallyRoadmap extends Component {
  constructor(props) {
    ...
    // Load stored progress for Tally
    const stored = JSON.parse(localStorage.getItem("tally_progress") || "{}");
  ...
  toggleComplete = (moduleId) => {
    this.setState((prev) => {
      ...
      localStorage.setItem("tally_progress", JSON.stringify(updated));
