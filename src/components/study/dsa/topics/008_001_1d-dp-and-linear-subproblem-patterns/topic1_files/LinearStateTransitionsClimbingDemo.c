 ...
 * Mentor: Sukanta Hui
 * Topic: Linear State Transitions: Climbing Stairs, Fibonacci, and House Robber (non-adjacent element maximum sum)
...
// Core demonstration for: Linear State Transitions: Climbing Stairs, Fibonacci, and House Robber (non-adjacent element maximum sum)
void executeTopicDemo(void) {
    printf("Executing: Linear State Transitions: Climbing Stairs, Fibonacci, and Ho\n");
