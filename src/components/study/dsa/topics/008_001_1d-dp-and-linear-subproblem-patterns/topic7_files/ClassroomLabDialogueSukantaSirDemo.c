 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Outer Loop Ordering (Combinations vs Permutations) in Unbounded Knapsack
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Outer Loop Ordering (Combinations vs Permutations) in Unbounded Knapsack
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Outer Loop Ordering (\n");
