 ...
 * Mentor: Sukanta Hui
 * Topic: Kruskal's Algorithm: Edge sorting, greedy selection, and cycle avoidance backed by DSU in O(E log E)
...
// Core demonstration for: Kruskal's Algorithm: Edge sorting, greedy selection, and cycle avoidance backed by DSU in O(E log E)
void executeTopicDemo(void) {
    printf("Executing: Kruskal's Algorithm: Edge sorting, greedy selection, and cyc\n");
