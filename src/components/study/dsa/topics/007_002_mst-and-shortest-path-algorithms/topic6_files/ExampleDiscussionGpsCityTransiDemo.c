 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: GPS City Transit Navigation & Route Optimization with Live Road Weights
...
// Core demonstration for: Example & Discussion: GPS City Transit Navigation & Route Optimization with Live Road Weights
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: GPS City Transit Navigation & Route Op\n");
