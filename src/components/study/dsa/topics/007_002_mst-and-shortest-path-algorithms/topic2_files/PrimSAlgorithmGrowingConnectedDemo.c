 ...
 * Mentor: Sukanta Hui
 * Topic: Prim's Algorithm: Growing connected component tree using Min-Heap priority queue in O(E log V)
...
// Core demonstration for: Prim's Algorithm: Growing connected component tree using Min-Heap priority queue in O(E log V)
void executeTopicDemo(void) {
    printf("Executing: Prim's Algorithm: Growing connected component tree using Min\n");
