 ...
 * Mentor: Sukanta Hui
 * Topic: Dijkstra's Algorithm: Greedy relaxation property `dist[v] = min(dist[v], dist[u] + weight)`, priority queue optimization
...
// Core demonstration for: Dijkstra's Algorithm: Greedy relaxation property `dist[v] = min(dist[v], dist[u] + weight)`, priority queue optimization
void executeTopicDemo(void) {
    printf("Executing: Dijkstra's Algorithm: Greedy relaxation property `dist[v] = \n");
