 ...
 * Mentor: Sukanta Hui
 * Topic: Counting Sort Mechanics: Frequency array counting, prefix sum position mapping, and stable backward placement
...
// Core demonstration for: Counting Sort Mechanics: Frequency array counting, prefix sum position mapping, and stable backward placement
void executeTopicDemo(void) {
    printf("Executing: Counting Sort Mechanics: Frequency array counting, prefix su\n");
