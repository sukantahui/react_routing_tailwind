const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 3,
    "question": "Why must dynamic memory allocations in \"Tree, Heap & Non-Comparison Linear Sorts: Heap, Counting, Radix & Bucket Sort\" be performed using `sizeof(*ptr)` rather than hardcoded primitive sizes?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Bucket Sort Mechanics: Normalizing floating-point numbers into linked buckets and sorting individual buckets\" actively applied?",
    "options": [
