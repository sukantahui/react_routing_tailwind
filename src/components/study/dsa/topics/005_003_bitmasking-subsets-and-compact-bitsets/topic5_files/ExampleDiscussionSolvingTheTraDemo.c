 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Solving the Traveling Salesperson Problem (TSP) State Space using Bitmask DP in C
...
// Core demonstration for: Example & Discussion: Solving the Traveling Salesperson Problem (TSP) State Space using Bitmask DP in C
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Solving the Traveling Salesperson Prob\n");
