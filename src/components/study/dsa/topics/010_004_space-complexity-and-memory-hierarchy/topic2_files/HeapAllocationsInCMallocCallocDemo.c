 ...
 * Mentor: Sukanta Hui
 * Topic: Heap Allocations in C: malloc, calloc, Memory Overhead, and Fragmentation Cost
...
// Core demonstration for: Heap Allocations in C: malloc, calloc, Memory Overhead, and Fragmentation Cost
void executeTopicDemo(void) {
    printf("Executing: Heap Allocations in C: malloc, calloc, Memory Overhead, and \n");
