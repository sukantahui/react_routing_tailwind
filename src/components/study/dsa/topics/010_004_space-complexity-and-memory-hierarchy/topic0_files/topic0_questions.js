const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Input Space vs Auxiliary Space: In-Place Algorithms vs Extra Buffer Allocations\" actively applied?",
    "options": [
