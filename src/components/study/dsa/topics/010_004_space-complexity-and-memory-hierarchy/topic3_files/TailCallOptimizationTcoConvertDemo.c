 ...
 * Mentor: Sukanta Hui
 * Topic: Tail Call Optimization (TCO) & Converting Deep Recursion to Iteration to Avoid Stack Overflow
...
// Core demonstration for: Tail Call Optimization (TCO) & Converting Deep Recursion to Iteration to Avoid Stack Overflow
void executeTopicDemo(void) {
    printf("Executing: Tail Call Optimization (TCO) & Converting Deep Recursion to \n");
