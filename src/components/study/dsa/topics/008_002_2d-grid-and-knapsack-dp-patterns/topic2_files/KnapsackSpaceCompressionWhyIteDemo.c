 ...
 * Mentor: Sukanta Hui
 * Topic: Knapsack Space Compression: Why iterating right-to-left (`for w = W down to weight[i]`) enables 1D array O(W) space
...
// Core demonstration for: Knapsack Space Compression: Why iterating right-to-left (`for w = W down to weight[i]`) enables 1D array O(W) space
void executeTopicDemo(void) {
    printf("Executing: Knapsack Space Compression: Why iterating right-to-left (`fo\n");
