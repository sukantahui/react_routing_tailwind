 ...
 * Mentor: Sukanta Hui
 * Topic: Target Sum & 0/1 Knapsack Reductions: Reducing algebraic sum/difference problems to Subset Sum
...
// Core demonstration for: Target Sum & 0/1 Knapsack Reductions: Reducing algebraic sum/difference problems to Subset Sum
void executeTopicDemo(void) {
    printf("Executing: Target Sum & 0/1 Knapsack Reductions: Reducing algebraic sum\n");
