 ...
 * Mentor: Sukanta Hui
 * Topic: Subset Sum & Partition Equal Problem: Boolean reachability state transitions and target sum division
...
// Core demonstration for: Subset Sum & Partition Equal Problem: Boolean reachability state transitions and target sum division
void executeTopicDemo(void) {
    printf("Executing: Subset Sum & Partition Equal Problem: Boolean reachability s\n");
