 ...
 * Mentor: Sukanta Hui
 * Topic: Logical vs Arithmetic Shifts: Zero-filling unsigned types vs sign-bit propagation on signed integers
...
// Core demonstration for: Logical vs Arithmetic Shifts: Zero-filling unsigned types vs sign-bit propagation on signed integers
void executeTopicDemo(void) {
    printf("Executing: Logical vs Arithmetic Shifts: Zero-filling unsigned types vs\n");
