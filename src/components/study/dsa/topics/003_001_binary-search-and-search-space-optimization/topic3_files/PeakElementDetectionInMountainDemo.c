 ...
 * Mentor: Sukanta Hui
 * Topic: Peak Element Detection in Mountain Arrays: Binary search on gradients without full array sorting
...
// Core demonstration for: Peak Element Detection in Mountain Arrays: Binary search on gradients without full array sorting
void executeTopicDemo(void) {
    printf("Executing: Peak Element Detection in Mountain Arrays: Binary search on \n");
