 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Why Binary Search on Answer is the Most Common Hard Problem Pattern
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Why Binary Search on Answer is the Most Common Hard Problem Pattern
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Why Binary Search on \n");
