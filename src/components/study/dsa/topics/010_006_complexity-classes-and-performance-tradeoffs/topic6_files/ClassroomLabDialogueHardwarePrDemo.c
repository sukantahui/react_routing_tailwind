 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Hardware Profiling (Valgrind, Cachegrind, gprof) vs Theoretical Big-O Curves
...
// Core demonstration for: Classroom Lab Dialogue: Hardware Profiling (Valgrind, Cachegrind, gprof) vs Theoretical Big-O Curves
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Hardware Profiling (Valgrind, Cacheg\n");
