 ...
 * Mentor: Sukanta Hui
 * Topic: Tractable vs Intractable Problems: Reductions, Verification vs Finding Solutions, and the P vs NP Question
...
// Core demonstration for: Tractable vs Intractable Problems: Reductions, Verification vs Finding Solutions, and the P vs NP Question
void executeTopicDemo(void) {
    printf("Executing: Tractable vs Intractable Problems: Reductions, Verification \n");
