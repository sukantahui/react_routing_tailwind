 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Multi-Pattern Document Scanning using Rabin-Karp Rolling Hashes
...
// Core demonstration for: Example & Discussion: Multi-Pattern Document Scanning using Rabin-Karp Rolling Hashes
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Multi-Pattern Document Scanning using \n");
