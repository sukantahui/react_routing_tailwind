const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 3,
    "question": "Why must dynamic memory allocations in \"Pattern Matching Masterclass: KMP (LPS Table) & Rabin-Karp Rolling Hash\" be performed using `sizeof(*ptr)` rather than hardcoded primitive sizes?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling\" actively applied?",
    "options": [
