 ...
 * Mentor: Sukanta Hui
 * Topic: Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling
...
// Core demonstration for: Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modulo arithmetic, and constant-time window rolling
void executeTopicDemo(void) {
    printf("Executing: Rabin-Karp Rolling Hash Mechanics: Polynomial hashing, modul\n");
