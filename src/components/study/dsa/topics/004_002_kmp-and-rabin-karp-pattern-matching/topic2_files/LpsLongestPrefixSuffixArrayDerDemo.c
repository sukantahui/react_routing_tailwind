 ...
 * Mentor: Sukanta Hui
 * Topic: LPS (Longest Prefix Suffix) Array Derivation: Step-by-step mathematical construction of pi-table in C
...
// Core demonstration for: LPS (Longest Prefix Suffix) Array Derivation: Step-by-step mathematical construction of pi-table in C
void executeTopicDemo(void) {
    printf("Executing: LPS (Longest Prefix Suffix) Array Derivation: Step-by-step m\n");
