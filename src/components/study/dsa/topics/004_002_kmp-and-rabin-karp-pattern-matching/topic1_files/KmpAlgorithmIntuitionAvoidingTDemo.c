 ...
 * Mentor: Sukanta Hui
 * Topic: KMP Algorithm Intuition: Avoiding text pointer regression by utilizing known matching prefix information
...
// Core demonstration for: KMP Algorithm Intuition: Avoiding text pointer regression by utilizing known matching prefix information
void executeTopicDemo(void) {
    printf("Executing: KMP Algorithm Intuition: Avoiding text pointer regression by\n");
