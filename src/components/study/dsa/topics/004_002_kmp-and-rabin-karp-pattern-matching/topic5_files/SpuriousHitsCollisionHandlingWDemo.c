 ...
 * Mentor: Sukanta Hui
 * Topic: Spurious Hits & Collision Handling: Why Rabin-Karp must verify string equality on hash match
...
// Core demonstration for: Spurious Hits & Collision Handling: Why Rabin-Karp must verify string equality on hash match
void executeTopicDemo(void) {
    printf("Executing: Spurious Hits & Collision Handling: Why Rabin-Karp must veri\n");
