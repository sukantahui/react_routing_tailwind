const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Stack ADT Architecture: Array implementation with top index vs dynamic linked list implementation\" actively applied?",
    "options": [
