 ...
 * Mentor: Sukanta Hui
 * Topic: IntroSort (Introspective Sort): Fast Quick Sort switching to Heap Sort at recursion depth 2*log(n)
...
// Core demonstration for: IntroSort (Introspective Sort): Fast Quick Sort switching to Heap Sort at recursion depth 2*log(n)
void executeTopicDemo(void) {
    printf("Executing: IntroSort (Introspective Sort): Fast Quick Sort switching to\n");
