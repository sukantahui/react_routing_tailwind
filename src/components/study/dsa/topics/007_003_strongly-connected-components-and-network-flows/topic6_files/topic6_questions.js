const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Example & Discussion: Identifying Single Points of Failure in Telecommunications Networks in C\" actively applied?",
    "options": [
