 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on the Low-Link Invariant Proof in Tarjan's Algorithm
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on the Low-Link Invariant Proof in Tarjan's Algorithm
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on the Low-Link Invarian\n");
