const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Kosaraju's Two-Pass Algorithm: DFS finishing time stack, graph transposition (reversing all edges), and component discovery\" actively applied?",
    "options": [
