const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Potential Method (Physicist's Method): Defining Potential Energy Functions Φ(Di)\" actively applied?",
    "options": [
