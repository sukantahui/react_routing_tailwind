const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Worst-Case Single-Operation vs Sequence of Operations: The Need for Amortized Analysis\" actively applied?",
    "options": [
