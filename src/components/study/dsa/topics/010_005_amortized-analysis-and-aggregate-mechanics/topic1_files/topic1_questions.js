const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Aggregate Method: Calculating Average Worst-Case Cost across a Sequence of k Operations\" actively applied?",
    "options": [
