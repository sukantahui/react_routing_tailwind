const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Tree Serialization & Deserialization: Encoding binary trees to text streams and reconstructing pointer hierarchies\" actively applied?",
    "options": [
