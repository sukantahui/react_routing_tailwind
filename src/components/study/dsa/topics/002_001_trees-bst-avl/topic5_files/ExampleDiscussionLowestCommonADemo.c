 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Lowest Common Ancestor (LCA) in BST vs General Binary Trees
...
// Core demonstration for: Example & Discussion: Lowest Common Ancestor (LCA) in BST vs General Binary Trees
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Lowest Common Ancestor (LCA) in BST vs\n");
