 ...
 * Mentor: Sukanta Hui
 * Topic: Amortized Inverse Ackermann Bound: Why alpha(n) <= 4 for all practical inputs n <= 10^80
...
// Core demonstration for: Amortized Inverse Ackermann Bound: Why alpha(n) <= 4 for all practical inputs n <= 10^80
void executeTopicDemo(void) {
    printf("Executing: Amortized Inverse Ackermann Bound: Why alpha(n) <= 4 for all\n");
