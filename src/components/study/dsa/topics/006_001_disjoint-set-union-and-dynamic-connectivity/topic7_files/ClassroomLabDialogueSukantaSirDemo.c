 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Path Compression Recursion Stack vs Iterative Two-Pass DSU
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Path Compression Recursion Stack vs Iterative Two-Pass DSU
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Path Compression Recu\n");
