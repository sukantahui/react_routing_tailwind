 ...
 * Mentor: Sukanta Hui
 * Topic: Path Compression Optimization: Flattening tree structure during Find operations to root
...
// Core demonstration for: Path Compression Optimization: Flattening tree structure during Find operations to root
void executeTopicDemo(void) {
    printf("Executing: Path Compression Optimization: Flattening tree structure dur\n");
