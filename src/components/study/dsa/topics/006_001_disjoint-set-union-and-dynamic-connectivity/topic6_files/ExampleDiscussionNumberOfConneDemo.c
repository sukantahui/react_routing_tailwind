 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Number of Connected Components in an Incremental Grid (Island counting in C)
...
// Core demonstration for: Example & Discussion: Number of Connected Components in an Incremental Grid (Island counting in C)
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Number of Connected Components in an I\n");
