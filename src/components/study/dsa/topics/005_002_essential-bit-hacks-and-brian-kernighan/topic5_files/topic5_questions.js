const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 3,
    "question": "Why must dynamic memory allocations in \"Essential Bit Hacks: Brian Kernighan, Power-of-Two & Lowest Set Bit\" be performed using `sizeof(*ptr)` rather than hardcoded primitive sizes?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"GCC Built-in Intrinsics: `__builtin_popcount`, `__builtin_clz` (count leading zeros), `__builtin_ctz` (count trailing zeros)\" actively applied?",
    "options": [
