const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Dutch National Flag 3-Way Partitioning: Low, Mid, and High pointer array sorting in single pass O(n)\" actively applied?",
    "options": [
