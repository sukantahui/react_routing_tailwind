const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"3-Sum & 4-Sum Generalization: Sorting, duplicate skipping mechanics, and avoiding hash set memory allocations\" actively applied?",
    "options": [
