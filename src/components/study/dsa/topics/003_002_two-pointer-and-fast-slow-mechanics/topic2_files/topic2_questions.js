const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Container with Most Water: Proof of correctness for moving the shorter boundary pointer\" actively applied?",
    "options": [
