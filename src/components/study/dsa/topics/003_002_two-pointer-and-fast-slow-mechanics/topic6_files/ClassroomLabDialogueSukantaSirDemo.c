 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Why Two Pointers Saves Heap Allocations in Embedded C
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Why Two Pointers Saves Heap Allocations in Embedded C
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Why Two Pointers Save\n");
