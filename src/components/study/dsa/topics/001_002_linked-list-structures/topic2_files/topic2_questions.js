const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Floyd's Cycle-Finding Algorithm: Mathematical proof of cycle detection, loop start node location, and loop removal\" actively applied?",
    "options": [
