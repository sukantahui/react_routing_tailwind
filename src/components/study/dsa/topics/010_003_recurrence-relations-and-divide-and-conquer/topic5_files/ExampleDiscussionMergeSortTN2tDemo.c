 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Merge Sort (T(n) = 2T(n/2) + O(n)) vs Binary Search (T(n) = T(n/2) + O(1)) Tree Breakdown
...
// Core demonstration for: Example & Discussion: Merge Sort (T(n) = 2T(n/2) + O(n)) vs Binary Search (T(n) = T(n/2) + O(1)) Tree Breakdown
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Merge Sort (T(n) = 2T(n/2) + O(n)) vs \n");
