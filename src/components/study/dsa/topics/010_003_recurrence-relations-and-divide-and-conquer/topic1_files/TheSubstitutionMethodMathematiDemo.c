 ...
 * Mentor: Sukanta Hui
 * Topic: The Substitution Method (Mathematical Induction) for Guessing and Verifying Bounds
...
// Core demonstration for: The Substitution Method (Mathematical Induction) for Guessing and Verifying Bounds
void executeTopicDemo(void) {
    printf("Executing: The Substitution Method (Mathematical Induction) for Guessin\n");
