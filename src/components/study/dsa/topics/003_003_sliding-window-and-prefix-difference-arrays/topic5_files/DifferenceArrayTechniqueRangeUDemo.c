 ...
 * Mentor: Sukanta Hui
 * Topic: Difference Array Technique: Range updates diff[L] += val, diff[R+1] -= val followed by prefix sum reconstruction
...
// Core demonstration for: Difference Array Technique: Range updates diff[L] += val, diff[R+1] -= val followed by prefix sum reconstruction
void executeTopicDemo(void) {
    printf("Executing: Difference Array Technique: Range updates diff[L] += val, di\n");
