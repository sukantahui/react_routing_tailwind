 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Sliding Window vs Prefix Sum Decision Framework
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Sliding Window vs Prefix Sum Decision Framework
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Sliding Window vs Pre\n");
