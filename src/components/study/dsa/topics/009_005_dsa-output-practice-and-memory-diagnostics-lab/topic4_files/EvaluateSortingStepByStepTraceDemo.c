 ...
 * Mentor: Sukanta Hui
 * Topic: Evaluate Sorting Step-by-Step Traces, Pivot Selection States, and Partition Array Snapshots
...
// Core demonstration for: Evaluate Sorting Step-by-Step Traces, Pivot Selection States, and Partition Array Snapshots
void executeTopicDemo(void) {
    printf("Executing: Evaluate Sorting Step-by-Step Traces, Pivot Selection States\n");
