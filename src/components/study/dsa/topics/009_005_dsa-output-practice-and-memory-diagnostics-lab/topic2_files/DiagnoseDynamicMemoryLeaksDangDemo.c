 ...
 * Mentor: Sukanta Hui
 * Topic: Diagnose Dynamic Memory Leaks, Dangling Pointers, Uninitialized Heap Read, and Double-Free Bugs
...
// Core demonstration for: Diagnose Dynamic Memory Leaks, Dangling Pointers, Uninitialized Heap Read, and Double-Free Bugs
void executeTopicDemo(void) {
    printf("Executing: Diagnose Dynamic Memory Leaks, Dangling Pointers, Uninitiali\n");
