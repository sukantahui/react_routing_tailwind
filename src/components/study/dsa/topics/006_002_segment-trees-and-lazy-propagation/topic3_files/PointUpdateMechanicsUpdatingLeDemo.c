 ...
 * Mentor: Sukanta Hui
 * Topic: Point Update Mechanics: Updating leaf node and propagating changes up the ancestor path in O(log n)
...
// Core demonstration for: Point Update Mechanics: Updating leaf node and propagating changes up the ancestor path in O(log n)
void executeTopicDemo(void) {
    printf("Executing: Point Update Mechanics: Updating leaf node and propagating c\n");
