 ...
 * Mentor: Sukanta Hui
 * Topic: Classroom Lab Dialogue: Sukanta Sir on Why Lazy Propagation is Mandatory for Range Interval Updates
...
// Core demonstration for: Classroom Lab Dialogue: Sukanta Sir on Why Lazy Propagation is Mandatory for Range Interval Updates
void executeTopicDemo(void) {
    printf("Executing: Classroom Lab Dialogue: Sukanta Sir on Why Lazy Propagation \n");
