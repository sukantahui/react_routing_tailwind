const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 3,
    "question": "Why must dynamic memory allocations in \"Segment Trees & Lazy Propagation: Range Minimum/Sum Queries & Range Updates\" be performed using `sizeof(*ptr)` rather than hardcoded primitive sizes?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Lazy Propagation Pushdown: Applying pending updates before querying child subtrees to guarantee correctness\" actively applied?",
    "options": [
