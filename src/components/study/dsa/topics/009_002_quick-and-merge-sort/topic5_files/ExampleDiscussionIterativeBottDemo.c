 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Iterative Bottom-Up Merge Sort without Recursion
...
// Core demonstration for: Example & Discussion: Iterative Bottom-Up Merge Sort without Recursion
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Iterative Bottom-Up Merge Sort without\n");
