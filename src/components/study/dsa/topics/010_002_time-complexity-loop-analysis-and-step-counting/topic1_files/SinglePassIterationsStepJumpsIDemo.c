 ...
 * Mentor: Sukanta Hui
 * Topic: Single-Pass Iterations: Step Jumps (i += 1, i += k, i *= 2, i /= 2) and Logarithmic Convergence
...
// Core demonstration for: Single-Pass Iterations: Step Jumps (i += 1, i += k, i *= 2, i /= 2) and Logarithmic Convergence
void executeTopicDemo(void) {
    printf("Executing: Single-Pass Iterations: Step Jumps (i += 1, i += k, i *= 2, \n");
