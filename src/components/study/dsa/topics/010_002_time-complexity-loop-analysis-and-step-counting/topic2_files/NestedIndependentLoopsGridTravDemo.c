 ...
 * Mentor: Sukanta Hui
 * Topic: Nested Independent Loops: Grid Traversals, Matrix Operations & Row-Major vs Column-Major Cache Discussion
...
// Core demonstration for: Nested Independent Loops: Grid Traversals, Matrix Operations & Row-Major vs Column-Major Cache Discussion
void executeTopicDemo(void) {
    printf("Executing: Nested Independent Loops: Grid Traversals, Matrix Operations\n");
