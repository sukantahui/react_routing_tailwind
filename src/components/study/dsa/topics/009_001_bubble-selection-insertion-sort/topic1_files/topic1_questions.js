const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 3,
    "question": "Why must dynamic memory allocations in \"Elementary Comparison Sorts: Bubble, Selection & Insertion Sort\" be performed using `sizeof(*ptr)` rather than hardcoded primitive sizes?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Selection Sort Mechanics: Finding minimum element in unsorted subarray, minimal O(n) swaps, and instability proof\" actively applied?",
    "options": [
