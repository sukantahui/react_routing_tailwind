const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Sorting Stability & Memory Classification: Preserving relative order of duplicate keys in structs\" actively applied?",
    "options": [
