 ...
 * Mentor: Sukanta Hui
 * Topic: Big-Omega (Ω) Lower Bound & Big-Theta (Θ) Tight Bound Analysis with Formal Invariants
...
// Core demonstration for: Big-Omega (Ω) Lower Bound & Big-Theta (Θ) Tight Bound Analysis with Formal Invariants
void executeTopicDemo(void) {
    printf("Executing: Big-Omega (Ω) Lower Bound & Big-Theta (Θ) Tight Bound Analys\n");
