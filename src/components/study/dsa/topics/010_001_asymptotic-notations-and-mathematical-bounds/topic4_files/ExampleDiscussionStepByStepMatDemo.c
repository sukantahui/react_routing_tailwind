 ...
 * Mentor: Sukanta Hui
 * Topic: Example & Discussion: Step-by-Step Mathematical Proof for Polynomial Growth (3n^2 + 5n + 12 = O(n^2) vs O(n))
...
// Core demonstration for: Example & Discussion: Step-by-Step Mathematical Proof for Polynomial Growth (3n^2 + 5n + 12 = O(n^2) vs O(n))
void executeTopicDemo(void) {
    printf("Executing: Example & Discussion: Step-by-Step Mathematical Proof for Po\n");
