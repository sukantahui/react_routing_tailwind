 ...
 * Mentor: Sukanta Hui
 * Topic: Matrix Chain Multiplication (MCM): Optimal parenthesization to minimize scalar matrix multiplications
...
// Core demonstration for: Matrix Chain Multiplication (MCM): Optimal parenthesization to minimize scalar matrix multiplications
void executeTopicDemo(void) {
    printf("Executing: Matrix Chain Multiplication (MCM): Optimal parenthesization \n");
