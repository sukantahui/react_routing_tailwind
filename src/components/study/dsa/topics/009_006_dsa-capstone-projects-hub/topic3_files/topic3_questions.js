const questions = [
  {
    "id": 1,
    "question": "What is the primary physical memory allocation pattern utilized in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 2,
    "question": "In \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\", what is the exact consequence of dereferencing a NULL or uninitialized pointer?",
    "options": [
  ...
  {
    "id": 4,
    "question": "How does CPU Spatial Locality impact the execution time of algorithms in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 5,
    "question": "What is the risk of Struct Padding and Byte Alignment when creating custom node structures for \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 6,
    "question": "What is the core algorithmic invariant that must be maintained throughout \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 7,
    "question": "In \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\", what is the primary state transition or recursion step?",
    "options": [
  ...
  {
    "id": 8,
    "question": "When executing pointer updates in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\", why is update ordering critical?",
    "options": [
  ...
  {
    "id": 9,
    "question": "How does in-place algorithm execution compare to auxiliary buffer allocation in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 10,
    "question": "What role do sentinel nodes (dummy heads/tails) play in simplifying pointer logic in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 11,
    "question": "What critical edge case must always be checked first when implementing \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 12,
    "question": "What is a 'Dangling Pointer' bug in the context of \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 15,
    "question": "What happens if a recursive function in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\" lacks a proper base termination condition?",
    "options": [
  ...
  {
    "id": 16,
    "question": "What is the optimal Asymptotic Time Complexity targeted in \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 17,
    "question": "What is the difference between 'Auxiliary Space Complexity' and 'Total Space Complexity' for \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\"?",
    "options": [
  ...
  {
    "id": 21,
    "question": "In the Barrackpore Lab dialogue for \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\", what key insight does Sukanta Sir emphasize regarding pointer ownership?",
    "options": [
  ...
  {
    "id": 22,
    "question": "Which compiler flag in GCC/Clang should always be enabled during development of \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\" to detect memory leaks and boundary violations at runtime?",
    "options": [
  ...
  {
    "id": 23,
    "question": "In real-world enterprise infrastructure (e.g. Linux Kernel, Redis, PostgreSQL), where is \"Modular C Architecture: Separation of Concerns with .h Header Files and Clean Encapsulation\" actively applied?",
    "options": [
