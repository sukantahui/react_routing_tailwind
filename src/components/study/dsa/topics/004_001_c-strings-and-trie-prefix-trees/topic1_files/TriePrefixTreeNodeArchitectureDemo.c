 ...
 * Mentor: Sukanta Hui
 * Topic: Trie (Prefix Tree) Node Architecture: Struct layout with 26 child pointers and isEndOfWord flag
...
// Core demonstration for: Trie (Prefix Tree) Node Architecture: Struct layout with 26 child pointers and isEndOfWord flag
void executeTopicDemo(void) {
    printf("Executing: Trie (Prefix Tree) Node Architecture: Struct layout with 26 \n");
