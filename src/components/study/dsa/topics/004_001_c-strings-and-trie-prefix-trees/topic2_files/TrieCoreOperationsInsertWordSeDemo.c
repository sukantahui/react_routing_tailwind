 ...
 * Mentor: Sukanta Hui
 * Topic: Trie Core Operations: Insert word, Search word, and StartsWith prefix matching in O(Length) time
...
// Core demonstration for: Trie Core Operations: Insert word, Search word, and StartsWith prefix matching in O(Length) time
void executeTopicDemo(void) {
    printf("Executing: Trie Core Operations: Insert word, Search word, and StartsWi\n");
