      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎙️ Macro Recording: Relative vs Absolute"} · Topic 2
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Code Recording & Refactoring"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Recording macros: Relative vs Absolute recording modes and examining generated code"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering the Macro Recorder: understanding Absolute vs Relative reference modes, examining generated code in VBE, and stripping recorded boilerplate bloat"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Macro Recording: Developer &gt; Record Macro (MacroName, Shortcut, Store in This Workbook) | Toggle: Use Relative References"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Absolute Recording Mode (Default)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Hardcodes exact cell coordinates (`Range(\"B4\").Select`). Running the macro always modifies cell B4 regardless of where the active cursor is placed."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Relative References Mode"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Records actions relative to the active cell (`ActiveCell.Offset(1, 0).Select`). Essential for repeating row-by-row data formatting down a list."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Code Refactoring Paradigm"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Recorder generates 10 lines of code for 1 simple action. Professional developers inspect recorded code and compress it into single-line direct object assignments."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Macro Recorder Translation Engine: User Actions -> Code Translator -> Clean Refactored VBA"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Code Recording & Refactoring"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Recording_macros__"
            title={"Recording macros: Relative vs Absolute recording modes and examining generated code - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Automating Daily Sales Header Formatting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Records a relative macro applying navy headers, bold text, and currency formatting across variable-length regional data tables."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Purchase Register Column Cleanup Macro"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Records and refactors a macro deleting unused tax columns and applying custom date formatting."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Shift Log Reformatting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Relative Recording mode to apply alternating row shading and border outlines on shopfloor inspection logs."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill Staging Area Data Extractor"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Records table extraction steps and refactors generated code for sub-second execution."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Place <code className="text-cyan-300 font-mono font-bold">Option Explicit</code> at the top and declare variables with explicit types <code className="text-cyan-300 font-mono font-bold">{"Macro Recording: Developer &gt; Record Macro (MacroName, Shortcut, Store in This Workbook) | Toggle: Use Relative References"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Absolute Mode When Relative Mode is Needed"}</td>
                  <td className="py-3 px-4">{"Recording a row formatting macro in Absolute mode causes it to repeatedly overwrite row 2 instead of moving down the table."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Click 'Use Relative References' on Developer tab before recording row-by-row actions."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Recording Unnecessary Mouse Clicks & Scrolling"}</td>
                  <td className="py-3 px-4">{"Every mouse scroll and accidental cell click gets recorded as a slow `.Select` line in VBA."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Plan keystrokes carefully before recording, and delete extraneous lines in the editor."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Naming Macro with Illegal Characters or Spaces"}</td>
                  <td className="py-3 px-4">{"Naming a macro `Monthly Sales Format` throws 'Invalid procedure name'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use camelCase or underscores: `Monthly_Sales_Format` (no spaces allowed)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Use Relative References"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Toggles relative offset recording mode on/off."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Developer > Use Relative References"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Macro Name Rules"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees valid procedure identifiers."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Letters, numbers, underscores only (No spaces)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Refactor Recorded Code"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Accelerates macro execution by 10x to 50x."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Replace .Select with direct assignment"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the difference in VBA code generated between Absolute Recording and Relative Recording mode?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does recorded VBA code contain so many redundant `.Select` and `.Activate` statements?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do professional VBA developers use the Macro Recorder as a syntax discovery tool rather than production code?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Recording macros: Relative vs Absolute recording modes and examining generated code - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Use the Macro Recorder like a dictionary! If you forget the VBA syntax for autofilter or pivot tables, turn on the recorder, do the action, copy the generated code, and delete the `.Select` statements."}
          />
        </div>
      </div>
    </div>
