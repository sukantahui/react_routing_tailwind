      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"💬 Interactive User Dialogs: MsgBox & InputBox"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"User Experience & Modal Dialogs"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Working with MsgBox and InputBox for user interaction"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Designing interactive user experiences in VBA: configuring MsgBox buttons (vbYesNo, vbCritical, vbInformation), capturing user decisions, and utilizing Application.InputBox for range selections"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"User Interaction: MsgBox(Prompt, [Buttons], [Title]) | InputBox(Prompt, [Title], [Default]) | Application.InputBox(..., Type:=8 for Range)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. MsgBox Button Configurations & Return Codes"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines button types and icons (`vbYesNo + vbQuestion`, `vbOKOnly + vbInformation`, `vbRetryCancel + vbCritical`) and evaluates response (`If res = vbYes Then ...`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. VBA InputBox vs Application.InputBox"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"VBA `InputBox` returns plain text. `Application.InputBox` supports strict data type enforcement using the `Type` parameter (e.g. `Type:=1` for Numbers, `Type:=8` for clickable Range selection)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Handling User Cancellation Gracefully"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Always check if user clicked 'Cancel' or closed dialog without entering data (`If strInput = \"\" Then Exit Sub`)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"VBA User Interaction Flow: Prompt -> Modal Dialog -> Return Code Evaluation -> Conditional Action"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"User Experience & Modal Dialogs"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_12)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic12_Working_with_MsgBo"
            title={"Working with MsgBox and InputBox for user interaction - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Critical Year-End Reset Confirmation Prompt"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Prompts CFO with `res = MsgBox(\"Are you sure you want to lock and finalize FY 2026-27 accounts?\", vbYesNo + vbQuestion + vbDefaultButton2, \"Confirm Year-End Lock\")`."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Clickable Range Selection with Application.InputBox"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Prompts tax auditors to click and select their invoice range on screen: `Set rng = Application.InputBox(\"Select Invoice Range:\", Type:=8)`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shift Operator Target Input"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Prompts machine operators for daily target tonnage with numeric validation (`Type:=1`)."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Trip Dispatch Status Confirmation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays trip dispatch completion summaries with informational icons."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Place <code className="text-cyan-300 font-mono font-bold">Option Explicit</code> at the top and declare variables with explicit types <code className="text-cyan-300 font-mono font-bold">{"User Interaction: MsgBox(Prompt, [Buttons], [Title]) | InputBox(Prompt, [Title], [Default]) | Application.InputBox(..., Type:=8 for Range)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Crashing on Application.InputBox Type:=8 Cancel"}</td>
                  <td className="py-3 px-4">{"User clicking 'Cancel' on a Range InputBox throws runtime error 424 'Object required'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap in `On Error Resume Next: Set rng = Application.InputBox(..., Type:=8): On Error GoTo 0: If rng Is Nothing Then Exit Sub`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Setting vbDefaultButton to 'Yes' on Dangerous Actions"}</td>
                  <td className="py-3 px-4">{"Defaulting to 'Yes' on a destructive delete action means an accidental press of Enter deletes all data."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Set default button to No: `vbYesNo + vbDefaultButton2`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Parentheses When Capturing Return Value"}</td>
                  <td className="py-3 px-4">{"Writing `res = MsgBox \"Text\"` without parentheses throws a compile error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"When assigning to a variable, use parentheses: `res = MsgBox(\"Text\", vbYesNo)`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Range InputBox (Type:=8)"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Allows user to click and drag a range directly on the worksheet."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Application.InputBox(\"Select:\", Type:=8)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Safe Confirmation"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Forces user to actively think before confirming dangerous actions."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"vbYesNo + vbQuestion + vbDefaultButton2"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"MsgBox Syntax Rule"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"`MsgBox \"Hi\"` vs `res = MsgBox(\"Hi\", vbYesNo)`."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Use parentheses ONLY when capturing result"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is `Application.InputBox(..., Type:=8)` vastly superior to standard VBA `InputBox` for selecting worksheet ranges?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should you use `vbDefaultButton2` on destructive confirmation dialogs?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you gracefully handle an end-user clicking 'Cancel' on a range input box?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Working with MsgBox and InputBox for user interaction - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Use `Application.InputBox(\"Select your table:\", Type:=8)` when you want the user to pick a range on their sheet. They can click and highlight cells with their mouse, and VBA gets the exact Range object."}
          />
        </div>
      </div>
    </div>
