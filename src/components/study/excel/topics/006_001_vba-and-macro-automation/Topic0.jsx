      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🤖 Introduction to VBA & Excel Automation"} · Topic 0
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Introduction to Visual Basic for Applications (VBA) and Excel Automation"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding Visual Basic for Applications (VBA) automation architecture: procedural programming paradigms, COM object automation, eliminating manual repetitive tasks, and executing code"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"VBA Execution Pipeline: User Trigger (Button/Key) -> VBA Interpreter Engine -> COM Automation Layer -> Excel Objects"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Procedural Automation Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"VBA executes code step-by-step from top to bottom, manipulating cells, sheets, charts, and files 1,000x faster than human manual interaction."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. COM Object Model Interoperability"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Communicates directly with Excel's internal Component Object Model (COM), accessing application settings, workbooks, windows, and system memory."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Cross-Application Automation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Enables controlling external Microsoft Office applications (Outlook, Word, PowerPoint, Access) and the Windows operating system directly from Excel."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"VBA Automation Architecture: User Event Trigger -> VBA Interpreter -> Excel Object Hierarchy"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Automation Architecture & Fundamentals"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Introduction_to_Vi"
            title={"Introduction to Visual Basic for Applications (VBA) and Excel Automation - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Automating 50 Monthly Branch Report Consolidations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces 16 hours of manual copy-pasting with a 4-second VBA macro consolidating 50 regional financial workbooks."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Automated GST Invoice Data Cleansing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Develops a VBA routine that strips whitespace, reformats HSN codes, and recalculates tax differentials in 1 click."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Daily Shopfloor Shift Report Generation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates daily morning factory production summaries and auto-formats summary matrices."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Automated Carrier Freight Rate Audit"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a VBA batch processing macro verifying 10,000 shipment invoices against contracted fuel tariffs."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Place <code className="text-cyan-300 font-mono font-bold">Option Explicit</code> at the top and declare variables with explicit types <code className="text-cyan-300 font-mono font-bold">{"VBA Execution Pipeline: User Trigger (Button/Key) -> VBA Interpreter Engine -> COM Automation Layer -> Excel Objects"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Saving Macro Workbooks as Plain .xlsx (Fatal Code Loss)"}</td>
                  <td className="py-3 px-4">{"Saving a workbook with VBA code as standard `.xlsx` strips and permanently DESTROYS all written macros."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always save macro-enabled workbooks as Excel Macro-Enabled Workbook (`.xlsm`) or Binary Workbook (`.xlsb`)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Relying on Recorded Code Without Cleanup"}</td>
                  <td className="py-3 px-4">{"Macro recorder generates bloated, slow `.Select` and `.Activate` statements for every mouse movement."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Refactor code to manipulate objects directly (`Range(\"A1\").Value = 100` instead of `Range(\"A1\").Select: Selection.Value = 100`)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Infinite Loop Freezing Excel"}</td>
                  <td className="py-3 px-4">{"Writing a `Do While` loop with no incrementing condition freezes Excel permanently."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always include loop counters and press Ctrl + Break (or Esc) to halt runaway macros."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Save as .XLSM"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory file format to preserve VBA code."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"File &gt; Save As > Excel Macro-Enabled Workbook (*.xlsm)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Open VBA Editor"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly launches the Visual Basic Editor environment."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + F11"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Run Macro Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Executes the active sub procedure."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"F5 (in VBE) or Alt + F8 (in Excel)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does saving a macro-enabled workbook as `.xlsx` permanently destroy all your VBA code?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should you eliminate `.Select` and `.Activate` statements from recorded macro code?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does VBA communicate with Excel's internal COM Object Model to automate tasks?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Introduction to Visual Basic for Applications (VBA) and Excel Automation - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Welcome to the superpower of Excel: VBA! Once you learn to automate your spreadsheets, you can do in 5 seconds what takes other people 5 days. Always save your files as `.xlsm`!"}
          />
        </div>
      </div>
    </div>
