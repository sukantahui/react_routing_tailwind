      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⚙️ Sub Procedures vs User-Defined Functions (UDFs)"} · Topic 9
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Authoring Sub procedures (action-oriented macros) versus custom User-Defined Functions (UDFs) callable directly inside worksheet cells like native Excel formulas"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"User-Defined Function: Function CalculateTax(Income As Double, Slab As String) As Double ... CalculateTax = Result ... End Function"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Sub Procedures (Perform Actions)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Executes procedural actions (formatting cells, creating sheets, exporting PDFs). Cannot be called inside worksheet formula cells (`=MySub()`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. User-Defined Functions (Return Values)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates and returns a single value or dynamic array. Can be typed directly into worksheet cells like native formulas (`=CalculateGST(A2, \"Tier1\")`)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. UDF Purity Sandbox Rules"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Worksheet UDFs CANNOT modify worksheet structure, change formatting, or insert new sheets; they can ONLY compute and return values."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Sub Procedures (Actions) vs User-Defined Functions (Calculations in Cells)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Custom Worksheet Functions"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_9)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Custom Indian Progressive Income Tax UDF"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors `=CALCULATE_INCOME_TAX(TaxableIncome, \"NewRegime\")` used by 500 payroll accountants across corporate subsidiaries."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Automated GSTIN Checksum Validation UDF"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds `=IS_VALID_GSTIN(TextCell)` validating 15-character statutory GST identification numbers using the Mod-36 checksum algorithm."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Alloy Steel Heat Conversion UDF"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Creates custom engineering formula `=STEEL_TENSILE_STRENGTH(CarbonPct, TempC)` for shopfloor metallurgists."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Dynamic Volumetric Freight Weight UDF"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds `=CALC_VOLUMETRIC_WEIGHT(Length, Width, Height)` for freight tariff billing."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Place <code className="text-cyan-300 font-mono font-bold">Option Explicit</code> at the top and declare variables with explicit types <code className="text-cyan-300 font-mono font-bold">{"User-Defined Function: Function CalculateTax(Income As Double, Slab As String) As Double ... CalculateTax = Result ... End Function"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Attempting to Format Cells Inside a UDF"}</td>
                  <td className="py-3 px-4">{"Writing `Range(\"A1\").Interior.Color = vbGreen` inside a worksheet UDF causes the function to fail and return `#VALUE!`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"UDFs called from cells can ONLY calculate and return values; use Sub procedures for formatting."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting to Assign the Return Value to the Function Name"}</td>
                  <td className="py-3 px-4">{"In VBA, functions return values by assigning to the function name (`CalculateTax = dblTax`); forgetting this causes function to return 0."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Assign the final result to the Function Name: `FunctionName = Result`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Application.Volatile on Timestamp UDFs"}</td>
                  <td className="py-3 px-4">{"Custom UDF not recalculating when other cells change."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Add `Application.Volatile True` at the top of the function if it must recalculate on every worksheet change."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Assign to Function Name"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory VBA syntax to return the result of a UDF."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"MyFunction = CalculatedValue"}</kbd>
            </div>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Document Arguments"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Enforces strict type safety on inputs and return values."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Function MyFunc(Val As Double) As Double"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the fundamental functional difference between a Sub procedure and a User-Defined Function (UDF)?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does attempting to format a cell or insert a sheet inside a worksheet UDF trigger a `#VALUE!` error?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you assign the final return value inside a VBA custom function?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Writing Sub procedures and custom User-Defined Functions (UDFs) callable in worksheet cells - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Custom functions (UDFs) are amazing. You can write `=CALCULATE_GST(A2, 18)` and use it across your entire spreadsheet just like `=VLOOKUP()`. Always put your UDF in a Standard Module!"}
          />
        </div>
      </div>
    </div>
