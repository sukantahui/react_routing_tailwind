    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏛️ The Excel Object Model Hierarchy"} · Topic 5
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Object-Oriented Excel Manipulation"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering the Excel Object Model hierarchy: Application, Workbooks, Worksheets, Range, and Cells: fully qualified references, active vs explicit objects, and parent-child encapsulation"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Hierarchical Encapsulation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Every Excel element is an Object living inside a parent container. `Application.Workbooks(\"Master.xlsx\").Worksheets(\"Sheet1\").Range(\"A1\")`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Danger of Unqualified References"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Writing `Range(\"A1\").Value = 5` modifies whichever sheet happens to be active when the macro runs. If the user clicked another tab, it corrupts that tab!"}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Fully Qualified Object Referencing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Always qualify sheet references explicitly (`ws.Range(\"A1\")`) or use `With...End With` blocks to guarantee absolute targeting regardless of user focus."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Object-Oriented Excel Manipulation"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_5)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Cross-Workbook Financial Transfer"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs fully qualified object transfers copying balance sheet metrics from closed acquisition workbooks to central model tabs."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Multi-Sheet Audit Ledger Automation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Explicitly targets `ThisWorkbook.Worksheets(\"Audit_Register\")` to prevent accidental overwrites of raw client ledger tabs."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shift Telemetry Object Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Packages worksheet references into scoped object variables for high-speed batch cell updates."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Dispatch Data Model Routing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Manages source and destination worksheet objects across regional logistics workbooks."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unqualified ActiveSheet Overwrite Bug (Fatal Data Corruption)"}</td>
                  <td className="py-3 px-4">{"Running a macro that uses `Range(\"A1\").ClearContents` while looking at the wrong worksheet clears critical master formulas."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Never use naked Range references; always qualify with explicit worksheet: `wsTarget.Range(\"A1\").ClearContents`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing ThisWorkbook with ActiveWorkbook"}</td>
                  <td className="py-3 px-4">{"`ActiveWorkbook` is whichever file currently has user focus; `ThisWorkbook` is the workbook containing the running VBA code."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `ThisWorkbook` when referencing the code's host file."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hardcoding Sheet Tab Names That Users Might Rename"}</td>
                  <td className="py-3 px-4">{"Using `Sheets(\"Sales Data\")` crashes with 'Subscript out of range' if user renames the tab to 'Sales_Data'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use Sheet CodeNames (e.g. `Sheet1.Range(...)`) which remain immutable even if the tab name changes."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Use With Blocks"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Clean, fast, and fully qualified object manipulation."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"With wsSource ... .Range(\"A1\").Value = 10 ... End With"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Use Sheet CodeNames"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Bulletproof referencing that never breaks when users rename worksheet tabs."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Sheet1.Range(\"A1\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"ThisWorkbook vs ActiveWorkbook"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees reliable code execution regardless of active window focus."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"ThisWorkbook = Code Host File"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is writing naked `Range(\"A1\").Value = 100` dangerous in corporate multi-sheet workbooks?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the fundamental difference between `ThisWorkbook` and `ActiveWorkbook`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why do professional developers use Sheet CodeNames (e.g. `Sheet1`) rather than tab strings (e.g. `Sheets(\"Report\")`)?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never write naked `Range(\"A1\")` in your code! If the user clicks on another tab while your macro is running, it will overwrite the wrong sheet. Always write `ws.Range(\"A1\")` or use `With ws ... .Range(\"A1\") ... End With`."}
          />
        </div>
      </div>
    </div>
