      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 1-Click Automated Report Generator & Formatter Capstone"} · Topic 13
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Production Automation Capstone"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Real-world project: Building an automated one-click workbook report generator and formatter"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive end-to-end production capstone: architecting an institutional One-Click Automated Workbook Report Generator and Formatter synthesizing range manipulation, high-speed arrays, error handling, and PDF export"}. Master the complete VBA language architecture, object model hierarchy, dynamic range operations, loops, performance switches, and defensive error handling.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Automated Report Engine: Clear Staging -> Ingest Multi-Sheet Data -> Calculate Metrics -> Apply Formatting -> Export PDF & Email"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. End-to-End Modular Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Integrates 5 modular subroutines: `InitSpeed`, `ConsolidateData`, `ApplyFinancialCalculations`, `FormatExecutiveDeck`, and `RestoreAndNotify`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. High-Speed Memory Execution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Processes 50,000 transaction records, builds executive summary scorecards, applies custom conditional formatting, and exports a pixel-perfect PDF in under 3 seconds."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Enterprise Fault Tolerance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Equipped with comprehensive error trapping, automatic recovery, and user-friendly status updates."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Enterprise Automated Report Generator Pipeline: Raw Data Consolidation -> Calculation Engine -> C-Suite Formatted Deck"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod15_13" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod15_13" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_13)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Production Automation Capstone"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod15_13)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title={"Real-world project: Building an automated one-click workbook report generator and formatter - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Executive Sales Pack Generator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a 1-click corporate report generator consolidating 12 branch sales registers into an executive presentation deck and PDF briefing."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly P&L Statement Consolidation Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates monthly factory ledger aggregation, EBITDA calculations, and variance formatting in 1 click."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Daily Plant Production Audit Suite"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates automated shift yield summaries and quality defect audit tables for factory management."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Nationwide Freight Manifest Consolidator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates carrier delivery manifest consolidation and billing verification across regional hubs."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Place <code className="text-cyan-300 font-mono font-bold">Option Explicit</code> at the top and declare variables with explicit types <code className="text-cyan-300 font-mono font-bold">{"Automated Report Engine: Clear Staging -> Ingest Multi-Sheet Data -> Calculate Metrics -> Apply Formatting -> Export PDF & Email"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Monolithic 500-Line Single Macro (Anti-Pattern)"}</td>
                  <td className="py-3 px-4">{"Writing a single giant unmaintainable 500-line Sub procedure."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Decompose into clean, modular single-responsibility Sub procedures called from a Master Controller macro."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hardcoding File Paths or Sheet Indices"}</td>
                  <td className="py-3 px-4">{"Hardcoded paths like `C:\\Users\\swadeep\\` breaking on other team members' laptops."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use relative paths: `ThisWorkbook.Path & \"\\Reports\\\"`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unprotected Master Template Overwrites"}</td>
                  <td className="py-3 px-4">{"Macro overwriting the master template file instead of saving a timestamped copy."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Save generated output as a new timestamped workbook: `\"Report_\" & Format(Now, \"yyyymmdd_hhnn\") & \".xlsx\"`."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"The standard software engineering pattern for enterprise VBA."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Master Controller calling Sub procedures"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Timestamped Output"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents accidental file overwriting on shared network drives."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format(Now, \"yyyymmdd_hhnnss\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Attach to Ribbon Button"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Delivers an intuitive 1-click software experience for end-users."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Assign Macro to custom button shape"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is breaking a complex macro into small, modular Sub procedures vastly superior to writing one giant monolithic script?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should corporate automation macros always use `ThisWorkbook.Path` rather than hardcoded local drive paths?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does assigning a macro to a sleek rounded button transform a standard spreadsheet into a custom enterprise software application?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the procedural execution mechanics and object model architecture.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Real-world project: Building an automated one-click workbook report generator and formatter - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Congratulations on mastering VBA and Macro Automation! You now command the ultimate automation engine inside Microsoft Excel. You can build 1-click enterprise software, eliminate weeks of manual work, and deliver tremendous value to any organization."}
          />
        </div>
      </div>
    </div>
