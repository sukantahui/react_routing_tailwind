      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔍 Sorting & Value Filters"} · Topic 7
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Filtering & Sifting Intelligence"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Sorting and filtering Pivot Tables: Top 10 filters, Label filters, and Value filters"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Applying precision filtering protocols: Top 10 rankings, threshold Value Filters, text Label Filters, and multi-key custom sorting"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Filter Types: Report Filters | Label Filters (Text) | Value Filters (Top 10 / Thresholds) | Wildcard Filters"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Label Filters (Qualitative Text Rules)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters row/column categories based on string patterns: Equals, Begins With, Contains, or Wildcards (`*`, `?`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Value Filters (Quantitative Threshold Rules)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters categories based on aggregated metric values (e.g. show only Branches where `Sum of Revenue > ₹5,00,000`)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Top 10 Filter Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Dynamically isolates top or bottom N items, top X percent, or top sum threshold based on any active value measure."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Pivot Filter Hierarchy: Global Page Filters -> Label Filters -> Top 10 Value Filters"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_7" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_7" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_7)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Filtering & Sifting Intelligence"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_7)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic7_Sorting_and_filter"
            title={"Sorting and filtering Pivot Tables: Top 10 filters, Label filters, and Value filters - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Top 10 Borrowing Clients Leaderboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies Top 10 Value Filter on Customer Name by Sum of Loan Outstanding to focus risk committee oversight."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: High-Value Transaction Threshold Filter"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters vendor ledger to show only vendors with total annual billings exceeding ₹50 Lakhs for statutory reporting."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Top Defect Categories Pareto Filter"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters manufacturing defect reasons by Top 80% Sum of Scrap Weight to drive Six Sigma quality initiatives."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Critical Delay Route Label Filter"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters dispatch routes using Label Filter: 'Contains Express' and Value Filter: 'Average Delay > 4 Hours'."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Label Filter vs Value Filter Mutual Exclusion"}</td>
                  <td className="py-3 px-4">{"Applying a Value Filter clears your active Label Filter because Excel defaults to one filter per field."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"PivotTable Options > Totals & Filters > Check 'Allow multiple filters per field'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Static Top 10 Visual Misconception"}</td>
                  <td className="py-3 px-4">{"Thinking Top 10 filters are static; Top 10 dynamically recalculates when slicers or page filters change."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Understand that Top 10 is dynamic and adapts to slicer selections automatically."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Sorting by Label Instead of Value"}</td>
                  <td className="py-3 px-4">{"Sorting a PivotTable alphabetically when management expects descending ranking by revenue."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Click row header dropdown > More Sort Options > Descending by Sum of Revenue."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Allow Multiple Filters"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Enables applying both text Label and numeric Value filters simultaneously."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Pivot Options > Totals & Filters > Check Allow multiple filters"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Top 10 Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly create dynamic top performer leaderboards."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Row Dropdown > Value Filters > Top 10"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Custom Sort by Value"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly ranks rows in descending revenue order."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click value cell > Sort > Sort Largest to Smallest"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How do you configure a PivotTable to allow both a text Label Filter and a numeric Value Filter on the same field?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does a 'Top 10' filter adapt dynamically when you click a Slicer?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you filter a PivotTable to display only customers who account for the top 80% of total revenue?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Sorting and filtering Pivot Tables: Top 10 filters, Label filters, and Value filters - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"To apply both a Label filter ('Begins with BKP') and a Value filter ('Revenue &gt; 10 Lakhs') on the same field, go to PivotTable Options -> Totals & Filters -> check 'Allow multiple filters per field'."}
          />
        </div>
      </div>
    </div>
