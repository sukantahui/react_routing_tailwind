      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📈 Pivot Charts & Dual-Axis Combo"} · Topic 10
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Designing Pivot Charts: Column, Bar, Line, and Combo pivot charts"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building dynamic Pivot Charts synchronized with PivotTable data caches, mastering Clustered Column, Stacked Bar, Line trends, and Dual-Axis Combo charts"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"PivotChart Engine: Clustered Column | Stacked Bar | Line with Markers | Dual-Axis Combo Pivot Chart"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Bi-Directional Synchronization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pivot Charts are intrinsically bound to their underlying PivotTable. Slicing, filtering, or drilling down in the chart immediately updates the table and vice versa."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dual-Axis Combo Pivot Charts"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines high-magnitude volume bars (Primary Axis: Revenue) with low-magnitude percentage lines (Secondary Axis: Gross Margin %) on a single canvas."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Field Button De-Cluttering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Hiding intrusive grey PivotChart field buttons creates publication-grade executive visualizations."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Pivot Chart Sync Pipeline: In-Memory Cache -> Pivot Table Matrix -> Dynamic Chart Canvas"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_10" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_10" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_10)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Dynamic Visual Analytics"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_10)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic10_Designing_Pivot_Ch"
            title={"Designing Pivot Charts: Column, Bar, Line, and Combo pivot charts - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Executive Revenue & Margin Dual-Axis Combo"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Designs a boardroom-ready combo chart showing monthly revenue bars on the primary axis and EBIT margin % line on the secondary axis."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Regional Vendor Compliance Distribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds 100% Stacked Bar pivot charts illustrating tax compliance status proportions across supplier tiers."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Production Line Scrap Defect Pareto Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Plots scrap defect quantities as descending columns with cumulative percentage curve on secondary axis."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Tonnage & Turnaround Trendlines"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors monthly freight tonnage volume against average delivery turnaround time."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Cluttered Grey Field Buttons"}</td>
                  <td className="py-3 px-4">{"Default PivotCharts display ugly grey dropdown buttons that clutter executive presentation slides."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"PivotChart Analyze > Field Buttons > Click 'Hide All' to create clean, professional charts."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Secondary Axis Scale Distortion"}</td>
                  <td className="py-3 px-4">{"Failing to set secondary axis bounds causes 20% margin lines to look identical to 80% margins."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Format Secondary Axis > Minimum: 0.0, Maximum: 1.0 (or appropriate fixed bound)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unsupported Pivot Chart Types"}</td>
                  <td className="py-3 px-4">{"Excel does not support Scatter (XY), Bubble, Treemap, or Waterfall charts directly as native PivotCharts."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Copy pivot data using GETPIVOTDATA or formulas to a secondary range to build advanced chart types."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Hide All Field Buttons"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The #1 visual enhancement for institutional-grade executive charts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"PivotChart Analyze > Field Buttons > Hide All"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dual-Axis Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Plots percentages on secondary axis alongside currency bars."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Change Chart Type > Combo > Secondary Axis Checkbox"}</kbd>
            </div>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Links chart title to a dynamic cell displaying active slicer selections."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Select Title > Type =CellReference"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must you hide field buttons on PivotCharts before presenting to executive leadership?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do dual-axis combo charts solve the problem of comparing 10-million-dollar revenues with 15% margin percentages?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why are certain chart types like Scatter and Treemap unavailable as native PivotCharts?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Designing Pivot Charts: Column, Bar, Line, and Combo pivot charts - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The first thing every professional modeler does after creating a PivotChart: Go to PivotChart Analyze -> Field Buttons -> click 'Hide All'. It instantly transforms amateur charts into boardroom graphics."}
          />
        </div>
      </div>
    </div>
