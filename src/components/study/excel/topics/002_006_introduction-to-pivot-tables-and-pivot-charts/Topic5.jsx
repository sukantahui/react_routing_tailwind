      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📅 Date & Numeric Grouping"} · Topic 5
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Grouping & Dimensional Binning"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Creating dynamic multi-tier date groupings (Years, Quarters, Months), numeric histogram bins (e.g. 0-10k, 10k-20k), and custom qualitative groupings in PivotTables"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Group By: Years, Quarters, Months (Dates) | Starting At, Ending At, By (Numeric Bins) | Custom Text Selection"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Automated Date Hierarchy Grouping"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Right-clicking any date cell and choosing 'Group' allows selecting multiple temporal intervals simultaneously (Years, Quarters, Months, Days)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Numeric Binning (Histograms)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Groups continuous numeric ranges (e.g. Invoices $0 to $100,000) into discrete equal-width brackets (Starting at 0, Ending at 100000, By 10000)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Manual Text Selection Grouping"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Select multiple arbitrary text categories (e.g. 'Barrackpore', 'Shyamnagar', 'Ichapur') and group them into custom sales territories ('North 24 Parganas Cluster')."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Grouping & Dimensional Binning"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_5)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Multi-Year Quarterly Seasonality Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Groups 5 years of daily transactions into Years and Quarters to analyze seasonal working capital demand."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Credit Risk Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Loan Size Distribution Histogram"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Bins loan balances into ₹10 Lakh increments (0-10L, 10-20L, 20-30L...) to evaluate lending portfolio distribution."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Maintenance Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machinery Breakdown Age Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Groups equipment runtime days into 30-day wear-and-tear buckets for preventive overhaul planning."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Custom Regional Territory Clustering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Groups individual pin-code delivery depots into unified Northern, Central, and Coastal distribution clusters."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"'Cannot Group That Selection' Error"}</td>
                  <td className="py-3 px-4">{"If the date column contains even a single blank cell, text date string ('27-Aug'), or invalid format, date grouping fails completely."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Filter source column for blank cells and text strings; ensure 100% pure serial dates."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Group Hierarchy Propagating Across All Pivot Tables"}</td>
                  <td className="py-3 px-4">{"Grouping dates in one PivotTable automatically groups the same date field across all other PivotTables sharing that Pivot Cache."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Uncheck sharing or create independent Data Model pivots if isolated grouping is required."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Uneven Numeric Bracket Bounds"}</td>
                  <td className="py-3 px-4">{"Choosing poor bin intervals creates misleading histogram distributions."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Align numeric bin widths with corporate credit or operational bracket standards."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Multi-Select Date Tiers"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Select multiple date tiers simultaneously in the Grouping modal dialog."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Click Years, Quarters, Months"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Ungroup Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quickly restores raw daily date serials."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click > Ungroup (Alt + H + G + U)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What single data defect causes the fatal 'Cannot group that selection' error in PivotTables?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How can you group daily dates into Years, Quarters, and Months all at the same time?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does numeric grouping allow you to build frequency distribution histograms in seconds?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Grouping data in Pivot Tables: Grouping dates (Years, Quarters, Months), Numbers, and Text - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"If Excel tells you 'Cannot group that selection', do not panic! It means you have a blank cell or text date in your source data. Find the blank, fill it in, and grouping will work instantly."}
          />
        </div>
      </div>
    </div>
