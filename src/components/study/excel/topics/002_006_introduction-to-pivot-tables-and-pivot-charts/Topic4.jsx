      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📊 Show Values As (% & Running Totals)"} · Topic 4
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Analytical Value Transformation"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Transforming raw numeric measures into powerful analytical insights: percentage contributions, running cumulative totals, and period-over-period variance tracking"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Show Values As: % of Grand Total | % of Column Total | % of Parent Row | Running Total In | Difference From"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Percentage Contributions (% of Grand / Column / Row Total)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes proportional distribution across the whole dataset (% of Grand Total) or within vertical/horizontal categories (% of Column / Row Total)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Running Total In (Cumulative Curves)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates progressive cumulative sums across date or milestone dimensions, essential for year-to-date (YTD) tracking."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Difference From / % Difference From (Variance Tracking)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes absolute or percentage variance compared to a specified baseline category (e.g. Previous Month or Budget)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Show Values As Calculation Engine: Base Aggregation to Relative Metric Matrix"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Analytical Value Transformation"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_4)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Regional Revenue Market Share Contribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays regional branch revenue as '% of Grand Total' to identify revenue concentration risk across Bengal branches."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Month-over-Month Revenue Growth Variance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures monthly revenue with 'Show Values As > % Difference From > (Previous)' to display MoM growth percentages."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Production Controller"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Cumulative Annual Output Tracking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies 'Running Total In > Month' to track cumulative steel manufacturing output against annual production targets."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Logistics Controller"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Cost Distribution by Zone"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates shipping costs as '% of Parent Row Total' to evaluate route expense allocations."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"#N/A in First Period of Difference From"}</td>
                  <td className="py-3 px-4">{"Comparing against '(previous)' item creates a #N/A in the first row because no prior period exists."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"This is mathematically expected; hide or annotate the first period row."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing % of Column Total with % of Parent Row"}</td>
                  <td className="py-3 px-4">{"In multi-level nested hierarchies, % of Column Total evaluates against the overall total rather than the subcategory total."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use '% of Parent Row Total' and select the specific parent grouping field."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overwriting Original Measure"}</td>
                  <td className="py-3 px-4">{"Changing a field to '% of Total' hides the original dollar amount."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Drag the same field into the Values quadrant TWICE: display one as raw Sum and the second as '% of Total'."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dual Value Columns"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Display raw currency alongside percentage contribution side-by-side."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Drag field into Values twice"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Instant Show Values As"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quick context menu access to all 15 relative calculation modes."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click > Show Values As"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"YTD Cumulative Sum"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Builds a smooth cumulative revenue trajectory without complex formulas."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Show Values As > Running Total In > Date"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How do you display both the raw sales amount and the percentage of total sales in the same PivotTable?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What base item should you select in 'Difference From' to calculate Month-over-Month growth?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the difference between '% of Column Total' and '% of Parent Row Total' in nested hierarchies?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Showing values as: % of Grand Total, % of Column/Row, Difference From, Running Total - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
