      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⏱️ Interactive Timelines"} · Topic 9
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Temporal Dashboard Intelligence"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Time-series filtering with Timelines"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Implementing interactive Timeline slicers to filter time-series data dynamically across Years, Quarters, Months, and Days with visual range sliders"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Timeline Component: Year | Quarter | Month | Day Sliding Granularity Window"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Dedicated Date-Field Filtering Component"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Timelines recognize true date serial fields and render continuous horizontal timeline sliders with interactive drag handles."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dynamic Granularity Switching"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Users can switch temporal zoom levels instantly between Years, Quarters, Months, and Days via a simple header dropdown."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Continuous Date Range Scrubbing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Drag edge handles to expand or contract historical observation windows (e.g. Q2 2025 through Q3 2026) across connected pivot reports."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Timeline Slider Architecture: Time-Series Windowing Across Hierarchical Granularities"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Temporal Dashboard Intelligence"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_9)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic9_Time_series_filter"
            title={"Time-series filtering with Timelines - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Rolling Multi-Quarter Financial Performance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses an interactive Timeline slider to scrub through rolling 18-month revenue trends during executive committee reviews."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Fiscal Year Audit Period Selection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters multi-year transactional ledgers down to specific quarterly statutory filing periods in a single click."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Maintenance Controller"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machinery Downtime Incident Timeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Analyzes equipment breakdown frequencies during specific monsoon months using monthly timeline zooming."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Fleet Logistics Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Peak Holiday Freight Shipping Window"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Scrubs daily timeline windows during festive season rush periods to analyze transport bottleneck trends."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Timeline Disabled ('No Valid Date Fields')"}</td>
                  <td className="py-3 px-4">{"If the source column contains text dates or blank cells, Excel refuses to insert a Timeline."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure source date column contains 100% pure serial dates without blank cells."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Non-Contiguous Date Selection Limitation"}</td>
                  <td className="py-3 px-4">{"Timelines only support continuous date ranges; you cannot select Jan 2025 and Mar 2025 while excluding Feb."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use a standard Slicer with a 'Month' grouping field for non-contiguous date filtering."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Theme Styling Inconsistency"}</td>
                  <td className="py-3 px-4">{"Default bright blue timeline clashes with dark corporate dashboard color schemes."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Apply matching custom Timeline styles from the Timeline ribbon tab."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Insert Timeline Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quickly insert a time-series slider on any date field."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"PivotTable Analyze > Insert Timeline (Alt + J + T + T)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Switch Granularity"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly adjust analytical zoom from macro-years to micro-days."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Timeline dropdown: Years / Quarters / Months"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Synchronize Across Pivots"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Link the timeline to update all time-series charts across the dashboard."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click Timeline > Report Connections"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does inserting a Timeline fail if your date column contains even one blank cell?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"When should you use a Timeline versus a standard Slicer for date filtering?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do Timelines handle date filtering across multi-year fiscal periods?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Time-series filtering with Timelines - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Timelines provide the most intuitive UI for historical analysis. Always pair a Timeline (for continuous periods) with categorical Slicers (for regions and products) on executive dashboards."}
          />
        </div>
      </div>
    </div>
