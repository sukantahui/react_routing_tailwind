    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔄 Data Refresh & Source Range"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Lifecycle & Data Source Management"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Managing the complete PivotTable data lifecycle: refreshing caches, updating data sources, automating background refresh, and troubleshooting stale cache errors"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Manual & Automated Refresh Protocols"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Alt + F5 refreshes the active pivot; Ctrl + Alt + F5 refreshes all connections. PivotTable Options allow configuring 'Refresh data when opening the file'."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Change Data Source vs Dynamic Tables"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Hardcoded range sources (`Sheet1!$A$1:$G$500`) require manual 'Change Data Source' when rows are added. Excel Tables (`Table1`) expand dynamically upon refresh."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Retaining Deleted Items in Filter Dropdowns"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"By default, deleted historical items linger in pivot filter lists. Solved by setting 'Number of items to retain per field' to None."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Lifecycle & Data Source Management"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_12)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Automated Morning Treasury Liquidity Refresh"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures daily treasury cash-flow pivot models to refresh automatically upon workbook open, pulling latest ERP bank balances."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly GST Ledger Source Expansion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Converts monthly purchase registers to dynamic structured tables to ensure 20,000 newly added invoices are included upon refresh."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Clearing Ghost Scrapped Part Numbers"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Flushes deleted discontinued component part numbers from pivot filter dropdown lists via Data tab options."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Multi-Source External Database Connection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Updates connection string endpoints for SQL server warehouse logistics feeds."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Newly Appended Rows"}</td>
                  <td className="py-3 px-4">{"Source data was defined as a static range ($A$1:$G$500); rows 501-600 are silently ignored on refresh."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Convert source range to an Excel Table (Ctrl + T) or use dynamic named ranges."}</td>
                </tr>
                ...
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"VBA / Macro Refresh Interruption"}</td>
                  <td className="py-3 px-4">{"Running macros while background queries are still refreshing causes race condition data errors."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Disable Background Refresh on queries in Connection Properties before macro execution."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Change Data Source"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Inspect and update the underlying source range or table definition."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"PivotTable Analyze > Change Data Source"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why do newly added rows at the bottom of your data fail to show up in your PivotTable after clicking Refresh?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do you remove old deleted products from lingering in your PivotTable filter dropdowns?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should you set 'Number of items to retain per field' to None in production workbooks?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Refreshing data, updating data sources, and dynamic table references - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Set 'Number of items to retain per field' to NONE in PivotTable Options. This stops deleted obsolete data from haunting your filter dropdowns forever."}
          />
        </div>
      </div>
    </div>
