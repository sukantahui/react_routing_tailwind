      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔢 Value Field Settings & Distinct Count"} · Topic 3
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Configuring Value Field Settings to calculate Sum, Count, Average, Min, Max, and generating Distinct Count aggregations via the Excel Data Model"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Summarize Values By: SUM | COUNT | AVERAGE | MIN | MAX | DISTINCT COUNT (Data Model)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Standard Aggregation Functions"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Summarize numeric fields using SUM (total), AVERAGE (arithmetic mean), MIN (lowest), MAX (highest), and COUNT (transaction volume)."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. The Distinct Count Aggregation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Checking 'Add this data to the Data Model' during pivot creation unlocks 'Distinct Count' in Value Field Settings, counting unique customers without duplicates."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Value Field Aggregation Engine: Standard Summary vs Data Model Distinct Count"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_3)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Aggregation & Metrics"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_3)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Unique Active Customer Counting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates total unique corporate borrowing clients (Distinct Count of AccountID) alongside total disbursed loan volume."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Average Unit Purchase Price Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures Unit Cost as AVERAGE alongside Quantity as SUM to monitor procurement inflation trends."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Extreme Tolerance Range Monitoring"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays MIN and MAX component thickness measurements side-by-side to track manufacturing variance."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Daily Consignment Shipment Volume"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Summarizes total waybills (COUNT) and total gross tonnage (SUM) across regional shipping hubs."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Distinct Count Option"}</td>
                  <td className="py-3 px-4">{"Distinct Count does not appear in standard PivotTables created without the Data Model."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"When inserting the PivotTable, check the box: 'Add this data to the Data Model'."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Averaging an Average (Statistical Distortion)"}</td>
                  <td className="py-3 px-4">{"Averaging pre-aggregated percentage columns in PivotTables produces mathematically incorrect weighted averages."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use Calculated Fields or DAX Measures to calculate true weighted averages: `=Sum(Margin) / Sum(Revenue)`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Value Field Settings Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quickly change aggregation type and currency formatting."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click > Value Field Settings (Alt + H + G)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Unlock Distinct Count"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Enables counting unique items like Customer IDs without duplicates."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Insert Pivot > Check 'Add to Data Model'"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Rename Field Header"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Add a trailing space (e.g. 'Revenue ') if Excel complains that the name already exists."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Type custom name in Value Field Settings"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does formatting PivotTable cells using the Home ribbon break when you refresh the table?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do you count unique customers in a PivotTable with 100,000 transaction rows?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is averaging an existing 'Profit Margin %' column in a PivotTable mathematically wrong?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Value field settings: Sum, Count, Average, Min, Max, and Distinct Count (Data Model) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
