      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📑 Tabular Layouts & Subtotals"} · Topic 11
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Presentation & Structural Formats"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering PivotTable layout architectures: Compact Form, Outline Form, and Tabular Form (with label repetition), subtotals positioning, and blank row insertion"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Report Layouts: Compact Form (Default) | Outline Form | Tabular Form (Flat Grid) | Repeat All Item Labels"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Compact Form (Indented Tree)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Default mode; places all row hierarchy fields in a single column with progressive indentation, saving horizontal space."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Outline Form (Stepped Columns)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Separates each row hierarchy field into its own distinct column while keeping subtotals at the top of each group."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Tabular Form (Relational Flat Grid)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Places each field in its own column with standard table headers. Pairing with 'Repeat All Item Labels' makes pivot output ready for downstream VLOOKUP and formulas."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"PivotTable Layout Modes: Compact (Indented) vs Outline vs Tabular (Database Grid)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_11" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_11" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_11)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Presentation & Structural Formats"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_11)" fill="none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · FP&A Director"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Institutional Boardroom Financial Summary"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formats corporate financial statements in Tabular Form with subtotal headers at the bottom and accounting single/double underlines."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Downstream VLOOKUP Table Export"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures procurement pivots in Tabular Form with 'Repeat All Item Labels' to feed automated downstream tax reconciliation formulas."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shift Handover Operations Ledger"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Outline Form with blank line separators between machine groups for clear shopfloor noticeboard printing."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Dispatch Manifest Route Schedules"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formats carrier route schedules in Tabular Form with subtotals disabled for clean ERP copy-pasting."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Item Labels in Downstream Lookups"}</td>
                  <td className="py-3 px-4">{"Tabular form leaves blank cells below category headers by default, breaking VLOOKUP / XLOOKUP on downstream formulas."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Design tab > Report Layout > Select 'Repeat All Item Labels'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Subtotal Visual Clutter"}</td>
                  <td className="py-3 px-4">{"Having subtotals on every single row level creates a messy, repetitive report."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Design tab > Subtotals > Select 'Do Not Show Subtotals' or toggle specific fields."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Column Width Auto-Reset on Refresh"}</td>
                  <td className="py-3 px-4">{"Refreshing a PivotTable resets manually adjusted column widths back to default."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"PivotTable Options > Format > Uncheck 'Autofit column widths on update'."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Lock Column Widths"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents column widths from jumping and changing on every refresh."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Pivot Options > Uncheck Autofit column widths on update"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is 'Tabular Form + Repeat All Item Labels' essential when using pivot output as a source for other formulas?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do you stop Excel from resizing your carefully formatted column widths every time you click Refresh?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"When is Compact Form preferred over Tabular Form in executive reports?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Formatting and Layout options: Compact, Outline, Tabular forms, and blank rows - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
