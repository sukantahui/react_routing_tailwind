      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 12-Month Sales Dashboard Capstone"} · Topic 13
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive end-to-end commercial capstone project: building a 12-month interactive executive sales performance dashboard with multi-pivot slicers, KPIs, and combo charts"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"12-Month Commercial Sales Performance Dashboard: Slicers + Timelines + Dual-Axis Combo + Tabular Form"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Multi-Perspective Analytical Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines 4 synchronized PivotTables: Executive Summary Scorecard, Monthly Revenue & Margin Trend, Regional Branch Breakdown, and Top 10 Product Leaderboard."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Unified Interactive Slicer Control"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links Master Region, Customer Segment, and Timeline sliders to all 4 pivot reports simultaneously."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Boardroom Design & Palette Standards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies institutional formatting: dark-themed container cards, hidden field buttons, muted financial palettes, and fixed column width locks."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Executive Commercial Sales Dashboard Architecture & Data Pipeline"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_13" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_13" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_13)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Capstone Business Project"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_13)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Annual Commercial Sales Performance Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds and presents an executive 12-month commercial revenue dashboard for ₹150 Crore enterprise operations across Eastern India."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Procurement & Cost Variance Dashboard Pack"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Structures comprehensive supplier expenditure, price inflation trends, and tax credit reconciliation models."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Plant Production Efficiency Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys real-time shift yield, scrap analysis, and machine utilization dashboard suites."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Regional Freight Fleet Intelligence Hub"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors transit turnaround SLAs, fuel surcharges, and regional route profitability."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Inconsistent Color Palette Across Charts"}</td>
                  <td className="py-3 px-4">{"Using random default colors on different charts creates a chaotic, amateurish dashboard."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Enforce a unified 3-color palette (e.g. Navy primary, Emerald accent, Slate neutral) across all charts."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overcrowding the Dashboard Canvas"}</td>
                  <td className="py-3 px-4">{"Squeezing 10 dense tables onto a single screen overwhelms executive decision-makers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Follow the 4-quadrant rule: Top KPIs, Time Trend, Category Breakdown, Top 10 Detail."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Instantly gives your dashboard a sleek, modern software application feel."}</p>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Executive KPI Card Layout"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Create high-impact big-number callouts for Total Revenue, Margin %, and Active Clients."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Single-cell pivot summaries"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Template Master Export"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Preserve the complete dashboard architecture for future fiscal reporting cycles."}</p>
        ...
        >
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do you organize multiple PivotTables and charts on a single dashboard to maximize executive clarity?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the single most important metric hierarchy to follow when designing executive commercial dashboards?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Real-world project: Building a 12-month commercial sales performance pivot report - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Congratulations on mastering Pivot Tables and Pivot Charts! You now possess the power to take 500,000 rows of raw, messy transaction data and transform it into boardroom-ready visual intelligence in minutes."}
          />
        </div>
      </div>
    </div>
