      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Interactive filtering with Slicers and multi-pivot slicer connections"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building interactive executive dashboard interfaces using visual Slicers, configuring multi-pivot report connections, and formatting custom button palettes"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Slicer Architecture: Visual Button Filtering | Multi-Pivot Slicer Connections | Multi-Select (Ctrl / Shift)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Visual Interactive Buttons"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Slicers convert standard hidden filter dropdowns into rich, clickable touch-friendly button panels with real-time state highlighting."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Report Connections Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A single slicer can be connected to multiple PivotTables and PivotCharts across different sheets, driving synchronized dashboard updates."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Multi-Column Layout & Color Styling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Slicers support multi-column grids (e.g. 4-column quarterly buttons) and custom corporate dark/light theme palettes."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Slicer Signal Router: Single Visual Slicer Connected to Multiple PivotTables"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Interactive Dashboard UI"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_8)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic8_Interactive_filter"
            title={"Interactive filtering with Slicers and multi-pivot slicer connections - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Executive C-Suite Commercial Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects 3 master slicers (Year, Business Segment, Region) across 6 synchronized PivotTables to power boardroom presentations."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Interactive Vendor Compliance Explorer"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds interactive GSTIN status slicer cards (Compliant, Pending, Flagged) for rapid vendor audits."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Production Line & Shift Slicer Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys multi-column touchscreen slicers on factory floor tablets to monitor scrap metrics by shift."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Corridor Fleet Slicer Controller"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links vehicle type and corridor slicers to dispatch performance scorecards."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Different Pivot Cache Connection Lockout"}</td>
                  <td className="py-3 px-4">{"Report Connections only shows PivotTables that share the exact same Pivot Cache or Data Model."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Create all dashboard PivotTables from the same source table so they share a unified cache."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Slicer Sizing Distortion on Row Resize"}</td>
                  <td className="py-3 px-4">{"Inserting or expanding rows moves and distorts slicer dimensions."}</td>
                ...
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hiding Items with No Data Glitch"}</td>
                  <td className="py-3 px-4">{"Slicers display inactive grayed-out buttons that clutter executive views."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Slicer Settings > Check 'Hide items with no data'."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Guarantees slicers stay perfectly locked on executive dashboard layouts."}</p>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Multi-Column Slicer"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Converts tall vertical lists into clean horizontal button toolbars."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Slicer tab > Columns: 3 or 4"}</kbd>
            </div>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Link a single slicer to control all PivotTables across the entire workbook."}</p>
        ...
        >
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is 'Don't move or size with cells' essential for professional dashboard UI design?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do multi-column slicers transform tall scrolling lists into compact toolbars?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Interactive filtering with Slicers and multi-pivot slicer connections - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Slicers turn boring spreadsheets into interactive software apps. Always right-click your slicer, choose Size and Properties, and select 'Don't move or size with cells' so your layout stays locked."}
          />
        </div>
      </div>
    </div>
