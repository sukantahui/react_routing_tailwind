      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎛️ 4-Quadrant Field Orchestration"} · Topic 2
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Layout & Quadrant Orchestration"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering the PivotTable Field List interface and orchestrating multi-level hierarchical groupings across Filters, Columns, Rows, and Values"}. Master the complete architecture, field layouts, calculation settings, and interactive executive reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Pivot Quadrants: Filters (Page Slicers) | Columns (X-Axis) | Rows (Y-Axis) | Values (Aggregates)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Rows Quadrant (Vertical Hierarchy)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Creates the primary vertical breakdown. Stacking multiple fields (e.g. Region > Branch > Salesperson) generates expandable drill-down hierarchies."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Columns Quadrant (Horizontal Matrix)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates horizontal cross-tabulation categories (e.g. Fiscal Years or Product Lines) across the top of the grid."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Values Quadrant (Aggregation)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Holds numeric metrics. Adding multiple value fields allows side-by-side comparison of different metrics (e.g. Sum of Revenue and Count of Orders)."}</p>
            </div>
            
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"4. Filters Quadrant (Global Context)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies page-level filtering to isolate specific divisions or years without displaying them on the grid axis."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"PivotTable 4-Quadrant Field Mapping & Drag-and-Drop Architecture"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod6_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod6_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Layout & Quadrant Orchestration"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod6_2)" fill="none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Head of FP&A"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Hierarchical Regional P&L Drilldown"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Places Region, Area, and Branch in Rows with Year in Columns and Revenue in Values for boardroom performance reviews."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Audit Manager"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Vendor Spend Quadrant Structuring"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures Supplier in Rows, Expense Category in Columns, and Invoice Amount in Values to spot spend anomalies."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Operations Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Shift Scrap Cross-Tabulation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Maps Machine Line in Rows, Shift (Morning/Night) in Columns, and Scrap Weight in Values."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Dispatch Volume Priority Matrix"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Structures Delivery Zone in Rows, Service Tier in Columns, and Consignment Weight in Values."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unintended Count Instead of Sum"}</td>
                  <td className="py-3 px-4">{"If a numeric column contains even a single blank cell or text value, Excel defaults to 'Count of Field' instead of 'Sum of Field'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-click value field > Summarize Values By > Sum, and clean source data."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Too Many Fields in Columns Quadrant"}</td>
                  <td className="py-3 px-4">{"Placing high-cardinality fields (like Customer Name) in Columns creates an unusable 500-column horizontal spreadsheet."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Keep Columns for low-cardinality attributes (e.g. Years, Quarters, Statuses)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Disappearing Field List Task Pane"}</td>
                  <td className="py-3 px-4">{"Accidentally closing the PivotTable Field List pane leaves users unable to modify field layouts."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Click inside PivotTable > PivotTable Analyze tab > Click 'Field List' button."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Restore Field List"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quickly toggle the PivotTable Field List task pane on/off."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + J + T + L"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Hierarchical Collapse"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly rolls up all lower-level branch details to high-level regional totals."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click > Expand/Collapse > Collapse Entire Field"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Rearrange Quadrants"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly reorient your analytical perspective."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Drag-and-drop in Field List"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does Excel sometimes default to 'Count of Revenue' instead of 'Sum of Revenue'?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the analytical difference between placing a field in Filters versus Columns?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does stacking multiple fields in the Rows area create drill-down hierarchies?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the multidimensional OLAP mechanics and dashboard interactivity principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Creating Pivot Tables: Fields list, Rows, Columns, Values, and Filters areas - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Keep your Columns quadrant compact! Reserve Columns for categories with 2 to 5 items (like Quarters or Years). Put high-cardinality fields in Rows to keep your reports easy to read."}
          />
        </div>
      </div>
    </div>
