    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧪 Dynamic Range Practice Lab (OFFSET & Coordinate Math)"} · Topic 23
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Dynamic Range Practice Lab"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive hands-on laboratory: engineering robust dynamic range models, rolling multi-period financial metrics, dynamic chart feeds, and coordinate math without formula breakage"}. Master syntax architecture, mathematical order of operations, dynamic spilling, and error-free execution.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Multi-Source Dynamic Window Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Synthesizes OFFSET, INDEX, ROW, and COUNTA into self-expanding financial reporting models."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automated Dynamic Chart Series Feeds"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects dynamic named ranges directly to Excel charts so new transactions auto-plot immediately."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Performance Benchmarking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates model recalculation latency comparing volatile OFFSET models vs non-volatile INDEX models."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowNew_002_005_lookup-functions-vlookup-hlookup-index-match-and-xlookup_23" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowNew_002_005_lookup-functions-vlookup-hlookup-index-match-and-xlookup_23" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowNew_002_005_lookup-functions-vlookup-hlookup-index-match-and-xlookup_23)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Dynamic Range Practice Lab"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowNew_002_005_lookup-functions-vlookup-hlookup-index-match-and-xlookup_23)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Rolling 90-Day Revenue Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a dynamic rolling 90-day executive revenue dashboard updating automatically as daily entries are posted."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Dynamic Multi-Month Tax Liability Window"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs rolling quarterly tax liability trackers with dynamic window ranges."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Live Shift Production Run Monitor"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Models dynamic 24-hour machine yield averages using coordinate formulas."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Dynamic Fleet Dispatch Capacity Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds self-updating dispatch capacity models for 50 delivery trucks."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Spill Clashes in Dynamic Array Combinations"}</td>
                  <td className="py-3 px-4">{"Placing text directly below spilled dynamic range formulas."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Leave sufficient empty cells for array expansion."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Blank Cells Distorting COUNTA in Dynamic Heights"}</td>
                  <td className="py-3 px-4">{"Empty cells in middle of column causing `COUNTA` to underestimate true table height."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure continuous data or use structured table referencing."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Circular References in Dynamic Name Definitions"}</td>
                  <td className="py-3 px-4">{"Named range formula referencing cell that consumes the named range."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Verify strict separation between input data and calculation cells."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Last Number in Column"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Retrieves the very last numerical entry in a column."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=LOOKUP(9.99E+307, Range)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Formula Auditing"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Visually verifies dynamic range boundaries."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + [ (Trace Precedents)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does combining `OFFSET` with `COUNTA` create a self-expanding range that grows as you add rows?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does using structured tables (`tblSales[Revenue]`) often eliminate the need for manual `OFFSET` formulas?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on formula evaluation sequence, dynamic memory bounds, and computational efficiency.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How can you verify that a dynamic named range is selecting the correct cells in Excel's Name Manager?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on formula evaluation sequence, dynamic memory bounds, and computational efficiency.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Practice Lab: Advanced Dynamic Range Modeling with OFFSET, INDEX, and Coordinate Formulas - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Mastering dynamic ranges is what separates junior spreadsheet users from true Excel architects. Practice building both OFFSET and INDEX dynamic ranges, and watch your dashboards update automatically forever!"}
          />
        </div>
      </div>
    </div>
