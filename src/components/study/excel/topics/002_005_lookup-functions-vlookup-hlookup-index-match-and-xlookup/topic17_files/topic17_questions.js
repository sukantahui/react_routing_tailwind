const questions = [
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute VLOOKUP exact match (FALSE / 0) linear scan mechanics (Question 1)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute VLOOKUP approximate match (TRUE / 1) sorted table binary scan (Question 2)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Left-lookup limitation of VLOOKUP and how INDEX-MATCH solves it (Question 3)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Column insertion vulnerability in VLOOKUP vs INDEX-MATCH resilience (Question 4)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute MATCH function exact match (0) vs less-than (1) vs greater-than (-1) (Question 5)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute INDEX function matrix coordinate extraction (Row, Col) (Question 6)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Two-way intersection lookup using Double MATCH in INDEX (Question 7)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Modern XLOOKUP universal 3-argument syntax (key, lookup_arr, return_arr) (Question 8)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP if_not_found parameter eliminating separate IFERROR wrappers (Question 9)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP search_mode 2 (binary search on sorted ascending data) (Question 10)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP match_mode 2 (wildcard search with *, ?) (Question 11)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP match_mode -1 (exact match or next smaller item) (Question 12)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP match_mode 1 (exact match or next larger item) (Question 13)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute XLOOKUP search_mode -1 (search last-to-first from bottom of table) (Question 14)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Multi-criteria lookup using boolean multiplication `(Arr1=Val1)*(Arr2=Val2)` (Question 15)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Cross-sheet lookup syntax `'SheetName'!Range` and sheet rename immunity (Question 16)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Cross-workbook lookup syntax `'[Workbook.xlsx]Sheet'!Range` and closed file caching (Question 17)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Dynamic dependent drop-down data validation using INDIRECT() (Question 18)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Coercing text numbers to pure numbers with double unary (--) in lookups (Question 19)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Cleaning trailing spaces in lookup keys with =TRIM(A1) (Question 20)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Primary key uniqueness and the danger of first-match silent termination (Question 21)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Surrogate key architecture (EMP-1001) vs ambiguous natural names (Question 22)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Composite multi-column keys constructed with concatenation (&) (Question 23)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Handling missing keys gracefully with IFERROR and IFNA (Question 24)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Performance optimization: Binary search O(log n) vs Linear search O(n) (Question 25)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Impact of massive full-column lookups (VLOOKUP(A1, A:Z, 5, 0)) on calculation speed (Question 26)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Structured table referencing in lookups: `tblSales[ColName]` (Question 27)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Formula auditing with F9 sub-expression evaluation and Alt+M+V (Question 28)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute Two-dimensional matrix retrieval from financial budget matrices (Question 29)?",
  ...
  {
    "question": "In the context of XLOOKUP vs VLOOKUP Comprehensive Feature Comparison Matrix, how does Excel evaluate and execute 3-tier financial model architecture: Data, Logic, and Presentation (Question 30)?",
