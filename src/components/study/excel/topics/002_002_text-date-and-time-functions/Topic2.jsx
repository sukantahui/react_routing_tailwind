...
import practicalQuestions from "./topic2_files/topic2_practical_questions";
...
export default function Topic2() {
  ...
  const categories = [
    "All",
    "Basic Concatenation",
    "Delimited Aggregation",
    "Formatted Output",
    "Range Assembly",
    "Advanced Dynamic Joins"
  ];
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                ...
                10 Practical Questions: String Concatenation &amp; Delimited Joining Lab
              </h2>
              <p className="text-xs sm:text-sm text-slate-300 mt-2 max-w-3xl leading-relaxed">
                Strictly practical enterprise problems testing ampersand binding, range concatenation, TEXTJOIN blank handling, multi-line formatting, and conditional array aggregation.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 text-center">
              ...
              <div className="text-[11px] text-slate-400 uppercase tracking-wider mt-0.5">Functions / Ops Tested</div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 text-center">
