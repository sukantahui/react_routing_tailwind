  ...
  "projects": [
    {
      ...
      "sheetName": "EX701",
      "formula": "=TIME(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX701 in range B4:C30. You must write formulas using function **TIME** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX701**.",
    ...
    },
    {
      ...
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX702 in range B4:C30. You must write formulas using function **TIMEVALUE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX702**.",
        "In cell **D4**, write formula using **TIMEVALUE** e.g. `=TIMEVALUE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX702**.\n2. **Type TIMEVALUE**: Enter `=TIMEVALUE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX703",
      "formula": "=HOUR(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX703 in range B4:C30. You must write formulas using function **HOUR** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX703**.",
        "In cell **D4**, write formula using **HOUR** e.g. `=HOUR(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX703**.\n2. **Type HOUR**: Enter `=HOUR(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX704",
      "formula": "=MINUTE(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX704 in range B4:C30. You must write formulas using function **MINUTE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX704**.",
        "In cell **D4**, write formula using **MINUTE** e.g. `=MINUTE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX704**.\n2. **Type MINUTE**: Enter `=MINUTE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX705",
      "formula": "=SECOND(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX705 in range B4:C30. You must write formulas using function **SECOND** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX705**.",
        "In cell **D4**, write formula using **SECOND** e.g. `=SECOND(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX705**.\n2. **Type SECOND**: Enter `=SECOND(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX706",
      "formula": "=EDATE(B4, 6)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX706 in range B4:C30. You must write formulas using function **EDATE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX706**.",
        "In cell **D4**, write formula using **EDATE** e.g. `=EDATE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX706**.\n2. **Type EDATE**: Enter `=EDATE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX707 in range B4:C30. You must write formulas using function **EOMONTH** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX707**.",
        "In cell **D4**, write formula using **EOMONTH** e.g. `=EOMONTH(B4, 0)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX707**.\n2. **Type EOMONTH**: Enter `=EOMONTH(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX708",
      "formula": "=DAYS(C4, B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX708 in range B4:C30. You must write formulas using function **DAYS** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX708**.",
        "In cell **D4**, write formula using **DAYS** e.g. `=DAYS(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX708**.\n2. **Type DAYS**: Enter `=DAYS(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX709",
      "formula": "=DAYS360(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX709 in range B4:C30. You must write formulas using function **DAYS360** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX709**.",
        "In cell **D4**, write formula using **DAYS360** e.g. `=DAYS360(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX709**.\n2. **Type DAYS360**: Enter `=DAYS360(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX710",
      "formula": "=WEEKDAY(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX710 in range B4:C30. You must write formulas using function **WEEKDAY** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX710**.",
        "In cell **D4**, write formula using **WEEKDAY** e.g. `=WEEKDAY(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX710**.\n2. **Type WEEKDAY**: Enter `=WEEKDAY(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX711",
      "formula": "=WEEKNUM(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX711 in range B4:C30. You must write formulas using function **WEEKNUM** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX711**.",
        "In cell **D4**, write formula using **WEEKNUM** e.g. `=WEEKNUM(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX711**.\n2. **Type WEEKNUM**: Enter `=WEEKNUM(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX712 in range B4:C30. You must write formulas using function **ISOWEEKNUM** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX712**.",
        "In cell **D4**, write formula using **ISOWEEKNUM** e.g. `=ISOWEEKNUM(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX712**.\n2. **Type ISOWEEKNUM**: Enter `=ISOWEEKNUM(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX713",
      "formula": "=EXACT(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX713 in range B4:C30. You must write formulas using function **EXACT** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX713**.",
        "In cell **D4**, write formula using **EXACT** e.g. `=EXACT(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX713**.\n2. **Type EXACT**: Enter `=EXACT(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX714",
      "formula": "=CHAR(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX714 in range B4:C30. You must write formulas using function **CHAR** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX714**.",
        "In cell **D4**, write formula using **CHAR** e.g. `=CHAR(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX714**.\n2. **Type CHAR**: Enter `=CHAR(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX715",
      "formula": "=CODE(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX715 in range B4:C30. You must write formulas using function **CODE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX715**.",
        "In cell **D4**, write formula using **CODE** e.g. `=CODE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX715**.\n2. **Type CODE**: Enter `=CODE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX716",
      "formula": "=UNICHAR(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX716 in range B4:C30. You must write formulas using function **UNICHAR** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX716**.",
        "In cell **D4**, write formula using **UNICHAR** e.g. `=UNICHAR(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX716**.\n2. **Type UNICHAR**: Enter `=UNICHAR(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX717",
      "formula": "=UNICODE(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX717 in range B4:C30. You must write formulas using function **UNICODE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX717**.",
        "In cell **D4**, write formula using **UNICODE** e.g. `=UNICODE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX717**.\n2. **Type UNICODE**: Enter `=UNICODE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX718",
      "formula": "=REPT(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX718 in range B4:C30. You must write formulas using function **REPT** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX718**.",
        "In cell **D4**, write formula using **REPT** e.g. `=REPT(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX718**.\n2. **Type REPT**: Enter `=REPT(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX719",
      "formula": "=FIXED(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX719 in range B4:C30. You must write formulas using function **FIXED** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX719**.",
        "In cell **D4**, write formula using **FIXED** e.g. `=FIXED(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX719**.\n2. **Type FIXED**: Enter `=FIXED(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX720",
      "formula": "=DOLLAR(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX720 in range B4:C30. You must write formulas using function **DOLLAR** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX720**.",
        "In cell **D4**, write formula using **DOLLAR** e.g. `=DOLLAR(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX720**.\n2. **Type DOLLAR**: Enter `=DOLLAR(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX721",
      "formula": "=BAHTTEXT(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX721 in range B4:C30. You must write formulas using function **BAHTTEXT** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX721**.",
        "In cell **D4**, write formula using **BAHTTEXT** e.g. `=BAHTTEXT(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX721**.\n2. **Type BAHTTEXT**: Enter `=BAHTTEXT(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX722",
      "formula": "=TIME(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX722 in range B4:C30. You must write formulas using function **TIME** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX722**.",
        "In cell **D4**, write formula using **TIME** e.g. `=TIME(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX722**.\n2. **Type TIME**: Enter `=TIME(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX723",
      "formula": "=TIMEVALUE(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX723 in range B4:C30. You must write formulas using function **TIMEVALUE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX723**.",
        "In cell **D4**, write formula using **TIMEVALUE** e.g. `=TIMEVALUE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX723**.\n2. **Type TIMEVALUE**: Enter `=TIMEVALUE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX724",
      "formula": "=HOUR(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX724 in range B4:C30. You must write formulas using function **HOUR** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX724**.",
        "In cell **D4**, write formula using **HOUR** e.g. `=HOUR(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX724**.\n2. **Type HOUR**: Enter `=HOUR(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
    ...
    },
    {
      ...
      "sheetName": "EX725",
      "formula": "=MINUTE(B4)",
      "description": "As a Senior Systems Analyst, you are processing date-time serials and text payloads on worksheet EX725 in range B4:C30. You must write formulas using function **MINUTE** to calculate elapsed days, extract month-end dates, compute shift hours, convert ASCII/Unicode codes, or generate repeated in-cell bar visualizers.",
      "requirements": [
        "Navigate to tab **EX725**.",
        "In cell **D4**, write formula using **MINUTE** e.g. `=MINUTE(B4)`.",
        "Format date/time serial outputs using custom masks e.g. `dd-mmm-yyyy (dddd)` or `[h]:mm:ss`.",
        "Drag formula down through row 30.",
        "Verify zero date calculation discrepancies."
      ],
      "stepByStep": "1. **Click Cell D4**: Open tab **EX725**.\n2. **Type MINUTE**: Enter `=MINUTE(B4)` and press **Enter**.\n3. **Apply Format**: Press **Ctrl + 1**, select Date or Time custom mask.\n4. **Copy Down**: Double-click fill handle down to D30.\n5. **Audit Verification**: Check calculated date or text string.",
      "rawMemoryVsRendered": {
        "raw": "46200",
        "mask": "Date Serial Mask",
        "rendered": "31-Dec-2026 (Thursday)"
