      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Shift & Overtime Engine: =MOD(Out - In, 1) * 24 | =MAX(0, Hours - 8) * OvertimeRate"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Shift Gross Duration Calculation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates total elapsed shift hours crossing midnight using `=MOD(PunchOut - PunchIn, 1) * 24`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automatic Meal Break Deduction"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies conditional break deductions (e.g. `IF(GrossHours > 5, GrossHours - 0.5, GrossHours)`)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Statutory Overtime Tiering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Separates regular hours (`MIN(8, NetHours)`) from overtime hours (`MAX(0, NetHours - 8)`) to compute double-time wage disbursements."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Employee Shift Calculation Engine: In/Out -> Break Deduction -> Overtime Tiering"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Practical Application Lab"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_12)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic12_Practice__Employee"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Head of Payroll"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Corporate Shift Payroll Disbursement"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a monthly timesheet calculation engine for 1,200 employees with variable day/night rotations and overtime tiers."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statutory Factory Overtime Audit"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Audits manufacturing shift logs to ensure overtime hours comply with maximum statutory weekly limits."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Rotational 3-Shift Roster Management"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks 8-hour shift handovers (Morning, Evening, Night) with automated break deductions."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Transport Coordinator"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics Hub"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Long-Haul Driver Allowance Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates driver transit allowances and rest period compliance across multi-day highway runs."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"Shift & Overtime Engine: =MOD(Out - In, 1) * 24 | =MAX(0, Hours - 8) * OvertimeRate"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Break Subtraction"}</td>
                  <td className="py-3 px-4">{"Failing to deduct mandatory 30-minute unpaid lunch breaks inflates payroll liabilities by 6.25%."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Embed automatic break deduction formulas into gross hour calculations."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overtime Rate Double Multiplier Bug"}</td>
                  <td className="py-3 px-4">{"Applying 1.5x overtime multiplier directly to total hours rather than only hours exceeding 8."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `=(RegularHours * BaseRate) + (OvertimeHours * BaseRate * 1.5)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Decimal vs Clock Minute Confusion"}</td>
                  <td className="py-3 px-4">{"Treating '8.30' as 8 hours 30 minutes in decimal math (0.30 of an hour is 18 minutes, not 30)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always convert time using serial fraction math `* 24` so 8:30 displays as 8.50 decimal hours."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Regular Hours Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Caps standard working shift hours at exactly 8 hours."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=MIN(8, TotalHours)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Overtime Hours Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Isolates only the overtime hours exceeding standard shift threshold."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=MAX(0, TotalHours - 8)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Total Wage Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Standard statutory overtime pay calculation formula."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=(Reg * Rate) + (OT * Rate * 1.5)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must 8 hours and 30 minutes be represented as 8.50 in wage calculation formulas?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do MIN() and MAX() functions eliminate nested IF statements in overtime tier calculations?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you handle weekend overtime where all hours worked are paid at double-rate (2.0x)?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Building an error-free payroll timesheet engine is the ultimate test of Excel time arithmetic. Master MIN, MAX, and MOD to calculate wages with zero discrepancies."}
          />
        </div>
      </div>
    </div>
