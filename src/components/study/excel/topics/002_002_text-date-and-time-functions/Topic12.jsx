...
import practicalQuestions from "./topic12_files/topic12_practical_questions";
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mt-1.5 flex items-center gap-2">
                <span>⚡</span> Employee Shift Duration &amp; Overtime Practical Questions
              </h2>
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Real-world enterprise problems solved with time math, midnight-crossing MOD formulas, break deductions, and tiered overtime engines.
              </p>
            </div>
