...
import practicalQuestions from "./topic9_files/topic9_practical_questions";
...
export default function Topic9() {
  ...
  const categories = [
    ...
    "Positional Masking",
    "Targeted Instance Replacement",
    "Character Frequency Analysis",
    "Data Hygiene & Normalization",
    "Sanitization & Punctuation Stripping",
    "Dynamic Positional Editing",
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mt-1.5 flex items-center gap-2">
                <span>⚡</span> REPLACE and SUBSTITUTE Practical Questions
              </h2>
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Real-world enterprise problems solved with content-based (SUBSTITUTE) and positional (REPLACE) string substitution.
              </p>
            </div>
                    ...
                    <div className="flex items-start sm:items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 font-mono mt-0.5">
                          Function: <span className="text-sky-400 font-semibold">{q.functionUsed}</span>
                        </p>
                      </div>
                    </div>
