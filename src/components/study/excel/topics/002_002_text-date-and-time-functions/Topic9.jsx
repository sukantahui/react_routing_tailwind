      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Content-Matching Substitution (SUBSTITUTE)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Searches for specific character strings (case-sensitive) and replaces all occurrences or a specific instance_num."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Positional Character Replacement (REPLACE)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces a chunk of characters based strictly on start_num index and length count, regardless of what text is inside."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Counting Character Occurrences with LEN"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates the count of a specific character via `=LEN(A2) - LEN(SUBSTITUTE(A2, \",\", \"\"))`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"String Mutation Architecture: Content Matching (SUBSTITUTE) vs Index Replacement (REPLACE)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"String Substitution & Masking"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_9)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic9_Replacing_and_subs"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Security Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Tax ID & Credit Card Privacy Masking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Masks middle credit card digits using =REPLACE(A2, 5, 8, \"-****-****-\") for public dashboard reporting."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Accounting Code Delimiter Normalization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Converts forward slashes to standardized hyphens in invoice codes (=SUBSTITUTE(A2, \"/\", \"-\"))."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Data Analyst"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: CSV Multi-Item Counter"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Counts total items in a comma-delimited string: =LEN(A2) - LEN(SUBSTITUTE(A2, \",\", \"\")) + 1."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Regional Dispatch Prefix Replacement"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Updates legacy branch prefixes across 10,000 shipment codes (=SUBSTITUTE(A2, \"OLD-\", \"BKP-\", 1))."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"=SUBSTITUTE(text, old_text, new_text, [instance_num]) | =REPLACE(old_text, start_num, num_chars, new_text)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"SUBSTITUTE Case-Sensitivity Mismatch"}</td>
                  <td className="py-3 px-4">{"SUBSTITUTE(\"Kolkata\", \"k\", \"X\") fails to replace capital 'K' because SUBSTITUTE is strictly case-sensitive."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure exact case match or nest UPPER()/LOWER() transformations."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"REPLACE Index Boundary Calculation Error"}</td>
                  <td className="py-3 px-4">{"Miscalculating start_num or num_chars replaces the wrong characters without warning."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use FIND() inside REPLACE() to calculate dynamic starting positions."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Accidental Global Overwrite"}</td>
                  <td className="py-3 px-4">{"Omitting the optional instance_num parameter in SUBSTITUTE replaces ALL instances of target string."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Specify instance_num (e.g. 1 or 2) when only a specific occurrence should change."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Count Word / Item Occurrences"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The universal Excel idiom for counting delimited list items."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=LEN(A2) - LEN(SUBSTITUTE(A2, \",\", \"\")) + 1"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Nested Multi-Replacement"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Chains multiple substitutions to strip multiple punctuation characters."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=SUBSTITUTE(SUBSTITUTE(A2, \"(\", \"\"), \")\", \"\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Mask Center Digits"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Fastest way to mask sensitive phone or ID numbers."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=REPLACE(A2, 5, 4, \"****\")"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is =LEN(A1) - LEN(SUBSTITUTE(A1, \",\", \"\")) the standard formula to count commas?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"When should you use REPLACE (positional) over SUBSTITUTE (content-based)?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you replace only the second hyphen in a product serial number?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Understanding the difference between REPLACE (position-based) and SUBSTITUTE (content-based) is a classic interview question. Master both for agile text engineering."}
          />
        </div>
      </div>
    </div>
