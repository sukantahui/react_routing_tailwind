...
import sampleWorkbookUrl from "./excel_files/text_date_and_time_functions_master.xlsx?url";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"=WORKDAY(start_date, days, [holidays]) | =WORKDAY.INTL(start_date, days, [weekend], [holidays]) | =NETWORKDAYS(start_date, end_date, [holidays]) | =NETWORKDAYS.INTL(start_date, end_date, [weekend], [holidays])"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Standard vs Custom Weekend Filtering (.INTL)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"WORKDAY/NETWORKDAYS assume Saturday/Sunday weekends. The .INTL variants allow custom weekend string masks (e.g. \"0000011\" for Fri/Sat or 11 for Sunday-only)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Statutory Holiday Array Exclusion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Accepts an optional range of holiday dates, automatically subtracting holidays that fall on active working business days."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Forward & Backward Project Milestone Shifting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Positive day offsets calculate future delivery deadlines; negative day offsets calculate prerequisite procurement cutoffs."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Commercial Calendar Engine: Weekend Filtering & Statutory Holiday Exclusion"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Working Day & Business Calendar Math"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_5)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic5_Working_day_calcul"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise ERP Go-Live Timeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates 45-working-day project milestones using =WORKDAY.INTL(B2, 45, 1, Holidays!A$2:A$20) excluding national holidays."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly Net Working Days Payroll"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes exact billable working days per employee using =NETWORKDAYS.INTL(MonthStart, MonthEnd, 11, HolidaysRange) for 6-day workweeks."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Procurement Head"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Raw Material Lead-Time Scheduling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Projects factory delivery arrival dates based on 15 working days supplier turnaround time."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight SLA Resolution Metrics"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Audits freight turnaround time by computing elapsed working days between shipment dispatch and delivery."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"=WORKDAY(start_date, days, [holidays]) | =WORKDAY.INTL(start_date, days, [weekend], [holidays]) | =NETWORKDAYS(start_date, end_date, [holidays]) | =NETWORKDAYS.INTL(start_date, end_date, [weekend], [holidays])"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Default Weekend Misalignment in India/Middle East"}</td>
                  <td className="py-3 px-4">{"Standard NETWORKDAYS assumes Sat/Sun off, miscalculating factories operating on 6-day (Sunday-only) workweeks."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use NETWORKDAYS.INTL with weekend code 11 (Sunday only) or custom 7-character string mask."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Holiday Falls on Weekend Double-Counting"}</td>
                  <td className="py-3 px-4">{"Worrying that a holiday falling on a Sunday subtracts 2 days (Excel handles this correctly)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Provide complete holiday lists; Excel automatically avoids double-deducting weekend holidays."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Start Date Exceeds End Date Negative Result"}</td>
                  <td className="py-3 px-4">{"Passing a start_date later than end_date to NETWORKDAYS returns negative day counts."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure chronological order or wrap in ABS() if unsigned duration is needed."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Sunday Only Weekend"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Sets Sunday as the sole weekend day in .INTL functions."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Weekend Code: 11"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Custom Shift Mask"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"1 represents non-working day, 0 represents working day (Mon-Sun)."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"\"0000001\" (7 digits)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dynamic Month Net Days"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates exact working days in any given month."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=NETWORKDAYS(A2, EOMONTH(A2,0), Holidays)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does WORKDAY.INTL interpret the custom weekend string mask \"0000011\"?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is WORKDAY.INTL essential for modeling manufacturing plants with 6-day operations?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What happens if a statutory holiday date in your holiday list falls on a Saturday?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never use simple addition (Date + 30) for contractual deadlines! Statutory contracts require =WORKDAY.INTL with explicit holiday schedules to avoid costly legal disputes."}
          />
        </div>
      </div>
    </div>
