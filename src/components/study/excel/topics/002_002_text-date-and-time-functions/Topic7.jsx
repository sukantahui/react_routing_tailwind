      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⏱️ Time & Timestamp Calculations"} · Topic 7
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Time calculations: TIME, HOUR, MINUTE, SECOND, NOW, and handling elapsed hours (>24h)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Time calculations, fractional day serial math (1 hour = 1/24), clock arithmetic, and elapsed duration formatting"}. Master the complete syntax, formulas, operational mechanics, and enterprise data hygiene protocols.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"=TIME(hour, minute, second) | =HOUR(serial_time) | =MINUTE(serial_time) | =SECOND(serial_time) | =NOW()"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Fractional Day Storage Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Time is stored as a decimal fraction of a 24-hour day (e.g. 06:00 AM = 0.25, 12:00 PM = 0.5, 06:00 PM = 0.75)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Clock Arithmetic & Overnight Shifts"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Subtracting times across midnight (e.g. 10 PM to 6 AM) yields negative fractions. Solved cleanly with `=MOD(End - Start, 1)`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Converting Time Serials to Decimal Hours"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Multiply time serial by 24 to convert to decimal hours for billing (e.g. 01:30 * 24 = 1.50 billable hours)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Time Decimal Serial System: Fractional Math & 24-Hour Modulo Logic"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_7" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_7" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_7)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Time & Duration Math"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_7)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic7_Time_calculations_"
            title={"Time calculations: TIME, HOUR, MINUTE, SECOND, NOW, and handling elapsed hours (>24h) - Interactive Practice Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Payroll Director"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Night-Shift Factory Overtime Payroll"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes overnight shift durations (8 PM to 4 AM) using =MOD(OutTime - InTime, 1) * 24 to calculate overtime pay."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Hospital Operations Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: ICU Doctor Shift Duty Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts hour and minute components to audit doctor duty allocations and emergency room coverage."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Plant Engineer"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Kiln Firing Duration Logs"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes total elapsed furnace heating cycles exceeding 48 hours formatted as [h]:mm."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Driver Trip Manifest Elapsed Hours"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates total transit turnaround time between toll plaza check-in and destination warehouse check-out."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"=TIME(hour, minute, second) | =HOUR(serial_time) | =MINUTE(serial_time) | =SECOND(serial_time) | =NOW()"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overnight Shift Negative Result"}</td>
                  <td className="py-3 px-4">{"Subtracting StartTime (22:00) from EndTime (06:00) yields negative number (-0.667) displaying ######."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `=MOD(EndTime - StartTime, 1)` to handle midnight boundary crossing seamlessly."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Multiplying Time Directly by Wage Rate"}</td>
                  <td className="py-3 px-4">{"Calculating `=TimeCell * HourlyRate` without multiplying by 24 results in 1/24th of the true pay amount."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always multiply by 24: `=(EndTime - StartTime) * 24 * HourlyWage`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"24-Hour Rollover in Sums"}</td>
                  <td className="py-3 px-4">{"Summing 30 hours of work using 'hh:mm' displays as '06:00' due to modulo 24 reset."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Apply custom number format `[h]:mm` to display cumulative hours over 24."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Overnight Shift Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Universal formula for shift durations crossing midnight."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=MOD(End - Start, 1)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Decimal Hours Conversion"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Converts time serial to standard decimal hours for hourly billing."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=(End - Start) * 24"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Current Timestamp Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Inserts static unformatted current clock time."}</p>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does =MOD(EndTime - StartTime, 1) fix overnight time calculations crossing midnight?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What decimal number represents 15 minutes in Excel's serial time system (15 / 1440)?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why does =A1 * 500 return ₹20.83 instead of ₹500 when A1 holds 01:00 hour?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Time calculations: TIME, HOUR, MINUTE, SECOND, NOW, and handling elapsed hours (>24h) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The =MOD(End - Start, 1) trick is one of the most famous and useful formulas in Excel history. Memorize it for all shift, payroll, and timesheet models."}
          />
        </div>
      </div>
    </div>
