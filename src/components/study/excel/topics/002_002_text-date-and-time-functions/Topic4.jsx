      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"=DATE(year, month, day) | =DAY(serial_date) | =MONTH(serial_date) | =YEAR(serial_date) | =TODAY()"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The 1900 Date System"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Excel stores every date as a sequential integer representing the number of days elapsed since January 1, 1900 (e.g. Jan 1, 2026 = 46023)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The DATE() Construction Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"DATE(yyyy, mm, dd) builds foolproof date serials, automatically handling month overflows (e.g. DATE(2026, 13, 1) = Jan 1, 2027)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Dynamic Temporal Clock (TODAY)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"TODAY() returns the volatile current date integer, recalculating automatically whenever the worksheet refreshes."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Date Serial Timeline: Integer Increments & Component Extraction"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Date Serial Architecture"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_4)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic4_Date_serial_number"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Maturity Date Rollover Calculations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates annual bond maturity dates via =DATE(YEAR(A2)+5, MONTH(A2), DAY(A2)) with automatic leap-year resolution."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Financial Year Fiscal Period Tagging"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts month and year components (=MONTH(A2), =YEAR(A2)) to classify corporate tax transactions into Q1-Q4 fiscal buckets."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Maintenance Supervisor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Preventive Overhaul Due Dates"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Projects 90-day equipment service schedules using =DATE(YEAR(B2), MONTH(B2)+3, DAY(B2))."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Vehicle Insurance Expiry Alarms"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes days remaining until policy expiration using =A2 - TODAY() to trigger renewal notices."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"=DATE(year, month, day) | =DAY(serial_date) | =MONTH(serial_date) | =YEAR(serial_date) | =TODAY()"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Text Date Entry Trap"}</td>
                  <td className="py-3 px-4">{"Entering dates as text strings ('27.08.2026') causes date math and sorting to fail."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always construct dates using =DATE(year, month, day) or enter valid system date formats."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"TODAY() Volatility Lag"}</td>
                  <td className="py-3 px-4">{"Overusing TODAY() in 100,000 cells forces continuous worksheet recalculation on every keystroke."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use static timestamps (Ctrl + ;) where fixed transaction dates are required."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 1900 Leap Year Bug"}</td>
                  <td className="py-3 px-4">{"Excel intentionally treats 1900 as a leap year for legacy Lotus 1-2-3 compatibility."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Avoid calculating historical dates prior to March 1, 1900."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Insert Today's Date"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Inserts static unformatted current date timestamp."}</p>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"First Day of Current Month"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly normalizes transactions to month start."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=DATE(YEAR(A2), MONTH(A2), 1)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Last Day of Month"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Using day 0 returns the exact last day of the target month."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=DATE(YEAR(A2), MONTH(A2)+1, 0)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does =DATE(2026, 1, 0) return December 31, 2025?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the mathematical advantage of storing dates as sequential integers?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does the keyboard shortcut Ctrl + ; differ from the formula =TODAY()?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never type dates as text! When building financial models, always construct dates with =DATE(year, month, day) to eliminate regional format bugs between US and UK systems."}
          />
        </div>
      </div>
    </div>
