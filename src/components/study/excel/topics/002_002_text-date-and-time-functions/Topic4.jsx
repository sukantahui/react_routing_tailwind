...
import practicalQuestions from "./topic4_files/topic4_practical_questions";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                ...
                10 Practical Questions: Number &amp; Date Formatting Lab
              </h2>
              <p className="text-xs sm:text-sm text-slate-300 mt-2 max-w-3xl leading-relaxed">
                Strictly practical enterprise problems testing custom number formatting with TEXT, European decimal parsing with NUMBERVALUE, type coercion with VALUE, and zero-padding techniques.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 text-center">
              <div className="text-xl font-bold text-sky-400 font-mono">3</div>
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Number and date formatting with formulas: TEXT, VALUE, and NUMBERVALUE - Frequently Asked Questions"
            questions={questions}
          />
        </div>
