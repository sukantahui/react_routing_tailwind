...
import practicalQuestions from "./topic10_files/topic10_practical_questions";
...
export default function Topic10() {
  ...
  const categories = [
    ...
    "Date Ingestion",
    "Time Ingestion",
    "Unit Extraction & Math",
    "Financial Percentage Coercion",
    "ISO Timestamp Parsing",
    "Financial Accounting Coercion",
    "Error Guardrails",
    "Dynamic Array Coercion"
  ];
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mt-1.5 flex items-center gap-2">
                <span>⚡</span> Text-to-Number Coercion Practical Questions
              </h2>
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Real-world enterprise problems solved with VALUE, NUMBERVALUE, DATEVALUE, and TIMEVALUE conversions.
              </p>
            </div>
