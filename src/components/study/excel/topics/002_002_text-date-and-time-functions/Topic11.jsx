      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Real-world case study: Parsing messy customer names, addresses, and timestamps</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Real-world case study: Parsing messy customer names, addresses, and timestamps - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 11: Real-world case study: Parsing messy customer names, addresses, and timestamps FAQ"
            questions={questions}
          />
        </div>
