      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Undocumented DATEDIF Unit Codes"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"\"Y\" (full years), \"M\" (full months), \"D\" (days), \"YM\" (remaining months excluding years), \"MD\" (remaining days excluding months)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Composite Tenure Construction"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines unit codes to build human-readable tenures: `=DATEDIF(A2, B2, \"Y\") & \" Yrs, \" & DATEDIF(A2, B2, \"YM\") & \" Mos, \" & DATEDIF(A2, B2, \"MD\") & \" Days\"`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Financial Day Count Basis (YEARFRAC)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"YEARFRAC() returns fractional year duration using actual/actual (basis 1), 30/360 (basis 0), or actual/365 (basis 3) for bond interest accruals."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"DATEDIF & YEARFRAC Tenure Computation Pipeline"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod2_6" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod2_6" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_6)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Date Intervals & Tenures"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod2_6)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic6_Date_differences_a"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Corporate Commercial Paper Interest Accrual"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates precise accrued interest on 90-day debentures using =Principal * Rate * YEARFRAC(IssueDate, SettledDate, 3)."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · HR Gratuity Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Employee Service Gratuity Eligibility"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Determines statutory gratuity eligibility (>5 full years) using =DATEDIF(JoiningDate, TODAY(), \"Y\")."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Asset Management Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Heavy Machinery Depreciation Lifecycle"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes fractional operational lifespans to calculate straight-line asset depreciation schedules."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Leasing Controller"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Warehouse Lease Contract Expiry Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks remaining warehouse lease tenures formatted as 'X Years, Y Months remaining'."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the adjacent calculation column, enter the formula <code className="text-cyan-300 font-mono font-bold">{"=DATEDIF(start_date, end_date, unit) | =YEARFRAC(start_date, end_date, [basis])"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"DATEDIF #NUM! on Inverted Dates"}</td>
                  <td className="py-3 px-4">{"Passing a start_date that is later than end_date triggers a #NUM! error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure start_date <= end_date or wrap in IF(Start > End, DATEDIF(End, Start, ...), ...)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'MD' Unit Known Bug"}</td>
                  <td className="py-3 px-4">{"The 'MD' unit in DATEDIF can yield negative or inaccurate day counts in certain leap-year month boundaries."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `=end_date - EDATE(start_date, DATEDIF(start_date, end_date, \"M\"))` for bulletproof day accuracy."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"YEARFRAC Day Count Basis Confusion"}</td>
                  <td className="py-3 px-4">{"Using default US 30/360 (basis 0) instead of Actual/Actual (basis 1) causes interest calculation discrepancies in banking audits."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Verify the statutory financial contract convention before setting the basis parameter."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Complete Tenure String"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The standard formula for employee service tenure cards."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"DATEDIF Y & YM & MD"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Exact Age in Years"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates completed age without rounding up premature birthdays."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=DATEDIF(DOB, TODAY(), \"Y\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Banking Year Fraction"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates precise financial year fractions under Actual/Actual day counts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=YEARFRAC(A2, B2, 1)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is =DATEDIF(DOB, TODAY(), \"Y\") superior to =(TODAY()-DOB)/365.25 for calculating legal age?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the financial difference between basis 0 (30/360) and basis 1 (Actual/Actual) in YEARFRAC?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why does DATEDIF not appear in Excel's formula autocomplete dropdown menu?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational and data engineering implications in large-scale enterprise models.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"DATEDIF is Excel's famous 'secret' undocumented function. Always use it for calculating employee tenures, age compliance, and warranty milestones."}
          />
        </div>
      </div>
    </div>
