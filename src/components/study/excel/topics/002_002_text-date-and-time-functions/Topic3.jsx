...
import practicalQuestions from "./topic3_files/topic3_practical_questions";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Character encoding & text substitution: EXACT, REPLACE, SUBSTITUTE, CHAR, CODE - Interactive Practice Grid"
            rowsPerPage={10}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                ...
                10 Practical Questions: Character Encoding &amp; Text Substitution Lab
              </h2>
              <p className="text-xs sm:text-sm text-slate-300 mt-2 max-w-3xl leading-relaxed">
                Strictly practical enterprise problems testing case-sensitive EXACT checks, PCI data masking with REPLACE, selective occurrence replacement with SUBSTITUTE, and ASCII CODE/CHAR encoding audits.
              </p>
            </div>
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Character encoding & substitution: EXACT, REPLACE, SUBSTITUTE, and CHAR/CODE - Frequently Asked Questions"
            questions={questions}
          />
        </div>
