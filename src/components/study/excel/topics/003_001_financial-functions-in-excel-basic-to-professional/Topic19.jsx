...
export default function Topic19() {
  ...
  const handleDownload = () => {
    ...
    link.download = "financial_functions_in_excel_basic_to_professional_master.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-950/80 border border-sky-800 text-sky-300 text-xs font-semibold uppercase tracking-wider mb-4">
            <span>📊</span> Excel Masterclass · Topic 19
          </div>
          <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent tracking-tight">
            Integrated 3-Statement Financial Modeling Architecture
          </h1>
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Dynamic linking of Income Statement, Balance Sheet, and Cash Flow Statement with circular debt loop resolution
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            <code className="text-sm sm:text-base font-mono text-emerald-300 block bg-slate-900 p-3 rounded-xl border border-slate-800 overflow-x-auto">
              =Net_Income - Capex + Depreciation - Change_in_NWC + Debt_Issued
            </code>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Links Net Income to Retained Earnings and Operating Cash Flow, feeding Cash into Balance Sheet Assets and resolving circular interest loops.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic19_3_Statement_Model"
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Integrated 3-Statement Financial Modeling Architecture Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Integrated 3-Statement Financial Modeling Architecture"
