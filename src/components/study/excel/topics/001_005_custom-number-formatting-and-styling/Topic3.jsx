      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Formatting domestic Lakhs &amp; Crores alongside global multi-currency ISO standard notations. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Indian Numbering System: Lakhs &amp; Crores in Excel
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Unlike the Western system which places thousands separators every 3 digits (1,000,000), the Indian numbering system places the first comma after 3 digits (Hundreds) and subsequent commas every 2 digits (Lakhs and Crores: 10,000,00). To achieve true Lakhs and Crores formatting in Excel without locale errors, we deploy custom bracket rules: [&gt;=10000000]##\,##\,##\,##0;[&gt;=100000]##\,##\,##0;##,##0.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Indian Lakhs: [&gt;=100000]##\,##\,##0;##,##0  |  Global: [$₹-439] #,##0.00  |  USD: $#,##0.00</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic3_Currency_International
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Currency and International Formats: $, ₹, €, £, and Indian Numbering (##,##,##0) - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="In corporate Indian financial models, always use the backslash escape sequence (##\,##\,##0) to prevent Excel from reverting to Western millions formatting on foreign client machines!"
          />
        </div>
      </div>
    </div>
