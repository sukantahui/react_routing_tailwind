      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Mastering the format engine, understanding stored IEEE 754 precision vs visual display masks, and exploring all core formatting symbols with 20 real-world examples. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        {/* =========================================================================
            SECTION: MASTER FORMATTING SYMBOL & TOKEN DICTIONARY
        ========================================================================= */}
        <section
          className="reveal-section rounded-xl p-4 sm:p-5 bg-slate-900/70 border border-sky-900/40 shadow-lg space-y-4"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Master Excel Formatting Symbols &amp; Token Dictionary
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
                Complete guide to all special characters used in custom number formatting, their exact rules, and how they behave.
              </p>
            </div>
            <span className="text-[10px] font-mono text-cyan-300 bg-cyan-950/80 px-2.5 py-1 rounded-full border border-cyan-800 shrink-0 font-bold">
              15 Standard Symbols
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
            ...
            <div key="0" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  #
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Digit Placeholder </span>
              </div>
            ...
            <div key="1" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  0
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Forced Digit Placeholder </span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="2" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  ?
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Space Placeholder </span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="3" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  .
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Decimal Point Marker</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="4" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  ,
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Thousands Group Separator &amp; Trailing Scale Operator</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="5" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  ;
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Section Delimiter </span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
                <strong>Meaning:</strong> Separates up to 4 formatting sections: &lt;Positive&gt; ; &lt;Negative&gt; ; &lt;Zero&gt; ; &lt;Text&gt;.
              </p>
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800 font-mono text-[10px] text-emerald-300 overflow-x-auto">
                Format: [Green]₹#,##0;[Red](₹#,##0);&quot;-&quot;;[Blue]@
              </div>
              <p className="text-slate-400 text-[10px] italic">
                <strong>When to use:</strong> Defines distinct visual presentation, colors, and labels based on whether a number is positive, negative, zero, or text.
              </p>
            </div>
            

            <div key="6" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  _ (Underscore)
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Invisible Width Reserver </span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
                <strong>Meaning:</strong> Skips the width of the immediately following character, creating invisible whitespace margin.
              </p>
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800 font-mono text-[10px] text-emerald-300 overflow-x-auto">
                Format: _(₹#,##0_) | Positive numbers reserve space equal to &#39;)&#39; so they align with negative numbers (₹#,##0).
              </div>
              <p className="text-slate-400 text-[10px] italic">
                <strong>When to use:</strong> The foundation of Wall Street accounting presentation. Ensures positive and negative numbers line up with laser precision.
              </p>
            </div>
            

            <div key="7" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  * (Asterisk)
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Character Repeat Fill </span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="8" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  @
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Text Placeholder Token</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="9" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  \ (Backslash)
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Literal Escape Character</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="10" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  &quot; &quot; (Quotes)
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Literal Text Wrapper</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="11" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  [Color]
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Color Identifier Tag</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
                <strong>Meaning:</strong> Applies a font color to the specified section. Supports 8 named colors and 56 palette index numbers.
              </p>
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800 font-mono text-[10px] text-emerald-300 overflow-x-auto">
                [Black], [Blue], [Cyan], [Green], [Magenta], [Red], [White], [Yellow], [Color1] to [Color56]
              </div>
              <p className="text-slate-400 text-[10px] italic">
                <strong>When to use:</strong> Highlights profits in green, losses in red, and alerts in magenta without calculating slow Conditional Formatting rules.
              </p>
            </div>
            

            <div key="12" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  [Condition]
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Logical Comparison Bracket</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
                <strong>Meaning:</strong> Overrides default 4-section behavior with custom numerical conditions (e.g. [&gt;=1000000], [&lt;100]).
              </p>
              <div className="p-1.5 rounded bg-slate-900 border border-slate-800 font-mono text-[10px] text-emerald-300 overflow-x-auto">
                Format: [&gt;=1000000][Color10]₹0.0,,&quot; M&quot;;[&gt;=1000][Blue]₹0,&quot; K&quot;;[Red]₹0
              </div>
              <p className="text-slate-400 text-[10px] italic">
                <strong>When to use:</strong> Creates multi-tiered KPI thresholds, progressive tax brackets, and volume-based pricing tiers.
              </p>
            </div>
            

            <div key="13" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  [h], [m], [s]
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Elapsed Time Accumulators</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
            ...
            <div key="14" className="p-3 rounded-lg bg-slate-950/90 border border-slate-800/90 hover:border-sky-700/60 transition-colors space-y-2">
              <div className="flex items-center justify-between">
                <span className="px-2 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 font-mono font-bold text-sm">
                  ;;;
                </span>
                <span className="text-[10px] text-slate-400 font-medium">Stealth Invisibility Operator</span>
              </div>
              <p className="text-slate-300 text-[11px] leading-relaxed">
        ...
        {/* =========================================================================
            SECTION: DIGIT PLACEHOLDERS COMPARISON (# vs 0 vs ?)
        ========================================================================= */}
        <section
          className="reveal-section rounded-xl p-4 sm:p-5 bg-slate-900/60 border border-slate-800 space-y-3.5"
        >
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-slate-800 text-slate-400 font-semibold bg-slate-950/50">
                  <th className="py-2 px-3">Placeholder Symbol</th>
                  <th className="py-2 px-3">Token Name</th>
                  <th className="py-2 px-3">Handling of Insignificant Leading Zeros</th>
                  <th className="py-2 px-3">Handling of Insignificant Trailing Decimals</th>
                  <th className="py-2 px-3">Ideal Use Case</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                <tr className="hover:bg-slate-800/30">
                  <td className="py-2.5 px-3 font-mono font-bold text-sky-400 text-sm">#</td>
                  <td className="py-2.5 px-3 font-semibold">Optional Digit</td>
                  <td className="py-2.5 px-3 text-emerald-300">Suppresses (Hides leading zeros completely)</td>
                  <td className="py-2.5 px-3 text-emerald-300">Suppresses (12.50 with #.## shows 12.5)</td>
                  <td className="py-2.5 px-3 text-slate-400">Standard numbers, pricing, currency where zeros are not wanted</td>
                </tr>
                <tr className="hover:bg-slate-800/30">
                  <td className="py-2.5 px-3 font-mono font-bold text-emerald-400 text-sm">0</td>
                  <td className="py-2.5 px-3 font-semibold">Forced Zero</td>
                  <td className="py-2.5 px-3 text-amber-300">Forces display (45 with 00000 shows 00045)</td>
                  <td className="py-2.5 px-3 text-amber-300">Forces display (12.5 with 0.00 shows 12.50)</td>
                  <td className="py-2.5 px-3 text-slate-400">Fixed-width IDs, PIN codes, mandatory 2 decimal cents/paise</td>
                </tr>
                <tr className="hover:bg-slate-800/30">
                  <td className="py-2.5 px-3 font-mono font-bold text-purple-400 text-sm">?</td>
                  <td className="py-2.5 px-3 font-semibold">Space Aligner</td>
                  <td className="py-2.5 px-3 text-purple-300">Replaces with invisible whitespace of equal width</td>
                  <td className="py-2.5 px-3 text-purple-300">Replaces with invisible whitespace of equal width</td>
                  <td className="py-2.5 px-3 text-slate-400">Financial tables, printed receipts, fractional alignment (?/?)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Visual Facade: Why What You See Is NOT What Excel Computes
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Excel operates on a dual-layer architecture: the underlying data layer (storing raw IEEE 754 floating-point numbers or 15-digit precision values) and the visual presentation layer (custom formatting masks). When a cell displays &#39;₹1,235&#39;, the underlying formula engine still uses the precise unrounded float &#39;1234.5678&#39; in all downstream calculations (=SUM, =AVERAGE, =VLOOKUP). Understanding this separation is essential to prevent rounding discrepancies in corporate financial statements.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Raw Data: 1234.5678  ──[ Format Mask: ₹#,##0.00 ]──&gt;  Display: ₹1,234.57  |  Formula Bar: 1234.5678</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic0_Format_Engine_Overview
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Introduction to Excel&#39;s Format Engine: Display Values vs Underlying Stored Values - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Always remember: Custom Number Formatting changes how data LOOKS, never what data IS! To verify true cell contents, always glance at the Formula Bar above the sheet grid."
          />
        </div>
      </div>
    </div>
