      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Building dynamic conditional color rules and custom mathematical thresholds without Conditional Formatting overhead. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                High-Speed In-Cell Conditional Formatting
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Did you know you can embed custom logical criteria ([&gt;=1000000]) and color tags directly inside format strings? This executes at native C++ rendering speed, completely avoiding the workbook recalculation lag caused by heavy Conditional Formatting rules. Excel supports 8 primary color names ([Black], [Blue], [Cyan], [Green], [Magenta], [Red], [White], [Yellow]) and 56 index codes ([Color1] to [Color56]).
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>[&gt;=1000000][Color10]₹#,##0.0,,&quot;M&quot;;[&gt;=1000][Blue]₹#,##0,&quot;K&quot;;[Red]₹#,##0</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic6_Conditional_Colors
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Embedded Conditional Criteria ([&gt;1000]) and Color Formatting ([Red], [Green], [ColorN]) - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="For massive 100,000-row models, replace heavy Conditional Formatting rules with native format bracket colors ([Green]/[Red]) to eliminate calculation lag completely!"
          />
        </div>
      </div>
    </div>
