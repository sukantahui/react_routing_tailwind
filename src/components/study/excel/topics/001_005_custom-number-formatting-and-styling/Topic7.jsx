      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Mastering the serial date engine and designing international ISO 8601, European, and US date representations. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Excel&#39;s Date Serial Number Architecture
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Excel does not store dates as text strings. Day 1 is January 1, 1900. Every subsequent day is an integer (+1), while time is stored as a decimal fraction of a 24-hour day (0.5 = 12:00 PM noon). Using custom date tokens (d, dd, ddd, dddd, m, mm, mmm, mmmm, yy, yyyy), you can transform the serial number 45678 into &#39;Tuesday, January 21, 2025&#39; or international ISO &#39;2025-01-21&#39;.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Full Date: dddd, mmmm dd, yyyy  |  ISO 8601: yyyy-mm-dd  |  12-Hour Time: hh:mm:ss AM/PM</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic7_Custom_Dates_Times
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Custom Date Serial Formatting (dddd, mmmm dd, yyyy) and 12h/24h Time Formatting - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Context matters for &#39;m&#39;: When &#39;m&#39; appears immediately after &#39;h&#39; or &#39;hh&#39; (like hh:mm), Excel formats MINUTES. Everywhere else, &#39;m&#39; formats MONTHS!"
          />
        </div>
      </div>
    </div>
