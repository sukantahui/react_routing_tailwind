      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-1.5 mb-2.5">
            ...
            <span className="px-2 py-0.5 rounded-full bg-indigo-950/80 border border-indigo-700/60 text-indigo-300 text-[10px] font-semibold">
              Mastery · Bloom Level 5: Synthesize
            </span>
          </div>
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Synthesizing custom formatting techniques into a Wall Street-grade financial P&amp;L reporting model. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Enterprise Financial P&amp;L Statement Architecture
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            In this comprehensive capstone project, students construct a multi-period corporate Income Statement. We integrate Wall Street accounting parenthetical alignments, Lakhs and Crores scaling, dynamic color variance indicators (+12.5% ▲ / -4.2% ▼), and custom unit masks into a board-ready financial presentation model.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Revenue: _(₹* #,##0,,&quot; Cr&quot;_)  |  Variance: [Color10]+0.0% ▲;[Red]-0.0% ▼;&quot;-&quot;  |  EBITDA: #,##0.0%</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic12_Financial_Statement
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Real-World Project: Building an Executive Financial Income Statement with Dynamic Scaling and Color Alerts - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="A truly executive financial model never relies on default Excel formatting. Masterful custom format strings transform raw spreadsheets into investment-banking grade deliverables!"
          />
        </div>
      </div>
    </div>
