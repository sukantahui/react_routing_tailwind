      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Structuring compliance-ready identifiers, masked KYC tokens, and country-specific telecom formats. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Regulatory Formatting &amp; Security Redaction
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Data security and compliance regulations (GDPR, RBI KYC) require masking sensitive digits while preserving database queryability. Custom number formats allow you to store raw 10-digit mobile numbers (9876543210) while displaying them with country codes &#39;+91 98765 43210&#39;, format US SSNs &#39;000-00-0000&#39;, or mask credit card tokens &#39;XXXX-XXXX-XXXX-1234&#39;.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Indian Mobile: +91 00000 00000  |  PAN/KYC: @@@@@0000@  |  Card Mask: \X\X\X\X-\X\X\X\X-0000</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic9_Tax_Phone_Masking
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Phone Numbers, Tax IDs (PAN/GSTIN/SSN), and Credit Card Masking Patterns - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Use the backslash escape sequence (\X) to display literal masking characters like &#39;XXXX&#39; in front of numeric account tokens without confusing the format parser!"
          />
        </div>
      </div>
    </div>
