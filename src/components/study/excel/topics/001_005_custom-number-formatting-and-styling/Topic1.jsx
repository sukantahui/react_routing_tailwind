      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Mastering the four-part semicolon delimiter structure that powers all Excel custom format masks. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Semicolon Engine: 4 Quadrants of Cell State Formatting
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Excel&#39;s formatting parser evaluates every cell against four sequential criteria separated by semicolons: Positive Section ; Negative Section ; Zero Section ; Text Section. If you supply fewer than 4 sections, Excel applies intelligent cascading rules. Understanding this 4-section architecture allows you to create color-coded accounting ledgers, conditional alerts, and stealth-masked dashboards with a single format string.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Format String: [Green]₹#,##0.00 ; [Red](₹#,##0.00) ; [Blue]&quot;Zero Balance&quot; ; [Magenta]@ &quot;(Note)&quot;</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic1_Four_Section_Syntax
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="The 4-Section Syntax Architecture: Positive ; Negative ; Zero ; Text - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Remember the 4-Section Mantra: Positive; Negative; Zero; Text. Whenever you want to hide a specific state, simply leave its semicolon section blank!"
          />
        </div>
      </div>
    </div>
