      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Deep-dive analysis into the three fundamental digit tokens (#, 0, ?) with exact comparative rules, when to use which, and why. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Three Digit Tokens: # (Optional) vs 0 (Forced) vs ? (Space Aligner)
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Excel provides three distinct numeric placeholder tokens that control how numbers are drawn on screen: 1. &#39;#&#39; (Optional Digit Placeholder): Displays significant digits only and completely suppresses leading zeros. 2. &#39;0&#39; (Forced Zero Placeholder): Forces display of zeros when the number has fewer digits than placeholders (e.g. 00045). 3. &#39;?&#39; (Space Placeholder): Leaves an invisible space for insignificant zeros to ensure perfect decimal point alignment across table columns.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div># = Optional Digit (123.4)  |  0 = Forced Zero (00123)  |  ? = Decimal/Fraction Align ( 12.5 )</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic2_Digit_Placeholders
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Digit Placeholders Deep-Dive: Forced Zero (0), Optional Digits (#), and Decimal Alignment (?) - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Use &#39;0&#39; when leading zeros are mandatory (like Employee IDs and Invoice numbers). Use &#39;#&#39; for standard currency amounts. Use &#39;?&#39; when you want decimal points to line up perfectly across printed invoices!"
          />
        </div>
      </div>
    </div>
