      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Preventing clock rollover in industrial machine run-times, SLA timers, and payroll shift calculations. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Bracket [h] Syntax: Stopping the 24-Hour Rollover Trap
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Standard time formatting (hh:mm:ss) represents time of day on a 24-hour clock. When a cumulative timesheet hits 26 hours and 30 minutes, standard &#39;hh:mm&#39; resets to &#39;02:30&#39; (rolling over to the next day). Enclosing the hour token in square brackets &#39;[h]:mm:ss&#39; instructs Excel to display total cumulative elapsed hours without resetting!
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Elapsed Hours: [h]:mm:ss  |  Elapsed Minutes: [m]:ss  |  Elapsed Seconds: [s]</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic8_Elapsed_Time_Log
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Elapsed Duration Tracking Exceeding 24 Hours with [h]:mm:ss for Timesheets - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="If your payroll or machine run-time sum shows 4 hours instead of 28 hours, wrap the hour in brackets: [h]:mm. It instantly solves the 24-hour clock reset!"
          />
        </div>
      </div>
    </div>
