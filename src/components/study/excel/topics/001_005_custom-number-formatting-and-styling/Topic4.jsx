      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-1.5 mb-2.5">
            <span className="px-2 py-0.5 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-[10px] font-bold uppercase tracking-wider">
              🎨 Wall Street Accounting · Topic 4
            </span>
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Creating Wall Street-grade financial statements with parenthesis padding, asterisks, and accounting hyphens. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Wall Street Accounting Standard: _) and *
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Professional financial reports demand impeccable vertical alignment. Positive numbers must align with negative numbers enclosed in parentheses. The underscore token &#39;_)&#39; reserves invisible whitespace equal to the width of a closing parenthesis. Meanwhile, the asterisk token &#39;* &#39; repeats the following character to fill the entire cell width, pushing currency symbols to the far left and numbers to the far right.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Standard: _(₹* #,##0.00_);(₹* (#,##0.00);_(* &quot;-&quot;??_);_(@_)</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic4_Accounting_Alignment
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="Financial Statement Presentation: Wall Street Accounting Alignment Using _) and * - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="The underscore (_) is Excel&#39;s invisible spacing wizard. Typing _) creates invisible margin space exactly equal to &#39;)&#39; so positive and negative numbers line up with laser precision!"
          />
        </div>
      </div>
    </div>
