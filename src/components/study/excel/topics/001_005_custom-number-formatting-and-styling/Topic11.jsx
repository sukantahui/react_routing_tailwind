      ...
      <div className="w-full space-y-4 sm:space-y-5">
        ...
        >
          ...
          <p className="text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed max-w-5xl">
            Invisibly cloaking sensitive assumptions, data table headers, and calculation toggles without hiding rows. Master the underlying Excel format syntax, avoid common financial presentation traps, and build executive-ready spreadsheets.
          </p>
        ...
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                The Triple Semicolon (;;;) Invisibility Cloak
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Applying the custom format &#39;;;;&#39; instructs Excel to display absolutely nothing for positive numbers, negative numbers, zero values, and text strings. Unlike hiding rows or columns (which alters sheet layout) or changing font color to white (which fails in dark themes or when cells are selected), the triple semicolon cloaks the cell surface invisibly while keeping formula evaluation, charts, and macros 100% operational.
          </p>
          ...
          <div className="p-3 rounded-lg bg-slate-950/90 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto shadow-inner">
            ...
            <div>Total Invisibility: ;;;  |  Header Text Mask: ;;;&quot;Executive Label&quot;  |  Number Only: ;;;@</div>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                ...
                Live Demonstration Sheet: Topic11_Stealth_Cloaking
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
        ...
        <div ref={(el) => (sectionsRef.current[5] = el)} className="reveal-section">
          <FAQTemplate
            title="The Stealth Cloaking Operator (;;;) for Hiding Cell Contents and Dashboard Security - Mastery Q&amp;A"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[6] = el)} className="reveal-section">
          <Teacher
            note="Use ;;; when building dynamic dashboard buttons, KPI toggle cells, or clean Data Table headers where raw formula references must be completely hidden from executive view."
          />
        </div>
      </div>
    </div>
