      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎛️ Synchronized Multi-Chart Slicers"} · Topic 11
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Multi-Perspective Dashboard Synchronization"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Connecting multiple charts to synchronized slicer panels"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Connecting multiple PivotTables, PivotCharts, and KPI Summary Cards to unified interactive Slicer panels using Report Connections for synchronized C-suite dashboards"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Slicer Multi-Link: Insert Slicer -> Right-Click Slicer -> Report Connections -> Check All Target PivotTables"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Unified Slicer Signal Broadcasting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A single user click on a Region or Year slicer broadcasts filtering instructions to all connected PivotTables across multiple worksheets simultaneously."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Multi-Pivot Cache Synchronization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Requires all connected PivotTables to originate from a shared data table or Data Model connection."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Coordinated Multi-Perspective Visual Updates"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Clicking 'Eastern Region' instantly updates the Top KPI Cards, Regional Bar Chart, Product Treemap, and Monthly Revenue Trendline in unison."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Unified Dashboard Slicer Mesh: Master Slicers -> Synchronized Pivot Cache -> Multi-Chart Dashboard Canvas"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_11" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_11" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_11)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Multi-Perspective Dashboard Synchronization"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_11)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic11_Connecting_multipl"
            title={"Connecting multiple charts to synchronized slicer panels - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Executive Command Center"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links 3 master slicers (Fiscal Year, Business Division, Sales Region) across 5 synchronized PivotCharts on a single C-suite dashboard."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Multi-Entity Tax & Procurement Portal"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Synchronizes vendor compliance charts, tax dispute ledgers, and purchase trends via shared slicer panels."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Operations Slicer Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links Shift and Machine Line slicers to scrap Pareto charts, yield curves, and operator productivity scorecards."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Fleet Performance Slicer Hub"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Synchronizes delivery turnaround time, fuel expenditure, and carrier scorecards across transport zones."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Slicer Multi-Link: Insert Slicer -> Right-Click Slicer -> Report Connections -> Check All Target PivotTables"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Report Connections Missing Target PivotTables"}</td>
                  <td className="py-3 px-4">{"PivotTables created from separate raw ranges have distinct Pivot Caches, preventing them from appearing in Report Connections."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Create all dashboard PivotTables from the exact same source table so they share a unified cache."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Slicers Drifting on User Interaction"}</td>
                  <td className="py-3 px-4">{"Expanding pivot tables shifts slicers out of alignment."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-click Slicer > Size and Properties > Properties > Select 'Don't move or size with cells'."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Disconnected Chart Series Glitch"}</td>
                  <td className="py-3 px-4">{"Having one standalone chart that does not update when slicers are clicked ruins the presentation."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Verify that every single chart on the dashboard is linked to a connected PivotTable."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Report Connections Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Link a single slicer to control all PivotTables across the workbook."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click Slicer > Report Connections"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Lock Slicer Position"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees slicers remain locked on dashboard layouts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Size & Properties > Don't move or size with cells"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Multi-Select Slicer Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Select multiple arbitrary categories simultaneously."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Click (or click Multi-Select button)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must PivotTables share the same Pivot Cache to be controlled by a single Slicer?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does Report Connections turn multiple independent charts into a unified interactive software application?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is 'Don't move or size with cells' essential for professional dashboard UI design?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Connecting multiple charts to synchronized slicer panels - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The magic of executive dashboards: Connect 3 Slicers (Year, Region, Segment) to all 5 PivotTables on your sheet via Report Connections. Now your entire dashboard dances together at the click of a button."}
          />
        </div>
      </div>
    </div>
