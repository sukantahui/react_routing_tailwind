      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📊 Histogram & Pareto (80/20 Rule)"} · Topic 7
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Statistical & Pareto Insights"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Histogram and Pareto charts (80/20 rule analysis) for quality and sales insights"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Statistical distribution modeling and Pareto Analysis (80/20 Rule): identifying the vital few root causes driving 80% of corporate revenues or quality defects"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Statistical Charts: Insert &gt; Statistical &gt; Histogram (Bin Width / Number of Bins) | Pareto Chart (Frequency Bars + Cumulative Line)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Automated Histogram Frequency Binning"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automatically groups continuous raw data into equal-width frequency bins, revealing normal distributions, skews, and outliers without manual COUNTIF formulas."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Pareto Principle (80/20 Rule)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Sorts categories in descending frequency order while plotting a secondary cumulative percentage curve, identifying the 20% of causes responsible for 80% of outcomes."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Bin Configuration Controls"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Allows setting explicit Bin Width, Number of Bins, Overflow Bin (e.g. `> ₹10,00,000`), and Underflow Bin (e.g. `< 0`)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Pareto Analysis Engine: Descending Defect Frequency Bars + Cumulative Percentage Curve (80/20 Cutoff)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_7" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_7" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_7)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Statistical & Pareto Insights"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_7)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic7_Histogram_and_Pare"
            title={"Histogram and Pareto charts (80/20 rule analysis) for quality and sales insights - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Customer Revenue Concentration Pareto Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Proves to the Board that 18% of corporate clients generate 82% of total company revenue using an executive Pareto chart."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Invoice Payment Delay Distribution Histogram"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Plots aging payment delay days across 15,000 customer invoices to isolate chronic delinquency bins."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Six Sigma Quality Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Scrap Defect Root Cause Pareto"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Identifies that 2 specific casting flaws account for 78% of all scrapped alloy production."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Shipment Weight Distribution Histogram"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Analyzes shipment parcel weight frequencies to optimize container packing tariffs."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Statistical Charts: Insert &gt; Statistical &gt; Histogram (Bin Width / Number of Bins) | Pareto Chart (Frequency Bars + Cumulative Line)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Pre-Aggregating Data for Native Histograms"}</td>
                  <td className="py-3 px-4">{"Feeding summary frequency tables into Excel's native Histogram chart causes Excel to re-bin the frequencies rather than plotting the data."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Feed raw unaggregated transactional lists into native Histograms; or use standard Combo charts for pre-aggregated data."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unconfigured Overflow / Underflow Bins"}</td>
                  <td className="py-3 px-4">{"Extreme outlier numbers stretching histogram axes into 50 empty, unreadable bins."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Format Axis > Set 'Overflow bin' (e.g. 1000) and 'Underflow bin' (e.g. 0)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Misreading the 80% Intersection Line"}</td>
                  <td className="py-3 px-4">{"Failing to draw attention to the 80% cumulative threshold cutoff point."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Add a subtle horizontal marker line at 80% to emphasize the vital few drivers."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Native Pareto Chart"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Automatically sorts categories and plots the cumulative 100% curve."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Insert &gt; Statistical > Pareto"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Adjust Bin Width"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Tailors histogram granularity to exact business reporting brackets."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format Axis > Bin Width: [Value]"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Raw Data Ingestion"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Native statistical charts calculate distributions directly from raw data."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Select raw column of numbers"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does a Pareto chart visually isolate the 20% of products generating 80% of company revenue?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should you feed raw unaggregated transaction data into Excel's native Histogram tool?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the operational purpose of configuring Overflow and Underflow bins on histogram axes?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Histogram and Pareto charts (80/20 rule analysis) for quality and sales insights - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The Pareto chart is the #1 tool of Six Sigma and management consulting. Use it to show management: 'If we fix these 2 defect types, we eliminate 80% of our scrap costs today'."}
          />
        </div>
      </div>
    </div>
