      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎯 Bullet Charts & Target Gauges"} · Topic 8
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Bullet charts and Gauge charts for target vs achievement tracking"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building high-density executive Bullet Charts and Target Gauge visualizations: comparing actual performance against quantitative targets and qualitative performance bands"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Bullet Chart: Stacked Target Ranges (Poor/Satisfactory/Good) + Primary Actual Bar + Target Marker Line"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Stephen Few Bullet Chart Standard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces clunky circular gauge speedometers with compact, linear, high-density charts comparing Actuals against Targets across qualitative bands (Poor, Good, Excellent)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dual-Axis Overlay Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Plots qualitative background bands on the Primary Axis (wide muted bars) and Actual performance on the Secondary Axis (narrow dark bar)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Target Marker Line Integration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Plots the quantitative target benchmark as an error bar or scatter point marker line intersecting the actual performance bar."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Bullet Chart Architecture: Qualitative Background Bands + Actual Measure Bar + Performance Target Marker"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Performance vs Target Benchmarking"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_8)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic8_Bullet_charts_and_"
            title={"Bullet charts and Gauge charts for target vs achievement tracking - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Quarterly Divisional Sales Quota Bullet Benchmark"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a compact bullet chart dashboard displaying actual sales against quarterly quotas across 8 regional sales directors."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Opex Budget Utilization Bullet Charts"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors factory department spending against allocated budget limits and warning thresholds."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Uptime Target Benchmarking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays production line operating hours against 95% availability targets."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Logistics SLA Manager"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Delivery SLA Performance Gauges"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks on-time delivery percentages against contractual benchmark SLAs across transport zones."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Bullet Chart: Stacked Target Ranges (Poor/Satisfactory/Good) + Primary Actual Bar + Target Marker Line"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Gimmicky Circular Gauge Charts"}</td>
                  <td className="py-3 px-4">{"Circular 3D speedometer gauges waste 80% of dashboard screen space while showing only a single number."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Replace circular speedometers with sleek, compact horizontal Bullet Charts."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Clashing Qualitative Band Colors"}</td>
                  <td className="py-3 px-4">{"Using bright saturated neon colors for Poor, Satisfactory, and Good bands distracts from the actual performance bar."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use progressive grayscale tones (#E2E8F0, #CBD5E1, #94A3B8) for background bands."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Axis Scale Inconsistency Across Multiple Bullets"}</td>
                  <td className="py-3 px-4">{"Allowing each bullet chart in a series to use different axis scales creates misleading visual comparisons."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Lock horizontal axis maximum bounds uniformly across all compared bullet charts."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Combo Chart Bullet Structure"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The standard native Excel technique to build bullet charts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Stacked Bar (Bands) + Clustered Bar (Actual)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Muted Grayscale Bands"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Ensures the dark actual performance bar stands out with crystal clarity."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Soft gray background tiers"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Target Error Bar Line"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Creates the crisp vertical target benchmark line."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format Data Series > Add Custom Error Bar"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why are linear Bullet Charts considered vastly superior to circular speedometer gauges in professional dashboard design?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do qualitative background bands (Poor, Good, Excellent) provide instant context for actual performance?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should multiple bullet charts on the same dashboard share identical horizontal axis scales?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Bullet charts and Gauge charts for target vs achievement tracking - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Speedometer gauge charts are amateur; Bullet charts are executive. A bullet chart packs Actual performance, Target benchmark, and 3 Qualitative performance bands into a 1-inch bar. Master this layout."}
          />
        </div>
      </div>
    </div>
