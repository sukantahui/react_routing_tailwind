      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 Executive C-Suite Sales & Profitability Dashboard Capstone"} · Topic 13
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Enterprise Master Capstone"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive end-to-end master capstone project: designing and constructing a complete, production-grade Executive C-Suite Sales & Profitability Dashboard from scratch"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Executive C-Suite Sales & Profitability Dashboard: KPI Summary Cards + Waterfall P&L Bridge + Slicers + Treemap + Sparklines"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. End-to-End Enterprise BI Synthesis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Integrates 4 top KPI Cards with delta badges, a central Waterfall P&L margin bridge, a 12-month Sparkline trajectory matrix, and a Category Treemap."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Unified Interactive Slicer Mesh"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links Master Region, Product Line, and Fiscal Quarter slicers across all dashboard components simultaneously."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Institutional Boardroom Formatting Standards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies dark-themed container styling, hidden gridlines, locked column widths, and zero-hardcoding formula architecture."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Executive C-Suite Dashboard Full Architecture & Interactivity Mesh"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_13" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_13" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_13)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Enterprise Master Capstone"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_13)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Executive Sales & Profitability Command Center"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs and delivers a complete ₹250 Crore commercial sales and EBITDA profitability dashboard for the Board of Directors."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Manufacturing Division Strategic Performance Pack"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Delivers comprehensive operational expenditure, yield variance, and net margin executive review dashboards."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Operational Excellence Command Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys real-time manufacturing yield, machine downtime, and quality defect analytics suites."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Nationwide Freight Distribution Intelligence Hub"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors transit turnaround SLAs, carrier profitability, and route fuel efficiency across India."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Executive C-Suite Sales & Profitability Dashboard: KPI Summary Cards + Waterfall P&L Bridge + Slicers + Treemap + Sparklines"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Information Overload (Dashboard Bloat)"}</td>
                  <td className="py-3 px-4">{"Crowding 25 disparate charts onto a single screen with no clear visual hierarchy."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Follow the rule of 5: 1 primary trend, 1 composition chart, 1 detailed table, and 4 top KPI cards."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Broken Cross-Sheet Formula Linkages"}</td>
                  <td className="py-3 px-4">{"Hardcoding numbers when transferring data from calculation sheets to the dashboard canvas."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Maintain strict dynamic formula links (`=Calcs!C10`) across all dashboard card elements."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Neglecting Mobile / Laptop Screen Aspect Ratios"}</td>
                  <td className="py-3 px-4">{"Designing only for massive 32-inch desktop monitors causes dashboard to clip on executive 14-inch laptops."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Design within standard 1366x768 / 1920x1080 responsive grid boundaries."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"The 5-Second Executive Rule"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Executives must understand business health within 5 seconds of opening."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Key metrics visible in 5 seconds"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Single Source of Truth Sheet"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Keeps messy background formulas completely separate from the clean presentation canvas."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Dedicated 'Calcs' engine tab"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the '5-Second Rule' in executive dashboard design?"}
              </h3>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do synchronized slicers transform static monthly reports into dynamic analytical exploration tools?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Real-world capstone: Building an Executive C-Suite Sales & Profitability Dashboard from scratch - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Congratulations on reaching the pinnacle of Executive Dashboard Design! You now possess the power to build world-class, interactive, boardroom-ready dashboards that inform multi-million dollar corporate decisions."}
          />
        </div>
      </div>
    </div>
