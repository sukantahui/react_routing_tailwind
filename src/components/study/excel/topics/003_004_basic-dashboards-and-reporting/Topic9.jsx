    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📈 In-Cell Sparklines (Micro-Charts)"} · Topic 9
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"In-Cell Micro-Visualizations"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Embedding intense, word-sized micro-charts directly inside single worksheet cells using Sparklines: Line trends, Column volumes, and Win/Loss binary performance"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Word-Sized Micro-Graphics (Edward Tufte Concept)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Sparklines live directly inside standard spreadsheet cells, presenting 12-month historical trajectories alongside tabular summary numbers."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Three Core Sparkline Typologies"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"1. Line (Continuous trendlines); 2. Column (Discrete period volumes); 3. Win/Loss (Binary positive vs negative outcomes, ideal for trading or monthly profitability)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Highlight Markers & High/Low Color Accents"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Enables highlighting High Point (Emerald Green), Low Point (Rose Red), Negative Points, and First/Last markers."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"In-Cell Micro-Visualizations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_9)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Branch 12-Month Sales Trajectory Column"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds 12-month Line sparklines with green High Point markers inside a 20-branch executive summary scorecard table."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Client Monthly Payment Win/Loss Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Win/Loss sparklines to visualize 24-month on-time vs delayed payment records for credit underwriting."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Monthly Scrap Volume Sparklines"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds miniature Column sparklines in shopfloor equipment maintenance registers."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Corridor Fuel Burn Micro-Trends"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks monthly fuel consumption trends across 30 regional trucking routes."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Independent Axis Scaling Distorting Real Comparisons"}</td>
                  <td className="py-3 px-4">{"By default, each Sparkline scales independently; a flat line varying between $99 and $100 looks identical to a volatile swing between $10 and $1000."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Sparkline tab > Axis > Set 'Vertical Axis Minimum/Maximum Value' to 'Same for All Sparklines'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Deleting Sparklines with Backspace/Delete Key"}</td>
                  <td className="py-3 px-4">{"Pressing Delete on a cell containing a Sparkline clears text but leaves the Sparkline drawing intact."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Sparkline tab > Click 'Clear' (or Clear Selected Sparklines)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Insert Sparklines Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Quickly insert in-cell sparklines on selected table rows."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + N + S + L (Line) | Alt + N + S + C (Column)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Unify Vertical Axis Scale"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees accurate relative visual comparisons across rows."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Sparkline > Axis > Same for All Sparklines"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"High/Low Point Markers"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly adds visual peak and valley markers."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Check High Point & Low Point boxes"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must you set 'Vertical Axis Maximum/Minimum to Same for All Sparklines' when comparing rows?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does pressing the Delete key fail to remove a Sparkline from a cell?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do Win/Loss sparklines help credit risk officers analyze customer payment habits?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"In-cell data visualization: Micro-charts with Sparklines (Line, Column, Win/Loss) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
