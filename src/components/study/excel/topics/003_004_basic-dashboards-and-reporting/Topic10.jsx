      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎨 In-Cell Data Bars & Heatmap Matrices"} · Topic 10
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"In-Cell Analytical Highlighting"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"In-cell progress bars and heatmap matrices using advanced conditional formatting"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Creating in-cell visual analytics using advanced Conditional Formatting: Data Bars (progress bars), 3-color Heatmap matrices, and Icon Sets with custom numeric threshold rules"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Conditional Formatting: Data Bars (Gradient/Solid) | Color Scales (Heatmaps) | Icon Sets (Traffic Lights, Stars)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. In-Cell Data Bars (Progress Bars)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Renders horizontal micro-bars directly inside numeric cells proportional to value. Checking 'Show Bar Only' hides numbers to create standalone visual progress meters."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Color Scales (Analytical Heatmaps)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies smooth 2-color or 3-color gradient fills across dense matrix grids, highlighting concentrations, anomalies, and performance hotspots instantly."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Icon Sets & Custom Threshold Rules"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Places traffic lights, arrows, or flags inside cells based on strict numerical percentage or percentile thresholds."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"In-Cell Formatting Engine: Cell Value Array -> Conditional Threshold Evaluator -> Dynamic In-Cell Visual"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_10" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_10" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_10)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"In-Cell Analytical Highlighting"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_10)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic10_In_cell_progress_b"
            title={"In-cell progress bars and heatmap matrices using advanced conditional formatting - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Executive Regional Sales Heatmap Matrix"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies a 3-color soft gradient heatmap across a 12-Month x 20-Branch revenue matrix, instantly isolating underperforming branch quarters."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Vendor Compliance Rating Data Bars"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds emerald green in-cell Data Bars representing supplier GST compliance scores from 0% to 100%."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Plant Quality Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machinery Thermal Sensor Heatmap"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Visualizes kiln temperature arrays with red/amber heatmap scales to spot hot-zone anomalies."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Vehicle Utilization Progress Bars"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays fleet capacity utilization using in-cell progress bars with 'Show Bar Only' mode."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Conditional Formatting: Data Bars (Gradient/Solid) | Color Scales (Heatmaps) | Icon Sets (Traffic Lights, Stars)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Excessive Rainbow Heatmap Colors"}</td>
                  <td className="py-3 px-4">{"Using default saturated neon red-yellow-green palettes across 1,000 cells creates an unreadable visual headache."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Customize Color Scale to use subtle, muted pastel tones or single-hue gradients (e.g. White to Deep Emerald)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Data Bar Automatic Scaling Distortion"}</td>
                  <td className="py-3 px-4">{"Allowing Data Bars to scale automatically means a maximum value of 10% fills the entire cell width, misleading viewers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Edit Rule > Minimum: Number 0, Maximum: Number 1 (or 100%)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Icon Sets Cluttering Numbers"}</td>
                  <td className="py-3 px-4">{"Placing traffic lights alongside numbers in narrow columns causes text truncation."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Widen columns or check 'Show Icon Only' in the Conditional Formatting Rule dialog."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Show Bar Only"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Hides numbers to turn cells into pure graphical progress meters."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Edit Rule > Check 'Show Bar Only'"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Fixed 0-100% Bounds"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Locks progress bars to true percentage completion."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Min: Number 0, Max: Number 1"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Soft Single-Hue Gradient"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The executive standard for boardroom-ready heatmap matrices."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"White to Soft Blue/Green"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must you set Data Bar Minimum to Number 0 and Maximum to Number 1 for percentage progress columns?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does 'Show Bar Only' transform raw data cells into sleek visual progress meters?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why are single-hue color scales (White to Deep Blue) preferred over bright rainbow scales in executive reporting?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"In-cell progress bars and heatmap matrices using advanced conditional formatting - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Use Data Bars with 'Show Bar Only' next to your percentage column. It gives you a gorgeous in-cell progress bar that updates dynamically as numbers change."}
          />
        </div>
      </div>
    </div>
