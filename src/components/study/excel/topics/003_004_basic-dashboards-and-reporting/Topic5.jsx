      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🌊 Waterfall Charts (P&L Walkthroughs)"} · Topic 5
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Financial Variance Visualization"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Advanced visualization types: Waterfall charts for variance and P&L walk-throughs"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building professional corporate Waterfall charts (Bridge charts) to visualize P&L walks, EBITDA reconciliations, and budget-to-actual variance waterfalls"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Waterfall Chart: Insert &gt; Waterfall | Format Data Point: Set as Total (Clear/Subtotal Pillars) | Connector Lines"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Floating Bar Variance Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Visualizes cumulative positive additions (Green) and negative deductions (Red) suspended between starting and ending baseline pillars."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Setting Total Pillars ('Set as Total')"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Right-clicking key milestone bars (e.g. Gross Profit, Operating Income, Net Income) and selecting 'Set as Total' anchors them to the horizontal zero baseline."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Connecting Flow Lines"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connector lines visually trace the bridge trajectory from one cost component to the next, illustrating exactly where margins were gained or lost."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Waterfall Chart Architecture: Starting Base -> Positive Additions -> Negative Deductions -> Ending Subtotal"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Financial Variance Visualization"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_5)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic5_Advanced_visualiza"
            title={"Advanced visualization types: Waterfall charts for variance and P&L walk-throughs - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Boardroom Annual EBITDA Bridge Waterfall"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Presents the annual P&L walk from Gross Revenue (₹120 Cr) to Net Profit (₹18.5 Cr), illustrating Raw Material Cost, Labor, SG&A, and Tax impacts."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Budget vs Actual Revenue Variance Waterfall"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Decomposes ₹4.2 Crore budget shortfall into Volume Variance, Price Discounting, and FX Currency Headwinds."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Manufacturing Cost Overrun Bridge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Illustrates component scrap, overtime labor premiums, and energy tariff spikes bridging planned vs actual factory costs."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Logistics Finance Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Cost per Ton Variance Waterfall"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Decomposes shipping cost increases into fuel price surges, toll tariffs, and empty return miles."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Waterfall Chart: Insert &gt; Waterfall | Format Data Point: Set as Total (Clear/Subtotal Pillars) | Connector Lines"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting to 'Set as Total' on Ending Milestone Bars"}</td>
                  <td className="py-3 px-4">{"Leaving Net Income or Subtotals as floating variance bars causes them to stack on top of expenses rather than anchoring to the baseline."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-click the subtotal column > select 'Set as Total'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Inconsistent Sign Input Convention"}</td>
                  <td className="py-3 px-4">{"Entering expense items as positive numbers causes the Waterfall chart to display cost additions as green increases rather than red subtractions."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Enter expenses as negative numbers (-) in the data table."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Selecting Unsupported Waterfall Chart Options"}</td>
                  <td className="py-3 px-4">{"Attempting to create a native PivotChart Waterfall (Excel does not support Waterfall charts directly on PivotTables)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Link a standard formula range to the PivotTable output and build the Waterfall chart from that range."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Set as Total Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Anchors summary pillars (Gross Margin, Net Income) to the zero baseline."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click data point > Set as Total"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Standard Corporate Colors"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The universal Wall Street financial presentation palette."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Green (Gains), Red (Losses), Navy (Totals)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Data Label Positioning"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Ensures clear readability of numerical variance figures."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format Data Labels > Outside End"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must milestone bars like 'Gross Profit' and 'Net Income' be configured as 'Set as Total' in Waterfall charts?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must expense and cost variances be entered as negative numbers in the source data table?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why are Waterfall charts the #1 choice of CFOs for explaining budget variances to boards of directors?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Advanced visualization types: Waterfall charts for variance and P&L walk-throughs - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The Waterfall chart is the language of CFOs. Always format your starting and ending pillars in Navy Blue, positive gains in Green, and negative expenses in Red. It tells a complete financial story in 5 seconds."}
          />
        </div>
      </div>
    </div>
