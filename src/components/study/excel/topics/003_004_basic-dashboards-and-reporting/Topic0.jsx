      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📐 Executive Dashboard Architecture"} · Topic 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Information Design & Layout Architecture"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering executive dashboard architecture: grid systems, visual scanning hierarchy (F-pattern), muted corporate color palettes, and single-screen fit principles"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Dashboard Canvas Standard: 4-Quadrant Visual Grid | 1 Screen Fit (No Horizontal Scroll) | 60-30-10 Color Rule"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The 4-Quadrant Visual Grid"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Top: High-impact KPI Summary Cards; Middle Left: Primary Time-Series Trend; Middle Right: Category/Product Breakdown; Bottom: Top 10 Detailed Matrix."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The 60-30-10 Palette Rule"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"60% Neutral Canvas (Slate/Charcoal/White); 30% Secondary Structural Contrast (Navy/Dark Blue); 10% Accent Alert Colors (Emerald for Positive, Rose for Alert)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Executive Dashboard 4-Quadrant Architecture & Visual Hierarchy Grid"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Information Design & Layout Architecture"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_0)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: C-Suite Commercial Revenue Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Designs a single-screen executive sales command center consolidating ₹150 Crore regional performance across 12 branch networks."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Head of Financial Audit"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Corporate Statutory Tax Audit Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Organizes multi-year tax liabilities, input tax credits, and dispute exposures into a clean 4-quadrant executive briefing."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Plant Production & Yield Command Center"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys dark-themed touchscreen dashboard consoles across industrial shopfloor control rooms."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Operations Telemetry Dashboard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Structures real-time transit turnaround, fuel efficiency, and carrier SLA compliance tracking."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Dashboard Canvas Standard: 4-Quadrant Visual Grid | 1 Screen Fit (No Horizontal Scroll) | 60-30-10 Color Rule"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'Christmas Tree' Color Trap"}</td>
                  <td className="py-3 px-4">{"Using 15 bright saturated rainbow colors across charts creates visual clutter and decision fatigue."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Enforce a unified 3-color palette following the 60-30-10 information design rule."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forcing Horizontal Scrolling"}</td>
                  <td className="py-3 px-4">{"Designing dashboards wider than standard 1920x1080 resolution forces executives to scroll horizontally."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Fit all core visual insights within columns A through N (1 screen width)."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Instantly elevates your spreadsheet to look like custom software."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"View tab > Uncheck Gridlines (Alt + W + V + G)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Container Card Design"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Groups related charts and KPIs into clean modular visual cards."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Insert Rounded Rectangle / Cell Border"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does turning off sheet gridlines immediately make an Excel dashboard look like custom enterprise software?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the 60-30-10 color rule in executive dashboard design?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should executive dashboards be strictly designed to fit on a single screen without horizontal scrolling?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Anatomy of an Executive Dashboard: Grid system, visual hierarchy, and color palettes - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Great dashboard design is all about discipline. Turn off gridlines, use a muted 3-color palette, and fit everything onto one clean screen. Your executives will be blown away."}
          />
        </div>
      </div>
    </div>
