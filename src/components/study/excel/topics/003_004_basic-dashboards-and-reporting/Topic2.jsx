      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"💳 Dynamic KPI Summary Cards"} · Topic 2
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Visual Executive Micro-Cards"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building high-impact C-suite KPI Summary Cards with dynamic Unicode delta arrows (▲ / ▼ / ▬), custom color formatting, and integrated micro-sparklines"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Custom Number Mask: [Color10]▲ +0.0%;[Red]▼ -0.0%;[Color16]▬ 0.0% | Dynamic KPI Formula: =TEXT(Val, \"₹#,##0.0\") & \" (\" & TEXT(Growth, \"+0.0%\") & \")\""}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Three-Tier Card Information Hierarchy"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tier 1 (Top): Small muted metric title (e.g. 'TOTAL REVENUE'); Tier 2 (Center): Massive bold KPI number (e.g. '₹45.8 Cr'); Tier 3 (Bottom): Dynamic delta badge (e.g. '▲ +12.4% vs LY')."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Unicode Delta Formatting Masks"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses embedded Unicode characters inside custom number formats: `[Color10]▲ +0.0%;[Red]▼ -0.0%;[Color16]▬ 0.0%` for automatic color-coded arrows."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Dynamic Text Formula Integration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Creates self-updating card subtitles: `=\"▲ \" & TEXT(Growth, \"0.0%\") & \" vs target (\" & TEXT(Variance, \"₹#,##0\") & \")\"`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"KPI Summary Card Architecture: Metric Value + Unicode Delta Badge + Sparkline Trajectory"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Visual Executive Micro-Cards"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_2)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Executive Boardroom Top-Line KPI Cards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs 4 master summary cards (Revenue, Gross Margin %, EBITDA, Active Accounts) featuring dynamic green/red delta badges."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Credit Utilization Summary Cards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds monthly input tax credit summary cards with variance indicators against projected tax liabilities."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Manufacturing OEE Efficiency Cards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Displays Overall Equipment Effectiveness (OEE) with real-time target variance arrows on shopfloor monitor displays."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Tonnage & Fuel Burn KPI Cards"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors monthly gross tonnage and average fuel efficiency with automated milestone badges."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Custom Number Mask: [Color10]▲ +0.0%;[Red]▼ -0.0%;[Color16]▬ 0.0% | Dynamic KPI Formula: =TEXT(Val, \"₹#,##0.0\") & \" (\" & TEXT(Growth, \"+0.0%\") & \")\""}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Reversed Direction Logic for Cost Metrics"}</td>
                  <td className="py-3 px-4">{"Displaying a green ▲ arrow for an INCREASE in operating costs (where cost increases are actually negative alerts)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Invert format mask for expenses: `[Red]▲ +0.0%;[Color10]▼ -0.0%` so cost increases display in red."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overcrowding Card Borders with Dark Shadows"}</td>
                  <td className="py-3 px-4">{"Heavy 3D drop-shadows and thick dark borders make cards look dated and clunky."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use subtle 1px border outlines (#334155) with soft neutral backgrounds."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unanchored Card Shapes Drifting on Grid Resizing"}</td>
                  <td className="py-3 px-4">{"Drawing cards as freeform shapes causes them to drift when columns are resized."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Build KPI cards directly inside cell grids using merged cells and cell borders for perfect alignment."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Unicode Delta Characters"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Embed real Unicode arrows directly into custom number formats."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"▲ (Alt+30) | ▼ (Alt+31)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Expense Card Color Inversion"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Inverts colors so rising costs show as red alerts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"[Red]▲ +0.0%;[Green]▼ -0.0%"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Grid-Aligned KPI Cards"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Building cards in cell grids guarantees they never drift or misalign."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format cell ranges directly"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must the color logic of delta arrows be inverted for cost and expense KPI cards?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do Unicode characters (▲ and ▼) inside custom number formats automate color-coded arrows without formulas?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is building KPI cards directly inside worksheet cells cleaner than floating drawn rectangle shapes?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Building KPI Summary Cards with dynamic change indicators (▲ / ▼) and conditional styling - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Executives look at KPI cards first. Make the main number huge (24pt font), the label small and muted (10pt uppercase), and add a clean delta badge like '▲ +12.4% vs LY'. It looks like a Bloomberg terminal."}
          />
        </div>
      </div>
    </div>
