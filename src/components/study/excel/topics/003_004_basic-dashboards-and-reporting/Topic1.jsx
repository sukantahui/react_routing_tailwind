      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎯 Key Performance Indicator (KPI) Math"} · Topic 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Key Performance Indicator Engineering"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Defining and calculating Key Performance Indicators (KPIs): Target vs Actual, YoY Growth, MoM Variance"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Defining, calculating, and presenting core enterprise Key Performance Indicators: Target vs Actual, Year-over-Year (YoY) Growth, Month-over-Month (MoM) Variance, and Run Rates"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"YoY Growth: =(Current - PriorYear) / PriorYear | MoM Variance: =Current - PriorMonth | Target Achievement: =Actual / Target"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Normalized Variance vs Absolute Variance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Absolute Variance (`Actual - Budget`) measures dollar impact; Percentage Variance (`(Actual - Budget) / Budget`) measures execution efficiency."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Zero & Negative Denominator Defense"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Standard percentage growth formulas crash on negative prior year numbers. Solved via `=(Current - Prior) / ABS(Prior)`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Run-Rate & Pace Projection Math"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`Run Rate = (YTD Actual / Elapsed Days) * 365`. Projects full-year milestone landing based on current operational velocity."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"KPI Mathematical Transformation Pipeline: Raw Actuals & Targets -> Normalized Growth & Variance Metrics"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Key Performance Indicator Engineering"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_Defining_and_calcu"
            title={"Defining and calculating Key Performance Indicators (KPIs): Target vs Actual, YoY Growth, MoM Variance - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Revenue YoY Growth Tracking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes audited Year-over-Year growth rates across ₹120 Crore divisional business lines with negative denominator protection."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly Budget Variance Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates MoM expense variances and budget achievement percentages across 18 manufacturing cost centers."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Quarterly Production Run-Rate Projector"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Projects annual steel tonnage delivery based on YTD 90-day manufacturing pace."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: On-Time Delivery SLA Achievement Metric"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates monthly on-time consignment delivery percentage against 98.5% contractual target."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"YoY Growth: =(Current - PriorYear) / PriorYear | MoM Variance: =Current - PriorMonth | Target Achievement: =Actual / Target"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Division by Zero on New Business Units"}</td>
                  <td className="py-3 px-4">{"Calculating YoY growth when prior year revenue was ₹0 returns `#DIV/0!`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap in safe division formula: `=IFERROR((Current - Prior) / Prior, \"N/A\")`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Negative Prior Year Mathematical Distortion"}</td>
                  <td className="py-3 px-4">{"If Prior Year Net Income was -₹10L and Current is +₹5L, standard `(5 - (-10)) / -10` returns -150% (indicating a decline when profits actually rebounded)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always use absolute value in the denominator: `=(Current - Prior) / ABS(Prior)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Comparing Non-Equivalent Time Horizons"}</td>
                  <td className="py-3 px-4">{"Comparing YTD 5-month sales against full 12-month prior year budget."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure comparisons use strictly annualized run rates or identical Year-to-Date periods."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Negative Base YoY Fix"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The mathematically correct formula for growth over negative base years."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=(Current - Prior) / ABS(Prior)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Safe Variance %"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Eliminates unsightly #DIV/0! errors across zero-target rows."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=IFERROR((Actual - Target)/Target, 0)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Annualized Run Rate"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Projects year-end finish based on active operational pace."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=(YTD / DaysElapsed) * 365"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does calculating YoY growth over a negative prior year profit require `ABS(Prior)` in the denominator?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is comparing absolute variance ($) alongside percentage variance (%) essential for executive context?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do annualized run-rate calculations help management spot revenue shortfalls months before fiscal year-end?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Defining and calculating Key Performance Indicators (KPIs): Target vs Actual, YoY Growth, MoM Variance - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never forget the ABS denominator trick: `=(Current - Prior) / ABS(Prior)`. If a company moves from -₹10 Lakhs loss to +₹5 Lakhs profit, only this formula correctly shows a positive +150% turnaround."}
          />
        </div>
      </div>
    </div>
