    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🌳 Treemap & Sunburst Charts"} · Topic 6
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Visualizing complex multi-level hierarchical categorical data using Treemaps (proportional nested rectangular tiles) and Sunburst charts (concentric categorical rings)"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Proportional Area Encoding (Treemap)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Represents categorical hierarchies as nested rectangles where rectangle area is strictly proportional to metric value, ideal for market share and budget breakdowns."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Concentric Ring Hierarchy (Sunburst)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Visualizes relational depth where inner rings represent high-level categories (e.g. Division) and outer rings represent fine-grained sub-categories (e.g. Products)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Multi-Column Tabular Source Layout"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Source table must be organized hierarchically: Column 1 = Major Category, Column 2 = Sub-Category, Column 3 = Value."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_6" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_6" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_6)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Hierarchical Composition Visualization"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_6)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Product Portfolio Revenue Breakdown"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Visualizes ₹200 Crore product catalog revenue across 4 Divisions and 35 Sub-Lines using an executive Treemap chart."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Statutory Spend Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Corporate Procurement Expense Treemap"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Maps annual supplier expenditures across Raw Materials, Utilities, Logistics, and SG&A expense categories."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Manufacturing Defect Taxonomy Sunburst"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Illustrates component defect hierarchies (Mechanical > Machining > Tool Wear) across 3 production shifts."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Logistics Network Director"}</span>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unsorted / Interspersed Category Rows"}</td>
                  <td className="py-3 px-4">{"Scattering rows of the same parent category throughout the table fragments Treemap tiles into disconnected blocks."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Sort source table by Major Category first, then Sub-Category."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Zero or Negative Values in Sunburst (#VALUE!)"}</td>
                  <td className="py-3 px-4">{"Hierarchy charts cannot process negative numbers or zero values in area-proportional slices."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Filter out zero and negative entries before generating Treemap or Sunburst charts."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Excessive Text Label Truncation"}</td>
                  <td className="py-3 px-4">{"Small tile slices truncate long category descriptions."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Format Data Labels to show 'Category Name and Value' with concise abbreviations."}</td>
                </tr>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"When is a Treemap chart preferred over a standard multi-series pie or bar chart?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must source data for Treemaps and Sunburst charts be strictly sorted by parent categories?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why are Treemap charts incapable of plotting negative financial values?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Treemap and Sunburst charts for hierarchical data breakdown - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Treemaps and Sunburst charts are modern visual powerhouses. When you have 50 products grouped into 5 categories, do not use 50 bars—use a Treemap! It looks stunning on executive presentation slides."}
          />
        </div>
      </div>
    </div>
