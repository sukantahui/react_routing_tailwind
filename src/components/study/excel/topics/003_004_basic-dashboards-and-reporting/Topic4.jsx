      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📈 Dynamic Named Ranges for Charts"} · Topic 4
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Automated Chart Expansion"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Dynamic named ranges using OFFSET, INDEX, and dynamic arrays for automated chart updates"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building self-updating dynamic charts using OFFSET, INDEX, and modern dynamic array spill references (#) that expand automatically as new monthly data is appended"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Dynamic Chart Range: =OFFSET(Anchor, 0, 0, COUNTA(Col), 1) | Modern Spill Range: =Sheet1!$A$2#"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Classic OFFSET Dynamic Range"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Defines a Named Range: `=OFFSET(Sheet1!$B$2, 0, 0, COUNTA(Sheet1!$B:$B)-1, 1)`. As new monthly rows are typed, the chart range expands automatically."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Modern Excel 365 Spill Reference (#)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Charts can link directly to dynamic spilled array formulas (`=Sheet1!$A$2#`), updating instantly as dynamic calculations filter or grow."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Workbook Scope Syntax in Chart Series"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"When assigning a Named Range to a chart series, you MUST prefix it with the workbook or sheet name: `=WorkbookName.xlsx!Chart_Revenue`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Dynamic Chart Range Engine: Appended Source Rows -> Dynamic Named Range Expansion -> Automatic Chart Redraw"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Automated Chart Expansion"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_4)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic4_Dynamic_named_rang"
            title={"Dynamic named ranges using OFFSET, INDEX, and dynamic arrays for automated chart updates - Interactive Practice Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · VP Commercial Planning"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Automated Rolling 12-Month Sales Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs dynamic chart series that automatically display the most recent 12 months of revenue without manual series resizing."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Statutory Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Self-Expanding Monthly Purchase Register Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates monthly vendor procurement trendlines that expand seamlessly as new ledger rows are appended."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Daily Scrap Variance Trendline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links shopfloor quality charts to dynamic named ranges, updating daily as operators type morning production data."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Corridor Volume Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates shipment tonnage charts using dynamic array spill references."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Dynamic Chart Range: =OFFSET(Anchor, 0, 0, COUNTA(Col), 1) | Modern Spill Range: =Sheet1!$A$2#"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Workbook Name Prefix in Chart Series (Syntax Error)"}</td>
                  <td className="py-3 px-4">{"Typing `=Chart_Revenue` into the chart series formula box causes Excel to reject the entry."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always include the workbook name or sheet name prefix: `=Sheet1!Chart_Revenue` or `='Model.xlsx'!Chart_Revenue`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Blank Cells Corrupting COUNTA in OFFSET"}</td>
                  <td className="py-3 px-4">{"Blank cells in the middle of a column cause `COUNTA()` to underestimate the total row count, truncating the chart series."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure source columns contain contiguous data, or use `MATCH(9.99E+307, Col)` to find the true last row."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"OFFSET Function Recalculation Lag"}</td>
                  <td className="py-3 px-4">{"OFFSET is volatile and can slow down massive workbooks containing hundreds of dynamic ranges."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use non-volatile INDEX dynamic ranges: `=$B$2:INDEX($B:$B, COUNTA($B:$B))`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Chart Series Link Syntax"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory format when assigning custom named ranges to chart series."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=Sheet1!DynamicRangeName"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Non-Volatile INDEX Range"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Fast, non-volatile alternative to OFFSET for large enterprise workbooks."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=$B$2:INDEX($B:$B, COUNTA($B:$B))"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Rolling Last N Months"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Always displays exactly the last 12 months of historical data."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=OFFSET(Anchor, COUNTA(Col)-12, 0, 12, 1)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must you include the sheet name prefix (e.g. `=Sheet1!RangeName`) when linking a named range to a chart series?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does `=OFFSET(Anchor, COUNTA(Col)-12, 0, 12, 1)` create a rolling 12-month chart automatically?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is the INDEX method preferred over OFFSET for high-performance enterprise financial models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Dynamic named ranges using OFFSET, INDEX, and dynamic arrays for automated chart updates - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"To make a chart that expands automatically every month: Define a Named Range with OFFSET or INDEX, then in the Chart Series edit box, type `=Sheet1!YourNamedRange`. It updates forever without touching it."}
          />
        </div>
      </div>
    </div>
