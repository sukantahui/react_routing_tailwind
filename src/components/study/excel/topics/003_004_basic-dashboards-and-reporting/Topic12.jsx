    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📄 Print & PDF Layout Architecture"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Executive Publication & PDF Export"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Designing pixel-perfect print and PDF export layouts for C-suite executive briefings: configuring Print Areas, 1-page fit constraints, header/footer branding, and vector PDF exports"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Exact 1-Page Wide Constraint"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures Page Setup to 'Fit to: 1 page wide by 1 page tall' to eliminate ugly orphan page splits in executive board packs."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Header/Footer Corporate Metadata Branding"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds institutional metadata: Confidentiality watermarks, Dynamic Date timestamps (`&[Date]`), and Document Revision codes."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. High-Resolution Vector PDF Export"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Exports charts and tables directly as high-resolution vector PDF documents suitable for boardroom printing or tablet distribution."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Executive Publication & PDF Export"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_12)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Board of Directors Monthly Briefing Pack"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Exports a 5-page institutional PDF financial pack formatted in Landscape Letter format with zero orphan rows and encrypted metadata."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Statutory Audit Partner"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Audited Financial Statement PDF Export"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formats audited balance sheets with clean repeat header rows and official sign-off footer blocks."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Weekly Shopfloor Noticeboard Printouts"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures 1-page A3 landscape print layouts for weekly factory performance noticeboards."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Driver Trip Manifest Print Template"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Designs high-speed 1-page thermal print manifests for daily delivery truck dispatches."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'Orphan Column' Print Split (Fatal Presentation Error)"}</td>
                  <td className="py-3 px-4">{"Allowing a 5-column dashboard to split column 5 onto a second useless page."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Page Layout > Width: 1 page, Height: 1 page (or Fit to 1 page wide)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Tiny Unreadable Shrinkage on Massive Sheets"}</td>
                  <td className="py-3 px-4">{"Forcing a 100-row table onto 1 page tall shrinks text to 4pt microscopic unreadable font."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Set Width to 1 page, but leave Height as 'Automatic' for multi-page tables."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Printing Unwanted Scratch Notes & Calc Columns"}</td>
                  <td className="py-3 px-4">{"Leaving background calculation scratchpad areas unhidden in printouts."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Explicitly set the Print Area: Select dashboard > Page Layout > Print Area > Set Print Area."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Set Print Area"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Locks printout strictly to the active presentation dashboard canvas."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + P + R + S"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Fit to 1 Page Wide"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Eliminates embarrassing horizontal page splits forever."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Page Layout > Width: 1 page"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is 'Fit to 1 page wide' the single most important print setting in Excel financial modeling?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does Page Break Preview allow you to visually adjust page splits by dragging blue borders?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why must you explicitly Set Print Area before distributing workbooks to executive leadership?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Designing clean print/PDF report layouts for C-suite executive briefings - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never print or export to PDF without checking Page Break Preview (Alt + W + I) first! Drag the blue lines so your dashboard fits on exactly ONE landscape page. Professional presentation is everything."}
          />
        </div>
      </div>
    </div>
