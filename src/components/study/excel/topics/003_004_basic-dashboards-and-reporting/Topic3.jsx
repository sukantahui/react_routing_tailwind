...
import sampleWorkbookUrl from "./excel_files/003_004_basic_dashboards_and_reporting_master.xlsx?url";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎛️ Form Controls & Interactive UI"} · Topic 3
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Interactive form controls: Drop-downs, Checkboxes, Option buttons, and Spinners"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Embedding interactive Excel Form Controls (Combo Boxes, Option Buttons, Checkboxes, and Spinners) to drive interactive dashboard scenario switches without VBA macros"}. Master the complete design system, KPI card engineering, interactive Form Controls, Waterfall variance bridges, and C-suite reporting standards.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Developer &gt; Insert &gt; Form Controls: Combo Box (Drop-down) | Option Button (Radio) | Check Box | Scroll Bar (Spinner)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Linked Cell Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Every Form Control writes an integer index (1, 2, 3...) or Boolean (TRUE/FALSE) into a hidden 'Linked Cell'. All dashboard formulas switch based on this cell."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Combo Box (Dropdown Switch)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Allows selecting a scenario or region from a list, outputting the selected item's row position (1 to N) into the linked cell."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Option Buttons & Group Boxes"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Radio buttons inside a Group Box allow mutually exclusive case switching (e.g. Option 1 = Revenue, Option 2 = Profit, Option 3 = Margin)."}</p>
            </div>
            
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"4. Checkboxes (Toggle Layers)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Outputs TRUE/FALSE to toggle secondary chart series on/off (e.g. 'Show Budget Target Line')."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Form Control Interactive Routing: UI Button Click -> Linked Cell ($A$1 Index) -> Dynamic Formula Switch"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod10_3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod10_3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_3)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Interactive Spreadsheet UI"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod10_3)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic3_Interactive_form_c"
            title={"Interactive form controls: Drop-downs, Checkboxes, Option buttons, and Spinners - Interactive Practice Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Executive Dashboard Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Dynamic Division Selector Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a Form Control Combo Box allowing executive directors to switch the entire dashboard view between 6 corporate business units."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Tax Planning Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Regime Option Button Switch"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Option Buttons (Radio) to toggle corporate tax calculations dynamically between Old vs New Tax Regimes."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Maintenance Alert Checkbox Overlay"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Checkboxes to toggle breakdown incident overlay trendlines on machine uptime charts."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Mileage Sensitivity Spinner"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses a Scroll Bar spinner control allowing users to dial fleet fuel cost increases from 0% to 50% in real time."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Build top KPI summary cards and apply custom Unicode format masks <code className="text-cyan-300 font-mono font-bold">{"Developer &gt; Insert &gt; Form Controls: Combo Box (Drop-down) | Option Button (Radio) | Check Box | Scroll Bar (Spinner)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Floating Form Controls Drifting on Window Resize"}</td>
                  <td className="py-3 px-4">{"Form Controls moving across the screen when users open the file on different resolution screens."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-click Form Control > Format Control > Properties > Select 'Don't move or size with cells'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Uncontained Option Buttons Overriding Each Other"}</td>
                  <td className="py-3 px-4">{"Option buttons placed on the sheet without a Group Box operate as a single global group, preventing multiple independent radio switches."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Enclose each set of Option Buttons inside a dedicated Group Box."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Exposing Raw Linked Cell Numbers to Users"}</td>
                  <td className="py-3 px-4">{"Leaving raw numbers (1, 2, 3) visible on the presentation dashboard surface."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Hide linked cells behind the control or format them with custom number format `;;;`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Format Control Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Configures Input Range and Linked Cell parameters."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click > Format Control (Ctrl + 1)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Group Box Mandatory"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Isolates independent sets of Option Radio Buttons."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Developer > Insert &gt; Group Box"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dynamic Switch Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Switches calculations instantly based on Form Control selection."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=CHOOSE(LinkedCell, Option1, Option2, Option3)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does the 'Linked Cell' act as the central bridge between a Form Control button and worksheet formulas?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must Option Buttons (Radio) be placed inside a Group Box?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do Form Controls allow you to build interactive software-like dashboards without writing a single line of VBA?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the cognitive ergonomics and executive decision science implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Interactive form controls: Drop-downs, Checkboxes, Option buttons, and Spinners - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Form Controls require ZERO macro code and work on all standard Excel installations. Link your combo box to cell A1, use =INDEX(Options, A1) in your chart title, and watch your dashboard become fully interactive."}
          />
        </div>
      </div>
    </div>
