const questions = [
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Converting static range to Excel Table (Ctrl + T) and ListObjects (Question 1)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Structured referencing [@ColumnName] current row syntax (Question 2)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Table[ColumnName] data body vector referencing (Question 3)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Table[#Headers], Table[#Totals], and Table[#All] reference tokens (Question 4)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Dynamic auto-expansion when typing new rows/columns below table (Question 5)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Table Total Row (Ctrl + Shift + T) and =SUBTOTAL(109) mechanics (Question 6)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Filter-aware subtotal recalculation skipping hidden rows (Question 7)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Calculated columns automatic formula cascading down entire column (Question 8)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Feeding `tblName` into PivotTables for zero-maintenance refreshing (Question 9)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Tab key in bottom-right cell to insert new table rows smoothly (Question 10)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Single-column sorting vs multi-level hierarchical sorting (Alt + D + S) (Question 11)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Danger of single-column selection sorting scrambling data rows (Question 12)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Custom List sorting for non-alphabetical business hierarchies (Question 13)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Left-to-Right horizontal column sorting in financial statements (Question 14)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Case-sensitive sorting to differentiate uppercase vs lowercase codes (Question 15)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize AutoFilter (Ctrl + Shift + L) search box and wildcard operators (*, ?) (Question 16)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Wildcard asterisk (*) matching any string vs question mark (?) single char (Question 17)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Number filters: Above/Below Average, Between, and Top 10 Percent (Question 18)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Relative date filters: This Quarter, Last Month, Year to Date (Question 19)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Alt + ; (Select Visible Cells Only) before copying filtered tables (Question 20)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Advanced Filter criteria ranges and same-row AND boolean logic (Question 21)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Advanced Filter multi-row OR boolean logic and empty row dangers (Question 22)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Computed formula criteria in Advanced Filter with blank header (Question 23)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Advanced Filter 'Unique records only' deduplication extraction (Question 24)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Starting Advanced Filter from destination sheet for cross-sheet copy (Question 25)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Slicers for Excel Tables (Alt + J + T + S) visual 1-click filtering (Question 26)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Multi-column Slicer button layout for horizontal dashboard headers (Question 27)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Slicer property 'Don't move or size with cells' distortion fix (Question 28)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize Multi-select on Slicers using Ctrl + Click for custom subsets (Question 29)?",
  ...
  {
    "question": "In the context of Sorting Data: Single-Column, Multi-Level Hierarchy and Custom List Sorting, how does Excel implement and optimize End-to-end data wrangling architecture: Table + Subtotals + Slicers (Question 30)?",
