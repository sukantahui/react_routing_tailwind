        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🪜 Natural Business Hierarchies"} · Topic 9
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Drill-Down Navigation Structures"}
            </span>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Single-Field Drag Drill-Down"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A Hierarchy bundles 4 separate columns into a single draggable field in the PivotTable list, allowing users to drill down (`+` / `-`) seamlessly."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Eliminating Multi-Column Drag Fatigue"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Instead of dragging Year, Quarter, Month, and Date individually, users drag the single `Date Hierarchy` field."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Natural Drill Paths"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Defines intuitive business exploration paths: `Geography (Country > State > City > Store)` and `Product (Department > Category > Subcategory > SKU)`."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Drill-Down Navigation Structures"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_9)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Regional Branch Commercial Hierarchy"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Creates a `Geography Hierarchy` (`Zone > State > District > Branch`) enabling instant multi-level sales drill-downs across India."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: GST Tariff Item Code Hierarchy"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds `GST Hierarchy` (`Chapter > Heading > Sub-Heading > 8-Digit Tariff Code`) for statutory tax audits."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Machinery Asset Hierarchy"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs `Equipment Hierarchy` (`Plant > Workshop > Machine Line > Component Part`) for maintenance tracking."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Delivery Routing Hierarchy"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Defines `Transit Hierarchy` (`Region > Corridor > Depot > Delivery Node`)."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Reversed Hierarchy Level Ordering"}</td>
                  <td className="py-3 px-4">{"Placing Product SKU at the top and Category at the bottom inverts the drill-down navigation."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Order hierarchy levels strictly from coarsest (Top) to finest granularity (Bottom)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Creating Hierarchies Across Separate Tables"}</td>
                  <td className="py-3 px-4">{"Attempting to create a single hierarchy combining columns located in two different tables."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"All levels of a hierarchy MUST reside within the same Dimension table."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Original Hierarchy Columns Unhidden"}</td>
                  <td className="py-3 px-4">{"Leaving individual columns (Year, Quarter, Month) visible alongside the new Date Hierarchy creates field list confusion."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Hide the individual component columns to encourage users to use the unified hierarchy."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Drill Down in Pivot"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Explores next level of hierarchy detail in real time."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Double-click item (or click + expand button)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must all levels of a Power Pivot hierarchy exist within the same Dimension table?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do hierarchies streamline PivotTable exploration for non-technical business users?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should you hide the individual raw columns after bundling them into a clean hierarchy?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
