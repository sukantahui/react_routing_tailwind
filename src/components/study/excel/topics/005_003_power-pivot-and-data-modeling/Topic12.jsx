      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔬 VertiPaq Compression & Performance Diagnostics"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Model Diagnostics & Memory Profiling"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Analyzing VertiPaq compression, memory usage, and relationship integrity"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Diagnosing, profiling, and optimizing Power Pivot Data Model memory consumption and query performance: analyzing column cardinality, relationship memory, and dictionary size"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Diagnostic Tools: VertiPaq Analyzer (DAX Studio) | File Size Auditing | Memory Cardinality Optimization"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Column Cardinality (The #1 Memory Driver)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Cardinality (number of unique values in a column) dictates dictionary size and run-length compression efficiency. Low cardinality = Tiny RAM; High cardinality = Huge RAM."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Memory Breakdown Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Total Data Model Memory = Data Hierarchy Columns + Column Dictionaries + Relationship Indexes + User Hierarchies."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Eliminating Timestamp Precision Bloat"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Splitting a DateTime column (`12/04/2026 14:32:15.892`) into separate Date and Hour columns can reduce column RAM footprint by 95%."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"VertiPaq Memory Profiling Pipeline: Table Inspection -> Column Cardinality Profiling -> RAM Optimization"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Model Diagnostics & Memory Profiling"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_12)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic12_Analyzing_VertiPaq"
            title={"Analyzing VertiPaq compression, memory usage, and relationship integrity - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Model Optimization (1.2 GB to 85 MB)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Profiles a massive corporate financial model, discovering that 2 unneeded GUID columns accounted for 88% of total workbook file size; removing them restored instant responsiveness."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Database Memory Footprint Audit"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Audits column cardinalities across 10 million purchase ledger records to ensure smooth execution on auditor laptops."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: IoT Sensor Column Optimization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Optimizes sensor telemetry columns by rounding floating-point temperatures to 1 decimal place, slashing dictionary memory by 80%."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill Tracking Model Acceleration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Splits shipment timestamps into discrete Date and Hour columns to maximize VertiPaq run-length compression."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Diagnostic Tools: VertiPaq Analyzer (DAX Studio) | File Size Auditing | Memory Cardinality Optimization"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving High-Precision Floats Unrounded"}</td>
                  <td className="py-3 px-4">{"Storing numbers with 10 decimal places (`₹45.129847192`) creates millions of unique values, destroying VertiPaq dictionary compression."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Round decimal currencies to 2 decimal places in Power Query."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Keeping Auto Date/Time Hidden Tables Enabled"}</td>
                  <td className="py-3 px-4">{"Excel creating hidden date hierarchy tables for every single date column in the model, wasting megabytes of RAM."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Disable Auto Date/Time in Power Pivot options; use a dedicated Date Dimension table."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unused Technical Columns Left in Fact Table"}</td>
                  <td className="py-3 px-4">{"Leaving 30 database audit columns (`CreatedBy`, `ModifiedDate`, `RowID`) in a 5-million row model."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Remove all columns not strictly required for reporting in Power Query before loading."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Cardinality Rule"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The foundational principle of tabular data modeling."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Low Unique Count = Maximum Speed"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Split Date & Time"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Slashes timestamp memory footprint by up to 95%."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Transform > Date & Time into 2 columns"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Remove Unused Columns"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The fastest way to optimize any Power Pivot workbook."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Power Query > Choose Columns"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is Column Cardinality (unique value count) the single most important factor determining VertiPaq memory size?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does splitting a DateTime column into separate Date and Hour columns dramatically increase compression?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should unneeded database tracking columns be stripped out in Power Query before loading to the Data Model?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Analyzing VertiPaq compression, memory usage, and relationship integrity - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"If your Power Pivot file is too big or slow, check your column cardinalities! Remove unique ID columns, split DateTime into Date and Hour, and round decimals to 2 places. Your model size will shrink by 90%."}
          />
        </div>
      </div>
    </div>
