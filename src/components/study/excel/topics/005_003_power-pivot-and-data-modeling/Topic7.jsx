      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏛️ Implicit vs Explicit Measures"} · Topic 7
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Implicit measures vs Explicit measures: Best practices in model governance"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding Implicit measures (dragging raw numeric columns into Pivot Values) vs Explicit measures (defining formal DAX calculation formulas) and institutional model governance"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Implicit Measure: Dragging numeric column into Values area | Explicit Measure: TotalSales := SUM(Sales[Amount]) in DAX Calculation Area"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Implicit Measures (Ad-Hoc UI Auto-Sums)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Created automatically when users drag a raw numeric column into the PivotTable Values box. Rigid, non-reusable, and cannot be referenced by other DAX formulas."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Explicit Measures (Formal DAX Formulas)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formally written DAX equations defined in the Power Pivot calculation area. Can be referenced by other measures, formatted consistently, and utilized in Power BI."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Measure Branching & Modularity"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Explicit measures can build upon one another (`[GrossMargin] := [TotalRevenue] - [TotalCost]`, `[Margin%] := DIVIDE([GrossMargin], [TotalRevenue])`), ensuring a single source of truth."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Measure Governance Architecture: Implicit Auto-Sum vs Explicit DAX Measure Reusability"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_7" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_7" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_7)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Model Governance & Best Practices"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_7)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic7_Implicit_measures_"
            title={"Implicit measures vs Explicit measures: Best practices in model governance - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Measure Suite Governance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a modular 30-measure explicit DAX library establishing standard corporate definitions for Revenue, EBITDA, and Return on Capital across 50 divisional analysts."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Statutory Audit Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Audited Tax Measure Library"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Develops explicit DAX formulas for Net Taxable Turnover and Input Credit Offsets to ensure uniform accounting reporting."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Standardized Factory OEE Measures"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Standardizes Availability, Performance, and Quality rate explicit measures across all plant shifts."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Cost & SLA Measure Governance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces 40 ad-hoc implicit pivot sums with 8 standardized explicit DAX measures."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Implicit Measure: Dragging numeric column into Values area | Explicit Measure: TotalSales := SUM(Sales[Amount]) in DAX Calculation Area"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Relying on Implicit Auto-Sums for Multi-Table Models"}</td>
                  <td className="py-3 px-4">{"Dragging raw columns from multiple tables into a single pivot can result in disconnected Cartesian cross-joins if relationships are complex."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always write explicit DAX measures using `SUM()`, `SUMX()`, or `CALCULATE()`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Measure Definition Duplication"}</td>
                  <td className="py-3 px-4">{"Re-typing `=SUM(Sales[Amount])` inside 10 different formulas instead of referencing `[TotalSales]` directly."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Practice Measure Branching: reference base measures by name `[BaseMeasure]`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Exposing Raw Numeric Fact Columns to Users"}</td>
                  <td className="py-3 px-4">{"Leaving raw numeric columns unhidden encourages end-users to create broken implicit sums."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Hide raw numeric fact columns in the Data Model so users ONLY interact with approved explicit measures."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Measure Branching"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Reuse existing measures to build complex modular calculations."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"[Profit] := [Revenue] - [Cost]"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Hide Fact Columns"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Forces users to use official, audited explicit DAX measures."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click column > Hide from Client Tools"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Explicit Measure Syntax"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The standard DAX definition syntax in Power Pivot calculation area."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"MeasureName := DAX_Formula"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why are Explicit DAX measures considered superior to Implicit drag-and-drop auto-sums?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is 'Measure Branching', and how does it prevent formula inconsistency across large corporate models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should data architects hide raw numeric columns from end-users in Power Pivot?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Implicit measures vs Explicit measures: Best practices in model governance - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Always write Explicit Measures! In the Power Pivot calculation area, type: `TotalSales := SUM(Sales[Amount])`. Explicit measures can be reused inside other formulas and ported directly to Power BI."}
          />
        </div>
      </div>
    </div>
