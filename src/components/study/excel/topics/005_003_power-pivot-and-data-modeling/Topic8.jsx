      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🗂️ Display Folders & Model Hygiene"} · Topic 8
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Data Model Presentation & UX"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Formatting measures, organizing display folders, and hiding technical keys from end-users"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Organizing enterprise Data Models for seamless end-user experience: configuring Display Folders, locking standard currency/percentage formats, and hiding technical foreign keys"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Power Pivot Property Grid: Formatting: Currency (₹) | Display Folder: Financials\\Margins | Hidden: True (Hide Foreign Keys)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Display Folder Grouping"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Organizes dozens of measures into nested subfolders in the PivotTable field list (e.g. `Sales\\YoY Metrics`, `Margins\\Percentages`), eliminating field list clutter."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Hiding Technical Keys from End-Users"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Hiding foreign keys (`Customer_ID_FK`, `Product_ID_FK`) and sorting helper columns prevents non-technical users from dragging useless technical codes into pivots."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Model-Level Number Formatting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formats numbers at the Data Model level once; formatting persists automatically across all PivotTables and PivotCharts throughout the entire workbook."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Data Model Ergonomics & UX: Clean Display Folders + Hidden Technical Keys + Formatted Measures"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Data Model Presentation & UX"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_8)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic8_Formatting_measure"
            title={"Formatting measures, organizing display folders, and hiding technical keys from end-users - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Field List UX Optimization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Organizes 60 corporate financial measures into 5 clean Display Folders (`Revenue`, `Gross Profit`, `Opex`, `EBITDA`, `Ratios`) for 200 non-technical sales directors."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Model Technical Key Lockdown"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Hides all internal database surrogate keys and raw integer timestamps to deliver an executive-clean tax audit pivot catalog."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Manufacturing Systems Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Machine Metrics Catalog"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Groups 40 telemetry calculations into `Shift Metrics`, `Scrap Rates`, and `Maintenance Alerts` display folders."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Performance Field Catalog"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Sets model-level INR Currency (`₹#,##0.00`) formatting on all freight billing measures."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Power Pivot Property Grid: Formatting: Currency (₹) | Display Folder: Financials\\Margins | Hidden: True (Hide Foreign Keys)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'Infinite Scroll' Field List Nightmare"}</td>
                  <td className="py-3 px-4">{"Leaving 80 unorganized measures scattered alphabetically in a flat table makes it impossible for users to locate specific KPIs."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Organize measures into logical Display Folders."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Formatting Measures Locally in Each PivotTable"}</td>
                  <td className="py-3 px-4">{"Spending 20 minutes re-formatting currency symbols in every single PivotTable manually."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Format the measure ONCE in the Power Pivot window; it will format automatically everywhere."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hiding Dimension Description Columns by Mistake"}</td>
                  <td className="py-3 px-4">{"Accidentally hiding Customer Name instead of Customer ID Key."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Audit hidden column statuses in Diagram View (hidden items appear grayed out)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Create Display Folder"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Organizes measures into neat collapsible folders in the field list."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Select measure > Property Grid > Display Folder: FolderName"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Nested Folders"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Creates multi-level nested folder hierarchies."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Use backslash: Finance\\Revenue\\YoY"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Hide from Client Tools"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Hides technical database keys from end-user view."}</p>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How do Display Folders improve spreadsheet ergonomics for non-technical executive users?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is model-level number formatting vastly superior to formatting individual PivotTable cells manually?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What columns should always be hidden from client tools in enterprise Power Pivot models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Formatting measures, organizing display folders, and hiding technical keys from end-users - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"A professional data model should look clean and friendly. Group your measures into Display Folders (like `Revenue` and `Profit Margins`) and hide all foreign key columns. Your users will love your models."}
          />
        </div>
      </div>
    </div>
