      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔌 Connecting PivotTables to the Data Model"} · Topic 11
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Data Model Front-End Integration"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Connecting Excel Pivot Tables directly to the Power Pivot Data Model"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Connecting modern Excel PivotTables directly to the Power Pivot Data Model: multi-table field lists, leveraging explicit DAX measures, and drill-through details"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Data Model Connection: Insert &gt; PivotTable &gt; Select 'Use this workbook\\'s Data Model' (Alt + N + V + M)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Multi-Table Unified Field List"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Unlike standard PivotTables that connect to a single sheet range, Data Model PivotTables display all Dimension and Fact tables in an integrated hierarchical catalog."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automatic DAX Query Generation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Every user drag, filter, and sort generates an optimized DAX query behind the scenes, executed by VertiPaq in milliseconds."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Server-Side OLAP Aggregation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculations evaluate inside the in-memory engine, returning only the aggregated summary rows to the worksheet grid."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"PivotTable Data Model Binding: VertiPaq Columnar Engine -> DAX Query Interceptor -> Interactive Pivot Canvas"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_11" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_11" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_11)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Data Model Front-End Integration"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_11)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic11_Connecting_Excel_P"
            title={"Connecting Excel Pivot Tables directly to the Power Pivot Data Model - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Executive Sales & Margin Pivot"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a unified Data Model PivotTable combining `Dim_Customer`, `Dim_Product`, `Dim_Calendar`, and `Fact_Sales` with 8 explicit DAX measures."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Multi-Table Tax Reconciliation Pivot"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pivots purchase ledgers, vendor masters, and tax rate tables in a single unified audit matrix."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Machine Downtime Pivot Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines machine telemetry facts with maintenance technician dimension tables."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Corridor Transit SLA Pivot"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pivots 3 million shipment rows across transport zones and carrier dimensions."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Data Model Connection: Insert &gt; PivotTable &gt; Select 'Use this workbook\\'s Data Model' (Alt + N + V + M)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Selecting Standard Worksheet Range by Mistake"}</td>
                  <td className="py-3 px-4">{"Clicking 'Select a table or range' connects to the sheet rather than the high-performance Data Model."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always select 'Use this workbook's Data Model' (Alt + N + V + M)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Cartesian Explosion from Missing Relationships"}</td>
                  <td className="py-3 px-4">{"Dragging fields from two unconnected tables causes the PivotTable to repeat the grand total across all rows."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Go to Diagram View and establish the missing 1-to-Many relationship."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Disabling OLAP Tools Drill-Through"}</td>
                  <td className="py-3 px-4">{"Attempting to double-click an OLAP Pivot cell when drill-through limit is set to default 1,000 rows."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"PivotTable Options > Data tab > Increase 'Maximum number of records to retrieve'."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Data Model Pivot Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly creates a PivotTable connected to the Data Model."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + N + V + M"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Convert to Formulas (OLAP)"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Transforms PivotTable into dynamic CUBEVALUE formulas for custom dashboards."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"PivotTable Analyze > OLAP Tools > Convert to Formulas"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Active vs All Tabs"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Displays all tables in the Data Model."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Click 'All' in Pivot Field List"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the operational difference between a standard Excel PivotTable and a Data Model PivotTable?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does a PivotTable display identical repeating grand totals when fields from two tables are dragged without a relationship?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does 'OLAP Tools > Convert to Formulas' unlock complete custom layout freedom for dashboard designers?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Connecting Excel Pivot Tables directly to the Power Pivot Data Model - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"When inserting a PivotTable, always choose 'Use this workbook's Data Model' (Alt + N + V + M). It gives you access to all tables, all relationships, and all explicit DAX measures in one unified field list."}
          />
        </div>
      </div>
    </div>
