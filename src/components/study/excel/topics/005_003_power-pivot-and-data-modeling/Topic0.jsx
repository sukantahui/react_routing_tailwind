      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🚀 VertiPaq In-Memory Engine"} · Topic 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"In-Memory Tabular Architecture"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Introduction to Power Pivot and the xVelocity In-Memory Tabular Engine (VertiPaq)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding Power Pivot and the VertiPaq (xVelocity) columnar in-memory calculation engine: columnar storage, dictionary encoding, run-length compression, and bit-packing"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Data Model Architecture: VertiPaq Columnar Store (In-Memory Compression) | Tabular Metadata Engine | Power Pivot Ribbon"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Columnar Storage Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Unlike traditional row-based Excel grids, VertiPaq stores each column as an independent contiguous vector in RAM, enabling 10x-20x data compression."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dictionary & Run-Length Encoding"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces repetitive strings with compact integer IDs and compresses consecutive identical values, allowing millions of rows to fit in megabytes of RAM."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. High-Speed Parallel Vector Processing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Scans billions of rows per second across multi-core CPU architectures without consuming disk I/O."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"VertiPaq Columnar Storage vs Traditional Row-Oriented Storage Architecture"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"In-Memory Tabular Architecture"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Introduction_to_Po"
            title={"Introduction to Power Pivot and the xVelocity In-Memory Tabular Engine (VertiPaq) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise 10-Million Row Transaction Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Compresses 10,000,000 corporate transaction records from 1.8 GB raw SQL into a 65 MB high-speed Power Pivot Data Model in Excel."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Multi-Year Purchase Ledger Consolidation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Loads 5 consecutive financial years of supplier purchase registers into an in-memory tabular schema for instant cross-year tax reconciliation."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Plant IoT Data Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Sensor Telemetry Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Ingests 4 million daily furnace temperature sensor readings into Power Pivot for real-time shift analytics."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Supply Chain Analytics Director"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Nationwide Freight Waybill Hub"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Maintains a 3-million row nationwide logistics manifest model refreshing in 4 seconds."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Data Model Architecture: VertiPaq Columnar Store (In-Memory Compression) | Tabular Metadata Engine | Power Pivot Ribbon"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Loading Unnecessary High-Cardinality Columns (GUIDs)"}</td>
                  <td className="py-3 px-4">{"Loading unique primary keys or transaction timestamps with milliseconds destroys VertiPaq compression ratios."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Remove high-cardinality IDs and split timestamps into Date and Hour columns."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Power Pivot Tab Missing in Excel Ribbon"}</td>
                  <td className="py-3 px-4">{"Power Pivot is an advanced COM Add-in that is disabled by default in standard Excel installations."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"File &gt; Options > Add-ins > COM Add-ins > Check 'Microsoft Power Pivot for Excel'."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing Workbook Grid Limits with Data Model Capacity"}</td>
                  <td className="py-3 px-4">{"Thinking Excel cannot handle more than 1,048,576 rows."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Load data directly into the Data Model (VertiPaq) rather than pasting onto standard worksheet grids."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Enable Power Pivot"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Activates the dedicated Power Pivot modeling ribbon."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"File &gt; Options > Add-ins > COM Add-ins > Power Pivot"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Launch Data Model Window"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Opens the standalone Power Pivot tabular modeling environment."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + B + M (or Power Pivot > Manage)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Optimize Cardinality"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Dramatically slashes file size and supercharges DAX query speeds."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Remove unnecessary high-unique columns"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does columnar storage achieve 10x to 20x higher compression than traditional row-oriented storage?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should high-cardinality columns (like unique GUIDs) be removed from Power Pivot models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does Power Pivot allow Excel users to analyze tens of millions of rows on a standard 8GB RAM laptop?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Introduction to Power Pivot and the xVelocity In-Memory Tabular Engine (VertiPaq) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Power Pivot changes everything. You are no longer trapped in Excel's 1-million row prison. With VertiPaq, you can load 15 million rows into Excel, compress it into 50MB, and pivot it in milliseconds."}
          />
        </div>
      </div>
    </div>
