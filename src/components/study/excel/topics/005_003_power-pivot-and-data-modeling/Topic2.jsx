      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⭐ Dimensional Modeling: Star vs Snowflake Schema"} · Topic 2
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Architecting enterprise dimensional schemas: differentiating Fact Tables (metrics/transactions) from Dimension Tables (business context/filters), and optimizing Star vs Snowflake schemas"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Schema Design: Star Schema (Central FactTable + Surrounding DimensionTables) | Snowflake Schema (Normalized Dimensions)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Fact Tables (Numeric Metrics)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Contains quantitative business transactions (e.g. SalesAmount, Quantity, UnitCost, Margin) alongside foreign key IDs linking to dimensions. Tall and narrow."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dimension Tables (Qualitative Context)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Contains descriptive business entities (e.g. Customer Name, Product Category, Store Region, Date). Short and wide with unique primary keys."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Star Schema Golden Rule"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"The Star Schema (1 central Fact table directly linked to 1-level Dimension tables) is the proven optimal architecture for VertiPaq compression and lightning-fast DAX calculation."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Enterprise Star Schema Architecture: Central Sales Fact Table surrounded by Dimension Satellites"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Dimensional Modeling Architecture"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_2)" fill="none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Lead Enterprise Data Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Corporate Commercial Star Schema Design"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a Star Schema centering on `Fact_Transactions` surrounded by `Dim_Customer`, `Dim_Product`, `Dim_Branch`, and `Dim_Calendar` tables."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Corporate Tax Systems Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Compliance Multi-Fact Dimensional Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Architects a multi-fact schema connecting `Fact_SalesInvoices` and `Fact_PurchaseOrders` to shared `Dim_Vendors` and `Dim_TaxRates`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Production Mix Star Schema"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects `Fact_DailyProduction` to `Dim_Machinery`, `Dim_Technicians`, and `Dim_AlloySpecifications`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 4 · Logistics Optimization Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Transit Dimensional Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links `Fact_Shipments` to `Dim_Carrier`, `Dim_OriginHub`, `Dim_DestinationHub`, and `Dim_Vehicles`."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Schema Design: Star Schema (Central FactTable + Surrounding DimensionTables) | Snowflake Schema (Normalized Dimensions)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Building a Flat 'Mega-Table' (De-Normalized Anti-Pattern)"}</td>
                  <td className="py-3 px-4">{"Merging all customer, product, and regional text attributes into a single 50-column fact table destroys memory compression."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Decompose flat tables into a normalized Star Schema: 1 Fact table + clean Dimension lookup tables."}</td>
                </tr>
                ...
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Putting Descriptive Attributes in the Fact Table"}</td>
                  <td className="py-3 px-4">{"Leaving customer addresses and telephone numbers in the 5-million row fact table wastes gigabytes of RAM."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Store descriptive attributes exclusively in Dimension tables."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Star Schema Over Snowflake"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Delivers maximum DAX calculation speed and simplest formula syntax."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Keep dimensions 1 hop away from fact"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Unique Primary Keys"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory foundation for 1-to-Many relational modeling."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Dimension key column must have 100% unique values"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Surrogate Key Optimization"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Substantially faster than long alphanumeric strings."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Use compact integer keys (e.g. 101, 102)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the fundamental functional difference between a Fact Table and a Dimension Table?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is a Star Schema vastly superior to a single giant flat table in Power Pivot?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why does excessive 'Snowflaking' of dimension tables degrade DAX query performance?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Dimensional Modeling principles: Fact Tables vs Dimension Tables (Star Schema vs Snowflake Schema) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The #1 secret to mastering Power Pivot and DAX: Build a Star Schema! Put your numbers in the central Fact table, put your categories in the surrounding Dimension tables, and connect them with 1-to-Many relationships. Everything else becomes easy."}
          />
        </div>
      </div>
    </div>
