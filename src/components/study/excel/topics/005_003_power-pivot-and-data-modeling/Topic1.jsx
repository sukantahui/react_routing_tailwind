...
import sampleWorkbookUrl from "./excel_files/power_pivot_and_data_modeling_master.xlsx?url";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🐘 Overcoming the 1-Million Row Limit"} · Topic 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Big Data Ingestion & Compression"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Overcoming Excel's 1-million row limit: Handling millions of rows with high compression"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Shattering Excel's traditional 1,048,576 row barrier: ingesting multi-million row enterprise datasets into the Data Model using Power Query connections with zero worksheet bloat"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Data Import Protocol: Data &gt; Get Data &gt; Only Create Connection -> Check 'Add this data to the Data Model'"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Connection-Only Ingestion Paradigm"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Data is streamed from SQL/CSV directly into the VertiPaq xVelocity compressed memory engine without populating worksheet grid cells."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Eliminating Workbook File Bloat"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A 5-million row CSV file of 600MB compresses to ~35MB inside the Excel `.xlsx` package."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Direct PivotTable Direct Querying"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Excel PivotTables and PivotCharts query the Data Model directly via DAX (Data Analysis Expressions) queries generated automatically in background."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Big Data Ingestion Pipeline: External Data Sources -> Power Query -> Data Model (Bypassing Grid Limit)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Big Data Ingestion & Compression"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_Overcoming_Excel_s"
            title={"Overcoming Excel's 1-million row limit: Handling millions of rows with high compression - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Banking Core Transaction Ingestion (8 Million Rows)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Streams 8,500,000 retail bank debit/credit transactions directly into the Data Model, enabling instant branch-level pivot reporting."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Statutory Tax Auditor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Enterprise GST E-Waybill Big Data Hub"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Loads 3.2 million state tax e-waybills into Excel Data Model for automated cross-checking against GSTR-2B files."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Multi-Machine Shopfloor Telemetry Ledger"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pulls 6 million sensor logs from SQL Server directly into Power Pivot with zero sheet slowdown."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Consolidated Multi-Year Transit Manifests"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Aggregates 4.8 million freight tracking milestones across 10 regional distribution centers."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Data Import Protocol: Data &gt; Get Data &gt; Only Create Connection -> Check 'Add this data to the Data Model'"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Attempting to 'Load to Table' on Multi-Million Row Datasets"}</td>
                  <td className="py-3 px-4">{"Selecting 'Table' in Power Query on a 3-million row query throws 'Data could not be written because the worksheet is full'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always select 'Only Create Connection' and CHECK 'Add this data to the Data Model'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Memory Exhaustion on 32-bit Excel"}</td>
                  <td className="py-3 px-4">{"32-bit Excel is capped at 2GB virtual RAM; loading 10 million rows throws 'Out of Memory'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Install 64-bit Microsoft Office to utilize full system RAM (16GB+)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Duplicate Source Query Refreshes"}</td>
                  <td className="py-3 px-4">{"Loading the same large table both to a worksheet grid and the Data Model doubles memory consumption."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Store large master facts exclusively in the Data Model."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Connection Only + Data Model"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The golden setting to bypass Excel's 1-million row grid barrier."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Check 'Add this data to the Data Model'"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"64-Bit Excel Mandatory"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Unlocks unlimited memory addressing for multi-million row datasets."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"File &gt; Account > About Excel"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Query Folding Before Model Load"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Minimizes initial data transfer time by 80%."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Push filter operations to SQL server"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must you select 'Only Create Connection' when importing datasets exceeding 1,048,576 rows?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is 64-bit Excel mandatory for enterprise-scale Power Pivot data modeling?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does the Data Model allow PivotTables to aggregate 10 million rows in under half a second?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Overcoming Excel's 1-million row limit: Handling millions of rows with high compression - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"When loading big data, never click 'Load' directly. Click the little arrow next to Load -> 'Load To...' -> select 'Only Create Connection' and check 'Add this data to the Data Model'. That is how pros handle millions of rows."}
          />
        </div>
      </div>
    </div>
