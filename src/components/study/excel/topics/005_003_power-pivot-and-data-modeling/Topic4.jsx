      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧭 Cross-Filter Direction & Path Resolution"} · Topic 4
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Filter Propagation & Directionality"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Cross-filter direction: Single vs Both directions and avoiding ambiguous relationship paths"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding filter propagation and cross-filter direction: default Single Direction (Dimension to Fact), dangers of Bi-directional filtering, and resolving ambiguous relationship paths"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Cross-Filter Direction: Single Direction (Dim -> Fact) | Both Directions (Bi-Directional Filtering) | Manage Relationships"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Natural Single-Direction Flow (Dim -> Fact)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"By default, filters placed on a Dimension table flow DOWN to the Fact table. Filters placed on a Fact table do NOT flow back up to dimensions."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Danger of Bi-Directional Filtering ('Both')"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Enabling Bi-directional filtering allows filters to travel in both directions, but introduces ambiguous cyclic calculation loops and severe performance degradation."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Dynamic DAX Directional Control"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Instead of permanent model-level Bi-directional relationships, use targeted DAX functions (`CROSSFILTER()`) inside explicit measures."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Filter Propagation Architecture: Dimension Filter -> Natural Flow Down -> Fact Table (Single vs Bi-Directional)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Filter Propagation & Directionality"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_4)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic4_Cross_filter_direc"
            title={"Cross-filter direction: Single vs Both directions and avoiding ambiguous relationship paths - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Filter Propagation Governance"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Maintains strict Single-Direction relationships across an 8-table financial schema, using `CROSSFILTER()` inside DAX for specialized cross-fact counting."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Active Vendor Spend Filtering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses dynamic DAX cross-filtering to count how many registered vendors had zero transactions in the current tax year."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Resolving Circular Relationship Loops"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deconstructs ambiguous relationship loops between `Dim_Shift`, `Fact_Production`, and `Fact_Downtime`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Driver Assignment Cross-Filtering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Safely handles driver-to-vehicle cross-filtering without causing ambiguous routing cycles."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Cross-Filter Direction: Single Direction (Dim -> Fact) | Both Directions (Bi-Directional Filtering) | Manage Relationships"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Defaulting to Bi-Directional Filtering Everywhere"}</td>
                  <td className="py-3 px-4">{"Setting all relationships to 'Both' cross-filter direction creates unpredictable results and massive CPU slowdowns."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Keep relationships as Single direction; use DAX `CROSSFILTER(..., BOTH)` only when explicitly needed."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Ambiguous Relationship Paths Error"}</td>
                  <td className="py-3 px-4">{"Creating multiple active relationship paths between the same two tables causes Power Pivot to disable one path."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use Inactive relationships and activate them dynamically in DAX with `USERELATIONSHIP()`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Expecting Fact Filters to Filter Dimension Slicers"}</td>
                  <td className="py-3 px-4">{"Wondering why filtering Fact_Sales doesn't reduce items in a Dim_Product slicer under Single Direction."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use measure-based visual filtering or explicit DAX filtering expressions."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Single Direction Default"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees clean, predictable, high-speed filter propagation."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Always use Single Direction by default"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"CROSSFILTER Function"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Enables bi-directional filtering temporarily for a single calculation."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=CALCULATE([Measure], CROSSFILTER(Dim[Key], Fact[Key], BOTH))"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Inspect Filter Arrows"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Shows exactly how filter selections flow across tables."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Look at arrow direction in Diagram View"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why do filters naturally flow from Dimension tables to Fact tables, but not in reverse under Single Direction?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What serious modeling risks and performance penalties occur when Bi-Directional ('Both') filtering is overused?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does the DAX `CROSSFILTER()` function allow targeted bi-directional filtering without corrupting the global model?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Cross-filter direction: Single vs Both directions and avoiding ambiguous relationship paths - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Keep your relationship arrows pointing ONE way: from Dimension to Fact. Never turn on 'Both' unless you have a very specific reason and understand the consequences. Use DAX CROSSFILTER instead!"}
          />
        </div>
      </div>
    </div>
