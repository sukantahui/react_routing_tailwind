    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔗 Relationships & 1-to-Many Cardinality"} · Topic 3
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Creating, validating, and managing 1-to-Many (1:*) relational models in Power Pivot Diagram View: primary keys, foreign keys, and referential integrity"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The 1-to-Many (1:*) Golden Standard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Dimension side MUST contain unique, non-duplicate primary keys (1). Fact table side contains multiple matching occurrences (*)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Eliminating VLOOKUP from Spreadsheets"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Relationships allow PivotTables to slice Fact metrics by Dimension attributes instantly without writing a single VLOOKUP or XLOOKUP formula."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Diagram View Visual Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Power Pivot Diagram View allows modelers to visually drag-and-drop relationship links between tables in seconds."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_3)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Relational Data Modeling"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_3)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Relational Schema Linking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds 6 core 1-to-Many relationships connecting central sales facts to customer, product, and regional sales branches in Diagram View."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Vendor Master to Purchase Ledger Linkage"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Establishes a 1:* relationship between `Dim_VendorMaster` (GSTIN) and `Fact_PurchaseLedger` for instant audited vendor spend pivots."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine ID to Daily Log Relational Schema"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Links `Dim_Machinery` (MachineID) to 500,000 records in `Fact_MaintenanceLogs`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Route ID to Shipment Manifest Relations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects `Dim_Routes` (RouteCode) to nationwide shipment manifests."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'Column Contains Duplicate Values' Fatal Error"}</td>
                  <td className="py-3 px-4">{"Attempting to create a relationship where the '1' side dimension table contains duplicate key values."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure the dimension key column has 100% unique values using Power Query `Remove Duplicates`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Many-to-Many Relationship Ambiguity"}</td>
                  <td className="py-3 px-4">{"Connecting two fact tables directly together creates ambiguous cartesian explosion."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Introduce a shared bridge Dimension table between the two Fact tables."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Data Type Mismatch Between Relational Keys"}</td>
                  <td className="py-3 px-4">{"Key column in Dimension table is formatted as Text while Foreign Key in Fact table is Whole Number."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Align data types identically in Power Query prior to establishing relationships."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Drag from Dim (1) to Fact (*)"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Standard practice to establish clean 1-to-Many relationships."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Drag key from dimension table to fact table"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Verify Unique Key"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees relationship creation without validation errors."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Power Query > Remove Duplicates on Dim key"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does Power Pivot reject creating a relationship if the dimension table contains duplicate key values?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do Power Pivot relationships completely eliminate the need for millions of VLOOKUP formulas?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should you never connect two Fact tables directly to each other without a bridge dimension table?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Creating and managing relationships: One-to-Many (1:*) and Cardinality - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Say goodbye to VLOOKUP forever! In Power Pivot Diagram View, simply drag 'CustomerID' from Dim_Customer to Fact_Sales. That 1-second drag replaces 500,000 VLOOKUP formulas and recalculates 1,000x faster."}
          />
        </div>
      </div>
    </div>
