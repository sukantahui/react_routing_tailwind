      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📅 Dedicated Calendar & Date Dimensions"} · Topic 5
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Designing a dedicated Calendar / Date Dimension table (Standard and Fiscal calendars)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Engineering an institutional, dedicated Date Dimension (Calendar Table) required for all Time Intelligence DAX calculations: continuous dates, fiscal calendars, and Mark as Date Table"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Calendar Table: Power Pivot &gt; Design &gt; Date Table &gt; New | DAX Calculated Table: Dim_Calendar = CALENDAR(DATE(2022,1,1), DATE(2030,12,31))"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Mandatory Time Intelligence Prerequisites"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"1. Must contain continuous dates with NO gaps; 2. Must cover full historical and projection years; 3. Must be explicitly flagged with 'Mark as Date Table'."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Standard vs Fiscal Calendar Engineering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds Indian Fiscal Year (`FY 2026-27`), Fiscal Quarter (Q1 = Apr-Jun), and Fiscal Month Number (Apr = Month 1) columns."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Sort by Column Configuration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Month Name ('April', 'May') must be configured with 'Sort by Column -> MonthNumberOfYear' to prevent alphabetical sorting ('April', 'August', 'December')."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Date Dimension Engine: Continuous Date Spine -> Extended Attributes (Fiscal Year, Quarter, Month Name, DayOfWeek)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Time Intelligence Foundation"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_5)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic5_Designing_a_dedica"
            title={"Designing a dedicated Calendar / Date Dimension table (Standard and Fiscal calendars) - Interactive Practice Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Director of FP&A"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Indian Fiscal Year Calendar (Apr-Mar)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a dedicated Indian Fiscal Calendar table spanning 2020 to 2030 with Fiscal Year, Fiscal Quarter, and Working Day flags."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statutory Tax Quarter & Due Date Calendar"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs calendar tables mapping statutory GST and Advance Tax filing deadline windows."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Plant Production Controller"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory 4-4-5 Manufacturing Accounting Calendar"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds retail/manufacturing 4-4-5 accounting period dimensions for weekly yield tracking."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: National Transit Holiday & Working Day Calendar"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds custom holiday and weekend boolean flags to calculate true business delivery turnaround days."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open Power Pivot window (<kbd className="px-1.5 py-0.5 rounded bg-slate-800 font-mono text-xs text-sky-300">Alt + B + M</kbd>), switch to Diagram View, and drag Primary Keys to Foreign Keys <code className="text-cyan-300 font-mono font-bold">{"Calendar Table: Power Pivot &gt; Design &gt; Date Table &gt; New | DAX Calculated Table: Dim_Calendar = CALENDAR(DATE(2022,1,1), DATE(2030,12,31))"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Date Gaps (Breaks Time Intelligence)"}</td>
                  <td className="py-3 px-4">{"Creating a calendar table from sales transactions containing days with zero sales breaks DAX time intelligence functions like TOTALYTD."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Generate a continuous date sequence using `=CALENDAR(StartDate, EndDate)` or Power Pivot > Date Table > New."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Alphabetical Month Sorting Trap"}</td>
                  <td className="py-3 px-4">{"PivotTables displaying months as 'April, August, December, February, January...'"}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Select 'MonthName' column > Home &gt; Sort by Column > Select 'MonthNumber'."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Generate Date Table"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly creates a complete standard calendar table in 1 click."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Design tab > Date Table > New"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Sort by Column Mandatory"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees chronological sorting in all PivotTables and charts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Sort MonthName by MonthNumber"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must a Calendar table contain a 100% contiguous sequence of dates with zero missing days?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why do Month names sort alphabetically by default, and how does 'Sort by Column' fix it?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the operational purpose of 'Mark as Date Table' in Power Pivot?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Designing a dedicated Calendar / Date Dimension table (Standard and Fiscal calendars) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Rule #1 of DAX: Never use the date column inside your Fact table for pivots! Always create a dedicated Calendar table, link it to your fact table, and mark it as a Date Table. Then time intelligence works like magic."}
          />
        </div>
      </div>
    </div>
