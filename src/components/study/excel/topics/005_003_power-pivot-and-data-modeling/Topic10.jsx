    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🚦 Power Pivot KPI Status Thresholds"} · Topic 10
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Executive Milestone Visuals"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Configuring native Power Pivot Key Performance Indicators (KPIs): defining Base Measures, Target Benchmarks, and dynamic 3-color Status Thresholds (Traffic Lights / Gauges)"}. Master the complete VertiPaq in-memory engine, Star Schema dimensional modeling, 1-to-Many relationships, Date dimensions, and enterprise model governance.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The 3 Components of a Power Pivot KPI"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"1. Base Measure (Actual Value); 2. Target Goal (Fixed Number or Dynamic Target Measure); 3. Status Thresholds (Percentage bands defining Red, Yellow, and Green zones)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Integrated Status & Trend Fields"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Power Pivot KPIs generate three sub-fields in the PivotTable list: `Value`, `Goal`, and `Status` (which automatically renders graphical traffic light icons)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Dynamic Ratio Benchmarking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"When target is a dynamic measure (`[BudgetSales]`), the KPI automatically adjusts targets when users filter across quarters or regions."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod13_10" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod13_10" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_10)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Executive Milestone Visuals"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod13_10)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Regional Revenue Target KPI Console"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a corporate KPI evaluating `[ActualRevenue]` against `[TargetRevenue]` with Red (`<90%`), Yellow (`90-99%`), and Green (`>=100%`) traffic lights."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Opex Budget Compliance KPI"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures reverse-threshold expense KPIs where spending `<95%` of budget is Green and `>105%` is Red."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Scrap Threshold KPI"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors daily casting defect percentages against ISO quality tolerance standards."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: On-Time Transit SLA KPI"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks delivery punctuality against 98.5% contractual carrier commitments."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Reversed Thresholds for Cost Metrics"}</td>
                  <td className="py-3 px-4">{"Showing green traffic lights when departmental expenses exceed budget limits."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Select the inverted status icon pattern (Lower is Better) in KPI setup."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"KPI Icons Not Rendering in Older Excel Viewers"}</td>
                  <td className="py-3 px-4">{"Opening modern Data Model KPIs in third-party spreadsheet viewers can render status icons as raw integer values (-1, 0, 1)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure corporate viewers use standard modern Microsoft Excel versions."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Choose Icon Graphic"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Customizes visual presentation for executive scorecards."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Select Traffic Lights, Stars, or Flags"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is linking a KPI target to a dynamic Measure superior to setting a fixed static number?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do Power Pivot KPIs automatically render graphic traffic light icons in PivotTable cells?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why must the status threshold logic be inverted for cost and defect rate KPIs?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the columnar compression architecture and relational data modeling principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Defining Key Performance Indicators (KPIs) with status thresholds in Power Pivot - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Power Pivot KPIs add instant executive polish. In the Power Pivot window, select your measure, click 'New KPI', set your budget target measure, and pick Traffic Light icons. Your PivotTables will display real graphical status badges."}
          />
        </div>
      </div>
    </div>
