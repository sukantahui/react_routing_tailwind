      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Eliminating empty edge cells and ragged spill borders with TRIMRANGE and range operators
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            <code className="text-sm sm:text-base font-mono text-emerald-300 block bg-slate-900 p-3 rounded-xl border border-slate-800 overflow-x-auto">
              =TRIMRANGE(range, [trim_row_mode], [trim_col_mode])
            </code>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Removes leading, trailing, or all blank boundary rows and columns from dynamic arrays and grid ranges.
            </p>
          </div>
        </section>
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Dynamic Array Boundary Trimming with TRIMRANGE Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Dynamic Array Boundary Trimming with TRIMRANGE"
