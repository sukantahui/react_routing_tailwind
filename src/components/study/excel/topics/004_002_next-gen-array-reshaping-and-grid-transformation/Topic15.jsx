...
import sampleWorkbookUrl from "./excel_files/next_gen_array_reshaping_and_grid_transformation_master.xlsx?url";
...
export default function Topic15() {
  ...
  const handleDownload = () => {
    ...
    link.download = "next_gen_array_reshaping_and_grid_transformation_master.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-950/80 border border-sky-800 text-sky-300 text-xs font-semibold uppercase tracking-wider mb-4">
            <span>📊</span> Excel Masterclass · Topic 15
          </div>
          <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent tracking-tight">
            Matrix Algebra & Simultaneous Linear Systems
          </h1>
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Solving multi-variable engineering and financial equations with MMULT, MINVERSE, and MDETERM
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            <code className="text-sm sm:text-base font-mono text-emerald-300 block bg-slate-900 p-3 rounded-xl border border-slate-800 overflow-x-auto">
              =MMULT(array1, array2) / =MINVERSE(array) / =MDETERM(array)
            </code>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Executes matrix multiplication, calculates matrix inverses, and computes determinants to solve systems of linear equations (A*X = B &rarr; X = A^-1 * B).
            </p>
          </div>
        </section>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic15_Matrix_Algebra"
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Matrix Algebra & Simultaneous Linear Systems Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Matrix Algebra & Simultaneous Linear Systems"
