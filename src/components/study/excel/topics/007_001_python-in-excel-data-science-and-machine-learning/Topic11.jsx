    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🤝 Sharing Python Workbooks with Team Members"} · Topic 11
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Sharing Python-powered Excel workbooks with non-technical stakeholders: understanding recipient license requirements, viewing calculated values without Python licenses, and workbook optimization"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Standard .XLSX File Format"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Python-powered workbooks save as standard `.xlsx` files with zero macro security warnings or special file extensions."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Seamless Recipient Experience"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Recipients with Microsoft 365 can open, view, and interact with Python-generated charts, tables, and metrics even if they know zero Python."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Cloud Calculation Infrastructure"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"When formulas recalculate, Microsoft Azure handles the Python execution transparently in the background."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_11" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_11" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_11)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Enterprise Collaboration & Governance"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_11)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Distributing Python Predictive Model to 50 Sales Directors"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Shares a customer churn prediction workbook saved as standard `.xlsx` with 50 regional sales directors who view churn risk scores seamlessly."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Boardroom Tax Audit Deck Distribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Distributes Python-audited general ledger models to external statutory auditors with zero software installation requirements."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Quality Summary Distribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Publishes Python seaborn quality trend decks to plant supervisors across tablet devices."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Nationwide Route Optimization Model Sharing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Distributes freight optimization workbooks to depot managers."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Recipient Opening File in Legacy Desktop Excel 2016 / 2019"}</td>
                  <td className="py-3 px-4">{"Legacy perpetual Office versions lack cloud Python runtime, displaying `#NAME?` error on `=PY()` cells."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Advise recipients to open file in Excel for Web or upgrade to Microsoft 365."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving 50 Unneeded Visualizations Rendering on Every Calc"}</td>
                  <td className="py-3 px-4">{"Recalculating 50 complex seaborn plots simultaneously on every cell edit causes cloud latency."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Convert static finalized plots to Excel Values or image snapshots."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing Co-Authoring Lockups"}</td>
                  <td className="py-3 px-4">{"Multiple users editing Python code cells simultaneously in live co-authoring sessions."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Designate specific input assumption cells for collaborators while locking Python formula cells."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Standard .xlsx Format"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Saves as standard clean Excel workbook."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"No .xlsm required"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Excel for Web Fallback"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees cross-platform viewing on Mac, Linux, and tablets."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Opens in any web browser"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is saving Python in Excel workbooks as standard `.xlsx` a major advantage over legacy macro `.xlsm` files?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How can non-technical team members interact with Python predictive models without knowing any Python code?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What should a user do if they open a Python workbook in an older version of Excel that displays `#NAME?`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Sharing Python-powered workbooks with non-technical team members seamlessly - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The best part about Python in Excel is that you can email your workbook to your boss as a standard `.xlsx` file. They don't need Python installed, they don't see scary macro warnings—they just see your beautiful charts and predictions!"}
          />
        </div>
      </div>
    </div>
