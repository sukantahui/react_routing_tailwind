      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🤖 Machine Learning with scikit-learn in Excel"} · Topic 9
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Applied Machine Learning & Predictive AI"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Predictive modeling and machine learning with scikit-learn (Classification, Clustering, Decision Trees)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building predictive machine learning workflows natively inside Excel using scikit-learn: data splitting (train_test_split), classification (Random Forest), clustering (K-Means), and model evaluation (accuracy, confusion matrix)"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Machine Learning: from sklearn.ensemble import RandomForestClassifier; model = RandomForestClassifier(n_estimators=100); model.fit(X_train, y_train); y_pred = model.predict(X_test)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The scikit-learn Estimator API"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Standardized 3-step workflow: 1. Instantiate model (`RandomForestClassifier()`); 2. Train model (`model.fit(X, y)`); 3. Generate predictions (`model.predict(new_data)`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Supervised Classification & Regression"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Predicts customer churn, loan default risk, lead conversion probability, and dynamic pricing."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Unsupervised Clustering (K-Means)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`KMeans(n_clusters=4).fit(X)` segments thousands of customers into behavioral demographic clusters in seconds."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Machine Learning Pipeline in Excel: Feature Matrix & Labels -> Train/Test Split -> Model Training (scikit-learn) -> Predictions & Accuracy Scorecard"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Applied Machine Learning & Predictive AI"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_9)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic9_Predictive_modelin"
            title={"Predictive modeling and machine learning with scikit-learn (Classification, Clustering, Decision Trees) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Customer Churn Machine Learning Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Trains a Random Forest classifier in Excel predicting enterprise client churn with 92.4% accuracy, outputting at-risk accounts to account managers."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Fraudulent Tax Invoice Classifier"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Trains an Isolation Forest anomaly detection model flagging suspicious vendor invoices for audit."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machinery Predictive Maintenance Classifier"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Predicts plant equipment breakdown risk 48 hours in advance using sensor features."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: K-Means Regional Warehouse Depot Clustering"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Clusters 10,000 retail delivery coordinates into 4 optimized regional distribution zones."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Machine Learning: from sklearn.ensemble import RandomForestClassifier; model = RandomForestClassifier(n_estimators=100); model.fit(X_train, y_train); y_pred = model.predict(X_test)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Data Leakage During Feature Preprocessing"}</td>
                  <td className="py-3 px-4">{"Fitting encoders or scalers on the entire dataset before splitting into train/test sets."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always split data first: `X_train, X_test, y_train, y_test = train_test_split(X, y)`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Passing Categorical Text Directly to scikit-learn"}</td>
                  <td className="py-3 px-4">{"scikit-learn algorithms require pure numeric matrices; passing text strings throws ValueError."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Encode text columns using `pd.get_dummies()` or `LabelEncoder()`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overfitting on Small Sample Datasets"}</td>
                  <td className="py-3 px-4">{"Training complex deep trees on 50 rows of data."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use cross-validation and regularize tree depth (`max_depth=5`)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Train/Test Split"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Evaluates true generalization accuracy."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"from sklearn.model_selection import train_test_split"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"One-Hot Encoding"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Converts text categories into numeric features."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"pd.get_dummies(df, drop_first=True)"}</kbd>
            </div>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Evaluates false positives and false negatives."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"from sklearn.metrics import confusion_matrix"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must machine learning models be evaluated on unseen test data (`X_test`) rather than training data?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must categorical text columns be converted to numbers (e.g. `pd.get_dummies`) before training scikit-learn models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does K-Means clustering group thousands of customers into behavioral segments without pre-existing labels?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Predictive modeling and machine learning with scikit-learn (Classification, Clustering, Decision Trees) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"You are running real Machine Learning directly inside Microsoft Excel! Train a Random Forest model in cell A1, predict customer churn in cell B1, and your spreadsheet becomes an enterprise AI prediction machine."}
          />
        </div>
      </div>
    </div>
