...
import sampleWorkbookUrl from "./excel_files/python_in_excel_data_science_and_machine_learning_master.xlsx?url";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🐍 Introduction to Python in Excel"} · Topic 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Cloud Data Science Architecture"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Introduction to Python in Excel: Running secure Python analytics natively in Microsoft Cloud containers"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding Microsoft Python in Excel architecture: secure cloud container sandbox execution, Anaconda distribution integration (pandas, numpy, statsmodels, seaborn), and zero local Python setup"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Python in Excel Entry: =PY(import pandas as pd; import seaborn as sns; df = xl(\"A1:D100\", headers=True); df.describe())"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Native Azure Container Sandbox"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Python code runs in isolated Microsoft Cloud hypervisor containers. Zero local Python or pip installation required on user laptops."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Pre-Loaded Anaconda Data Science Stack"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Comes pre-packaged with industry-standard libraries: pandas, numpy, scipy, matplotlib, seaborn, statsmodels, and scikit-learn."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Enterprise Security & Data Isolation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Containers have zero internet access, preventing data leaks. Containers spin down automatically after calculation."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Python in Excel Architecture: Excel Grid -> Azure Hyper-V Sandbox -> Anaconda Python 3.11 Runtime -> Python Object / Value Return"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Cloud Data Science Architecture"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Introduction_to_Py"
            title={"Introduction to Python in Excel: Running secure Python analytics natively in Microsoft Cloud containers - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Financial Econometrics Pipeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Runs sophisticated statistical regressions and Monte Carlo simulations on corporate data using Python directly in Excel cells."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Outlier Detection with Isolation Forests"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applies Python machine learning algorithms to detect anomalies across 100,000 purchase tax records in Excel."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 3 · Plant Data Scientist"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Sensor Signal FFT Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Performs Fast Fourier Transform (FFT) signal processing on industrial vibration telemetry using Python scipy."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Logistics Fuel Price Forecasting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds ARIMA time-series models for quarterly fuel tariff projections."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Python in Excel Entry: =PY(import pandas as pd; import seaborn as sns; df = xl(\"A1:D100\", headers=True); df.describe())"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Attempting to Connect to Internet / External APIs (Security Sandbox)"}</td>
                  <td className="py-3 px-4">{"Calling `requests.get()` or socket connections inside Python in Excel fails because Azure containers have zero outbound internet access."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ingest external web data via Power Query first, then pass the table into Python via `xl()`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Attempting to Install Custom Pip Packages"}</td>
                  <td className="py-3 px-4">{"Running `!pip install my_package` is not supported in the locked Anaconda sandbox."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use the extensive built-in Anaconda data science library suite."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Saving Files to Local Disk from Python"}</td>
                  <td className="py-3 px-4">{"Calling `df.to_csv(\"C:\\data.csv\")` fails in cloud containers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Output results directly to worksheet cells as Excel Values."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Toggle Python Mode"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Activates Python formula editor mode in active cell."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Type =PY in cell or press Ctrl + Alt + Shift + P"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Formula Bar Expansion"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Expands formula bar for comfortable multi-line Python coding."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Shift + U"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Commit Python Code"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates Python formula and executes in Azure container."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Enter"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does Python in Excel run inside Microsoft Azure cloud containers rather than on your local computer?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why are outbound internet calls (`requests.get`) blocked inside Python in Excel containers?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do pre-loaded Anaconda libraries eliminate pip installation issues for enterprise corporate users?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Introduction to Python in Excel: Running secure Python analytics natively in Microsoft Cloud containers - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Python is now a native formula inside Excel! Just type `=PY` and press Tab. You can write real Python code, use pandas DataFrames, and run machine learning without installing Python on your computer."}
          />
        </div>
      </div>
    </div>
