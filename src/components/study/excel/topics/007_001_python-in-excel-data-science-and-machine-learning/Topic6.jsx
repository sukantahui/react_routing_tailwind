      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⏱️ Time-Series Analysis & Trend Decomposition"} · Topic 6
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Time-series analysis, rolling statistics, and trend decomposition with pandas"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Engineering time-series models and rolling statistics with pandas: datetime index conversion, resampling (daily to monthly), rolling moving averages, lag features, and seasonal trend decomposition"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Time Series: df['Date'] = pd.to_datetime(df['Date']); df.set_index('Date', inplace=True); df['Rolling_7D'] = df['Sales'].rolling('7D').mean()"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Native Datetime Indexation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Converts raw date strings to `pd.to_datetime()` and sets as DatetimeIndex, unlocking high-speed calendar slicing (`df['2026-Q1']`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dynamic Rolling Windows (`.rolling()`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates 7-day, 30-day, and 90-day moving averages and rolling standard deviations with zero row offset formula errors."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Seasonal Trend Decomposition"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Decomposes revenue time series into Trend, Seasonal, and Residual components using `statsmodels.tsa.seasonal_decompose()`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Time-Series Decomposition Architecture: Datetime Ingestion -> Resampling -> Rolling Windows -> Trend & Seasonality Extraction"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_6" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_6" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_6)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Time Series & Trend Analysis"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_6)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic6_Time_series_analys"
            title={"Time-series analysis, rolling statistics, and trend decomposition with pandas - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: 3-Year Revenue Trend & Seasonality Decomposition"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Decomposes 36 months of corporate revenue into underlying secular growth trends and Diwali seasonal spikes using Python."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly Tax Outflow Resampling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Resamples daily voucher records into monthly tax liability summaries using `df.resample('ME').sum()`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Vibration 30-Day Rolling Volatility"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes rolling standard deviation of furnace sensor metrics to predict bearing failure."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: 7-Day Rolling Freight Volume Forecast"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates 7-day moving average carrier freight shipments for depot dispatch scheduling."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Time Series: df['Date'] = pd.to_datetime(df['Date']); df.set_index('Date', inplace=True); df['Rolling_7D'] = df['Sales'].rolling('7D').mean()"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Failing to Convert Dates to pd.to_datetime() First"}</td>
                  <td className="py-3 px-4">{"Calling `.resample()` or date slicing on string date columns throws TypeError."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always convert date column: `df['Date'] = pd.to_datetime(df['Date']); df.set_index('Date', inplace=True)`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unsorted Datetime Index Breaking Rolling Windows"}</td>
                  <td className="py-3 px-4">{"Calculating rolling averages on chronologically unsorted data produces invalid trend metrics."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always sort index before time series operations: `df.sort_index(inplace=True)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Resample Frequency Deprecation Warnings ('M' vs 'ME')"}</td>
                  <td className="py-3 px-4">{"Using deprecated frequency string `'M'` in newer pandas versions."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use modern frequency aliases: `'ME'` (Month End), `'QE'` (Quarter End), `'YE'` (Year End)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Rolling 7-Day Average"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Smooths out day-of-week volatility."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df['Sales'].rolling(7).mean()"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Monthly Resample"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Aggregates daily data into clean monthly buckets."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df.resample('ME').sum()"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Date Range Slicing"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Intuitive date range filtering on DatetimeIndex."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df['2026-01':'2026-03']"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must date columns be converted using `pd.to_datetime()` and set as index before running time-series operations?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does `.rolling(7).mean()` eliminate daily noise and reveal true underlying sales trends?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the difference between resampling daily data to monthly (`.resample('ME').sum()`) versus a rolling window?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Time-series analysis, rolling statistics, and trend decomposition with pandas - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Time-series in pandas is unbeatable. Set your date column as the index (`df.set_index('Date')`), and you can calculate 30-day moving averages in one command: `df['Sales'].rolling(30).mean()`."}
          />
        </div>
      </div>
    </div>
