      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📦 Python Objects vs Excel Values"} · Topic 2
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Object Encapsulation & Output Modes"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Python Objects vs Excel Values: Viewing DataFrames and data structures in cells"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Navigating Python Objects versus Excel Values: DataFrame card exploration, inspecting nested properties, formula bar preview cards, and converting objects to dynamic spilled array grids"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Output Toggle: Ctrl + Alt + Shift + M (Toggle between Python Object [Card Icon] and Excel Value [Spill Array])"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Python Object Mode (Data Card)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Stores complex data structures (DataFrames, Series, ML Models, Dictionaries) inside a single cell represented by a compact card icon."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Interactive Card Inspection Preview"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Clicking the card icon opens a rich interactive preview showing rows, columns, data types, and summary statistics without cluttering the sheet."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Excel Value Mode (Dynamic Array Spill)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts underlying scalar data or tabular arrays, spilling values directly across neighboring cells like standard dynamic array formulas."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Python Output Modes: Python Object (Encapsulated Data Card) vs Excel Value (Native Spilled Grid)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Object Encapsulation & Output Modes"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Python_Objects_vs_"
            title={"Python Objects vs Excel Values: Viewing DataFrames and data structures in cells - Interactive Practice Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 1 · Chief Financial Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Encapsulating 1-Million Row DataFrames in 1 Cell"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Stores a 1-million-row customer transaction DataFrame in cell A1 as a Python Object, and extracts summary metrics in cell B1."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Interactive Tax DataFrame Inspection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Inspects multi-column tax calculation cards without expanding thousands of intermediate columns on the worksheet."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Learning Model Object Storage"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Stores trained scikit-learn Random Forest model in cell C5, passing model object into scoring cells."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Spilling Filtered Freight Tables"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Converts filtered logistics DataFrame into Excel Values to spill formatted delivery schedules across worksheet."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Output Toggle: Ctrl + Alt + Shift + M (Toggle between Python Object [Card Icon] and Excel Value [Spill Array])"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Spill Range Collision (#SPILL! Error) in Excel Value Mode"}</td>
                  <td className="py-3 px-4">{"Switching a large DataFrame to Excel Value mode when neighboring cells contain text or formulas blocking the spill area."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure empty canvas cells below and to the right of the formula cell."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Extracting Complex Objects as Values (Unreadable Output)"}</td>
                  <td className="py-3 px-4">{"Setting output mode to Excel Value on a trained ML Model or complex nested dictionary."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Keep complex non-tabular objects as Python Objects."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting Keyboard Shortcut to Toggle Modes"}</td>
                  <td className="py-3 px-4">{"Manually right-clicking every cell to change output format."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press `Ctrl + Alt + Shift + M` to toggle instantly."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Toggle Output Mode"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly switches active cell between Python Object and Excel Value."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Alt + Shift + M"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Click Card Icon"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Opens rich flyout preview of DataFrame contents."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Click cell card icon"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Extract Specific Column"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Pulls specific Series from an existing DataFrame cell."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df['Revenue'] in next Python cell"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the difference between a Python Object and an Excel Value in Excel cells?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is storing a 500,000-row DataFrame as a Python Object in a single cell superior to spilling 500,000 rows across the sheet?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you toggle between Python Object and Excel Value modes using the keyboard?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Python Objects vs Excel Values: Viewing DataFrames and data structures in cells - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Python Objects are like magical containers. You can hold 500,000 rows in ONE single cell (cell A1). When you want to see the numbers on the sheet, press Ctrl + Alt + Shift + M to spill them as Excel Values."}
          />
        </div>
      </div>
    </div>
