      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📈 Descriptive Statistics & Correlation Matrices"} · Topic 4
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Descriptive statistics and summary matrices with pandas (`describe()`, `corr()`, `value_counts()`)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Generating comprehensive exploratory data analysis (EDA) summary matrices with pandas: descriptive statistics (mean, std, quartiles), correlation matrices, covariance, and frequency distributions"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Summary Statistics: df.describe() | Correlation Matrix: df.corr(numeric_only=True) | Value Counts: df['Category'].value_counts() | Skew/Kurt: df.skew(), df.kurt()"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Automated 8-Metric Statistical Profiling (`describe()`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes count, mean, standard deviation, min, 25%, 50% (median), 75%, and max across all numeric columns in a single command."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. High-Speed Multi-Variable Correlation (`corr()`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates full Pearson / Spearman correlation matrices revealing hidden statistical relationships between pricing, volume, and profitability."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Categorical Frequency Profiling (`value_counts()`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes exact distribution counts and normalized percentages across categorical dimensions."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Exploratory Data Analysis (EDA) Pipeline: Raw Data -> pandas describe() -> Correlation Matrix -> Frequency Profiling"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Exploratory Data Analysis (EDA)"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_4)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic4_Descriptive_statis"
            title={"Descriptive statistics and summary matrices with pandas (`describe()`, `corr()`, `value_counts()`) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Pricing & Profit Elasticity Analysis"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates a 10x10 correlation matrix analyzing price sensitivity, discount rates, and customer lifetime value across corporate divisions."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statistical Outlier Profiling in Vendor Invoices"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses `df['TaxRate'].describe()` and quartile thresholds to identify non-standard tax rates."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Casting Tensile Strength Distribution Matrix"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates standard deviation, skewness, and kurtosis of factory steel strength measurements."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Transit Delay Statistical Profile"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Profiles delivery transit variances and 95th percentile delay outliers."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Summary Statistics: df.describe() | Correlation Matrix: df.corr(numeric_only=True) | Value Counts: df['Category'].value_counts() | Skew/Kurt: df.skew(), df.kurt()"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Correlation Crashing on Non-Numeric Text Columns"}</td>
                  <td className="py-3 px-4">{"Calling `df.corr()` in newer pandas versions on DataFrames with text columns throws ValueError."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always pass `numeric_only=True`: `df.corr(numeric_only=True)`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing Correlation with Causation"}</td>
                  <td className="py-3 px-4">{"Assuming high correlation (0.85) automatically means Variable A causes Variable B."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Validate statistical correlations with domain expertise and regression hypothesis testing."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing NaN Treatment in Correlation"}</td>
                  <td className="py-3 px-4">{"Datasets with extreme missing values distorting correlation matrices."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Inspect missing value counts with `df.isnull().sum()` prior to correlation."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Full Statistical Profile"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instant 8-metric statistical summary of all numeric columns."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df.describe()"}</kbd>
            </div>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Reveals statistical relationships between variables."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df.corr(numeric_only=True)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Percentage Distribution"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Generates percentage breakdown of categories."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df['Status'].value_counts(normalize=True) * 100"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What 8 statistical summary metrics does `df.describe()` generate in a single line of code?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must you specify `numeric_only=True` when calling `df.corr()` on mixed datasets?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do correlation matrices help financial analysts identify multicollinearity in forecasting models?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Descriptive statistics and summary matrices with pandas (`describe()`, `corr()`, `value_counts()`) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Want an instant summary of your entire dataset? Just type `df.describe()`! In half a second, Python gives you the average, median, min, max, standard deviation, and quartiles for every single numeric column."}
          />
        </div>
      </div>
    </div>
