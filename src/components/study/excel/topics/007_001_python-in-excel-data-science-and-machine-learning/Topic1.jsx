      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📐 The =PY() Formula & xl() Reference Function"} · Topic 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Cell Referencing & Execution Order"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"The `=PY()` formula: Syntax, cell referencing (`xl(\"A1:D100\", headers=True)`), and execution flow"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering the =PY() formula syntax and xl() bridge function: referencing cell ranges, structured tables, sheet qualifications, headers parameters, and grid calculation sequence"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Cell Referencing Syntax: df = xl(\"Sales_Table[#All]\", headers=True) | Single Cell: val = xl(\"Sheet1!B2\") | Calc Order: Top-to-Bottom, Left-to-Right"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The `xl()` Bridging Function"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`xl(\"Range\", headers=True)` converts Excel ranges and Tables directly into strongly-typed pandas DataFrames or scalar values."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Top-to-Bottom, Left-to-Right Execution Flow"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Python cells calculate sequentially across the worksheet grid. A Python cell in C10 can reference variables defined in A1 or B5, but NOT D12."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Structured Table Referencing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`xl(\"tblSales[#All]\", headers=True)` automatically expands as new rows are added to the table, creating self-updating Python data pipelines."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"The =PY() and xl() Reference Engine: Worksheet Cells -> xl() Translation Bridge -> pandas DataFrame"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Cell Referencing & Execution Order"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_The___PY____formul"
            title={"The `=PY()` formula: Syntax, cell referencing (`xl(\"A1:D100\", headers=True)`), and execution flow - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Dynamic Table Ingestion into pandas"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Ingests structured `tblRegionalSales` into pandas DataFrame `df = xl(\"tblRegionalSales[#All]\", headers=True)` for automated profit margin aggregation."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Cross-Sheet Ledger Referencing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"References raw voucher sheets using `df_tax = xl(\"'Tax_Data'!A1:G50000\", headers=True)`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Chained Python Calculation Grid"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Defines clean dataset in cell A1, transforms in B5, and outputs predictive chart in D10."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Dynamic Freight Matrix Referencing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"References transport rate grids with `headers=True` for matrix multiplications."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Cell Referencing Syntax: df = xl(\"Sales_Table[#All]\", headers=True) | Single Cell: val = xl(\"Sheet1!B2\") | Calc Order: Top-to-Bottom, Left-to-Right"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Backward Calculation Dependency (#NAME? / NameError)"}</td>
                  <td className="py-3 px-4">{"Attempting to reference variable `df` in cell A1 when `df` was created in cell E20 (violates top-to-bottom calculation order)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Place foundational Python data definitions in the upper-left of the worksheet."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting headers=True on Data Tables"}</td>
                  <td className="py-3 px-4">{"Omitting `headers=True` causes column names to be treated as row 0 data, corrupting numeric types."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always pass `headers=True` when reading tables: `xl(\"A1:D50\", headers=True)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Circular Calculation Dependency"}</td>
                  <td className="py-3 px-4">{"Cell A1 referencing B1 while B1 references A1 in Python."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Maintain clean unidirectional dataflows."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Reference Entire Table"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Dynamically sizes DataFrame as table grows."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"df = xl(\"TableName[#All]\", headers=True)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Upper-Left Rule"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees proper execution order across the grid."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Define variables above and to the left"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Reference Single Cell"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Pulls scalar numeric/text values into Python variables."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"val = xl(\"B2\")"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must Python variable definitions be placed above and to the left of cells that reference them?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What happens to column data types if you forget to pass `headers=True` into `xl()`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does referencing structured Excel Tables (`TableName[#All]`) make Python scripts automatically dynamic?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"The `=PY()` formula: Syntax, cell referencing (`xl(\"A1:D100\", headers=True)`), and execution flow - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Remember the Golden Rule of Python in Excel: Top-to-Bottom, Left-to-Right! Define your DataFrame in cell A1, do your calculations in cell B5, and output your charts in cell D10. If you try to reference backwards, Python will say 'Variable Not Defined'."}
          />
        </div>
      </div>
    </div>
