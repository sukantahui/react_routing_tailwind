...
export default function Topic5() {
  ...
  const handleDownload = () => {
    ...
    link.download = "007_001_python-in-excel-data-science-and-machine-learning_practice.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            ...
            <span className="px-3 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-semibold">
              Python in Excel: Data Science &amp; Machine Learning
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots)</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            ...
            >
              ...
              <text x="430" y="115" textAnchor="middle" fill="#a7f3d0" fontSize="11" fontFamily="monospace">Advanced data visualizat</text>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots) - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 5: Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots) FAQ"
            questions={questions}
          />
        </div>
