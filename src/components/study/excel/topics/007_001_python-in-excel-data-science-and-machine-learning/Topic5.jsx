      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎨 Matplotlib & Seaborn Visualizations in Cells"} · Topic 5
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Rendering publication-quality data visualizations directly inside Excel cells using matplotlib and seaborn: Correlation Heatmaps, Pair Plots, Violin Plots, Box Plots, and KDE Distribution Curves"}. Master native Python in Excel execution, pandas DataFrame wrangling, seaborn cell visualizations, statistical hypothesis testing, and scikit-learn predictive AI models.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Visualization Syntax: import matplotlib.pyplot as plt; import seaborn as sns; fig, ax = plt.subplots(); sns.heatmap(df.corr(), annot=True, ax=ax); fig"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Cell-Embedded Vector Graphics"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Matplotlib figures render directly inside Excel cells as crisp, scalable graphic objects that resize dynamically with cell dimensions."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Statistical Heatmaps & Annotations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`sns.heatmap(df.corr(), annot=True, cmap=\"coolwarm\", ax=ax)` visualizes correlation matrices with color-coded correlation coefficient labels."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Advanced Distribution Visualizations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Renders violin plots, box plots, pair plots, and swarm plots that are completely impossible to build with native Excel chart tools."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Python Visualization Rendering Pipeline: Data Vector -> matplotlib / seaborn Canvas -> Rendered Cell Image / Floating Chart"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod19_5" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod19_5" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_5)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Advanced Data Visualization"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod19_5)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic5_Advanced_data_visu"
            title={"Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Executive Correlation Heatmap in Cell A1"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Renders a publication-ready color-coded correlation heatmap in cell A1 analyzing 12 commercial KPI drivers for C-Suite briefing."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Discrepancy Box Plot Charting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Renders seaborn box plots identifying statistical tax rate outliers across 15 factory vendor categories."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Casting Yield Violin Distribution Plot"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Visualizes bimodal furnace temperature distribution curves with seaborn violin plots."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Transit Delay KDE Density Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Plots Kernel Density Estimation (KDE) curves comparing transit times across 4 shipping carriers."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Ingest ranges: <code className="text-cyan-300 font-mono font-bold">{"Visualization Syntax: import matplotlib.pyplot as plt; import seaborn as sns; fig, ax = plt.subplots(); sns.heatmap(df.corr(), annot=True, ax=ax); fig"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting to Return 'fig' at the End of Script (Blank Cell)"}</td>
                  <td className="py-3 px-4">{"Creating plots without returning the `fig` object at the bottom causes the cell to display None or a memory pointer."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always place `fig` or `plt.gcf()` as the final line of the Python formula."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Calling plt.show() (Fails in Cloud Container)"}</td>
                  <td className="py-3 px-4">{"Calling interactive GUI method `plt.show()` throws error in headless cloud containers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Do NOT call `plt.show()`; simply return `fig` on the last line."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overcrowded Axis Labels on Small Cell Sizes"}</td>
                  <td className="py-3 px-4">{"Rendering 50 x-axis labels inside a standard 200px cell makes text illegible."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Rotate labels with `plt.xticks(rotation=45)` and resize cell dimensions."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Return fig on Last Line"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory syntax to display plot inside cell."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"fig, ax = plt.subplots() ... fig"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Do NOT Use plt.show()"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Cloud container expects figure object return."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Omit plt.show()"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Seaborn Themes"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Applies sleek modern styling to plots."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"sns.set_theme(style=\"whitegrid\")"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must the `fig` object be returned on the final line of a Python visualization formula in Excel?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does calling `plt.show()` fail inside Python in Excel cloud containers?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What advanced chart types (e.g. Heatmaps, Violin plots) can seaborn create that native Excel charts cannot?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on Python data structures, cloud execution mechanics, and statistical inference.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Advanced data visualization in Excel cells with matplotlib and seaborn (Heatmaps, Pair plots, Violin plots) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"You can put stunning data science charts right inside your Excel cells! Build a seaborn Heatmap or Violin plot, return `fig` on the last line, and you have visualizations that standard Excel charts could never dream of making."}
          />
        </div>
      </div>
    </div>
