...
import sampleWorkbookUrl from "./excel_files/advanced_power_query_m_code_scripting_and_custom_functions_master.xlsx?url";
...
export default function Topic14() {
  ...
  const handleDownload = () => {
    ...
    link.download = "advanced_power_query_m_code_scripting_and_custom_functions_master.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent tracking-tight">
            Functional Recursion & State Accumulation in Power Query M
          </h1>
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Dynamic REST API pagination with List.Generate and iterative state folding with List.Accumulate
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            <code className="text-sm sm:text-base font-mono text-emerald-300 block bg-slate-900 p-3 rounded-xl border border-slate-800 overflow-x-auto">
              =List.Generate(initial, condition, next, [selector]) / =List.Accumulate(list, seed, accumulator)
            </code>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Executes while-loops in pure functional M-code for REST API pagination with List.Generate and fold/reduce state aggregation with List.Accumulate.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic14_M_Recursion_List"
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Functional Recursion & State Accumulation in Power Query M Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Functional Recursion & State Accumulation in Power Query M"
