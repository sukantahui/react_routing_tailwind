      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master MEDIAN Function (Central Value Analysis) for rigorous business analytics, empirical hypothesis testing, and executive data science modeling in Microsoft Excel.
          </p>
        ...
        >
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed">
            <p>
              In Microsoft Excel, <strong>MEDIAN Function (Central Value Analysis)</strong> operates on IEEE 754 floating-point data streams. The calculation engine processes ranges in linear or vectorized memory sweeps.
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-xl p-5 bg-slate-950/80 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 space-y-3">
              ...
              <div className="pt-2 border-t border-slate-800/80 text-xs space-y-1">
                <div className="text-sky-300 font-mono font-semibold">Applied: =MEDIAN(A1:A100)</div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Click destination cell and input formula syntax: <code className="text-sky-300 font-mono">=MEDIAN(A1:A100)</code>.
                </p>
              </div>
            </div>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="MEDIAN Function (Central Value Analysis) - Frequently Asked Questions"
            questions={questions}
          />
        </div>
