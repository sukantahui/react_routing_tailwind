...
export default function Topic40() {
  ...
  const handleDownload = () => {
    ...
    link.download = "statistical_functions_for_data_analysis_master.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-950/80 border border-sky-800 text-sky-300 text-xs font-semibold uppercase tracking-wider mb-4">
            <span>📊</span> Excel Masterclass · Topic 40
          </div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent tracking-tight">
            Multiple Linear & Non-Linear Regression ANOVA
          </h1>
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Full matrix coefficient, standard error, and R-squared analysis with LINEST and LOGEST
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Calculates the statistics for a straight line using ordinary least squares to fit known_y's against known_x's.
            </p>
          </div>
        </section>
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Multiple Linear & Non-Linear Regression ANOVA Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Multiple Linear & Non-Linear Regression ANOVA"
