const questions = [
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Grid coordinate system and cell address parsing (Question 1)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage OpenXML compressed .xlsx package structure (Question 2)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Physical row (1,048,576) and column (16,384) bounds (Question 3)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Ribbon keytips and keyboard navigation accessibility (Question 4)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Formula Bar expansion and multi-line editing (Ctrl+Shift+U) (Question 5)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Status Bar real-time non-destructive aggregation metrics (Question 6)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Used Range memory footprint and file size optimization (Question 7)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Binary workbook format (.xlsb) vs OpenXML (.xlsx) (Question 8)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Macro-enabled workbook format (.xlsm) and VBA security (Question 9)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage AutoRecover shadow snapshot intervals and restoration (Question 10)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Ctrl + Arrow edge traversal mechanics across data blocks (Question 11)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Ctrl + Shift + Arrow range selection techniques (Question 12)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Name Box coordinate input and named range teleportation (Question 13)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Go To Special (F5) blank cell batch population (Question 14)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Select Visible Cells Only (Alt + ;) during filtered copying (Question 15)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Relative referencing (A1) vector offset calculation (Question 16)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Absolute referencing ($A$1) coordinate anchor mechanics (Question 17)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Mixed referencing ($A1 vs A$1) in 2D multiplication tables (Question 18)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage 3D cross-sheet calculation referencing (=SUM(Sheet1:Sheet4!A1)) (Question 19)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage F4 reference mode toggle cycling sequence (Question 20)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Cross-footing mathematical audit verification (Question 21)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Freeze Panes viewport configuration and ergonomics (Question 22)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Data type coercion between text, numeric, and date literals (Question 23)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Formula view mode (Ctrl + `) for structural auditing (Question 24)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage AutoSum (Alt + =) intelligent boundary detection (Question 25)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Paste Special Values (Alt + E + S + V) formula freezing (Question 26)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Circular reference warning diagnostics and resolution (Question 27)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage #VALUE! error prevention with =SUM() vs direct addition (+) (Question 28)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage Worksheet tab naming rules and character limitations (Question 29)?",
  ...
  {
    "question": "In the context of Cell Referencing Fundamentals: Relative, Absolute ($), Mixed ($A1 vs A$1) and 3D Sheet References, how does Excel evaluate and manage 3-tier spreadsheet design: Inputs, Calculations, Presentation (Question 30)?",
