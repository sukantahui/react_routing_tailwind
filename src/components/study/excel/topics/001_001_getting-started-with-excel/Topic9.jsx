      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Final foundational checkpoint quiz for Module 1.1: Consolidate your core spreadsheet reflexes, shortcut memory, formula anatomy, and interface navigation skills before advancing to Module 1.2 (Data Entry, Editing and Formatting).
          </p>
        ...
        >
            ...
            <table className="w-full text-left text-xs sm:text-sm text-slate-300 border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50 font-mono">
                ...
                <tr className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-3 px-4 text-slate-300 font-sans">Verify comprehensive mastery across all Module 1.1 topics.</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 text-sky-300 font-semibold font-sans">Next Step</td>
                  <td className="py-3 px-4 text-teal-400">Module 1.2 Unlock</td>
                  <td className="py-3 px-4 text-amber-400 font-sans">Progression</td>
                  <td className="py-3 px-4 text-slate-300 font-sans">Advance to Data Entry Hygiene, Custom Number Formatting, and Flash Fill.</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-3 px-4 text-slate-300 font-sans">Direct pedagogical summary and practice guidelines from Sukanta Hui.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="p-4 rounded-xl bg-sky-950/40 border border-sky-800/60 flex items-start gap-3">
            ...
            <div className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              ...
              Returns a <span className="text-sky-300 font-semibold">Final Module 1.1 Mastery Evaluation</span> directly to the active cell coordinates.
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed">
            <p>Foundational ergonomics form 80% of daily spreadsheet efficiency. Mastering interface keytips, formula bar controls, and navigation shortcuts frees mental bandwidth for advanced analytics.</p>
            <p>A true Excel expert never touches the mouse for standard grid operations. Developing keyboard muscle memory now will make advanced Dynamic Arrays, Power Query, and VBA intuitive.</p>
            <p>Review the comprehensive FAQ and Teacher's Note below to finalize your Module 1.1 certification readiness.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl p-5 bg-slate-950/80 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 space-y-3">
              ...
              <div className="pt-2 border-t border-slate-800/80 text-xs space-y-1">
                <div className="text-sky-300 font-mono font-semibold">Applied: Completion of Module 1.1 Mastery Checkpoint</div>
                <div className="text-emerald-400 font-semibold">Result: Ready for advanced enterprise data entry workflows.</div>
                <div className="text-slate-400 text-[11px]">A rock-solid foundation in grid architecture makes all future modules faster to learn.</div>
              </div>
            </div>
            <div className="rounded-xl p-5 bg-slate-950/80 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-white">Barrackpore Corporate Internship Placement Readiness</h3>
              </div>
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">A student demonstrates high-speed spreadsheet navigation to prospective accounting employers.</p>
              
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-300 border border-slate-800">
                  <tbody className="divide-y divide-slate-800">
                    
                    <tr><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Skill_Demonstrated</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Traditional_Method</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Advanced_Keyboard_Method</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Employer_Impression</td></tr>
                    <tr><td className="p-2 border-r border-slate-800 font-mono text-[11px]">50,000-Row Navigation</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Mouse wheel scroll</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Ctrl + Down Arrow (0.01s)</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Highly Impressed</td></tr>
                    <tr><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Audit All Formulas</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Clicking cells one by one</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Ctrl + ` (1s instant view)</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Immediate Job Offer</td></tr>
                  </tbody>
                </table>
              </div>

              <div className="pt-2 border-t border-slate-800/80 text-xs space-y-1">
                <div className="text-sky-300 font-mono font-semibold">Applied: Keyboard Ergonomics Execution</div>
                <div className="text-emerald-400 font-semibold">Result: Selected for Corporate Financial Modeling Internship.</div>
                <div className="text-slate-400 text-[11px]">Workplace efficiency is immediately apparent when an analyst operates without mouse friction.</div>
              </div>
            </div>
            <div className="rounded-xl p-5 bg-slate-950/80 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-white">Shyamnagar Business Owner Financial Dashboard Layout Setup</h3>
              </div>
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">Setting up a clean 3-sheet corporate financial workbook for a manufacturing business.</p>
              ...
              <div className="pt-2 border-t border-slate-800/80 text-xs space-y-1">
                <div className="text-sky-300 font-mono font-semibold">Applied: Professional 3-Tier Spreadsheet Architecture</div>
                <div className="text-emerald-400 font-semibold">Result: Error-free, scalable business financial management system.</div>
                <div className="text-slate-400 text-[11px]">Separating data, calculation, and reporting tiers is the gold standard of financial modeling.</div>
              </div>
            </div>
            <div className="rounded-xl p-5 bg-slate-950/80 border border-slate-800 hover:border-sky-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-white">Kolkata Auditing Firm Rapid Quality Assurance Check</h3>
              </div>
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">Reviewing a 100-page tax model for accidental circular references and broken formulas.</p>
              ...
              <div className="pt-2 border-t border-slate-800/80 text-xs space-y-1">
                <div className="text-sky-300 font-mono font-semibold">Applied: Systematic Automated QA Audit</div>
                <div className="text-emerald-400 font-semibold">Result: Clean audited tax model approved for client delivery.</div>
                <div className="text-slate-400 text-[11px]">Systematic audit procedures guarantee 100% mathematical integrity.</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm text-slate-300 border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50">
                ...
                <tr className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 text-rose-300 font-mono font-bold">Advancing Without Keyboard Fluency</td>
                  <td className="py-3 px-4 text-slate-300">Relying on mouse clicks for basic row navigation and cell editing.</td>
                  <td className="py-3 px-4 text-amber-300">Productivity remains slow during large-scale data entry.</td>
                  <td className="py-3 px-4 text-emerald-400 font-medium">Commit to practicing 15 minutes of pure keyboard navigation daily.</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 text-rose-300 font-mono font-bold">Ignoring Cell Data Types</td>
                  <td className="py-3 px-4 text-slate-300">Treating text strings, numbers, and dates as interchangeable literals.</td>
                  <td className="py-3 px-4 text-amber-300">Formulas yield #VALUE! or incorrect date serials.</td>
                  <td className="py-3 px-4 text-emerald-400 font-medium">Understand Excel's data coercion rules before building complex formulas.</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 text-rose-300 font-mono font-bold">Unprotected Parameter Cells</td>
                  <td className="py-3 px-4 text-slate-300">Leaving tax rate and discount parameter cells editable by general users.</td>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-purple-500/40 transition-all duration-200 flex items-start gap-3">
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">Close the currently active workbook window safely.</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-purple-500/40 transition-all duration-200 flex items-start gap-3">
              <kbd className="px-2.5 py-1 rounded-lg bg-purple-950/80 border border-purple-800 text-purple-300 font-mono text-xs font-bold shrink-0">
                Ctrl + Tab
              </kbd>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">Cycle between multiple open Microsoft Excel workbook windows.</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-purple-500/40 transition-all duration-200 flex items-start gap-3">
              <kbd className="px-2.5 py-1 rounded-lg bg-purple-950/80 border border-purple-800 text-purple-300 font-mono text-xs font-bold shrink-0">
                Ctrl + F9
              </kbd>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">Minimize the current Excel workbook window.</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-purple-500/40 transition-all duration-200 flex items-start gap-3">
              <kbd className="px-2.5 py-1 rounded-lg bg-purple-950/80 border border-purple-800 text-purple-300 font-mono text-xs font-bold shrink-0">
                Ctrl + F10
              </kbd>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">Maximize or restore the current Excel workbook window.</p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800/80 flex items-start gap-3">
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">How does mastering keyboard shortcuts create a state of 'flow' in financial modeling?</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800/80 flex items-start gap-3">
              <span className="text-teal-400 text-base">❓</span>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">What are the top 3 principles of spreadsheet hygiene every professional analyst must follow?</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800/80 flex items-start gap-3">
              <span className="text-teal-400 text-base">❓</span>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">How will the referencing skills learned in this module empower you when writing complex VLOOKUP, INDEX/MATCH, and XLOOKUP formulas?</p>
            </div>
          </div>
        </section>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note="Bravo! You have completed Module 1.1: Getting Started with Excel. You now possess the foundational grid knowledge, keyboard reflexes, and structural understanding of a professional spreadsheet engineer. Carry this discipline forward into Module 1.2 as we master Data Entry, Editing, and Custom Formatting!"
          />
        </div>
      </div>
    </div>
