...
export default function Topic11() {
  ...
  const handleDownload = () => {
    ...
    link.download = "007_002_using-ai-with-excel-for-productivity_practice.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            ...
            <span className="px-3 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-semibold">
              Using AI with Excel for Productivity
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Real-world project: Building an AI-powered customer feedback sentiment analysis and summarization dashboard</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Real-world project: Building an AI-powered customer feedback sentiment analysis and summarization dashboard - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 11: Real-world project: Building an AI-powered customer feedback sentiment analysis and summarization dashboard FAQ"
            questions={questions}
          />
        </div>
