      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
            ...
            Visual Formatting Flow: Excel Data Type Memory Hierarchy & Alignment Detection
          </h2>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-300 border border-slate-800">
                  <tbody className="divide-y divide-slate-800">
                    ...
                    <tr><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Mobile with Leading 0</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">09830123456</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Drops leading zero -> 9830123456</td><td className="p-2 border-r border-slate-800 font-mono text-[11px]">Format as Text or Custom Format: 00000000000</td></tr>
                  </tbody>
                </table>
              </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm text-slate-300 border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50">
                ...
                <tr className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-3 px-4 text-emerald-400 font-medium">Pre-format the column as Text (Ctrl+1 -> Text) before entering data or use an apostrophe prefix (' ).</td>
                </tr>
                <tr className="hover:bg-slate-800/30 transition-colors">
