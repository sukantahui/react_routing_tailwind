      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⚖️ Row Context vs Filter Context"} · Topic 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"DAX Context Engine Core"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Understanding Evaluation Contexts: Row Context vs Filter Context (The core of DAX)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Mastering the two fundamental evaluation contexts of DAX: Row Context (iterating row-by-row through a table) and Filter Context (the set of active filters from pivot rows, columns, and slicers)"}. Master evaluation contexts, Context Transition, CALCULATE filter overriding, X-iterator engines, Time Intelligence comparisons, and ranking.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Evaluation Contexts: Row Context (Active Record Iteration) | Filter Context (Active Slicers, Rows, Columns, Pages)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Row Context (The Concept of 'Current Row')"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Exists automatically in Calculated Columns and inside Iterator functions (`SUMX`, `FILTER`). It knows the current row's values, but cannot see other rows or filter other tables."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Filter Context (The 'Environment' of the Calculation)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"The combined set of active filters applied by PivotTable Row headers, Column headers, Slicers, Report Filters, and DAX `CALCULATE()` statements."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. The Independence Principle"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A pure Row Context does NOT automatically filter other tables; a pure Filter Context does NOT have a concept of the 'current row'."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"The Two Evaluation Contexts of DAX: Row Context (Iteration) vs Filter Context (Active Coordinates)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod14_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod14_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"DAX Context Engine Core"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_Understanding_Eval"
            title={"Understanding Evaluation Contexts: Row Context vs Filter Context (The core of DAX) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Executive Filter Context Debugging"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Explains why a measure displays ₹12.5 Lakhs in Cell C4: the Filter Context combines Year=2026, Region='East', and Category='Electronics'."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Purchase Ledger Row Context Iteration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Row Context inside a calculated column to compute line-level GST liabilities (`[BaseAmount] * [GSTRate]`)."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shift Production Filter Context Isolation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Analyzes how shift and operator slicers restrict the Filter Context to evaluate true machine yield."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Route Cost Row-Level Computation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates individual trip toll costs using row context inside `SUMX`."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the formula bar, type your measure name and formula: <code className="text-cyan-300 font-mono font-bold">{"Evaluation Contexts: Row Context (Active Record Iteration) | Filter Context (Active Slicers, Rows, Columns, Pages)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Expecting Row Context to Filter Related Tables"}</td>
                  <td className="py-3 px-4">{"Thinking a calculated column in Table A automatically filters Table B during evaluation."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Row Context does not propagate across relationships unless transformed via Context Transition (`CALCULATE`)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing Filter Context with Row Coordinates"}</td>
                  <td className="py-3 px-4">{"Writing a measure that expects to know 'what row number am I on'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Measures operate in Filter Context; use Iterator functions if row-by-row iteration is required."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Assuming Filter Context Modifies Physical Data"}</td>
                  <td className="py-3 px-4">{"Thinking filtering changes underlying stored tables in RAM."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Filter Context only restricts the temporary virtual view of data passed to the formula."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Row Context = Loop"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Native to calculated columns and X-iterator functions."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Iterates record by record"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Filter Context = Sieve"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Native to PivotTable cells and explicit measures."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Slices data based on active UI coordinates"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Master Both Contexts"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Every DAX behavior stems from the interaction between these two contexts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"The secret to 100% DAX mastery"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the difference between what Row Context 'sees' versus what Filter Context 'sees'?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why does a Calculated Column have a Row Context by default, while a Measure does not?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do PivotTable Row headers, Column headers, and Slicers combine to create the active Filter Context for a single cell?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Understanding Evaluation Contexts: Row Context vs Filter Context (The core of DAX) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Row Context and Filter Context are the twin engines of DAX. Row context is your cursor moving down rows. Filter context is the active filters on your pivot table. Understand this, and DAX becomes second nature."}
          />
        </div>
      </div>
    </div>
