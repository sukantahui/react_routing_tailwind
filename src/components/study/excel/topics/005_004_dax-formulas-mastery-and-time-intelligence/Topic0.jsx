      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧠 Introduction to DAX Philosophy"} · Topic 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"DAX Philosophy & Syntax Core"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Introduction to DAX: Philosophy, Syntax, and Comparison with Excel formulas"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding Data Analysis Expressions (DAX) philosophy: functional programming paradigms, tabular context engines, and distinguishing Excel cell-based formulas from DAX table/column-based expressions"}. Master evaluation contexts, Context Transition, CALCULATE filter overriding, X-iterator engines, Time Intelligence comparisons, and ranking.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"DAX Expression Syntax: MeasureName := CALCULATE(Expression, Filter1, Filter2, ...) | Table[Column] vs [MeasureName]"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Column & Table References"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"DAX never references individual cells (`A1`, `B4`). DAX operates exclusively on structured tables and columns (`Sales[Amount]`, `Customer[Region]`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Functional Language Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Every DAX formula is a single nested function execution that takes tables, columns, and scalar expressions as inputs and returns an aggregated scalar or temporary table."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Universal Syntax Rule"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Always prefix Column references with Table Name (`Fact_Sales[Revenue]`). Never prefix Measure references with Table Name (`[TotalSales]`)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Excel Cell Formula Paradigm (A1:B10) vs DAX Tabular Relational Engine (Table[Column])"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod14_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod14_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"DAX Philosophy & Syntax Core"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Introduction_to_DA"
            title={"Introduction to DAX: Philosophy, Syntax, and Comparison with Excel formulas - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Corporate DAX Syntax Standardization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Establishes corporate DAX syntax standards across 40 financial modelers: mandatory table names for columns, naked brackets for measures."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Replacing Complex SUMIFS with DAX"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Replaces 500 fragile multi-condition SUMIFS formulas with 3 clean, reusable explicit DAX measures."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Yield Metric Library"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a functional DAX library calculating scrap rates, machine availability, and throughput."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Nationwide Freight Margin Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Develops modular DAX measures computing dynamic ton-kilometer freight margins across 25 logistics corridors."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the formula bar, type your measure name and formula: <code className="text-cyan-300 font-mono font-bold">{"DAX Expression Syntax: MeasureName := CALCULATE(Expression, Filter1, Filter2, ...) | Table[Column] vs [MeasureName]"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Table Name in Column References"}</td>
                  <td className="py-3 px-4">{"Writing `SUM([Revenue])` makes it impossible for another developer to know if `[Revenue]` is a raw column or an explicit measure."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always write `SUM(Sales[Revenue])` for columns and `[TotalRevenue]` for measures."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Expecting DAX to Support Cell Offsets (A1 + 1)"}</td>
                  <td className="py-3 px-4">{"Attempting to reference the 'previous row' by row number."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use Time Intelligence functions (`DATEADD`, `SAMEPERIODLASTYEAR`) or `EARLIER()` / variables to reference previous records."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Writing Iterative Calculations in Standard SUM"}</td>
                  <td className="py-3 px-4">{"Trying to write `=SUM(Sales[Qty] * Sales[Price])` in standard SUM (which only accepts a single column)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use the iterator function `=SUMX(Sales, Sales[Qty] * Sales[Price])`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"DAX Syntax Standard"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The universal golden formatting rule of DAX."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Table[Column] for columns, [Measure] for measures"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Shift + Enter for New Line"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Formats complex multi-line DAX formulas cleanly in the formula bar."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Shift + Enter"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Comment Code"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Documents business logic inside DAX formulas."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"-- comment or // comment"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must column references always include the Table Name, while measure references must NEVER include the Table Name?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How is DAX's column-based evaluation fundamentally different from Excel's traditional cell-grid coordinate system?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why does `=SUM(Sales[Qty] * Sales[Price])` fail in DAX, and what function must be used instead?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Introduction to DAX: Philosophy, Syntax, and Comparison with Excel formulas - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"DAX is not Excel formulas! Always remember: Tables and Columns represent your raw data, while Measures represent your business logic. Prefix columns with table names `Sales[Amount]`, and keep measures clean `[TotalSales]`."}
          />
        </div>
      </div>
    </div>
