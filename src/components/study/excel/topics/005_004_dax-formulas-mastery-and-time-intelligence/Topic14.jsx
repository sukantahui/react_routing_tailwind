      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Real-world capstone: Building an Enterprise Financial &amp; Sales Performance DAX Measure Suite</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Real-world capstone: Building an Enterprise Financial &amp; Sales Performance DAX Measure Suite - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 14: Real-world capstone: Building an Enterprise Financial &amp; Sales Performance DAX Measure Suite FAQ"
            questions={questions}
          />
        </div>
