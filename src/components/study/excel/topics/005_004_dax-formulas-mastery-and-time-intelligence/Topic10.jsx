      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔄 Period-over-Period: SAMEPERIODLASTYEAR & DATEADD"} · Topic 10
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Period-over-Period comparisons: SAMEPERIODLASTYEAR, DATEADD, and PARALLELPERIOD"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Building comparative Period-over-Period analytics using SAMEPERIODLASTYEAR, DATEADD, and PARALLELPERIOD: calculating Prior Year Sales, YoY Growth %, and flexible N-period time shifting"}. Master evaluation contexts, Context Transition, CALCULATE filter overriding, X-iterator engines, Time Intelligence comparisons, and ranking.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Period Comparisons: CALCULATE([TotalSales], SAMEPERIODLASTYEAR(Dim_Calendar[Date])) | YoY Growth: DIVIDE([Sales] - [SalesLY], [SalesLY])"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. SAMEPERIODLASTYEAR (Exact 1-Year Shift)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Shifts the active date selection back by exactly 1 year. If viewing 'June 2026', it evaluates the measure over 'June 2025'."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. DATEADD (Universal Time Shifter)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"The flexible time shifter: `DATEADD(Dim_Calendar[Date], -1, MONTH)` shifts by 1 month; `DATEADD(Dim_Calendar[Date], -1, QUARTER)` shifts by 1 quarter."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. PARALLELPERIOD (Full Period Shifter)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Shifts the entire period regardless of granular date filters (e.g. shifts whole year parallelly)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Period Comparison Shift Engine: Active Date Range -> Shift by -1 Year -> Prior Period Measure Evaluation"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod14_10" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod14_10" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_10)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Comparative Historical Analytics"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_10)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic10_Period_over_Period"
            title={"Period-over-Period comparisons: SAMEPERIODLASTYEAR, DATEADD, and PARALLELPERIOD - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise YoY Revenue Growth Benchmark"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds `Sales_LY := CALCULATE([TotalSales], SAMEPERIODLASTYEAR(Dim_Calendar[Date]))` and `YoY_Growth% := DIVIDE([TotalSales] - [Sales_LY], [Sales_LY])`."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Month-over-Month (MoM) Variance Tracking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Computes prior month spending: `PriorMonthSpend := CALCULATE([TotalOpex], DATEADD(Dim_Calendar[Date], -1, MONTH))`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Quarter-over-Quarter Scrap Comparison"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Compares quarterly scrap rate metrics against the prior quarter using `DATEADD(..., -1, QUARTER)`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Prior Year Freight Volume Comparison"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates seasonal freight shipping volume against same period last year."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the formula bar, type your measure name and formula: <code className="text-cyan-300 font-mono font-bold">{"Period Comparisons: CALCULATE([TotalSales], SAMEPERIODLASTYEAR(Dim_Calendar[Date])) | YoY Growth: DIVIDE([Sales] - [SalesLY], [SalesLY])"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Comparing Incomplete Months (Apples-to-Oranges)"}</td>
                  <td className="py-3 px-4">{"Comparing 15 days of current month against full 30 days of prior year month."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure date range is synchronized to equivalent elapsed days using `DATESBETWEEN()`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Division by Zero in YoY Growth Measure"}</td>
                  <td className="py-3 px-4">{"Prior year sales being zero returns `#DIV/0!`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always wrap in `DIVIDE([Sales] - [SalesLY], [SalesLY], 0)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Passing Inactive Date Column into DATEADD"}</td>
                  <td className="py-3 px-4">{"Passing non-continuous fact table dates."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always pass the master `Dim_Calendar[Date]` column."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Prior Year Sales"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The standard DAX formula for Last Year revenue."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"CALCULATE([Sales], SAMEPERIODLASTYEAR(Dim_Calendar[Date]))"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Prior Month Sales"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Shifts time window back by exactly 1 month."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"CALCULATE([Sales], DATEADD(Dim_Calendar[Date], -1, MONTH))"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Safe YoY Growth %"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates YoY growth percentage with zero math errors."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"DIVIDE([Sales] - [SalesLY], [SalesLY], 0)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does `SAMEPERIODLASTYEAR()` automatically adjust whether the user is viewing a Day, a Month, or a full Year in a PivotTable?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the difference between `DATEADD(..., -1, MONTH)` versus `SAMEPERIODLASTYEAR()`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is `DIVIDE()` mandatory when computing Year-over-Year growth percentages?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Period-over-Period comparisons: SAMEPERIODLASTYEAR, DATEADD, and PARALLELPERIOD - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"To calculate YoY Growth in DAX: Step 1: `Sales_LY := CALCULATE([TotalSales], SAMEPERIODLASTYEAR(Dim_Calendar[Date]))`. Step 2: `YoY_Growth := DIVIDE([TotalSales] - [Sales_LY], [Sales_LY])`. It dynamically adapts to days, months, or years."}
          />
        </div>
      </div>
    </div>
