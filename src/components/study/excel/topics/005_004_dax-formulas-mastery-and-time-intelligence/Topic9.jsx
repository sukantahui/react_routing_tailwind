      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📈 YTD, QTD, MTD & Fiscal Year Accumulations"} · Topic 9
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Cumulative Period Calculations"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Year-to-Date, Quarter-to-Date, Month-to-Date metrics: TOTALYTD, DATESYTD, TOTALQTD, TOTALMTD"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Calculating cumulative Year-to-Date (YTD), Quarter-to-Date (QTD), and Month-to-Date (MTD) metrics using TOTALYTD, DATESYTD, and configuring custom Indian Fiscal Year year-end parameters (\"03-31\")"}. Master evaluation contexts, Context Transition, CALCULATE filter overriding, X-iterator engines, Time Intelligence comparisons, and ranking.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Cumulative DAX: TOTALYTD([Measure], Dim_Calendar[Date], \"03-31\") | DATESYTD(Dim_Calendar[Date]) | TOTALQTD | TOTALMTD"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Automatic Cumulative Filter Expansion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`TOTALYTD([TotalSales], Dim_Calendar[Date])` dynamically expands the filter context from the first day of the year up to the current date in the pivot cell."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Indian Fiscal Year Configuration (\"03-31\")"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Standard YTD resets on Dec 31. For Indian companies (Apr-Mar), add the optional year-end parameter: `TOTALYTD([TotalSales], Dim_Calendar[Date], \"03-31\")`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. CALCULATE + DATESYTD Equivalent"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`TOTALYTD([Sales], Date)` is syntax sugar for `CALCULATE([Sales], DATESYTD(Dim_Calendar[Date]))`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Cumulative Time Intelligence Engine: Daily Granularity -> Period-to-Date Cumulative Accumulation (YTD / QTD / MTD)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod14_9" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod14_9" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_9)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Cumulative Period Calculations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_9)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic9_Year_to_Date__Quar"
            title={"Year-to-Date, Quarter-to-Date, Month-to-Date metrics: TOTALYTD, DATESYTD, TOTALQTD, TOTALMTD - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Indian Corporate Fiscal YTD Revenue Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds `FiscalYTD_Revenue := TOTALYTD([TotalSales], Dim_Calendar[Date], \"03-31\")` accumulating revenue from April 1st to March 31st."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Quarterly Advance Tax Cumulative Liability (QTD)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates cumulative Quarter-to-Date net profits using `TOTALQTD([NetProfit], Dim_Calendar[Date], \"03-31\")`."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Monthly Production Target Accumulator (MTD)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tracks Month-to-Date steel tonnage output against monthly quota using `TOTALMTD([TotalTonnage], Dim_Calendar[Date])`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Cumulative Fuel Spend YTD Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Monitors fleet fuel expenditure accumulation across the fiscal year."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the formula bar, type your measure name and formula: <code className="text-cyan-300 font-mono font-bold">{"Cumulative DAX: TOTALYTD([Measure], Dim_Calendar[Date], \"03-31\") | DATESYTD(Dim_Calendar[Date]) | TOTALQTD | TOTALMTD"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting the Fiscal Year-End String Parameter (\"03-31\")"}</td>
                  <td className="py-3 px-4">{"Indian corporate models resetting YTD accumulation on December 31st rather than March 31st."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Add `\"03-31\"` as 3rd argument in TOTALYTD: `TOTALYTD([Sales], Dim_Calendar[Date], \"03-31\")`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Passing Sliced Months Beyond Current Date"}</td>
                  <td className="py-3 px-4">{"YTD displaying flat repeated numbers for future months with zero sales."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap in condition checking if sales exist: `=IF([TotalSales] > 0, TOTALYTD(...), BLANK())`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Table Name in DATESYTD"}</td>
                  <td className="py-3 px-4">{"Passing entire table `DATESYTD(Dim_Calendar)` instead of date column `DATESYTD(Dim_Calendar[Date])`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Pass the specific Date column."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Indian Fiscal YTD"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Accumulates from April 1 to March 31."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"TOTALYTD([Sales], Dim_Calendar[Date], \"03-31\")"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Standard Calendar YTD"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Accumulates from January 1 to December 31."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"TOTALYTD([Sales], Dim_Calendar[Date])"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Quarter-to-Date (QTD)"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Accumulates across fiscal quarters."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"TOTALQTD([Sales], Dim_Calendar[Date], \"03-31\")"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does the optional `\"03-31\"` parameter in TOTALYTD configure calculations for the Indian Financial Year (April to March)?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the mathematical difference between `TOTALYTD()` and `TOTALMTD()`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is `TOTALYTD([Measure], Calendar[Date])` preferred over complex manual multi-condition SUMIFS formulas?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Year-to-Date, Quarter-to-Date, Month-to-Date metrics: TOTALYTD, DATESYTD, TOTALQTD, TOTALMTD - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"For Indian corporate accounting (April to March), always add `\"03-31\"` at the end of TOTALYTD: `Sales_YTD := TOTALYTD([TotalSales], Dim_Calendar[Date], \"03-31\")`. It automatically starts accumulating from April 1st."}
          />
        </div>
      </div>
    </div>
