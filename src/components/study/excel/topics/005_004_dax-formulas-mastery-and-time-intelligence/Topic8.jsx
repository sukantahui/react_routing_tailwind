      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⏱️ Time Intelligence Architecture & Setup"} · Topic 8
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding the strict structural prerequisites required for DAX Time Intelligence: continuous date spans, leap year handling, and eliminating common calculation traps"}. Master evaluation contexts, Context Transition, CALCULATE filter overriding, X-iterator engines, Time Intelligence comparisons, and ranking.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Time Intelligence Prerequisites: 1. Contiguous Dates | 2. Full Years | 3. Mark as Date Table | 4. Link to Fact via 1:*"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Zero Missing Days Rule"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"If even a single calendar date (e.g. Sunday or holiday) is missing from the Date table, DAX time intelligence functions produce corrupted results or return blank values."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Full Year Coverage"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"The Calendar table MUST span from January 1st of the earliest historical year to December 31st of the latest projected fiscal year."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Date Column Data Type"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"The primary key column MUST be of data type Date (not DateTime or Text integer like `20260401`)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Time Intelligence Engine Prerequisites: Continuous Date Sequence + Standard Date Marking"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod14_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod14_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Time Series Foundations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod14_8)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Time Intelligence Certification"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Audits the corporate 10-year Calendar table to guarantee full continuity across 3,653 consecutive dates for flawless YoY calculation."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Indian Fiscal Year Time Intelligence Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures fiscal date attributes allowing automated Q1-Q4 quarterly tax rollups."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: 24/7 Factory Operating Date Dimension"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds shift and operational day flags into continuous calendar models."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Holiday-Aware Time Series Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Integrates working-day offsets for accurate delivery pace calculations."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                In the formula bar, type your measure name and formula: <code className="text-cyan-300 font-mono font-bold">{"Time Intelligence Prerequisites: 1. Contiguous Dates | 2. Full Years | 3. Mark as Date Table | 4. Link to Fact via 1:*"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Fact Table Dates for Time Intelligence"}</td>
                  <td className="py-3 px-4">{"Passing `Fact_Sales[OrderDate]` into `DATESYTD()` returns incorrect results because sales dates have gaps."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always pass the continuous date column from your dedicated Calendar table: `Dim_Calendar[Date]`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"DateTime Timestamps in Date Column"}</td>
                  <td className="py-3 px-4">{"Time components (`12/04/2026 15:30:00`) break date equality matching."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Convert column data type to pure Date (without time) in Power Query."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Calendar Ending Mid-Year"}</td>
                  <td className="py-3 px-4">{"Calendar table ending on today's date causes full-year functions like `SAMEPERIODLASTYEAR()` to fail."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Extend calendar to December 31st of the current or future year."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Always Use Dim_Calendar[Date]"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The golden rule of DAX Time Intelligence."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Never pass Fact table date columns"}</kbd>
            </div>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Continuous Sequence"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Generates zero-gap date tables automatically."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=CALENDARAUTO() or =CALENDAR(Min, Max)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does passing a Fact table date column into Time Intelligence functions cause calculations to fail?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must your Calendar table cover full calendar years from January 1 to December 31?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What happens if there is a single missing date in your Date Dimension table?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the evaluation context dynamics and functional programming paradigm.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Time Intelligence setup: Requirements for standard date tables and continuous dates - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The #1 mistake beginners make with Time Intelligence: They pass `Sales[OrderDate]` into TOTALYTD! That will fail. Always pass `Calendar[Date]` from your dedicated, marked Date table. It works 100% of the time."}
          />
        </div>
      </div>
    </div>
