      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Moving averages and rolling totals: DATESINPERIOD and DATESBETWEEN</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            ...
            >
              ...
              <text x="430" y="115" textAnchor="middle" fill="#a7f3d0" fontSize="11" fontFamily="monospace">Moving averages and roll</text>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Moving averages and rolling totals: DATESINPERIOD and DATESBETWEEN - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 11: Moving averages and rolling totals: DATESINPERIOD and DATESBETWEEN FAQ"
            questions={questions}
          />
        </div>
