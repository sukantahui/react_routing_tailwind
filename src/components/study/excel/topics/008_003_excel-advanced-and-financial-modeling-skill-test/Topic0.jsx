      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"💰 Financial Modeling & Investment Valuation"} · Assessment 0
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Financial Amortization & Investment Valuation Lab (XNPV, XIRR)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing advanced corporate financial modeling: irregular cash flow valuation (XNPV, XIRR vs NPV/IRR), multi-tier loan amortization schedules (PMT, PPMT, IPMT), and cost of capital discounting"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Investment Valuation: =XNPV(DiscountRate, CashFlows, Dates) | =XIRR(CashFlows, Dates) | Loan Amortization: =PMT(r, n, pv) | =PPMT(...) | =IPMT(...)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Exact-Day Discounting (XNPV / XIRR)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Accounts for real-world irregular cash flow timing down to the exact day, eliminating standard NPV/IRR equal-interval distortion."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dynamic Debt Amortization Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Separates monthly loan repayments into interest expense (`IPMT`) and principal reduction (`PPMT`) across a 360-month loan schedule."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. WACC & Capital Hurdle Rate Benchmarking"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates project viability: Accept project if `XNPV > 0` and `XIRR > WACC` (Weighted Average Cost of Capital)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Corporate Financial Valuation Pipeline: Irregular Cash Flows & Exact Dates -> XNPV / XIRR Discounting -> Capital Investment Go/No-Go"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Corporate Finance & Capital Budgeting"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Financial_Amortiza"
            title={"Financial Amortization & Investment Valuation Lab (XNPV, XIRR) - Assessment Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 1 · Chief Financial Officer"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise ₹50 Crore M&A Project Valuation Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on constructing an institutional DCF model calculating exact-day XNPV and XIRR for a ₹50 Crore factory acquisition."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Machinery Lease vs Buy Financial Valuation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate calculation of after-tax net present value comparing leasing vs bank loan equipment financing."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 3 · Plant Engineering Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Solar Kiln Capital Payback Assessment"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates financial payback period and discounted ROI on factory energy efficiency capital expenditure."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Vehicle Amortization Schedule Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs a 60-month vehicle financing amortization table splitting principal and interest."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Investment Valuation: =XNPV(DiscountRate, CashFlows, Dates) | =XIRR(CashFlows, Dates) | Loan Amortization: =PMT(r, n, pv) | =PPMT(...) | =IPMT(...)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Standard NPV with Irregular Dates"}</td>
                  <td className="py-3 px-4">{"Standard `=NPV()` assumes all cash flows occur at strictly equal 1-year intervals, producing invalid valuations."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always use `=XNPV(rate, cash_flows, dates)` for real-world projects."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Negative Sign on Initial Investment Outflow"}</td>
                  <td className="py-3 px-4">{"Passing positive number for Year 0 investment in XIRR causes `#NUM!` error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Initial capital outflow MUST be negative: `-50000000`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Annual vs Monthly Interest Rate Mismatch in PMT"}</td>
                  <td className="py-3 px-4">{"Passing 12% annual rate into monthly loan formula without dividing by 12."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Divide annual rate by 12 and multiply years by 12: `=PMT(Rate/12, Years*12, -LoanAmount)`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Always Use XNPV / XIRR"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The institutional standard for corporate capital budgeting."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=XNPV(Rate, CashFlows, Dates)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"First Cash Flow Negative"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory requirement for XIRR calculation."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Year 0 = -Investment"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Principal + Interest = Total Payment"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The mathematical identity of debt amortization."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"PPMT + IPMT = PMT"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is `XNPV` vastly more accurate than legacy `NPV` for real-world corporate financial modeling?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why will the `XIRR` function fail and return `#NUM!` if all cash flows in the series are positive?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do `IPMT` and `PPMT` separate debt service payments into tax-deductible interest and balance-sheet principal?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Financial Amortization & Investment Valuation Lab (XNPV, XIRR) - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"In corporate finance, NEVER use standard NPV or IRR—always use XNPV and XIRR! They use exact dates so your calculations are 100% accurate. And remember: your initial investment MUST be a negative number!"}
          />
        </div>
      </div>
    </div>
