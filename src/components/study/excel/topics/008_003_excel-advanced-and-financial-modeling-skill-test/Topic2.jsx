    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⚖️ What-If Sensitivity & Solver Optimization"} · Assessment 2
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing candidate mastery of sensitivity modeling and linear programming: One-Variable and Two-Variable Data Tables, Scenario Manager, Goal Seek, and Excel Solver for constrained profit maximization"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Two-Variable Sensitivity Data Tables"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates project Net Profit across 50 combinations of Price and Sales Volume simultaneously in an instant matrix."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Excel Solver Linear Programming"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Maximizes Profit (`Objective: Max`) by adjusting production quantities (`Changing Cells`) subject to raw material and labor constraints (`<= Available`)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Goal Seek Back-Solving"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates exact required sales volume to achieve a target break-even profit margin."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Sensitivity Analysis & Optimization"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_2)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Pricing Sensitivity Matrix Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on building a 10x10 Two-Variable Data Table modeling EBITDA across various inflation and discount rate scenarios in 4 minutes."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Production Mix Profit Optimization Lab (Solver)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Uses Excel Solver to find the optimal manufacturing mix of 4 alloy steel products maximizing profit under furnace hour constraints."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Foundry Raw Material Blending Solver"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Solves least-cost raw material ingot blending formulas subject to chemical grade constraints."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Distribution Cost Minimization Solver"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Optimizes multi-depot shipping routes to minimize total freight cost."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Reversing Row and Column Input Cells in Two-Variable Data Table"}</td>
                  <td className="py-3 px-4">{"Swapping row/column inputs produces a matrix of completely inverted nonsensical numbers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure Row Input Cell matches top header variable; Column Input Cell matches left header variable."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unbounded Solver Models (Infinite Profit / Crash)"}</td>
                  <td className="py-3 px-4">{"Forgetting to add non-negativity constraint (`Make Unconstrained Variables Non-Negative`)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always check 'Make Unconstrained Variables Non-Negative' in Solver."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Data Table Formulas Not Recalculating"}</td>
                  <td className="py-3 px-4">{"Excel calculation options set to 'Automatic Except for Data Tables'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press F9 or set Calculation Options to Automatic."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Top-Left Corner Formula"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory setup for Two-Variable Data Tables."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Link top-left cell of Data Table to Output Cell"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Simplex LP in Solver"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Fastest, guaranteed optimal solution for linear optimization."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Select 'Simplex LP' for linear models"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must the top-left corner cell of a Two-Variable Data Table be linked directly to your model's target output formula?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does Excel Solver find the optimal product mix when multiple manufacturing constraints exist simultaneously?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What is the difference between Goal Seek (single variable) and Solver (multi-variable with constraints)?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"What-If Sensitivity & Solver Optimization Challenge - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"What-If Data Tables are the secret weapon of corporate finance. Build a 2-variable table for Price vs Volume, and your C-suite can see 50 financial scenarios on one screen instantly. And use Solver when you want to find the exact mix that makes the most money!"}
          />
        </div>
      </div>
    </div>
