      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔄 Power Query M Transformation & Unpivoting"} · Assessment 4
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Power Query M Transformation & Unpivoting Practical"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing candidate ETL data engineering skills in Power Query: unpivoting multi-month matrix tables, merging multi-file folders, cleaning data types, custom M-Code transformations, and loading to Data Models"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"M-Code Transformation: Table.SelectRows -> Table.TransformColumnTypes -> Table.UnpivotOtherColumns -> Table.AddColumn -> Table.Group"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Unpivoting Wide Matrix Tables"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Transforms wide human-formatted reports (Month columns across the top) into normalized 3-column tabular databases (Date, Attribute, Value) using `Table.UnpivotOtherColumns`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automated Multi-File Folder Consolidation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Combines 50 monthly branch CSV files from a folder into a single unified table in 1 click."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Data Type Coercion & Schema Standardization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Enforces strict type safety (Int64, Currency, Date, Text) preventing corruptions before data enters the Excel Data Model."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Power Query ETL Pipeline: Messy Source File -> M-Code Transformations (Unpivot/Filter/Type) -> Clean Star Schema Model"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Data Extraction, Transformation & Loading (ETL)"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_003_excel-advanced-and-financial-modeling-skill-test_4)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic4_Power_Query_M_Tran"
            title={"Power Query M Transformation & Unpivoting Practical - Assessment Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 1 · Chief Data Architect"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise 50-Branch Consolidation & Unpivot Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on ingesting 50 unformatted regional budget files, unpivoting 12 month columns, and loading a clean 100,000-row tabular dataset in 5 minutes."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Ledger Multi-File Folder ETL Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate Power Query pipeline combining monthly purchase ledgers and stripping messy blank rows."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Telemetry Ingestion ETL"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Cleanses and transforms industrial sensor logs into normalized time-series data tables."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill EDI Text Ingestion Pipeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts, parses, and unpivots carrier freight rate tariffs via Power Query."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"M-Code Transformation: Table.SelectRows -> Table.TransformColumnTypes -> Table.UnpivotOtherColumns -> Table.AddColumn -> Table.Group"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unpivoting Selected Columns Instead of 'Unpivot Other Columns'"}</td>
                  <td className="py-3 px-4">{"Using 'Unpivot Columns' hardcodes column names; when next month's data arrives, the query fails."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always select fixed ID columns and click 'Unpivot Other Columns'."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Dirty 'Changed Type' Steps Hardcoding Deleted Columns"}</td>
                  <td className="py-3 px-4">{"Auto-generated Changed Type step referencing deleted columns breaking refresh."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Clean up intermediate M-code steps before publishing queries."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Loading Massive Data to Worksheet Grid Instead of Data Model Only"}</td>
                  <td className="py-3 px-4">{"Loading 5 million rows into Excel crashes sheet row limit (1,048,576)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Select 'Only Create Connection' and check 'Add this data to the Data Model'."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Unpivot Other Columns"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Dynamic unpivoting that automatically handles new months."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click ID cols > Unpivot Other Columns"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Load to Data Model Only"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Handles multi-million row datasets with zero worksheet lag."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Close & Load To > Only Create Connection + Data Model"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"View Advanced Editor"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Inspects and edits underlying Power Query M-Code."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Home &gt; Advanced Editor"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is 'Unpivot Other Columns' vastly superior to 'Unpivot Columns' when new monthly columns are added over time?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should multi-million row Power Query datasets be loaded to the Data Model rather than a worksheet tab?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does Power Query automate data cleaning so you never have to repeat manual copy-pasting ever again?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Power Query M Transformation & Unpivoting Practical - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Power Query is the greatest time-saver in the history of spreadsheets. Always use 'Unpivot Other Columns' so your query never breaks when next month's column is added. Click 'Refresh', and your entire report updates in 2 seconds."}
          />
        </div>
      </div>
    </div>
