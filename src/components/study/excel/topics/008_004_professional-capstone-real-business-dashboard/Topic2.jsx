      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧠 Phase 2: Star Schema & DAX Measure Suite"} · Assessment 2
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Constructing the enterprise Star Schema data model and authoring the DAX Measure calculation suite: establishing 1-to-many relationships, configuring official Date tables, and authoring core KPIs, YTD metrics, and variances"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Phase 2 Modeling: Power Pivot Star Schema (1:Many Relationships) + DAX Measure Suite (Revenue, Gross Margin %, YTD, SPLY Growth %)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Star Schema Relationship Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds 1-to-many unidirectional relationships between `Fact_Sales` and `Dim_Customer`, `Dim_Product`, `Dim_Store`, and `Dim_Date`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Core Financial KPI Suite"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors foundational DAX measures: `[Total Revenue]`, `[Total COGS]`, `[Gross Profit]`, `[Gross Margin %]`, and `[Average Order Value]`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Time Intelligence & Period Variance Suite"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors advanced time intelligence measures: `[Revenue YTD]`, `[Revenue SPLY]`, `[YoY Growth %]`, and `[3-Month Rolling Average]`."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_004_professional-capstone-real-business-dashboard_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_004_professional-capstone-real-business-dashboard_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_004_professional-capstone-real-business-dashboard_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Data Modeling & DAX Engineering"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_004_professional-capstone-real-business-dashboard_2)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise 15-Measure DAX Suite Implementation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors a complete institutional DAX measure suite powering corporate financial scorecards and regional variance analysis."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statutory Tax DAX Reconciliation Model"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds DAX measures calculating CGST/SGST/IGST breakdowns and tax liability variances."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Plant Yield & OEE DAX Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors complex DAX measures tracking furnace throughput, defect rates, and overall equipment effectiveness."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier SLA Performance DAX Metrics"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs DAX measures calculating on-time delivery rates and fuel cost per ton-kilometer."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Phase 2 Modeling: Power Pivot Star Schema (1:Many Relationships) + DAX Measure Suite (Revenue, Gross Margin %, YTD, SPLY Growth %)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Creating Many-to-Many Relationships Without Bridge Tables"}</td>
                  <td className="py-3 px-4">{"Duplicate keys in dimension tables creating ambiguous relationships."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure dimension tables contain 100% unique primary keys."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Bi-Directional Cross-Filtering Indiscriminately"}</td>
                  <td className="py-3 px-4">{"Bi-directional relationships causing unpredictable filter propagation and calculation performance degradation."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Keep relationships strictly single-directional (1-to-many)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Continuous Date Table for Time Intelligence"}</td>
                  <td className="py-3 px-4">{"Time intelligence DAX functions returning `#ERROR` on missing calendar dates."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Generate complete contiguous Date table in Power Query or DAX."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Single-Directional Relationships"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees clean, predictable filter context flow."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"1:Many Unidirectional Standard"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Use Explicit DAX Measures"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Lightweight, reusable, and high-performance."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Always write explicit measures with =SUMX or =DIVIDE"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is a Star Schema with 1-to-many relationships the gold standard for enterprise Power Pivot modeling?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does `CALCULATE([Total Revenue], SAMEPERIODLASTYEAR('Date'[Date]))` calculate previous year performance?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should you always use explicit DAX measures rather than dragging numeric fields into Pivot Table values?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Phase 2: Star Schema Data Modeling, Dimensional Relationships & Advanced DAX Analytics - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Phase 2 is the brain of your dashboard. Connect your Fact table to your Dimension tables with 1-to-many relationships, write your DAX measures using `DIVIDE` and `CALCULATE`, and your data model will calculate instantly across millions of rows."}
          />
        </div>
      </div>
    </div>
