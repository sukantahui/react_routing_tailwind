    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 Phase 4: Automated Distribution & Final Capstone Sign-Off"} · Assessment 4
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Completing the capstone with full automated distribution: authoring a 1-click VBA / Office Script master controller that refreshes data, exports high-resolution vector PDF briefing decks, and dispatches automated Outlook emails"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Master Controller Subroutine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Single automated controller: 1. `ThisWorkbook.RefreshAll`; 2. Waits for background data refresh; 3. Formats summary deck; 4. Exports PDF; 5. Emails stakeholders."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Native Vector PDF Publishing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`wsDashboard.ExportAsFixedFormat xlTypePDF, pdfPath` generates crisp, vector-quality PDF presentation packs ready for executive tablets."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Automated Email Distribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates Microsoft Outlook / Power Automate to compose personalized emails, attach the PDF briefing, and dispatch to regional directors."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_004_professional-capstone-real-business-dashboard_4" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_004_professional-capstone-real-business-dashboard_4" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_004_professional-capstone-real-business-dashboard_4)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"End-to-End Enterprise Automation"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_004_professional-capstone-real-business-dashboard_4)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: 1-Click Executive Flash Report & PDF Email Engine"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Authors a 1-click master macro that refreshes the entire corporate model, exports a 1-page executive PDF briefing, and emails it to the Board in 4 seconds."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Automated Monthly Financial PDF Distribution"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates monthly plant P&L ledger refreshes and PDF email distribution to factory directors."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Daily Morning Plant Briefing Generator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates daily 06:00 AM factory shift summary PDF export and management dispatch."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Automated Carrier SLA Scorecard Emailer"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Dispatches weekly performance scorecards and PDF attachments to 20 shipping carriers."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Exporting PDF Before Background Query Refresh Completes"}</td>
                  <td className="py-3 px-4">{"Calling PDF export while Power Query is still asynchronously calculating in background produces stale PDF reports."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Disable Background Refresh on queries or wait for calculation completion."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hardcoding Output File Paths to Local Folders"}</td>
                  <td className="py-3 px-4">{"Script breaking when executed on another user's machine."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `ThisWorkbook.Path & \"\\Reports\\\"` or prompt user for destination directory."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving ScreenUpdating Disabled on Error"}</td>
                  <td className="py-3 px-4">{"Macro crash leaving Excel UI frozen."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Include structured error handling resetting `Application.ScreenUpdating = True`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Disable Background Refresh"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees data finishes refreshing before PDF export."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Connection Properties > Uncheck 'Enable background refresh'"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"1-Click Action Button"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Delivers an intuitive software experience for end-users."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Assign Master Controller to sleek rounded shape button"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Timestamped Filenames"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents accidental file overwriting on network drives."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"\"Report_\" & Format(Now, \"yyyymmdd_hhnn\") & \".pdf\""}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must 'Enable background refresh' be UNCHECKED on data connections when automating PDF exports in VBA?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does assigning a master macro to a sleek button transform your spreadsheet into an enterprise software application?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"What are the 4 phases of an enterprise-grade Excel business intelligence capstone project?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Phase 4: VBA / Office Script Automation for Scheduled Reporting, PDF Export & Email Dispatch - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
