      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🖼️ Professional GUI UserForms"} · Topic 2
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Designing professional GUI UserForms: TextBoxes, ComboBoxes, ListBoxes, CheckBoxes, and CommandButtons"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Designing professional, ergonomic graphical UserForms in the Visual Basic Editor: layout alignment, naming conventions, tab ordering, and control typography"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"UserForm Architecture: Insert &gt; UserForm | Toolbox: TextBox, ComboBox, ListBox, OptionButton, CheckBox, CommandButton, Label, Frame"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Visual GUI Canvas"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Provides custom standalone modal and modeless window forms with floating textboxes, dropdown combos, checkboxes, and buttons."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Standard Control Naming Conventions"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Mandatory prefixing standard: `txtCustomerName` (TextBox), `cboRegion` (ComboBox), `lstProducts` (ListBox), `chkActive` (CheckBox), `btnSubmit` (CommandButton)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Tab Order & Keyboard Ergonomics"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configures TabIndex properties so data entry operators can glide through fields using the Tab key with zero mouse clicks."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"UserForm Component Architecture: Modal Window -> Structured Input Controls -> Event Handlers"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Graphical User Interface (GUI) Design"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Designing_professi"
            title={"Designing professional GUI UserForms: TextBoxes, ComboBoxes, ListBoxes, CheckBoxes, and CommandButtons - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Commercial Deal Entry Portal"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a sleek UserForm for sales managers to input client contracts with dropdown selectors and automated commission calculations."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Voucher Entry GUI Form"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs standardized debit/credit voucher input forms preventing direct manual editing of audited master sheets."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shopfloor Defect Logging GUI"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys touchscreen-friendly large button UserForms for foundry operators logging scrap weights."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Driver Dispatch Entry Window"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Designs high-speed dispatch forms with automated waybill number generation."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Implement the event procedure <code className="text-cyan-300 font-mono font-bold">{"UserForm Architecture: Insert &gt; UserForm | Toolbox: TextBox, ComboBox, ListBox, OptionButton, CheckBox, CommandButton, Label, Frame"}</code> with appropriate guard rails.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Default Control Names (TextBox1, CommandButton1)"}</td>
                  <td className="py-3 px-4">{"Writing code with `TextBox1.Text` and `CommandButton1_Click` makes maintenance a nightmare across 20 fields."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Rename every control immediately in the Properties window (`txtName`, `btnSave`)."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Chaotic Tab Order Frustrating Operators"}</td>
                  <td className="py-3 px-4">{"Pressing Tab jumping randomly between field 1 and field 8 because TabIndex was not configured."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-click UserForm > Tab Order > arrange fields in logical top-to-bottom sequence."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Overcrowding UserForm with Clashing Colors"}</td>
                  <td className="py-3 px-4">{"Using bright neon backgrounds and mismatched font sizes."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Follow clean corporate UI standards (Segoe UI / Inter, subtle gray borders, standard 8pt grid padding)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Naming Convention"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Self-documenting, professional code architecture."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"txt, cbo, lst, chk, btn prefixes"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Tab Order Dialog"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Ensures seamless keyboard navigation for operators."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Right-click form > Tab Order"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Show UserForm"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Launches the modal dialog on screen."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"UserForm1.Show (or frmMain.Show)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is standard control naming (`txtCustomerName`, `btnSubmit`) essential for UserForm development?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does configuring the Tab Order property streamline high-speed data entry for corporate operators?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why are UserForms vastly superior to freehand worksheet cell data entry for preventing data corruption?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Designing professional GUI UserForms: TextBoxes, ComboBoxes, ListBoxes, CheckBoxes, and CommandButtons - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"UserForms turn Excel into real desktop software! Always rename your controls (e.g. `txtName` instead of `TextBox1`) and configure Tab Order so users can type and press Tab smoothly without touching the mouse."}
          />
        </div>
      </div>
    </div>
