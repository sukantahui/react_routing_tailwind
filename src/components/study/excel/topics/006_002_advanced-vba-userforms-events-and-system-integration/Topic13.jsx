      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 Corporate Inventory Management & Billing System Capstone"} · Topic 13
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Enterprise Capstone System"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Real-world project: Developing a full-fledged Corporate Inventory Management & Billing System with UserForms"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive end-to-end enterprise capstone project: engineering a production-grade Corporate Inventory Management, Invoicing, and Billing System with tabbed UserForms, PDF generation, and automated Outlook email dispatch"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Enterprise Inventory & Billing Engine: MultiPage GUI + Event Traps + FSO File Auditing + Outlook Invoicing + .XLAM Packaging"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. End-to-End Enterprise System Integration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Synthesizes multi-page UserForms (`Stock Ingest`, `Invoice Generator`, `Customer CRM`), real-time stock availability validation, and atomic ledger write-backs."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automated Invoicing & Vector PDF Generation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates formatted corporate GST tax invoices, exports vector PDF copies, and logs transactions to immutable audit registers."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Automated Outlook Dispatch & Reporting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automatically composes and dispatches email invoices with attached PDFs to clients, and updates inventory reorder alerts."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Corporate Inventory Management & Invoicing Master Architecture"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_13" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_13" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_13)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Enterprise Capstone System"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_13)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title={"Real-world project: Developing a full-fledged Corporate Inventory Management & Billing System with UserForms - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Inventory & Invoicing Portal Deployment"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys a complete corporate inventory and billing system processing ₹25 Crore monthly sales across 4 regional distribution hubs."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Factory Spare Parts Requisition & Billing System"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates internal parts billing, scrap inventory depreciation, and inter-departmental chargebacks."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Raw Material Ingot Inventory Control Suite"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys touchscreen inventory consumption UserForms tracking alloy stock in real time."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Fleet Consumables Billing & Transit Portal"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Manages nationwide tire, fuel, and maintenance inventory with automated replenishment alerts."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Implement the event procedure <code className="text-cyan-300 font-mono font-bold">{"Enterprise Inventory & Billing Engine: MultiPage GUI + Event Traps + FSO File Auditing + Outlook Invoicing + .XLAM Packaging"}</code> with appropriate guard rails.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Allowing Invoicing of Out-of-Stock Items (Negative Inventory)"}</td>
                  <td className="py-3 px-4">{"UserForm accepting orders exceeding warehouse stock."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Add stock validation check: `If reqQty > stockQty Then MsgBox \"Insufficient Stock!\", vbCritical: Exit Sub`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Single-Point Transaction Failure Corrupting Balance"}</td>
                  <td className="py-3 px-4">{"Writing the invoice but crashing before decrementing warehouse stock."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap transactions in structured rollback error handling."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unsanitized User Inputs Causing SQL / Array Errors"}</td>
                  <td className="py-3 px-4">{"Failing to validate special characters or apostrophes in client names."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Sanitize all input strings using `Replace(str, \"'\", \"''\")`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Stock Check Before Write"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents negative inventory anomalies."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Verify Available >= Requested"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Atomic Transaction Pattern"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees complete end-to-end data integrity."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Write Invoice + Decrement Stock + Generate PDF"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"1-Click Launch Button"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Delivers an intuitive custom software experience for operators."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"frmBillingMaster.Show"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does this comprehensive inventory system combine UserForms, worksheet write-backs, and PDF generation into a unified enterprise tool?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must inventory decrementing and invoice generation execute as an atomic transaction?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does packaging this entire application as an `.xlam` add-in empower regional branch staff to use it with zero setup?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Real-world project: Developing a full-fledged Corporate Inventory Management & Billing System with UserForms - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Congratulations on completing Advanced VBA and System Integration! You have built a complete, commercial-grade enterprise software application right inside Microsoft Excel. You possess elite-level automation capabilities."}
          />
        </div>
      </div>
    </div>
