      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📦 Creating & Distributing Excel Add-Ins (.XLAM)"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Custom Tool Deployment & Distribution"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Creating and distributing custom Excel Add-ins (`.xlam`)"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Creating, packaging, and distributing custom Excel Add-Ins (.xlam): converting macro workbooks into global background toolkits, custom ribbon XML buttons, and seamless corporate deployment"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Excel Add-In (.xlam): Save As &gt; Excel Add-In (*.xlam) | Install: Developer &gt; Excel Add-ins &gt; Browse &gt; Check Add-in"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The `.xlam` Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"A hidden, worksheet-less workbook that loads automatically into background memory whenever Excel starts up, making its macros and UDFs available across ALL open workbooks."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Universal Worksheet UDF Availability"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Custom functions inside an installed `.xlam` (e.g. `=CALCULATE_GST()`) work in any new blank workbook with zero file copying."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Custom Ribbon XML Integration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Embeds custom tabs, groups, and sleek icon buttons directly into Microsoft Excel's top ribbon via `CustomUI` XML."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Excel Add-In (.XLAM) Lifecycle: Development -> .XLAM Compilation -> Global Ribbon Installation -> Universal Availability"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Custom Tool Deployment & Distribution"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_12)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic12_Creating_and_distr"
            title={"Creating and distributing custom Excel Add-ins (`.xlam`) - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Corporate Finance Ribbon Toolkit (.xlam)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Packages 40 corporate financial macros into `AccoTax_Finance_Tools.xlam` deployed across 500 analyst laptops with custom ribbon buttons."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Tax Systems Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statutory GST Calculator Add-In"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Distributes `=CALCULATE_GST()` and `=VALIDATE_GSTIN()` custom formulas as an installable add-in for accounting staff."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Manufacturing Engineering Add-In"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys standardized engineering conversion formulas across plant workstations via `.xlam`."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Freight Route Planning Toolkit"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys custom freight distance and toll calculation add-ins for shipping dispatchers."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Implement the event procedure <code className="text-cyan-300 font-mono font-bold">{"Excel Add-In (.xlam): Save As &gt; Excel Add-In (*.xlam) | Install: Developer &gt; Excel Add-ins &gt; Browse &gt; Check Add-in"}</code> with appropriate guard rails.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Worksheet Tabs Visible in .xlam Master"}</td>
                  <td className="py-3 px-4">{"Worksheets left unhidden in `.xlam` can cause confusing blank windows on Excel startup."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Set `ThisWorkbook.IsAddin = True` in the Properties window before saving."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Modifying Code in .xlam Without Re-Saving Add-in"}</td>
                  <td className="py-3 px-4">{"Editing code inside an installed add-in without saving loses edits when Excel closes."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Explicitly click Save in the VBE window (`Ctrl + S`) while add-in project is selected."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hardcoding File Paths in Add-In Macros"}</td>
                  <td className="py-3 px-4">{"Add-in macros attempting to write to `ThisWorkbook.Path` write to the hidden Microsoft AddIns roaming folder."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Prompt user for target save paths or use `ActiveWorkbook.Path`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Set IsAddin = True"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Converts workbook into a hidden background add-in."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"ThisWorkbook Properties > IsAddin = True"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Save As .XLAM"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Saves to default `%appdata%\\Microsoft\\AddIns` folder."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"File &gt; Save As > Excel Add-in (*.xlam)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Install Add-In"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Activates the add-in globally across Excel."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Developer > Excel Add-ins > Browse"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does an installed Excel Add-In (`.xlam`) make custom UDF formulas available in every workbook on your computer?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must you set `ThisWorkbook.IsAddin = True` before saving an add-in?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do corporate IT teams deploy standardized custom ribbon toolbars using `.xlam` add-in packages?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Creating and distributing custom Excel Add-ins (`.xlam`) - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"The ultimate way to distribute your macros: Save your workbook as an Excel Add-In (`.xlam`). Now your custom formulas and macros appear in EVERY workbook on your computer automatically!"}
          />
        </div>
      </div>
    </div>
