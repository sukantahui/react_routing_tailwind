    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔒 VBA Project Protection & Security Governance"} · Topic 11
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Intellectual Property & Code Security"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Securing proprietary algorithms and intellectual property: locking VBA Projects with passwords, obfuscation techniques, trusted code deployment, and enterprise security governance"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. VBAProject Password Protection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Locks the VBE project. When unauthorized users press Alt + F11, Excel prompts for a password before showing code or forms."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Code Obfuscation Principles"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Renaming variables and procedures to non-descriptive identifiers (`Sub x1()`, `Dim o7 As Object`) to make decompiled code unreadable to competitors."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Compiled Binary Add-Ins (.XLAM / .XLSB)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Distributing proprietary algorithms as compiled Excel Add-Ins (`.xlam`) or binary sheets (`.xlsb`) rather than exposed `.xlsm` worksheets."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_11" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_11" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_11)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Intellectual Property & Code Security"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_11)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Proprietary M&A Valuation Algorithm Protection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Locks proprietary DCF valuation code with AES-compliant project passwords before distributing financial models to external clients."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Statutory Tax Audit Algorithm Security"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Protects proprietary tax deduction algorithms from unauthorized tampering by branch accountants."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Proprietary Alloy Formula Code Lock"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Locks metallurgical calculation subroutines on shopfloor operator terminals."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Proprietary Freight Rate Card Obfuscation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Obfuscates proprietary logistics rate algorithms on client-facing quote generators."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Believing VBA Passwords Are 100% Unbreakable"}</td>
                  <td className="py-3 px-4">{"Standard VBA passwords can be bypassed using hex editor binary byte alteration (`DPB` to `DPx`)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Combine VBA passwords with code obfuscation, C++ DLL compilation, or compiled `.xlam` add-ins for true commercial security."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Lost VBA Passwords (No Recovery Option)"}</td>
                  <td className="py-3 px-4">{"Forgetting project password locks author out of their own source code permanently."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Store master unencrypted source code copies in secure corporate Git repositories."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Protecting Project Before Debugging Concludes"}</td>
                  <td className="py-3 px-4">{"Leaving project locked makes testing and error debugging painful during active development."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Apply VBA password protection ONLY as the final deployment step."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Lock Project Shortcut"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Enables password protection for the VBE project."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Tools > VBAProject Properties > Protection"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Backup Unlocked Master"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Essential safeguard against forgotten passwords."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Keep Master_Unlocked.xlsm in vault"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Distribute as .XLAM"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Hides sheets completely and integrates macros into Excel ribbon."}</p>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How do you lock your VBA Project so end-users cannot view or modify your source code?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should you always maintain a clean unlocked master backup in a secure repository?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is distributing your code as an Excel Add-In (`.xlam`) superior to distributing individual macro-enabled workbooks?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Protecting and locking VBA Project code with passwords and obfuscation principles - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
