      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📊 Automated PowerPoint Slide Decks from Excel"} · Topic 8
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Executive Slide Deck Automation"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Automating PowerPoint from Excel VBA: Generating executive slide decks dynamically from Excel charts"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Automating Microsoft PowerPoint from Excel VBA: launching PowerPoint, creating presentation decks, copying Excel charts and KPI cards as vector images, and pasting them onto formatted slide layouts"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"PowerPoint Automation: Set pptApp = CreateObject(\"PowerPoint.Application\") | Set pres = pptApp.Presentations.Add | pres.Slides.AddSlide | chartObj.CopyPicture -> Slide.Shapes.Paste"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Cross-Application COM Interoperability"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Instantiates PowerPoint via `CreateObject(\"PowerPoint.Application\")` and commands its object model (`Presentations`, `Slides`, `Shapes`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. High-Quality Vector Picture Copy (`CopyPicture`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`chartObj.Chart.CopyPicture Appearance:=xlScreen, Format:=xlPicture`. Captures high-res vector graphics rather than blurry low-res bitmaps."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Precise Shape Positioning & Alignment"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Positions pasted charts precisely on the slide using `.Left`, `.Top`, `.Width`, and `.Height` coordinates in points."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Excel-to-PowerPoint Automation Pipeline: Excel Charts & KPI Tables -> Vector Picture Copy -> PowerPoint Slide Injection"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Executive Slide Deck Automation"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_8)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic8_Automating_PowerPo"
            title={"Automating PowerPoint from Excel VBA: Generating executive slide decks dynamically from Excel charts - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Automated 20-Slide Boardroom Deck Generation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Generates a complete 20-slide executive PowerPoint presentation deck from 15 Excel charts and 5 KPI summary tables in 6 seconds."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Lead Financial Analyst"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly P&L PowerPoint Briefing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates monthly financial variance bridge slide decks for factory executive reviews."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Plant Operational Excellence Slide Deck"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pushes daily scrap Pareto charts and yield trends into corporate PowerPoint templates."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier SLA Review Presentation Generator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Constructs quarterly vendor performance slide decks with auto-aligned charts."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Implement the event procedure <code className="text-cyan-300 font-mono font-bold">{"PowerPoint Automation: Set pptApp = CreateObject(\"PowerPoint.Application\") | Set pres = pptApp.Presentations.Add | pres.Slides.AddSlide | chartObj.CopyPicture -> Slide.Shapes.Paste"}</code> with appropriate guard rails.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Paste Timing Lag (Clipboard Sync Failure)"}</td>
                  <td className="py-3 px-4">{"Pasting into PowerPoint before Excel finishes copying to the Windows clipboard throws runtime error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Include a short `DoEvents` or 1-second pause between Copy and Paste."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Pasting Blurry Low-Resolution Bitmaps"}</td>
                  <td className="py-3 px-4">{"Using standard `.Copy` instead of `.CopyPicture Appearance:=xlScreen, Format:=xlPicture`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always use `.CopyPicture` for crisp vector visuals."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Hidden PowerPoint Background Processes"}</td>
                  <td className="py-3 px-4">{"Failing to make PowerPoint visible (`pptApp.Visible = True`) leaves phantom PowerPoint instances in Task Manager."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always set `.Visible = True` or close cleanly."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Vector Chart Copy"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees crystal-clear, high-res presentation graphics."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Chart.CopyPicture Appearance:=xlScreen, Format:=xlPicture"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Precise Slide Positioning"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Pixel-perfect alignment on executive slide templates."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Shape.Left = 50: Shape.Top = 100"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"DoEvents Clipboard Sync"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents clipboard synchronization errors."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"DoEvents (between copy & paste)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is `Chart.CopyPicture` vastly superior to standard `.Copy` when exporting charts to PowerPoint?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do coordinate properties (`Left`, `Top`, `Width`, `Height`) guarantee pixel-perfect chart alignment on slides?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is `DoEvents` essential when transferring clipboard images between Excel and PowerPoint?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Automating PowerPoint from Excel VBA: Generating executive slide decks dynamically from Excel charts - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never build weekly PowerPoint decks manually again! Write a VBA macro that loops through your Excel charts, copies them with `.CopyPicture`, and pastes them onto PowerPoint slides in exact coordinates. It saves hours of executive prep time."}
          />
        </div>
      </div>
    </div>
