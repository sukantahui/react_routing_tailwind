    ...
    <div className="dark bg-slate-950 text-slate-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔄 Batch Processing All Workbooks in a Folder"} · Topic 6
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Batch Processing & Workload Scaling"}
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Engineering automated batch processing engines using the Dir() looping pattern: scanning directories, opening hundreds of client/branch workbooks sequentially, extracting data, and consolidating into master sheets"}. Master event-driven programming, GUI UserForm engineering, FileSystemObject automation, cross-Office integrations, and custom add-in deployment.
          </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Headless Silent Processing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Sets `Application.ScreenUpdating = False` and `Application.DisplayAlerts = False` so 100 workbooks open, process, and close invisibly in seconds without screen flashing."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Defensive Corrupted File Isolation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Wraps individual workbook processing in localized error traps so a single password-protected or corrupted file does not halt the entire batch run."}</p>
            </div>
        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod16_6" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod16_6" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_6)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Batch Processing & Workload Scaling"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod16_6)" fill="none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Consolidating 50 Regional Branch Sales Files"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Automates the sequential extraction of monthly revenue from 50 branch `.xlsx` files in a shared network folder into 1 master workbook in 12 seconds."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Batch Processing 1,000 Vendor Invoices"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Iterates through a folder of 1,000 monthly purchase ledgers, extracting tax summaries into an audited compliance master register."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Batch Machine Telemetry Consolidator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Aggregates 30 daily machine logs into an ISO monthly maintenance archive."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Regional Depot Manifest Batch Extractor"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Consolidates weekly freight transit logs across 15 regional shipping terminals."}</p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"The 'Infinite Same File' Loop Trap"}</td>
                  <td className="py-3 px-4">{"Forgetting to write `strFile = Dir()` before the `Loop` statement causes the loop to re-open the first file forever."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always call `strFile = Dir()` at the bottom of the loop to advance to the next file."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Saving Changes to Source Files Accidentally"}</td>
                  <td className="py-3 px-4">{"Calling `wbSource.Close SaveChanges:=True` modifies client source files."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always close extraction sources safely with `wbSource.Close SaveChanges:=False`."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Silent Headless Mode"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Processes 100 workbooks completely invisibly."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"ScreenUpdating & DisplayAlerts = False"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does the `Dir()` function in VBA iterate through all `.xlsx` files in a folder sequentially?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must you ignore files starting with `~$` during batch processing?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should you always use `wbSource.Close SaveChanges:=False` when consolidating data from source files?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the event lifecycle dynamics and system integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Batch processing all workbooks inside a directory automatically - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Batch processing is where you save real human hours. Write a `Dir()` loop, point it at a folder with 100 files, and let Excel open, copy data, and close every file in 10 seconds. Always skip files starting with `~$`!"}
          />
        </div>
      </div>
    </div>
