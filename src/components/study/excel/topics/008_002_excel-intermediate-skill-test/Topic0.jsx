...
import sampleWorkbookUrl from "./excel_files/008_002_excel_intermediate_skill_test_master.xlsx?url";
...
export default function Topic0() {
  ...
  const handleDownload = () => {
    ...
    link.download = "008_002_excel-intermediate-skill-test_practice.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📋 Structured Tables & Filter Challenge"} · Assessment 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Table Architecture & Structured Referencing"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Structured Tables & Advanced Multi-column Filter Challenge"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing candidate mastery of official Excel Tables: converting ranges (Ctrl + T), structured table referencing (`tbl[Column]`), total row calculations, multi-column filtering, and interactive Slicers"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-2.5 text-slate-300">
              ...
              <span><strong>Module:</strong> {"Excel Intermediate Skill Test"}</span>
            </div>
            <div className="flex items-center gap-2.5 text-slate-300">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Structured Table: Ctrl + T | Structured Reference: =SUM(tblSales[Revenue]) | Multi-Column Filter: Slicers + Advanced Filter Criteria"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Self-Expanding Structured Referencing"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Formulas use readable column names (`=tblSales[@Qty]*tblSales[@Price]`) that auto-expand dynamically when new rows are added."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Automated Total Row Aggregations"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates Sum, Average, Count, and Subtotals with zero manual formula ranges."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Interactive Visual Slicers"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects 1-click visual Slicer buttons filtering complex multi-column tables in real time."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Structured Table Architecture: Flat Range -> Ctrl+T Conversion -> Structured References -> Interactive Slicers"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_002_excel-intermediate-skill-test_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_002_excel-intermediate-skill-test_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Table Architecture & Structured Referencing"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Structured_Tables_"
            title={"Structured Tables & Advanced Multi-column Filter Challenge - Assessment Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 1 · VP Commercial Strategy"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Sales Table Slicer & Filter Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on converting 10,000 raw sales rows into structured `tblSales`, adding Slicers for Region and Year, and calculating weighted margin totals."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Register Table Slicing Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate ability to filter multi-rate GST tables using structured column references."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Downtime Structured Log"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates structured table creation for factory downtime logs with Total Row sums."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Manifest Multi-Filter Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests multi-condition table filters isolating delayed shipments across transport zones."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Structured Table: Ctrl + T | Structured Reference: =SUM(tblSales[Revenue]) | Multi-Column Filter: Slicers + Advanced Filter Criteria"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Hardcoded Cell Coordinates ($A$2:$A$100) Instead of Structured Names"}</td>
                  <td className="py-3 px-4">{"Writing legacy formulas that fail to auto-expand when new rows are pasted into the table."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use structured table referencing: `tblSales[Revenue]`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Adding Slicers to Unformatted Standard Ranges"}</td>
                  <td className="py-3 px-4">{"Slicers require official Excel Tables or Pivot Tables to function."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press `Ctrl + T` to convert range to Table first."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Duplicate Column Header Names"}</td>
                  <td className="py-3 px-4">{"Excel appending numbers (e.g. `Sales2`) causing formula ambiguity."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure every table column has a unique, descriptive header name."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Convert to Table"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Converts range to official Excel Table."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + T"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Insert Slicer"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Adds interactive 1-click visual filter buttons."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Table Design &gt; Insert Slicer"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Toggle Total Row"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Toggles Table Total Row on and off."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Shift + T"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is structured table referencing (`tbl[Revenue]`) vastly superior to hardcoded cell ranges (`$C$2:$C$5000`)?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do interactive Slicers transform a static spreadsheet table into an intuitive interactive app?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why does adding a new row to an official Excel Table automatically expand all attached formulas and charts?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Structured Tables & Advanced Multi-column Filter Challenge - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Structured Tables (`Ctrl + T`) are the backbone of modern Excel. Always give your table a name (like `tblSales`), use structured formulas like `=SUM(tblSales[Revenue])`, and add Slicers so your boss can filter with 1 click!"}
          />
        </div>
      </div>
    </div>
