      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔀 Text, Date & Complex Conditional Logic Test"} · Assessment 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Logic, String & Date Engineering"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Text, Date & Complex Conditional Logic Test"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing complex logical branching and string/date manipulation: nested IFS, multi-condition AND/OR logic, TEXTJOIN, TEXTSPLIT, EDATE, EOMONTH, and DATEDIF calculations"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Text/Date/Logic: =IFS(B2>1000000, \"Tier 1\", B2>500000, \"Tier 2\", TRUE, \"Standard\") | Date: =EDATE(A2, 3) | Text: =TEXTJOIN(\", \", TRUE, A2:C2)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Multi-Tier IFS Logical Branching"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates multi-condition business rules sequentially without unreadable nested IF parentheses: `=IFS(Cond1, Val1, Cond2, Val2, TRUE, DefaultVal)`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Calendar & Maturity Date Modeling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Calculates precise fiscal quarter ends (`EOMONTH`), milestone deadlines (`EDATE`), and tenure durations (`DATEDIF`)."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Modern String Aggregation (TEXTJOIN)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Concatenates variable-length text ranges with custom delimiters while ignoring blank cells."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Complex Logic & String Transformation Pipeline: Input Data -> Nested IFS Decision Tree -> String/Date Formatting -> Clean Business Classification"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_002_excel-intermediate-skill-test_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_002_excel-intermediate-skill-test_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Logic, String & Date Engineering"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_Text__Date___Compl"
            title={"Text, Date & Complex Conditional Logic Test - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Customer Tier & Contract Maturity Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on constructing multi-condition commission tier formulas and contract expiration date calculations for 5,000 corporate clients."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: GST Filing Due Date & Penalty Logic Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate formulas calculating statutory filing deadlines with late fee penalty IF conditions."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Maintenance Due Date Calculator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidate use of `EDATE` to project equipment servicing schedules across factory units."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill Address TEXTJOIN & Status Logic"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests address concatenation and delivery SLA threshold IF formulas."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Text/Date/Logic: =IFS(B2>1000000, \"Tier 1\", B2>500000, \"Tier 2\", TRUE, \"Standard\") | Date: =EDATE(A2, 3) | Text: =TEXTJOIN(\", \", TRUE, A2:C2)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Reversing Inequality Order in IFS Statements"}</td>
                  <td className="py-3 px-4">{"Placing `B2 > 100000` before `B2 > 1000000` causes all high numbers to trigger the smaller tier first."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Order inequalities strictly from most restrictive (highest) to least restrictive."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Final 'TRUE, Default' Catch-All in IFS"}</td>
                  <td className="py-3 px-4">{"IFS returning `#N/A` when no condition matches."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always end IFS formulas with `TRUE, \"DefaultValue\"`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Hardcoded Date Strings ('15/08/2026') in Formulas"}</td>
                  <td className="py-3 px-4">{"Regional date format misinterpretation causing formula errors."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use the `DATE(year, month, day)` function for reliable date construction."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"IFS Catch-All"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees no #N/A errors for unmatched cases."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"IFS(..., TRUE, \"Other\")"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Month-End Date"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Calculates exact last day of current month."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"EOMONTH(Date, 0)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Clean TEXTJOIN"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Joins text strings with commas, skipping blanks."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"TEXTJOIN(\", \", TRUE, Range)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why must condition tiers in an `IFS()` formula be ordered from highest value to lowest value?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should you always use `EOMONTH()` rather than adding 30 days to calculate month-end dates?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does `TEXTJOIN()` eliminate trailing commas when concatenating ranges with blank cells?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Text, Date & Complex Conditional Logic Test - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Switch from `IF` to `IFS`! It is so much cleaner. Just write `=IFS(Score>=90, \"A\", Score>=80, \"B\", TRUE, \"C\")`. Always put `TRUE` at the end as your safety net."}
          />
        </div>
      </div>
    </div>
