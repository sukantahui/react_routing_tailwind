      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧮 Statistical Analysis & Multi-Condition Summation"} · Assessment 2
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Statistical Analysis & Multi-condition Summation Challenge"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing advanced conditional aggregations across multi-criteria datasets: SUMIFS, COUNTIFS, AVERAGEIFS, dynamic wildcard filtering (*, ?), date window filtering, and quartile metrics"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Multi-Condition Aggregation: =SUMIFS(SumRng, CritRng1, Crit1, CritRng2, Crit2) | =COUNTIFS(...) | =AVERAGEIFS(...) | =MEDIAN(IF(...))"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Multi-Dimensional SUMIFS Architecture"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Syntax: `=SUMIFS(SumRange, CriteriaRange1, Criteria1, CriteriaRange2, Criteria2)`. Aggregates data intersecting multiple categorical and numerical conditions."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Dynamic Date Window Summation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filtering transactions within specific date ranges: `CriteriaRange, \">=\"&StartDate, CriteriaRange, \"<=\"&EndDate`."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Wildcard Text Matching (*, ?)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Aggregating all product models containing 'Pro': `CritRange, \"*Pro*\"`."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Multi-Condition Summation Pipeline: Raw Dataset -> SUMIFS Criteria Intersect -> Aggregated Metric Output"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_002_excel-intermediate-skill-test_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_002_excel-intermediate-skill-test_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Conditional Statistical Aggregations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Statistical_Analys"
            title={"Statistical Analysis & Multi-condition Summation Challenge - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Regional Sales Matrix SUMIFS Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on building a dynamic 2-way summary matrix calculating total sales by Region and Product Category using `SUMIFS` in 4 minutes."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Multi-Condition Tax Surcharge Reconciliation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate formulas aggregating tax liabilities for specific tax slabs within Q3 date windows."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Machine Defect COUNTIFS Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidate calculations of defect occurrences matching specific shift and temperature criteria."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Multi-Zone Freight Volume SUMIFS"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests freight tonnage aggregations across carrier zones and delivery urgency levels."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Multi-Condition Aggregation: =SUMIFS(SumRng, CritRng1, Crit1, CritRng2, Crit2) | =COUNTIFS(...) | =AVERAGEIFS(...) | =MEDIAN(IF(...))"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Confusing SUMIF vs SUMIFS Argument Order"}</td>
                  <td className="py-3 px-4">{"In `SUMIF`, the sum range is LAST; in `SUMIFS`, the sum range is FIRST! Mixing them causes formula errors."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always use `SUMIFS` (sum range FIRST) even for single-condition queries for consistency."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Mismatched Range Dimensions in SUMIFS"}</td>
                  <td className="py-3 px-4">{"Sum range `B2:B100` with criteria range `A2:A150` throws `#VALUE!` error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure all range arguments have identical row and column dimensions."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Forgetting Ampersand in Dynamic Comparison Operators"}</td>
                  <td className="py-3 px-4">{"Writing `\">=A1\"` searches for the literal text '>A1' instead of comparing against cell value."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Concatenate operator with cell reference: `\">=\" & A1`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Always Use SUMIFS"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Consistent argument order across all conditional queries."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=SUMIFS(SumRng, CritRng1, Crit1)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dynamic Cell Reference"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory concatenation syntax for cell dates/numbers."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"\">=\" & StartDateCell"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Wildcard Matching"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Matches partial text anywhere within cells."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"\"*\" & SearchText & \"*\""}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"What is the critical difference in argument order between `SUMIF()` and `SUMIFS()`?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must comparison operators be concatenated with cell references using ampersands (e.g. `\">=\" & E1`) in `SUMIFS`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why will `SUMIFS` throw a `#VALUE!` error if the sum range and criteria ranges have different row lengths?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Statistical Analysis & Multi-condition Summation Challenge - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Forget about `SUMIF` and always use `SUMIFS`! In `SUMIFS`, the column you want to add up is always the VERY FIRST argument: `=SUMIFS(Revenue, Region, \"East\", Year, 2026)`. It is much easier to remember."}
          />
        </div>
      </div>
    </div>
