      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎯 VLOOKUP, INDEX-MATCH & XLOOKUP Accuracy Test"} · Assessment 3
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"VLOOKUP, INDEX-MATCH & XLOOKUP Accuracy Test"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing candidate mastery across legacy and modern lookup engines: VLOOKUP exact vs approximate matching, INDEX-MATCH 2-way matrix lookups, XLOOKUP left lookups, built-in IFERROR handling, and wildcard lookups"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Lookup Matrix: =XLOOKUP(LookupVal, LookupArray, ReturnArray, \"Not Found\", MatchMode, SearchMode) | =INDEX(Array, MATCH(...))"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The Modern XLOOKUP Gold Standard"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Syntax: `=XLOOKUP(LookupVal, LookupArray, ReturnArray, [if_not_found], [match_mode], [search_mode])`. Looks left, looks right, never breaks on column insertions."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. INDEX-MATCH Two-Way Matrix Lookups"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`=INDEX(Table, MATCH(RowVal, RowHdr, 0), MATCH(ColVal, ColHdr, 0))`. Retrieves data intersecting dynamic row and column headers."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. VLOOKUP Column Index Fragility"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Testing candidate awareness of why hardcoded column indices (`4`) break when new columns are inserted into source tables."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Lookup Engine Comparison: VLOOKUP (Right Only) vs INDEX-MATCH (2-Way) vs XLOOKUP (Left/Right/Spill)"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_002_excel-intermediate-skill-test_3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_002_excel-intermediate-skill-test_3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_3)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Lookup & Reference Mastery"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_002_excel-intermediate-skill-test_3)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic3_VLOOKUP__INDEX_MAT"
            title={"VLOOKUP, INDEX-MATCH & XLOOKUP Accuracy Test - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Price Card XLOOKUP & Left-Lookup Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on retrieving product costs located to the left of SKU IDs using `XLOOKUP` with built-in 'Not Found' error handling."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Two-Way Tax Rate Matrix INDEX-MATCH Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate construction of 2-way matrix lookups matching HSN codes against state tax percentage tables."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 3 · Plant Quality Superintendent"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Tolerance Lookup Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates approximate matching lookups for temperature tolerance brackets."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Freight Tariff XLOOKUP Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests multi-condition and reverse search XLOOKUP formulas on shipment rate tables."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Lookup Matrix: =XLOOKUP(LookupVal, LookupArray, ReturnArray, \"Not Found\", MatchMode, SearchMode) | =INDEX(Array, MATCH(...))"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"VLOOKUP Column Insertion Breakage Bug"}</td>
                  <td className="py-3 px-4">{"Inserting a new column in source data breaks hardcoded `col_index_num = 3`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `XLOOKUP` which references columns directly by range."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Exact Match Parameter (FALSE / 0) in VLOOKUP"}</td>
                  <td className="py-3 px-4">{"Defaulting to approximate match on unsorted tables returning random incorrect values."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always pass `FALSE` in VLOOKUP: `=VLOOKUP(A2, Table, 3, FALSE)`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Approximate Match on Unsorted Reference Tables"}</td>
                  <td className="py-3 px-4">{"Running approximate lookup (`match_mode = 1`) on unsorted data."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Ensure reference lookup table is sorted ascending when using approximate lookups."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Use XLOOKUP Exclusively"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The fastest, most robust lookup function in Excel."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=XLOOKUP(LookupVal, LookupCol, ReturnCol)"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Built-In If Not Found"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Eliminates need for outer IFERROR wrapping."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"XLOOKUP(..., \"Not Found\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Two-Way XLOOKUP"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Modern 2-way matrix lookup syntax."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"=XLOOKUP(RowVal, RowCol, XLOOKUP(ColVal, ColHdr, Matrix))"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is `XLOOKUP` completely immune to the column insertion bugs that break `VLOOKUP`?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does `XLOOKUP` eliminate the need to wrap formulas in `IFERROR()`?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How do you perform a 2-way matrix lookup using nested `XLOOKUP` functions?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"VLOOKUP, INDEX-MATCH & XLOOKUP Accuracy Test - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"`XLOOKUP` is the king of lookups! It looks left, it looks right, it doesn't care if someone inserts a column, and it has error handling built right in. If you are still using VLOOKUP, switch to XLOOKUP today!"}
          />
        </div>
      </div>
    </div>
