      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🧮 Mathematical & Aggregation Formula Challenge"} · Assessment 2
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Formula Architecture & Order of Operations"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Basic Mathematical & Aggregation Formula Challenge"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Testing core mathematical formula construction: basic arithmetic (+, -, *, /), AutoSum shortcuts (Alt + =), statistical aggregations (SUM, AVERAGE, MIN, MAX, COUNT vs COUNTA), and absolute cell referencing ($)"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Aggregation Formulas: =SUM(B2:B100) | =AVERAGE(B2:B100) | =COUNT(B2:B100) | =MAX(B2:B100) | =MIN(B2:B100) | AutoSum: Alt + ="}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Mathematical Order of Operations (PEMDAS/BODMAS)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Ensuring proper parenthetical grouping in multi-step formulas: `=(Revenue - Cost) / Revenue`."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Absolute Reference Lock ($)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Locking tax rate cells (`$B$1`) with F4 so formulas copy down without drift."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. COUNT vs COUNTA Precision"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`COUNT` counts numeric cells only; `COUNTA` counts all non-blank text and numeric cells."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Aggregation Engine Flow: Range Input Vector -> Aggregator (SUM/AVG/COUNT) -> Single Scalar Metric"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_001_excel-beginner-skill-test_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_001_excel-beginner-skill-test_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Formula Architecture & Order of Operations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Basic_Mathematical"
            title={"Basic Mathematical & Aggregation Formula Challenge - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Corporate Sales Summary Aggregation Lab"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on constructing total revenue, gross margin %, and average order size formulas across 50 regional tables."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Tax Surcharge Allocation Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate use of absolute cell referencing (`$D$2`) to allocate corporate tax surcharges across branch ledgers."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Shift Machine Telemetry Min/Max Challenge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidate calculations of peak temperature (`MAX`), lowest pressure (`MIN`), and sample count (`COUNTA`)."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Transit Cost Aggregation Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests AutoSum multi-range calculations across regional delivery manifests."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Aggregation Formulas: =SUM(B2:B100) | =AVERAGE(B2:B100) | =COUNT(B2:B100) | =MAX(B2:B100) | =MIN(B2:B100) | AutoSum: Alt + ="}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing Absolute Lock ($) on Multiplier Cell"}</td>
                  <td className="py-3 px-4">{"Writing `=A2*B1` and dragging down becomes `=A3*B2` (multiplying against wrong blank cells)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press F4 on multiplier cell to lock coordinates: `=A2*$B$1`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Omitting Parentheses in Percentage Calculations"}</td>
                  <td className="py-3 px-4">{"Writing `=A2-B2/A2` calculates `A2 - (B2/A2)` instead of `(A2-B2)/A2` due to operator precedence."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap subtraction in parentheses: `=(A2-B2)/A2`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using COUNT on Text Columns"}</td>
                  <td className="py-3 px-4">{"`COUNT(NamesRange)` returns 0 because names are text strings."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `COUNTA()` for text columns."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Instant AutoSum"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Automatically writes =SUM() for active row or column."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + ="}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Toggle Lock ($)"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Cycles through $A$1 -> A$1 -> $A1 -> A1."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Press F4 while in formula"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Highlight All Cells"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Selects contiguous table range."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Shift + 8 (or Ctrl + A)"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does writing `=A2-B2/A2` calculate an incorrect margin percentage in Excel?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the operational difference between the `COUNT()` function and the `COUNTA()` function?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does pressing the `F4` key prevent formula references from shifting when dragged down a column?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Basic Mathematical & Aggregation Formula Challenge - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Always remember PEMDAS! If you want profit margin, write `=(Revenue - Cost) / Revenue`. If you forget the parentheses, Excel will divide cost by revenue first. And always press F4 to lock tax rate cells!"}
          />
        </div>
      </div>
    </div>
