...
import sampleWorkbookUrl from "./excel_files/excel_beginner_skill_test_master.xlsx?url";
...
export default function Topic3() {
  ...
  const handleDownload = () => {
    ...
    link.download = "008_001_excel-beginner-skill-test_practice.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"📊 Visual Chart Construction & Customization"} · Assessment 3
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Visual Communication & Charting"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Visual Chart Construction & Customization Lab"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Constructing and styling core Excel visualizations: Clustered Column, Line, Bar, and Pie/Donut charts: configuring chart titles, data series, axis scales, legends, and data labels"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-2.5 text-slate-300">
              ...
              <span><strong>Module:</strong> {"Excel Beginner Skill Test"}</span>
            </div>
            <div className="flex items-center gap-2.5 text-slate-300">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Chart Standard: Alt + F1 (Instant Embedded Chart) | F11 (Chart Sheet) | Elements: Data Labels, Deselect Gridlines, Clear Legend"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. 1-Keystroke Chart Generation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Pressing `Alt + F1` generates an instant embedded column chart on the active sheet from highlighted data."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Data-to-Ink Ratio Optimization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Removing cluttered background gridlines, eliminating redundant legends on single-series charts, and adding direct data labels."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Axis Scaling & Dynamic Series"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Setting minimum and maximum axis bounds and linking chart titles directly to cell formulas (`=Sheet1!$A$1`)."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Visual Chart Pipeline: Tabular Data Source -> Chart Type Selection -> Element Formatting -> Executive Visual Asset"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_001_excel-beginner-skill-test_3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_001_excel-beginner-skill-test_3" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_3)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Visual Communication & Charting"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_3)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic3_Visual_Chart_Const"
            title={"Visual Chart Construction & Customization Lab - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Regional Revenue Visual Briefing Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on constructing an executive Clustered Column chart comparing regional actuals against annual targets with custom data labels."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 2 · Lead FP&A Analyst"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Monthly Tax Outflow Trend Line Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests construction of 12-month tax liability trend line chart with highlighted peak markers."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 3 · Plant Operations Superintendent"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Daily Plant Scrap Breakdown Donut Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates creation of clean donut charts displaying defect contribution by factory shop."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier On-Time Delivery Bar Chart"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests horizontal bar charts ranking shipping carriers by on-time SLA performance."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Chart Standard: Alt + F1 (Instant Embedded Chart) | F11 (Chart Sheet) | Elements: Data Labels, Deselect Gridlines, Clear Legend"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using 3D Charts or Exploding Pie Charts"}</td>
                  <td className="py-3 px-4">{"3D perspective distorts visual proportions and misleads executive decision makers."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always use clean 2D Clustered Column, Bar, or Line charts."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Redundant Legends on Single-Series Charts"}</td>
                  <td className="py-3 px-4">{"Displaying a legend saying 'Series 1' when chart title already explains data."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Delete legend on single-series charts to maximize chart canvas area."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Truncated Axis Labels Due to Overcrowding"}</td>
                  <td className="py-3 px-4">{"Trying to fit 30 monthly labels horizontally causing angled unreadable text."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Switch to a horizontal Bar chart for high-cardinality category comparisons."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Instant Embedded Chart"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Creates column chart from active selection in 1 keystroke."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + F1"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dynamic Chart Title"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Links chart title dynamically to cell content."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Click Title > Formula Bar > type =A1"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Clean Data-to-Ink Ratio"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Delivers sleek modern executive chart aesthetics."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Delete background gridlines"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why are 3D charts considered an anti-pattern in professional financial modeling?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How do you link an Excel chart title to a cell so it updates automatically when the month changes?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"When is a horizontal Bar chart superior to a vertical Column chart?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Visual Chart Construction & Customization Lab - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Never use 3D charts! Keep your charts clean, simple, and 2D. Delete the gray gridlines, delete the redundant legend, and make your chart title bold. It will look like a McKinsey presentation."}
          />
        </div>
      </div>
    </div>
