...
import sampleWorkbookUrl from "./excel_files/008_001_excel_beginner_skill_test_master.xlsx?url";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⏱️ Core Interface & Navigation Test"} · Assessment 0
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Interface & Navigation Proficiency"}
            </span>
            <span className="px-3 py-1 rounded-full bg-indigo-950/80 border border-indigo-700/60 text-indigo-300 text-xs font-semibold">
              {"Beginner · Bloom Level 3: Apply"}
            </span>
          </div>

          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Core Interface & Workbook Navigation Speed Test"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Evaluating candidate fluency with Excel's core interface: keyboard navigation, ribbon shortcuts, formula bar ergonomics, zooming, and rapid sheet management"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Navigation Benchmark: Ctrl+Arrow (Jump Boundaries) | Ctrl+Home/End | Shift+F11 (New Sheet) | Ctrl+PageUp/PageDown (Switch Tabs)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Boundary Traversal Speed"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Navigating across 50,000-row grids in milliseconds using Ctrl + Arrow keys without touching the mouse."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Sheet Lifecycle Management"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Creating, renaming, color-coding, and reordering worksheet tabs using keyboard shortcuts."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. View & Window Customization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configuring Freeze Panes (Alt + W + F + F) and Split Windows for seamless navigation across massive tables."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Interface Navigation Assessment: Keystroke Trigger -> Active Cell Traversal -> Target Range Selection"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_001_excel-beginner-skill-test_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_001_excel-beginner-skill-test_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Interface & Navigation Proficiency"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Core_Interface___W"
            title={"Core Interface & Workbook Navigation Speed Test - Assessment Grid"}
            rowsPerPage={10}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 1 · Lead Assessor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Barrackpore HQ"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Interface Navigation Speed Benchmark"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates new financial analysts on navigating 100,000-row corporate ledger sheets under timed 2-minute test."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 2 · Tax Trainer"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Freeze Panes & Split Window Setup"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidates on freezing header rows and vendor columns on tax registers."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 3 · Plant Systems Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Ichapur Works"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Multi-Sheet Navigation Assessment"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests candidate speed cycling through 30 shift inspection tabs using Ctrl + PageUp/Down."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Challenge 4 · Logistics Assessor"}</span>
                <span className="text-xs font-mono text-slate-400">{"Naihati Logistics"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Zoom & Gridlines Customization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates presentation layout setup on driver dispatch manifests."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Navigation Benchmark: Ctrl+Arrow (Jump Boundaries) | Ctrl+Home/End | Shift+F11 (New Sheet) | Ctrl+PageUp/PageDown (Switch Tabs)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Touching the Mouse for Basic Navigation"}</td>
                  <td className="py-3 px-4">{"Scrolling 10,000 rows with the mouse scroll wheel."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use `Ctrl + Down Arrow` to jump to table bottom instantly."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Freezing Wrong Rows with Freeze Panes"}</td>
                  <td className="py-3 px-4">{"Placing cursor in cell A1 before clicking Freeze Panes."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Place active cursor in cell B2 to freeze Row 1 and Column A simultaneously."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Accidentally Hiding Formula Bar / Ribbon"}</td>
                  <td className="py-3 px-4">{"Pressing Ctrl + F1 hiding ribbon tabs."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press `Ctrl + F1` to restore full ribbon."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Jump to Bottom"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Instantly navigates to last data cell."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Down Arrow"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Freeze Panes"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Locks headers on screen while scrolling."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + W + F + F"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Select to End"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Highlights entire column data block."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Shift + Down Arrow"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is keyboard navigation 5x faster than mouse scrolling in corporate spreadsheet modeling?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Where must your active cursor be placed to freeze both the top header row and left ID column?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does `Ctrl + .` (period) cycle your active selection between the 4 corners of a highlighted range?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Core Interface & Workbook Navigation Speed Test - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Speed starts with your fingers! Master `Ctrl + Arrows` and `Ctrl + Shift + Arrows`. If you never touch the mouse, you will work 5 times faster than anyone else in your office."}
          />
        </div>
      </div>
    </div>
