      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🎨 Data Entry & Professional Formatting Test"} · Assessment 1
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Data Hygiene & Number Formatting"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Tabular Data Entry & Professional Formatting Assignment"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Evaluating proficiency in tabular data entry, professional custom number formatting, date standardization, border hierarchy, and auto-fitting column widths"}. Rigorous practical and analytical competency evaluation testing speed, precision, and business execution.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Formatting Standard: Indian Rupee: [₹-en-IN] #,##0.00 | Date: dd-mmm-yyyy | Header: Fill #0f172a, Font #ffffff Bold | AutoFit: Alt+H+O+I"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Custom Number Formatting Tokens"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Configuring 4-section tokens (`#,##0.00;[Red](#,##0.00);\"-\";@`) and Indian currency symbols (`₹ #,##0.00`)."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Date & Text Standardization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Enforcing unambiguous date formats (`DD-MMM-YYYY`) and Proper Case capitalization."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Visual Hierarchy & Auto-Fitting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Applying subtle header fills, thin gridlines, double accounting bottom underlines, and `Alt + H + O + I` auto-fitting."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Professional Formatting Pipeline: Raw Data -> Number Format Tokenization -> Border & Fill Styling -> AutoFit"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowModSeg8_008_001_excel-beginner-skill-test_1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowModSeg8_008_001_excel-beginner-skill-test_1" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_1)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Data Hygiene & Number Formatting"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowModSeg8_008_001_excel-beginner-skill-test_1)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic1_Tabular_Data_Entry"
            title={"Tabular Data Entry & Professional Formatting Assignment - Assessment Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: C-Suite Financial Report Makeover Test"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates candidates on transforming an unformatted raw data dump into a boardroom-ready executive financial table in 3 minutes."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Accounting Format & Negative Red Styling"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests formatting of tax liability ledgers with accounting underlines and red negative brackets."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Factory Production Shift Log Layout"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Tests standardized shift layout formatting with alternating zebra shading."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill Rate Card Presentation Formatter"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Evaluates clean formatting of regional freight transport rate sheets."}</p>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Inspect raw data columns, types, and required deliverables: <code className="text-cyan-300 font-mono font-bold">{"Formatting Standard: Indian Rupee: [₹-en-IN] #,##0.00 | Date: dd-mmm-yyyy | Header: Fill #0f172a, Font #ffffff Bold | AutoFit: Alt+H+O+I"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Truncated Cell Content (### Display Bug)"}</td>
                  <td className="py-3 px-4">{"Narrow columns hiding numbers as `###`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Press `Alt + H + O + I` to auto-fit all column widths."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Centering Numerical Data Columns"}</td>
                  <td className="py-3 px-4">{"Centering numbers impairs rapid visual decimal alignment for accountants."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Right-align numbers; left-align text; center dates and codes."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Using Bright Neon Background Fills"}</td>
                  <td className="py-3 px-4">{"Unprofessional eye-straining colors in business reports."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Use curated corporate palettes (Navy `#0f172a`, Slate `#1e293b`, subtle gray `#f8fafc`)."}</td>
                </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-300 leading-relaxed">{"Instantly sizes columns to fit contents."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Alt + H + O + I"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Currency Format"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Applies clean standard currency formatting."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Ctrl + Shift + $ (or custom ₹ format)"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Accounting Underline"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"The universal accounting standard for totals."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Top thin border + bottom double line"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why should numerical columns always be right-aligned in corporate financial spreadsheets?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"How does the custom format `#,##0.00;[Red](#,##0.00);\"-\";@` format positive, negative, zero, and text values?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why is `DD-MMM-YYYY` (e.g. 15-Aug-2026) vastly superior to `MM/DD/YYYY` for global corporate reporting?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the computational mechanics, data model, and commercial implications.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Tabular Data Entry & Professional Formatting Assignment - Comprehensive Assessment Q&A"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Formatting is your first impression. Never leave columns showing `###`! Right-align your numbers, use `dd-mmm-yyyy` for dates, and put a double-underline under your total row. It makes you look like an elite professional."}
          />
        </div>
      </div>
    </div>
