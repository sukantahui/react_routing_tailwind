      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🔌 Introduction to ADO (ActiveX Data Objects)"} · Topic 0
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Introduction to ADO (ActiveX Data Objects) and connecting Excel to relational databases"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Understanding ActiveX Data Objects (ADODB) architecture in Excel VBA: establishing database connections, executing server-side SQL queries, and streaming relational recordsets directly into RAM"}. Master ADODB relational database connectivity, high-speed CopyFromRecordset pipelines, closed Excel SQL querying, REST APIs, and ACID transactions.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"ADODB Architecture: Set conn = CreateObject(\"ADODB.Connection\") | Set rs = CreateObject(\"ADODB.Recordset\") | conn.Open connStr | rs.Open sql, conn"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Direct Server-Side Data Querying"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Allows Excel to query massive corporate relational databases (SQL Server, MySQL, Oracle, PostgreSQL) without launching heavy third-party client GUIs."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. The Connection & Recordset Pair"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`ADODB.Connection` manages the authenticated network socket connection; `ADODB.Recordset` holds the returned tabular rows in volatile RAM."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Bypassing Excel Memory Limits"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Filters and aggregates multi-gigabyte databases directly on the database server hardware, streaming only the final summary rows into Excel."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"ADODB Architecture: Excel VBA Client -> OLE DB / ODBC Driver -> Remote Relational Database Engine"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod17_0" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod17_0" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_0)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Relational Database Connectivity"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_0)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic0_Introduction_to_AD"
            title={"Introduction to ADO (ActiveX Data Objects) and connecting Excel to relational databases - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise SQL Server Financial Data Pipeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Builds a high-speed ADO connector streaming 50,000 corporate transaction records from corporate SQL Server directly into Excel in 0.8 seconds."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Automated MySQL Tax Database Reconciliation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects Excel directly to the factory MySQL ERP database to audit purchase tax liabilities against statutory filing tables."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: PostgreSQL Shopfloor Telemetry Reader"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Streams industrial sensor logs from PostgreSQL servers directly into Excel analytical grids."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Oracle Fleet Logistics DB Bridge"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects transport dispatch sheets directly to central Oracle transportation database tables."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open database socket or send HTTP request with custom headers: <code className="text-cyan-300 font-mono font-bold">{"ADODB Architecture: Set conn = CreateObject(\"ADODB.Connection\") | Set rs = CreateObject(\"ADODB.Recordset\") | conn.Open connStr | rs.Open sql, conn"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Missing OLE DB / ODBC Driver on Client PC"}</td>
                  <td className="py-3 px-4">{"Running ADO code on a computer that lacks the MySQL or PostgreSQL ODBC driver throws 'Data source name not found'."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Verify driver installation or use standard Microsoft OLE DB providers for SQL Server / Access."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Leaving Database Connections Open (Connection Leak)"}</td>
                  <td className="py-3 px-4">{"Forgetting to close `conn.Close` exhausts available connection pool sockets on the database server."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always close connections in clean-up blocks: `rs.Close: Set rs = Nothing: conn.Close: Set conn = Nothing`."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Hardcoding Passwords in Plaintext VBA Modules"}</td>
                  <td className="py-3 px-4">{"Writing `Password=MySecret123;` directly in VBA code exposes database credentials to anyone viewing the module."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Store connection strings in protected configuration sheets or use Windows Integrated Authentication (`Trusted_Connection=Yes;`)."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Late Binding ADODB"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Runs on all client machines with zero missing reference errors."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Set conn = CreateObject(\"ADODB.Connection\")"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Windows Trusted Auth"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Eliminates hardcoded database passwords."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Trusted_Connection=Yes; or Integrated Security=SSPI;"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Close & Clear"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory cleanup to prevent server connection leaks."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"conn.Close: Set conn = Nothing"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why is querying a remote database using ADODB in VBA vastly faster than downloading giant CSV files manually?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"What is the operational difference between an `ADODB.Connection` object and an `ADODB.Recordset` object?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"Why should corporate applications use Windows Integrated Security (`Trusted_Connection=Yes`) rather than plaintext passwords?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Introduction to ADO (ActiveX Data Objects) and connecting Excel to relational databases - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"ADODB gives Excel infinite power. You don't need to ask IT for CSV exports—you can write 5 lines of VBA, connect directly to SQL Server or MySQL, and pull exactly the data you need in 1 second."}
          />
        </div>
      </div>
    </div>
