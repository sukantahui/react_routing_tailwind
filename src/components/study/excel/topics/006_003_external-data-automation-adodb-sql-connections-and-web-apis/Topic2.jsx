      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"⚡ Executing SQL Queries (CRUD) from VBA"} · Topic 2
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Executing SQL Queries (SELECT, INSERT, UPDATE, DELETE) directly from Excel VBA"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Executing full Create, Read, Update, and Delete (CRUD) SQL operations directly from Excel VBA using conn.Execute: INSERT, UPDATE, DELETE, and DDL commands"}. Master ADODB relational database connectivity, high-speed CopyFromRecordset pipelines, closed Excel SQL querying, REST APIs, and ACID transactions.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"SQL Execution: conn.Execute \"INSERT INTO Table (Col1) VALUES ('Val1')\" | conn.Execute \"UPDATE Table SET Col1 = 'NewVal' WHERE ID = 101\""}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. The `conn.Execute` Command Pipeline"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Dispatches non-query SQL statements (INSERT, UPDATE, DELETE) directly to the database engine with zero recordset overhead."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. Tracking Affected Rows (`RecordsAffected`)"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"`conn.Execute sqlStr, recordsAffected`. Returns the exact count of rows inserted, updated, or deleted by the query."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Atomic Batch Data Manipulation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Allows updating 50,000 customer records on the database server with a single SQL statement in milliseconds without pulling rows to Excel."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"CRUD SQL Execution Flow: Excel VBA -> SQL Statement Dispatch -> Database Execution -> Affected Rows Count"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod17_2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod17_2" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_2)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"CRUD Database Operations"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_2)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic2_Executing_SQL_Quer"
            title={"Executing SQL Queries (SELECT, INSERT, UPDATE, DELETE) directly from Excel VBA - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Two-Way Customer Credit Limit Update"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Updates client credit ceilings directly in the corporate SQL database using `conn.Execute \"UPDATE Customers SET CreditLimit = 5000000 WHERE CustomerID = 'C101'\"`."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Automated Tax Audit Flag Insertion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Inserts audit approval stamps directly into MySQL ERP database tables."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Machine Calibration Log Injection"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Appends daily machine calibration records directly to the SQL telemetry database from shopfloor UserForms."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Waybill Transit Status Updates"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Executes batch SQL updates setting shipment statuses to 'Dispatched'."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open database socket or send HTTP request with custom headers: <code className="text-cyan-300 font-mono font-bold">{"SQL Execution: conn.Execute \"INSERT INTO Table (Col1) VALUES ('Val1')\" | conn.Execute \"UPDATE Table SET Col1 = 'NewVal' WHERE ID = 101\""}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unsanitized Single Quotes in String Values (Syntax Error)"}</td>
                  <td className="py-3 px-4">{"Inserting a company name like `O'Reilly Steel` breaks SQL syntax (`'O'Reilly Steel'`), throwing runtime error."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Sanitize strings by escaping single quotes: `Replace(strName, \"'\", \"''\")`."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Accidental Table Wiping (Missing WHERE Clause)"}</td>
                  <td className="py-3 px-4">{"Executing `UPDATE Customers SET Status = 'Inactive'` without a `WHERE` clause updates the ENTIRE database table!"}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Always double-check `WHERE` clauses before executing non-query SQL commands."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"SQL Type Mismatch on Dates and Decimals"}</td>
                  <td className="py-3 px-4">{"Formatting dates with slashes (`12/04/2026`) instead of ISO standard format (`'2026-04-12'`)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Format SQL dates strictly in ISO standard: `Format(myDate, \"yyyy-mm-dd\")`."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Escape Single Quotes"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Mandatory sanitizer to prevent SQL syntax errors."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Replace(str, \"'\", \"''\")"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"ISO Standard Date Format"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees reliable date parsing across all database engines."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Format(myDate, \"yyyy-mm-dd\")"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Records Affected Counter"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Provides instant feedback on affected record counts."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"conn.Execute sql, lngRows: MsgBox lngRows & \" rows updated!\""}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"Why does a company name containing an apostrophe (like `O'Connor Logistics`) break SQL strings, and how do you fix it?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why must SQL date literals always be formatted in ISO standard `YYYY-MM-DD` format?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does `conn.Execute` execute database updates 1,000x faster than looping through spreadsheet cells?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Executing SQL Queries (SELECT, INSERT, UPDATE, DELETE) directly from Excel VBA - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Always sanitize your text before building SQL strings! If a customer's name has an apostrophe (e.g. `McDonald's`), use `Replace(str, \"'\", \"''\")`. And NEVER run an UPDATE or DELETE without a WHERE clause!"}
          />
        </div>
      </div>
    </div>
