      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏗️ Multi-Database ETL Data Extraction"} · Topic 8
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Automating multi-database ETL data extraction into Excel staging sheets"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Engineering enterprise Extract, Transform, and Load (ETL) data pipelines in Excel VBA: extracting from heterogeneous databases, normalizing data in RAM, and staging for financial models"}. Master ADODB relational database connectivity, high-speed CopyFromRecordset pipelines, closed Excel SQL querying, REST APIs, and ACID transactions.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"ETL Pipeline: Extract (ADO SQL / REST API) -> Transform (VBA RAM Array Cleansing) -> Load (CopyFromRecordset / Staging Sheet)"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Heterogeneous Multi-Source Ingestion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects to SQL Server (Accounting), MySQL (Web Store), and REST APIs (Forex) in a single unified automated workflow."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. In-Memory RAM Transformation & Standardization"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Normalizes divergent date formats, currency exchange conversions, and tax classification codes inside high-speed VBA memory arrays."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Automated Staging Sheet Loading"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Dumps cleaned, unified datasets into dedicated `Staging_Data` sheets ready for downstream Power Pivot or financial model ingestion."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Enterprise Multi-Source ETL Pipeline: SQL Server + MySQL + REST APIs -> VBA Memory Cleansing -> Staging Canvas"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod17_8" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod17_8" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_8)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Enterprise Data Pipeline Engineering"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_8)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic8_Automating_multi_d"
            title={"Automating multi-database ETL data extraction into Excel staging sheets - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Multi-Subsidiary ETL Consolidation"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts sales data from 3 subsidiary databases (SQL Server in Mumbai, Oracle in Delhi, MySQL in Kolkata), converts currencies to INR, and stages a master report in 4 seconds."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: ERP & E-Waybill Staging ETL"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts internal SAP invoices and external government e-waybill records, reconciling tax variations in RAM."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Multi-Machine Shift Telemetry ETL"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Extracts casting temperatures and scrap logs across 4 production lines into an integrated quality dashboard."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Carrier Multi-Hub Freight ETL"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Consolidates shipment milestones from 5 regional warehouse databases into unified logistics staging sheets."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open database socket or send HTTP request with custom headers: <code className="text-cyan-300 font-mono font-bold">{"ETL Pipeline: Extract (ADO SQL / REST API) -> Transform (VBA RAM Array Cleansing) -> Load (CopyFromRecordset / Staging Sheet)"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Single Source Failure Halting Entire Pipeline"}</td>
                  <td className="py-3 px-4">{"Database #2 timing out crashes the macro before extracting Database #3."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap each extraction source in independent error-handling blocks so healthy sources continue processing."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Inconsistent Date/Currency Formats Across Sources"}</td>
                  <td className="py-3 px-4">{"Database A using US dates (MM/DD/YYYY) while Database B uses UK dates (DD/MM/YYYY)."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Normalize all dates into ISO standard (`YYYY-MM-DD`) during the Transformation phase."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Memory Leaks Across Multi-Database Loops"}</td>
                  <td className="py-3 px-4">{"Failing to close and deallocate connection objects between loop iterations."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Explicitly close and set connections to Nothing after each source extraction."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Modular ETL Stages"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Clean modular software architecture."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Sub Extract_Source1() -> Sub Transform() -> Sub Load()"}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Fault-Tolerant Extraction"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Prevents one offline server from crashing the entire pipeline."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"On Error Resume Next on individual DB calls"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Dedicated Staging Tab"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Keeps messy background data hidden from executive users."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"wsStaging.Visible = xlSheetVeryHidden"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does a VBA ETL pipeline integrate data from three completely different database brands (SQL Server, MySQL, Oracle) into a single Excel model?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why should each extraction source be isolated in its own independent error-handling block?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does in-memory transformation ensure consistent currency and date standards across corporate reports?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Automating multi-database ETL data extraction into Excel staging sheets - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Building an automated ETL pipeline is what transforms Excel into enterprise BI software. You extract from SQL Server, extract from MySQL, fetch live exchange rates from an API, clean everything in RAM, and load a perfect dashboard in 5 seconds."}
          />
        </div>
      </div>
    </div>
