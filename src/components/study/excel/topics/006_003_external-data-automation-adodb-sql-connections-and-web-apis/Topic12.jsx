      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            <span className="px-3.5 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-bold uppercase tracking-wider shadow-inner">
              {"🏆 Live Market Exchange Rate & Stock Price Fetcher Project"} · Topic 12
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold">
              {"Live Market Intelligence Project"}
            </span>
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
            {"Real-world project: Automated daily exchange rate and stock price fetcher via web API"}
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            {"Comprehensive real-time market data capstone project: building an automated Daily Foreign Exchange Rate, Commodity Price, and Stock Market Fetcher consuming live cloud REST APIs via JSON parsing"}. Master ADODB relational database connectivity, high-speed CopyFromRecordset pipelines, closed Excel SQL querying, REST APIs, and ACID transactions.
          </p>
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/90 font-mono text-sm sm:text-base text-sky-300 overflow-x-auto shadow-inner">
            {"Automated Web API Fetcher: MSXML2.ServerXMLHTTP -> Parse JSON -> Extract Rates/Stock Prices -> Populate Dashboard -> Schedule Auto-Refresh"}
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"1. Automated Live Market Data Ingestion"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Connects to cloud financial REST APIs, fetching real-time currency exchange rates (USD, EUR, GBP, JPY to INR) and stock market indices."}</p>
            </div>
            
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"2. JSON Stream Decomposition & Formatting"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Parses hierarchical JSON responses into clean structured arrays and populates executive dashboard summary cards with daily change delta arrows."}</p>
            </div>
            
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-2">
              <h3 className="text-sm font-bold text-emerald-300 uppercase tracking-wider">{"3. Automatic Timer Refresh Integration"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Integrates with `Application.OnTime` to refresh market data automatically every morning at 09:15 AM or on customizable 15-minute intervals."}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <h2 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-3">
              ...
              Visual Dataflow: {"Live Market Intelligence Ingestion Engine: Cloud Web API Endpoints -> ServerXMLHTTP -> JSON Parser -> Live Dashboard HUD"}
            </h2>
          ...
          <div className="p-4 rounded-xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            <svg viewBox="0 0 820 220" className="w-full max-w-4xl h-auto text-slate-200 select-none font-sans">
              <defs>
                <linearGradient id="gradFlowMod17_12" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#0284c7" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#0369a1" stopOpacity="0.8" />
                </linearGradient>
                <marker id="arrowMod17_12" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
              ...
              <path d="M 245 110 L 305 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_12)" fill="none" />
              ...
              <g transform="translate(315, 30)">
                ...
                <text x="125" y="75" textAnchor="middle" fill="#7dd3fc" fontSize="13" fontFamily="monospace" fontWeight="bold">{"Live Market Intelligence Project"}</text>
              ...
              <path d="M 570 110 L 630 110" stroke="#38bdf8" strokeWidth="2.5" markerEnd="url(#arrowMod17_12)" fill="none" />
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title={"Real-world project: Automated daily exchange rate and stock price fetcher via web API - Interactive Practice Grid"}
            rowsPerPage={10}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div key="0" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Swadeep Banerjee: Enterprise Treasury Live Forex & Hedging Monitor"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Deploys an automated live currency fetcher monitoring ₹100 Crore foreign exchange exposure with real-time INR conversion updates."}</p>
            </div>
            ...
            <div key="1" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-amber-400">{"Case 2 · Corporate FP&A Lead"}</span>
                <span className="text-xs font-mono text-slate-400">{"Shyamnagar Plant"}</span>
              </div>
              <h3 className="font-bold text-white text-base">{"Tuhina Mukherjee: Commodity Steel & Aluminum Spot Price Tracker"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Fetches daily global metals commodity prices from web APIs to calculate raw material inflation variance."}</p>
            </div>
            ...
            <div key="2" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Abhronila Das: Energy & Fuel Spot Price Ingestion Suite"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Fetches live natural gas and electricity spot tariffs to optimize factory kiln firing schedules."}</p>
            </div>
            ...
            <div key="3" className="p-5 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 transition-all duration-300 space-y-3">
              ...
              <h3 className="font-bold text-white text-base">{"Debangshu Roy: Diesel Price API Route Cost Calculator"}</h3>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{"Fetches state-level daily retail diesel prices to calculate dynamic freight fuel surcharges."}</p>
            </div>
        ...
        >
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1.5">
              ...
              <p className="text-slate-300 leading-relaxed">
                Open database socket or send HTTP request with custom headers: <code className="text-cyan-300 font-mono font-bold">{"Automated Web API Fetcher: MSXML2.ServerXMLHTTP -> Parse JSON -> Extract Rates/Stock Prices -> Populate Dashboard -> Schedule Auto-Refresh"}</code>.
              </p>
            </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60 text-slate-300">
                ...
                <tr key="0" className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-3 px-4">{"Running the fetcher in a tight loop calling the API 1,000 times per minute, getting IP-blocked by the provider."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Cache API responses locally and enforce a minimum 5-minute refresh interval."}</td>
                </tr>
                
                <tr key="1" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Unchecked API Provider Schema Changes"}</td>
                  <td className="py-3 px-4">{"API provider renaming a JSON field breaks hardcoded key references."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Include defensive key verification (`If json.Exists(\"rate\") Then ...`)."}</td>
                </tr>
                
                <tr key="2" className="hover:bg-slate-800/30 transition-colors">
                  <td className="py-3 px-4 font-mono font-bold text-rose-300">{"Crashing on No Internet Connection"}</td>
                  <td className="py-3 px-4">{"Network disconnection throwing unhandled runtime error on `.Send`."}</td>
                  <td className="py-3 px-4 font-mono text-cyan-300">{"Wrap `.Send` in structured error handling alerting the user to check internet connectivity."}</td>
                </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Application.OnTime Scheduling"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Schedules automated recurring background data refreshes."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Application.OnTime Now + TimeValue(\"00:15:00\"), \"FetchLiveRates\""}</kbd>
            </div>
            
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Local Cache Safeguard"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Ensures dashboard remains functional even when offline."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Store last known good rate in cell"}</kbd>
            </div>
            
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
              <div className="font-bold text-purple-300 flex items-center gap-2">
                <span>⚡</span> {"Status 200 Verification"}
              </div>
              <p className="text-slate-300 leading-relaxed">{"Guarantees robust execution across intermittent network drops."}</p>
              <kbd className="inline-block px-2 py-0.5 rounded bg-slate-800 border border-slate-700 font-mono text-xs text-cyan-300 mt-1">{"Verify http.Status = 200 before parsing"}</kbd>
            </div>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-300">
            ...
            <div key="0" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 1: {"How does `Application.OnTime` schedule Excel to refresh live API data automatically at specific times of day?"}
              </h3>
            ...
            <div key="1" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 2: {"Why is local response caching essential to prevent exceeding free API rate limits?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
            ...
            <div key="2" className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
              <h3 className="font-bold text-white flex items-center gap-2">
                <span className="text-teal-400">💭</span> Question 3: {"How does this real-time market fetcher transform Excel into a live Bloomberg-style treasury monitoring terminal?"}
              </h3>
              <p className="text-slate-400 leading-relaxed">
                Reflect on the database connection architecture and cloud integration principles.
              </p>
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title={"Real-world project: Automated daily exchange rate and stock price fetcher via web API - Frequently Asked Questions"}
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[11] = el)} className="reveal-section">
          <Teacher
            note={"Your Excel spreadsheet can now fetch live financial data from anywhere in the world! Schedule it with `Application.OnTime`, let it run in the background, and your executive team will always have up-to-the-minute market intelligence."}
          />
        </div>
      </div>
    </div>
