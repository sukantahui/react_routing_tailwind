      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-300 bg-clip-text text-transparent leading-tight">
            One-Variable Data Tables: Testing single parameter sensitivities (e.g., price vs revenue)
          </h1>

          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>One-Variable Data Tables: Testing single parameter sensitivities (e.g., price vs revenue)</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            ...
            >
              ...
              <text x="430" y="115" textAnchor="middle" fill="#a7f3d0" fontSize="11" fontFamily="monospace">One-Variable Data Tables</text>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="One-Variable Data Tables: Testing single parameter sensitivities (e.g., price vs revenue) - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 2: One-Variable Data Tables: Testing single parameter sensitivities (e.g., price vs revenue) FAQ"
            questions={questions}
          />
        </div>
