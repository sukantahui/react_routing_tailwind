      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-sky-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent tracking-tight">
            Sensitivity Analysis & Tornado Risk Diagrams
          </h1>
          <p className="text-slate-300 mt-4 text-base sm:text-lg leading-relaxed max-w-4xl">
            Multi-variable stress testing using Two-Way Data Tables and visual Tornado variance ranking
          </p>
        </header>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Evaluates model output sensitivity across a 2D matrix of input variations, feeding Tornado charts that rank risk drivers by impact.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            sheetName="Topic14_Tornado_Sensitivity"
        ...
        <div ref={(el) => (sectionsRef.current[7] = el)} className="reveal-section">
          <FAQTemplate
            title="Sensitivity Analysis & Tornado Risk Diagrams Frequently Asked Questions"
            questions={questions}
          />
        </div>
        ...
        <div ref={(el) => (sectionsRef.current[8] = el)} className="reveal-section">
          <Teacher
            topicName="Sensitivity Analysis & Tornado Risk Diagrams"
