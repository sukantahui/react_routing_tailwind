...
export default function Topic7() {
  ...
  const handleDownload = () => {
    ...
    link.download = "002_003_conditional-logic-with-if-and-related-functions_practice.xlsx";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 mb-4">
            ...
            <span className="px-3 py-1 rounded-full bg-sky-950/80 border border-sky-700/60 text-sky-300 text-xs font-semibold">
              Conditional Logic with IF and Related Functions
            </span>
          ...
          <p className="text-slate-300 text-base sm:text-lg mt-4 leading-relaxed max-w-4xl">
            Master the rigorous implementation and practical execution of <strong>Array-based conditional logic and Boolean arithmetic (0/1 multiplication)</strong> in modern Microsoft Excel workflows.
          </p>
        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800/80 flex flex-col items-center justify-center overflow-x-auto shadow-inner">
            ...
            >
              ...
              <text x="430" y="115" textAnchor="middle" fill="#a7f3d0" fontSize="11" fontFamily="monospace">Array-based conditional </text>
        ...
        >
          ...
          <ExcelFileLoader
            ...
            title="Array-based conditional logic and Boolean arithmetic (0/1 multiplication) - Practice Ledger"
            rowsPerPage={10}
        ...
        <div ref={(el) => (sectionsRef.current[10] = el)} className="reveal-section">
          <FAQTemplate
            title="Topic 7: Array-based conditional logic and Boolean arithmetic (0/1 multiplication) FAQ"
            questions={questions}
          />
        </div>
