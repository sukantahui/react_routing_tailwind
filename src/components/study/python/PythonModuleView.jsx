// src/components/study/python/PythonModuleView.jsx
...
export default function PythonModuleView() {
  ...
  // -------------------------------------------
  const PROGRESS_KEY = `python_module_progress_${mod.moduleId}`;
  const LAST_TOPIC_KEY = `python_module_lastTopic_${mod.moduleId}`;
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between px-4 py-3">
          <div>
            <p className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
              Python Track · {segmentData?.level || "Module"}
            </p>
        ...
        <div className="max-w-4xl mx-auto space-y-10 animate-fadeInSlow">
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-slate-400 mt-1">
                    ...
                    <span className="text-slate-200">
                      {segmentData?.title || "Python Track"}
                    </span>
                  </p>
                </div>
              ...
              {/* Meta row: Prerequisites & actions */}
              <div className="mt-4 flex flex-wrap items-center gap-3 text-[11px] text-slate-300">
                ...
                {lastTopicIndex != null &&
                  ...
                  lastTopicIndex < totalTopics && (
                    <Link
                      to={`/python/topic/${mod.slug}/${lastTopicIndex}`}
          ...
          <section className="flex flex-wrap items-center justify-between gap-3 text-xs mt-4">
            ...
            <div>
              {prevModule ? (
                <Link
                  to={`/python/module/${prevModule.slug}`}
            ...
            <div>
              {nextModule ? (
                <Link
                  to={`/python/module/${nextModule.slug}`}
