...
import demoCode from "./topic14_files/StrategyPatternDemo.java?raw";
    ...
    <div className="space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen">
      <header className="space-y-4 border-b border-slate-800 pb-6">
        ...
        <p className="text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl">
          Algorithm abstraction: swapping payment calculations, sorting strategies, and compression algorithms dynamically using Java 8 Lambdas and Functions.
        </p>
      </header>
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Module 012_001 Topic 14: Strategy Pattern"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Printable Note"
          downloadFileName="012_001_topic14_strategy_pattern_note.txt"
        />
      </section>
