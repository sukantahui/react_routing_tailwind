...
import looseCouplingDemoCode from "./topic14_files/LooseCouplingPrincipleDemo.java?raw";
    ...
    <div className="space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen">
      ...
      <header className="space-y-4 border-b border-slate-800 pb-6 animate-fade-in">
        ...
        <p className="text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl">
          Learn why Gang of Four and modern enterprise architecture demand programming to interfaces: enabling zero-friction provider swapping and frictionless unit test mocking.
        </p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <JavaFileLoader
          fileModule={looseCouplingDemoCode}
          title="LooseCouplingPrincipleDemo.java"
          highlightLines={[11, 26, 29, 44, 48]}
        />
      </section>
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Module 002_008 Topic 14: Loose Coupling Principle"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Printable Note"
          downloadFileName="002_008_topic14_loose_coupling_note.txt"
        />
      </section>
