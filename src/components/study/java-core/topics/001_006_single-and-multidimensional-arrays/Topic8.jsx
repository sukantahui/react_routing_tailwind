      ...
      <section className="space-y-5 bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-slate-800 shadow-lg hover:border-slate-700 transition-all duration-300">
        ...
        <div className="w-full overflow-hidden rounded-xl border border-slate-700 bg-slate-950 p-4">
          ...
          >
            ...
            <text x="55" y="122" fill="#a7f3d0" fontSize="11" fontFamily="monospace">0 → 1 → 2 → 3 → 4</text>
            ...
            <text x="335" y="122" fill="#bae6fd" fontSize="11" fontFamily="monospace">4 → 3 → 2 → 1 → 0</text>
            ...
            <text x="615" y="102" fill="#ddd6fe" fontSize="11" fontFamily="monospace">left=0 → &larr; right=len-1</text>
