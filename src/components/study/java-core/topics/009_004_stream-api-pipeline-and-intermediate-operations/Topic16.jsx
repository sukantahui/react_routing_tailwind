...
import demoCode from "./topic16_files/SortedComparatorsDemo.java?raw";
    ...
    <div className="space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen">
      <header className="space-y-4 border-b border-slate-800 pb-6">
        ...
        <p className="text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl">
          Ordering stream elements: natural Comparable order, custom Comparator lambdas, chaining comparators with thenComparing(), and null handling.
        </p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <JavaFileLoader
          fileModule={demoCode}
          title="SortedComparatorsDemo.java"
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Module 009_004 Topic 16: sorted() & Comparators"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Printable Note"
          downloadFileName="009_004_topic16_sorted_comparators_note.txt"
        />
      </section>
