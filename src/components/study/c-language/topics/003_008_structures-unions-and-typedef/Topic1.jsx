...
import cCode from "./topic1_files/StructPointerDemo.c?raw";
...
{`====================================================
  CODER & ACCOTAX - STRUCT POINTERS & ARROW OPERATOR
  Center: Barrackpore | Educator: Sukanta Hui
====================================================

[Before Salary Hike] Employee ID: 501 | Salary: INR 65000.00
[After 15% Hike]    Employee ID: 501 | Salary: INR 74750.00

Efficient Pointer Pass: Only 8-byte pointer transferred on call stack!`}
          </pre>
        </div>
      </section>
      ...
      <section>
        <Teacher note="Tuhina noticed that passing a 500-byte structure by value copies all 500 bytes to the call stack. Sukanta Hui demonstrated how passing an 8-byte pointer with the arrow (->) operator runs 60x faster! — Sukanta Hui" />
      </section>
    </div>
  );
}
