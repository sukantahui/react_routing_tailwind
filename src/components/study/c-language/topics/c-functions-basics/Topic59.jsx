...
import projectsData from "./topic59_files/basic-function-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic59_files/answers/*.c", { query: "?raw", import: "default", eager: true });
