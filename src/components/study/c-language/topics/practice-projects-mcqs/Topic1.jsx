...
import projectsData from "./topic1_files/c-segment2-generation.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic1_files/answers/*.c", { query: "?raw", import: "default", eager: true });
