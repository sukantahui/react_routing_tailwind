// src/components/study/c-language/topics/001_005_c-pattern-output-practice-lab/Topic3.jsx

import React, { useEffect, useState } from "react";
import CProjectAnswerTemplateEnhanced from "../../../CProjectAnswerTemplateEnhanced";
import projectsData from "./topic3_files/c-segment1-capstone-projects.json";

export default function Topic3() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    // 1. Import all 10 .c answer files dynamically from topic3_files/answers/ as raw text
    const modules = import.meta.glob("./topic3_files/answers/*.c", {
      query: "?raw",
      import: "default",
      eager: true,
    });
    ...
    return (
      <div className="p-8 text-slate-400 flex items-center justify-center min-h-[350px]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold">Loading 10 Segment 1 Capstone Projects...</span>
        </div>
      </div>
    );
  }
