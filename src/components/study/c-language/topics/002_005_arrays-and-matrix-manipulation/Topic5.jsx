...
import projectsData from "./topic5_files/c-arrays-matrix-projects.json";
    ...
    return (
      <div className="p-8 text-slate-400 flex items-center justify-center min-h-[350px]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold">Loading 10 C Arrays, Matrix &amp; Sorting Projects...</span>
        </div>
      </div>
    );
  }
