...
import noteText from "./topic48_files/topic48_note.txt?raw";
    ...
    const examples = [
        {
            ...
            explanation: "The objective function Z = x + y is parallel to the constraint x + y = 10. Therefore, any point on the edge between A(10,0) and B(0,10) gives the same optimal value of Z = 10.",
            edgePoints: [
                { x: 10, y: 0, label: "A (10,0)" },
                { x: 7.5, y: 2.5, label: "P (7.5,2.5)" },
                { x: 5, y: 5, label: "Q (5,5)" },
                { x: 2.5, y: 7.5, label: "R (2.5,7.5)" },
                { x: 0, y: 10, label: "B (0,10)" },
            ]
        },
        {
            id: 1,
            name: "Multiple Optima with 3 Constraints",
            description: "Z = x + y with multiple constraints",
            constraints: [
                { label: "x + y ≤ 10", a: 1, b: 1, c: 10, sign: "≤", color: "#8b5cf6" },
            ...
            cornerPoints: [
                { x: 0, y: 0, label: "O (0,0)", Z: 0, isOptimal: false },
                { x: 5, y: 0, label: "A (5,0)", Z: 5, isOptimal: false },
                { x: 4, y: 3, label: "B (4,3)", Z: 7, isOptimal: false },
                { x: 2, y: 4, label: "C (2,4)", Z: 6, isOptimal: false },
                { x: 0, y: 5, label: "D (0,5)", Z: 5, isOptimal: false },
            ],
            optimal: { x: 4, y: 3, Z: 7 },
            explanation: "In this case, the objective function Z = x + y is NOT parallel to any constraint edge. The unique optimal solution is at B(4,3) with Z = 7.",
            edgePoints: []
        },
        {
            id: 2,
            name: "Multiple Optima with Minimum",
            description: "C = x + y with constraints x + y ≥ 5",
            constraints: [
            ...
            explanation: "The objective function C = x + y is parallel to the constraint x + y = 5. Therefore, any point on the edge between A(0,5) and B(5,0) gives the same optimal value of C = 5.",
            edgePoints: [
                { x: 0, y: 5, label: "A (0,5)" },
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
                ...
                >
                    <div className="inline-block px-4 py-1 mb-4 text-xs font-semibold tracking-widest uppercase rounded-full bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800">
                        Topic 48 — Multiple Optimal Solutions
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Multiple <br className="sm:hidden" />
                    ...
                    <p className="mt-4 text-lg sm:text-xl text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">
                        Learn about the special case where multiple corner points (or an entire edge) give the
                        same optimal objective value — an important concept in LP.
                    </p>
                    <div className="mt-4 flex flex-wrap justify-center gap-3 text-sm text-gray-500 dark:text-slate-500">
                        ...
                        <span className="flex items-center gap-1">
                            <span className="w-2 h-2 rounded-full bg-violet-500"></span> Intermediate/Advanced
                        </span>
                        <span className="flex items-center gap-1">
                ...
                {/* ===== SECTION 1: What are Multiple Optimal Solutions? ===== */}
                <section
                ...
                >
                    ...
                    <div className="mt-4 space-y-4 text-gray-700 dark:text-slate-300">
                        <p>
                            <strong className="text-purple-600 dark:text-purple-400">Multiple optimal solutions</strong>{" "}
                            occur when two or more corner points (or an entire edge) give the same optimal
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800/50">
                                <h3 className="font-semibold text-purple-700 dark:text-purple-300">Cause</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                                    The objective function is <strong>parallel</strong> to a constraint edge.
                                    The slopes are equal.
                                </p>
                            </div>
                            <div className="p-4 rounded-xl bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800/50">
                                <h3 className="font-semibold text-violet-700 dark:text-violet-300">Result</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                                    Any point on the edge (including both corners) gives the same optimal value.
                                </p>
                            </div>
                        </div>
                        <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50">
                            <p className="text-sm text-amber-800 dark:text-amber-300">
                                <span className="font-semibold">💡 Key insight:</span> Multiple optimal solutions
                                give the decision-maker <strong>flexibility</strong> — they can choose among
                                equally good options based on other factors.
                            </p>
                        </div>
                    </div>
                </section>

                {/* ===== SECTION 2: Why Do Multiple Optima Occur? ===== */}
                <section
                ...
                >
                    ...
                    <div className="mt-4 space-y-4 text-gray-700 dark:text-slate-300">
                        <p>
                            Multiple optimal solutions occur when the <strong className="text-purple-600 dark:text-purple-400">slope</strong>{" "}
                            of the objective function equals the slope of a constraint edge.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50">
                                <h3 className="font-semibold text-emerald-700 dark:text-emerald-300">For Maximization</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                                    The objective line overlaps the constraint edge at the maximum value.
                                    Both corners on that edge are optimal.
                                </p>
                            </div>
                            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50">
                                <h3 className="font-semibold text-amber-700 dark:text-amber-300">For Minimization</h3>
                                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                                    The objective line overlaps the constraint edge at the minimum value.
                                    Both corners on that edge are optimal.
                                </p>
                            </div>
                        </div>
                        <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                            <p className="text-sm text-blue-800 dark:text-blue-300">
                                <span className="font-semibold">💡 Think about:</span> When the objective line
                                is parallel to a constraint edge, moving along that edge doesn't change the
                ...
                {/* ===== SECTION 3: Interactive Multiple Optima Explorer ===== */}
                <section
                ...
                >
                    <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-white flex items-center gap-3">
                        ...
                        Interactive Multiple Optima Explorer
                    </h2>
                    <div className="mt-4 text-gray-700 dark:text-slate-300">
                        <p className="mb-3">
                            Select a problem to see multiple optimal solutions highlighted. The optimal edge
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="w-full aspect-[3/2] bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-2 shadow-inner">
                                <svg viewBox="0 0 600 400" className="w-full h-full" role="img" aria-label="Multiple optima graph">
                                    {/* Grid */}
                                    <defs>
                                        <pattern id="grid_t48" width="40" height="40" patternUnits="userSpaceOnUse">
                                            <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#e2e8f0" strokeWidth="0.5" className="dark:stroke-slate-700" />
                                        </pattern>
                                    </defs>
                                    <rect width="600" height="400" fill="url(#grid_t48)" />
                                    ...
                                    {isMultipleOptima && showEdgeHighlight && currentExample.edgePoints && currentExample.edgePoints.length > 1 && (
                                        <polyline
                                            points={currentExample.edgePoints.map(p => {
                                    ...
                                    {isMultipleOptima && showEdgeHighlight && currentExample.edgePoints && currentExample.edgePoints.map((ep, idx) => {
                                        // Skip corner points (already shown above)
                                        const isCorner = currentExample.cornerPoints.some(cp => cp.x === ep.x && cp.y === ep.y);
                                        if (isCorner) return null;
                                        const { px, py } = toPixel(ep.x, ep.y);
                                        return (
                                            <g key={`ep-${idx}`}>
                                                <circle
                                                    cx={px}
                                    ...
                                    {isMultipleOptima && showOptimalHighlight && (
                                        <g>
                                            ...
                                            <text x="30" y="128" fontSize="10" fill="#ef4444">
                                                Any point on the highlighted edge is optimal
                                            </text>
                                        </g>
                                    )}
                                    ...
                                    <text x="20" y="50" fontSize="13" fill="#8b5cf6" className="font-mono font-bold">
                            ...
                            <div className="p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm overflow-auto max-h-[450px]">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {isMultipleOptima && (
                                        <div className="p-3 rounded-lg bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800">
                                            ...
                                            <div className="mt-2 space-y-1 text-sm text-slate-600 dark:text-slate-400">
                                                ...
                                                {currentExample.edgePoints && currentExample.edgePoints.length > 0 && (
                                    ...
                                    {!isMultipleOptima && (
                                        <div className="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800">
                                            ...
                                            <p className="text-sm font-mono text-emerald-800 dark:text-emerald-300">
                                                {currentExample.cornerPoints.filter(cp => cp.isOptimal).map(cp => 
                                                    `${cp.label} (${cp.x}, ${cp.y})`
                                                ).join(", ")}
                                            </p>
                                        </div>
                                    ...
                                    <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                                        ...
                                        <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                                            {isMultipleOptima 
                                                ? "Multiple optimal solutions give decision-makers flexibility. They can choose based on other factors like brand preference, risk, or strategic goals."
                                                : "A unique optimal solution gives a clear recommendation. The decision-maker should follow this exact plan."
                                            }
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                            ...
                            <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                ...
                                <li>If two corners have the same optimal value, there are multiple optima.</li>
                                <li>Multiple optima give decision-makers flexibility.</li>
                                <li>Any point on the optimal edge is equally good.</li>
                                <li>This is not a problem — it's an opportunity.</li>
                            </ul>
                        </div>
                        <div className="p-5 rounded-xl bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800/50">
                            ...
                            <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                ...
                                <li>Confusing multiple optima with unbounded solutions.</li>
                            </ul>
                        </div>
                        <div className="p-5 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50">
                            ...
                            <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                ...
                                <li>Explain the flexibility multiple optima provide.</li>
                ...
                >
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I understand why multiple optima occur (parallel objective).</span>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I can identify the optimal edge when multiple optima exist.</span>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I can state all optimal solutions.</span>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I understand that multiple optima provide flexibility.</span>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I can distinguish between multiple optima and unbounded solutions.</span>
                        </div>
                    </div>
                </section>
                ...
                <div className="mb-14">
                    <PlainTextPrint
                        content={noteText}
                        title="Multiple Optimal Solutions – Printable Notes"
                        stampEnabled={true}
                        showDownload={true}
                        downloadButtonText="Download Notes (TXT)"
                        downloadFileName="topic48_note.txt"
                    />
                </div>
                ...
                <div className="mb-8">
                    <Teacher
                        note={
                            "Multiple optimal solutions are often misunderstood. I tell my students: 'Multiple optima are not a problem — they're an opportunity!' The key insight is that the objective line is parallel to a constraint edge. A great exercise: have students find the slope of the objective function and compare it to the slopes of the constraints. If they match, multiple optima exist."
                        }
                    />
                </div>
                ...
                <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-sm text-slate-500 dark:text-slate-400">
                    <p>
                        Topic 48 — Multiple Optimal Solutions &bull; Flexibility in decision-making
                    </p>
                    <p className="mt-1 text-xs">
                        🎯 Next: Identifying Alternate Optimal Solutions Graphically (Topic 49)
                    </p>
                </footer>
