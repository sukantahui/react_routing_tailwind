...
const Topic33 = () => {
    ...
    // Worked Example 6: Labour and Machine-Hour Constraint Problem
    const problem = {
        title: "Labour and Machine-Hour Constraint Problem",
        description: "A factory balances labour and machine hours between two products.",
        problemStatement: "A factory produces two products: Product P and Product Q. Product P requires 3 hours of labour and 2 hours of machine time. Product Q requires 4 hours of labour and 3 hours of machine time. The factory has 120 hours of labour and 90 hours of machine time available. The profit from Product P is ₹12 per unit and from Product Q is ₹15 per unit. How many units of each product should be produced to maximize profit?",
        constraints: [
            { label: "3x + 4y ≤ 120", a: 3, b: 4, c: 120, sign: "≤", color: "#8b5cf6" },
            { label: "2x + 3y ≤ 90", a: 2, b: 3, c: 90, sign: "≤", color: "#f59e0b" },
        ...
        cornerPoints: [
            ...
            { x: 40, y: 0, label: "A (40,0)", Z: 480 },
            { x: 30, y: 10, label: "B (30,10)", Z: 510 },
            { x: 0, y: 30, label: "C (0,30)", Z: 450 },
        ],
        optimal: { x: 30, y: 10, Z: 510 },
        steps: [
            "Step 1: Define variables:",
            "  x = units of Product P",
            "  y = units of Product Q",
            "Step 2: Formulate the problem:",
            "  Maximize Z = 12x + 15y",
            "  Subject to:",
            "    3x + 4y ≤ 120  (labour constraint)",
            "    2x + 3y ≤ 90   (machine constraint)",
            "    x ≥ 0, y ≥ 0   (non-negativity)",
            "Step 3: Graph the constraints and find the feasible region.",
            "Step 4: Identify corner points: O(0,0), A(40,0), B(30,10), C(0,30).",
            "Step 5: Evaluate Z at each corner:",
            "  O (0,0): Z = 0",
            "  A (40,0): Z = 12(40) + 15(0) = 480",
            "  B (30,10): Z = 12(30) + 15(10) = 360 + 150 = 510",
            "  C (0,30): Z = 12(0) + 15(30) = 450",
            "Step 6: The maximum profit is ₹510 at (30, 10).",
            "Conclusion: Produce 30 units of P and 10 units of Q.",
            "Check: Labour: 3(30)+4(10)=90+40=120 ✓, Machine: 2(30)+3(10)=60+30=90 ✓."
        ],
        interpretation: "The optimal solution is to produce 30 units of Product P and 10 units of Product Q. This uses all available labour hours (3×30 + 4×10 = 90 + 40 = 120 hours) and all available machine hours (2×30 + 3×10 = 60 + 30 = 90 hours). The maximum profit is ₹510. Both labour and machine resources are fully utilized at the optimum."
    };
    ...
    const generateMultipleLines = () => {
        const lines = [];
        const values = [50, 100, 200, 300, 400, 500, 510, 550];
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
                ...
                >
                    <div className="inline-block px-4 py-1 mb-4 text-xs font-semibold tracking-widest uppercase rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800">
                        Topic 33 — Worked Example 6
                    </div>
                    <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Worked Example 6: <br className="sm:hidden" />
                        <span className="bg-gradient-to-r from-rose-600 to-pink-600 dark:from-rose-400 dark:to-pink-400 bg-clip-text text-transparent">
                            Labour and Machine-Hour Constraint
                        </span>
                    </h1>
                    <p className="mt-4 text-lg sm:text-xl text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">
                        Learn how to balance labour and machine hours between two products to maximize profit
                        — a classic production planning problem.
                    </p>
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                            ...
                            <ul className="mt-2 text-sm space-y-1 text-slate-600 dark:text-slate-400">
                                <li>• Product P: 3 labour, 2 machine, ₹12 profit</li>
                                <li>• Product Q: 4 labour, 3 machine, ₹15 profit</li>
                                <li>• Available: 120 labour, 90 machine</li>
                            </ul>
                        </div>
                        <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50">
                            ...
                            <ul className="mt-2 text-sm space-y-1 text-slate-600 dark:text-slate-400">
                                <li>• How many units of Product P?</li>
                                <li>• How many units of Product Q?</li>
                ...
                &gt;
                    ...
                    <div className="mt-4 space-y-4 text-gray-700 dark:text-slate-300">
                        ...
                        <div className="p-3 rounded-lg bg-slate-100 dark:bg-slate-800 font-mono text-sm">
                            3x + 4y ≤ 120  (labour constraint)<br/>
                            2x + 3y ≤ 90   (machine constraint)<br/>
                            x ≥ 0, y ≥ 0   (non-negativity)
                        </div>
                    </div>
                </section>
                ...
                &gt;
                    ...
                    <div className="mt-4 text-gray-700 dark:text-slate-300">
                        <p className="mb-3">
                            Use the interactive graph below to explore the labour and machine-hour constraint
                            problem. Adjust the objective line to see how different profit levels compare.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="w-full aspect-square bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-2 shadow-inner">
                                <svg viewBox="0 0 400 400" className="w-full h-full" role="img" aria-label="Worked example 6 graph">
                                    {/* Grid */}
                                    <defs>
                                        <pattern id="grid_t33" width="40" height="40" patternUnits="userSpaceOnUse">
                                            <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#e2e8f0" strokeWidth="0.5" className="dark:stroke-slate-700" />
                                        </pattern>
                                    </defs>
                                    <rect width="400" height="400" fill="url(#grid_t33)" />
                                        ...
                                        if (val &ge; 0 && val &le; 45) {
                                            return (
                                                <g key={`t33-tick-${v}`}>
                                                    ...
                                                    {v &ge; 40 && v &le; 360 && val !== 0 && val <= 40 && val % 10 === 0 && (
                                                        <>
                                    ...
                                    <g>
                                        ...
                                        <text x="28" y="114" fontSize="9" fill="#f43f5e">
                                            Labour and machine both fully used
                                        </text>
                                    </g>
                    ...
                    <div className="mt-4 space-y-4 text-gray-700 dark:text-slate-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                                ...
                                <ul className="mt-2 text-sm space-y-1 text-slate-600 dark:text-slate-400">
                                    <li>• Both labour and machine hours are fully utilized</li>
                                    <li>• The optimal mix is 30 units of P and 10 units of Q</li>
                                    <li>• Profit is ₹510 — higher than producing only one product</li>
                                    <li>• Product Q is more profitable but uses more of both resources</li>
                                </ul>
                            </div>
                            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50">
                                <h3 className="font-semibold text-amber-700 dark:text-amber-300">Business Insight</h3>
                                <ul className="mt-2 text-sm space-y-1 text-slate-600 dark:text-slate-400">
                                    <li>• The factory should produce more P than Q</li>
                    ...
                    <div className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                            ...
                            <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                <li>Labour and machine constraints are common in manufacturing.</li>
                                <li>Look for the resource that limits production.</li>
                                <li>The optimal plan balances both labour and machine hours.</li>
                ...
                &gt;
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            ...
                            <span>I can formulate a problem with labour and machine constraints.</span>
                        </div>
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <span className="text-emerald-500 text-lg">☑️</span>
                            <span>I can explain the trade-off between labour and machine hours.</span>
                        </div>
                    </div>
                </section>
                ...
                <div className="mb-14">
                    <PlainTextPrint
                        content={noteText}
                        title="Worked Example 6 – Printable Notes"
                        stampEnabled={true}
                        showDownload={true}
                ...
                <div className="mb-8">
                    <Teacher
                        note={
                            "This example shows the importance of balancing labour and machine hours. I tell my students: 'In real factories, you have multiple constraints — labour, machine time, materials. LP helps you find the optimal mix.' The key insight is that the optimal solution balances both resources perfectly. I recommend having students try different production plans to understand why (30,10) is optimal."
                        }
                    />
                </div>
                ...
                <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-sm text-slate-500 dark:text-slate-400">
                    <p>
                        Topic 33 — Worked Example 6 &bull; Labour and machine-hour constraint
                    </p>
                    <p className="mt-1 text-xs">
                        🎯 Next: Worked Example 7: Production Planning Problem (Topic 34)
                    </p>
                </footer>
