...
import questions from './topic86_files/topic86_questions';
import noteText from './topic86_files/topic86_note.txt?raw';
...
const Topic86 = () => {
  ...
  const numericalExercises = [
    ...
    {
      id: 7,
      title: 'Exercise 7: Diet Planning',
      difficulty: 'Advanced',
      problem: 'A dietitian needs to plan a meal with minimum nutritional requirements. Two foods are available. Food A costs ₹20 per unit and contains 3 units of protein and 2 units of carbohydrates. Food B costs ₹30 per unit and contains 2 units of protein and 5 units of carbohydrates. Minimum requirements: 12 units of protein and 15 units of carbohydrates. Find the minimum cost diet.',
      tasks: [
        'Define variables',
        'Formulate the LP problem',
        'Graph the constraints',
      ...
      solution: {
        variables: 'Let x = units of Food A, y = units of Food B',
        objective: 'Minimize Z = 20x + 30y (Cost in ₹)',
        constraints: [
          'Protein: 3x + 2y ≥ 12',
          'Carbohydrates: 2x + 5y ≥ 15',
          'x ≥ 0, y ≥ 0'
        ],
        cornerPoints: [
          '(0, 6)',
        ...
        evaluations: [
          'Z(0,6) = 20(0) + 30(6) = 180',
          'Z(2,3) = 20(2) + 30(3) = 40 + 90 = 130',
          'Z(7.5,0) = 20(7.5) + 30(0) = 150'
        ],
        optimal: '(2, 3)',
        minCost: '₹130',
        surplusProtein: 'Protein: 3(2) + 2(3) = 12 (exactly met)',
        surplusCarbs: 'Carbs: 2(2) + 5(3) = 19 (4 units surplus)',
        steps: [
          'Step 1: Define variables: x = Food A, y = Food B',
          'Step 2: Formulate objective: Min Z = 20x + 30y',
          'Step 3: Formulate constraints: protein, carbs',
          'Step 4: Graph constraints and find feasible region (above lines)',
          'Step 5: Identify corner points',
          'Step 6: Evaluate Z at each corner point',
          'Step 7: Select min Z = 130 at (2,3)',
          'Step 8: Use 2 units of Food A and 3 units of Food B'
        ]
      }
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="space-y-4">
                  ...
                  {showSolution && numericalExercises[selectedExercise]?.solution && (
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border-l-4 border-green-500">
                      ...
                      {numericalExercises[selectedExercise].solution.surplusProtein && (
                        <div className="mt-2">
                          <p className="font-semibold text-gray-800 dark:text-gray-200">Nutrient Analysis:</p>
                          <p className="text-sm text-gray-700 dark:text-gray-300">{numericalExercises[selectedExercise].solution.surplusProtein}</p>
                          <p className="text-sm text-gray-700 dark:text-gray-300">{numericalExercises[selectedExercise].solution.surplusCarbs}</p>
                        </div>
                      )}
                    </div>
                  )}
        ...
        <div className="mt-8">
          <PlainTextPrint
            ...
            downloadFileName="topic86_note.txt"
          />
        </div>
