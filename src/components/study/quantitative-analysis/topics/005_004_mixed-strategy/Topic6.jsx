              ...
              <table className="w-full text-center border-collapse">
                ...
                <tbody className="divide-y divide-slate-800/60 text-slate-200">
                  <tr>
                    ...
                    <td className="p-2 font-bold">{currentEx.matrix[0][0] &ge; 0 ? `+${currentEx.matrix[0][0]}` : currentEx.matrix[0][0]}k</td>
                    <td className="p-2 font-bold">{currentEx.matrix[0][1] &ge; 0 ? `+${currentEx.matrix[0][1]}` : currentEx.matrix[0][1]}k</td>
                  </tr>
                  <tr>
                    <td className="p-2 text-left font-bold text-rose-300">A₂</td>
                    <td className="p-2 font-bold">{currentEx.matrix[1][0] &ge; 0 ? `+${currentEx.matrix[1][0]}` : currentEx.matrix[1][0]}k</td>
                    <td className="p-2 font-bold">{currentEx.matrix[1][1] &ge; 0 ? `+${currentEx.matrix[1][1]}` : currentEx.matrix[1][1]}k</td>
                  </tr>
                </tbody>
              </table>
            </div>
