// Project: Sort() With Custom Comparator Functions (Marks, Price, Name)
// Description: This project demonstrates sort() with custom comparator functions (marks, price, name) in JavaScript.
