// Project: Advanced: Optional Chaining (?.) And Nullish Coalescing (??)
// Description: This project demonstrates advanced: optional chaining (?.) and nullish coalescing (??) in JavaScript.
