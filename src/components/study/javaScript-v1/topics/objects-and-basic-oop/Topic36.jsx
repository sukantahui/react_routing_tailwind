...
import projectsData from "./topic36_files/js-object-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic36_files/answers/*.js", { query: "?raw", import: "default", eager: true });
