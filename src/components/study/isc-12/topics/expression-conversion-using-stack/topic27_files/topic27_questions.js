...
// 30 FAQs on "Rules for Prefix to Infix Conversion" – basic to expert.

const questions = [
  {
    question: "What is the first step in converting prefix to infix?",
  ...
  {
    question: "What is the output for prefix `^ ^ A B C`?",
    shortAnswer: "((A^B)^C) or (A^(B^C))? Let's trace: ^ ^ A B C → scan from right: C, B, A, ^, ^. First ^: pop A, B → (A^B). Second ^: pop (A^B), C → ((A^B)^C). So result is ((A^B)^C).",
    explanation: "Prefix is left‑associative unless parentheses specify otherwise.",
    hint: "Left‑assoc.",
    level: "advanced",
    codeExample: "((A^B)^C)"
  },
  ...
  {
    question: "What is the difference between prefix and postfix conversion?",
