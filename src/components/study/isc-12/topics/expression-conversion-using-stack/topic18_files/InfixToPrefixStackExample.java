// InfixToPrefixStackExample.java
// Complete stack‑based infix‑to‑prefix conversion with trace.

import java.util.*;

public class InfixToPrefixStackExample {
    ...
    public static void traceConversion(String infix) {
        ...
        System.out.println("3. Modified postfix result: " + infixToPostfixModified(swapParentheses(reverse(infix))));
