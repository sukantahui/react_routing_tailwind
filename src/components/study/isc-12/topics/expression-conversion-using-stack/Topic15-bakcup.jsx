    ...
    <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className="mb-2">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Output (built in reverse)</h3>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <section className="animate-fadeUp delay-400">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-2 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800 text-sm">
              <span className="font-medium">🧠 How it works:</span> This method avoids swapping parentheses. Instead, you scan the original expression from right to left. When you see an operand, push it to output (which is built in reverse). For operators, pop from the stack if precedence is higher or equal (except for right‑associative <code>^</code>). Parentheses are handled by treating <code>)</code> as an opening marker and <code>(</code> as a closing marker. Finally, reverse the output to get the prefix.
            </div>
            <Tracer
