      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <header className="animate-fadeUp">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
            Practice Problems: Prefix to Infix
          </h1>
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Sharpen your prefix‑to‑infix conversion skills with these 30 problems.
          </p>
        </header>
        ...
        <div className="animate-fadeUp delay-400">
          <Teacher
            note={
              "These problems are designed to build fluency in prefix‑to‑infix conversion. I encourage students in Shyamnagar to practice with a stack of strings on paper. The key is to remember: scan from right to left, and the first popped operand is the left operand. Use the hints to guide, but try to solve independently first."
            }
          />
        </div>
        ...
        <div className="animate-fadeUp delay-500">
          <FAQTemplate
            title="Prefix to Infix – Extra Q&A"
