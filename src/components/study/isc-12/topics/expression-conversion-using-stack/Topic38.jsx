      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <header className="animate-fadeUp">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
            Practice Problems: Postfix to Prefix
          </h1>
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Sharpen your postfix‑to‑prefix conversion skills with these 30 problems.
          </p>
        </header>
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-400/10">
            ...
            <div className="mt-4 space-y-3 text-gray-700 dark:text-gray-300">
              <p>
                For each postfix expression, apply the conversion rules:
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Scan the postfix expression from <strong>left to right</strong>.</li>
                <li>Push operands onto the stack.</li>
                <li>When an operator is encountered, pop the <strong>right</strong> operand, then the <strong>left</strong> operand.</li>
                <li>Combine them as <code>operator + " " + left + " " + right</code> and push the result.</li>
                <li>At the end, the stack contains the prefix expression.</li>
              </ul>
              <p>
          ...
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              <ol className="list-decimal pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>Split the postfix expression into tokens (space‑separated).</li>
                <li>Scan the tokens from <strong>left to right</strong>.</li>
                <li>If token is an operand, push it onto the stack.</li>
                <li>If token is an operator:
                  <ul className="list-disc pl-5 mt-1">
                    <li>Pop the <strong>right</strong> operand (first pop).</li>
                    <li>Pop the <strong>left</strong> operand (second pop).</li>
                    <li>Push <code>operator + " " + left + " " + right</code></li>
                  </ul>
                </li>
        ...
        <div className="animate-fadeUp delay-400">
          <Teacher
            note={
              "These problems are designed to build fluency in postfix‑to‑prefix conversion. I encourage students in Shyamnagar to practice with a stack of strings on paper. The key is to remember: scan from left to right, and the first popped operand is the right operand. Use the hints to guide, but try to solve independently first."
            }
          />
        </div>
        ...
        <div className="animate-fadeUp delay-500">
          <FAQTemplate
            title="Postfix to Prefix – Extra Q&A"
