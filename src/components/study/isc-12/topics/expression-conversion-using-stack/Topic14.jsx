      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <header className="animate-fadeUp">
          ...
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Sharpen your infix‑to‑postfix conversion skills with these 30 problems.
          </p>
        </header>
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-400/10">
            ...
            <div className="mt-4 space-y-3 text-gray-700 dark:text-gray-300">
              <p>
                For each infix expression, apply the conversion rules:
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Scan left to right.</li>
                <li>Output operands immediately.</li>
                <li>Push operators and parentheses onto a stack.</li>
                <li>Pop operators based on precedence and associativity.</li>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                <span className="font-medium">💡 Tip:</span> Write down the step‑by‑step trace for the more complex
                expressions – it helps solidify your understanding.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="animate-fadeUp delay-300">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2">
              ...
              Quick Reference: Precedence & Associativity
            </h2>
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <ul className="mt-2 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li>Logical OR (<code>||</code>) – lowest</li>
                </ul>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                <h3 className="font-bold text-gray-700 dark:text-gray-300">Associativity</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                  <li><strong>Left‑associative:</strong> <code>+</code>, <code>-</code>, <code>*</code>, <code>/</code>, <code>%</code>, relational, logical</li>
                  <li><strong>Right‑associative:</strong> <code>^</code> (exponentiation)</li>
                  <li>Parentheses override all</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="animate-fadeUp delay-400">
          <Teacher
            note={
              "Practice is key to mastering infix‑to‑postfix conversion. I encourage my students in Shyamnagar to solve these problems by hand first, then verify with code. The mistakes highlighted in the solutions are ones I see often – remind your students to always check precedence and associativity, and to never assume left‑to‑right evaluation."
            }
          />
        </div>

        {/* FAQ (optional, but we can reuse for extra Q&A) */}
        <div className="animate-fadeUp delay-500">
          <FAQTemplate
            title="Infix to Postfix – Extra Q&A"
