      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <header className="animate-fadeUp">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
            Practice Problems: Postfix to Infix
          </h1>
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Sharpen your postfix‑to‑infix conversion skills with these 30 problems.
          </p>
        </header>
          ...
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-400/10">
            ...
            <div className="mt-4 space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>When an operator is encountered, pop the right operand, then the left operand.</li>
                <li>Combine them as <code>"(" + left + operator + right + ")"</code> and push the result.</li>
                <li>At the end, the stack contains the fully parenthesised infix expression.</li>
              </ul>
              <p>
              ...
              <ol className="list-decimal pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>If token is an operator:
                  <ul className="list-disc pl-5 mt-1">
                    <li>Pop the right operand (top).</li>
                    <li>Pop the left operand (next).</li>
                    <li>Push <code>"(" + left + operator + right + ")"</code></li>
                  </ul>
                </li>
        ...
        <div className="animate-fadeUp delay-400">
          <Teacher
            note={
              "These problems are designed to build fluency in postfix‑to‑infix conversion. I encourage students in Shyamnagar to practice with a stack of strings on paper. The key is to always wrap the combined expression in parentheses – it's a safety net that ensures correctness. Use the hints to guide, but try to solve independently first."
            }
          />
        </div>
        ...
        <div className="animate-fadeUp delay-500">
          <FAQTemplate
            title="Postfix to Infix – Extra Q&A"
