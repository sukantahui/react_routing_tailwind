...
// Local files
import infixToPrefixExamplesJava from "./topic17_files/InfixToPrefixExamples.java?raw";
...
export default function Topic17() {
  ...
  const javaCode = typeof infixToPrefixExamplesJava === 'string'
    ? infixToPrefixExamplesJava
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 space-y-12">
        ...
        <header className="animate-fadeUp">
          ...
          <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">
            Detailed step‑by‑step traces of infix‑to‑prefix conversion with expert insights.
          </p>
        </header>
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-400/10">
            ...
            <div className="mt-4 space-y-4">
              <p>
                The following 8 examples walk through the infix‑to‑prefix conversion algorithm step by step.
                Each example includes:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
                <li>The original infix expression.</li>
                <li>The reversed and parenthesis‑swapped intermediate.</li>
                <li>A full trace table with <strong>Stack</strong> and <strong>Output</strong> columns.</li>
                <li>A key observation explaining the tricky part.</li>
                <li>A <strong>Common Mistake</strong> box that highlights what experts often get wrong.</li>
              </ul>
              <p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 shadow-sm">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <span className="font-medium">💡 Key insight:</span> Prefix conversion is postfix in a mirror – reversing, swapping, applying modified postfix, and reversing again.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">2</td><td className="p-2 border border-gray-200 dark:border-gray-700">SWAP</td><td className="p-2 border border-gray-200 dark:border-gray-700">No parentheses to swap</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">3</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[]</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">5</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[+]</td><td className="p-2 border border-gray-200 dark:border-gray-700">BA</td></tr>
            ...
            <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <span className="font-medium">✅ Observation:</span> Simple case – the result is <code>+AB</code>.
              </p>
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
                ⚠️ <span className="font-medium">Common Mistake:</span> Forgetting to reverse the final output – would give <code>BA+</code> which is wrong.
              </p>
            </div>
        ...
        <section className="animate-fadeUp delay-300">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 dark:hover:shadow-emerald-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">3</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[]</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">5</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[*]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CB</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">6</td><td className="p-2 border border-gray-200 dark:border-gray-700">+</td><td className="p-2 border border-gray-200 dark:border-gray-700">No equal pop: * &gt; +? No, * has higher precedence, so pop *</td><td className="p-2 border border-gray-200 dark:border-gray-700">[+]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CB*</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">7</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[+]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CB*A</td></tr>
            ...
            <div className="mt-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <span className="font-medium">✅ Observation:</span> Multiplication is done first, then addition. Prefix: <code>+A*BC</code>.
              </p>
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
                ⚠️ <span className="font-medium">Common Mistake:</span> Some might write <code>*+ABC</code> (wrong order) or forget the final reverse.
              </p>
            </div>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10 dark:hover:shadow-purple-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">1</td><td className="p-2 border border-gray-200 dark:border-gray-700">REVERSE</td><td className="p-2 border border-gray-200 dark:border-gray-700">(A+B)*C → C*(B+A)</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">2</td><td className="p-2 border border-gray-200 dark:border-gray-700">SWAP</td><td className="p-2 border border-gray-200 dark:border-gray-700">C*(B+A) → C*(B+A) (no change)</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">3</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[]</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">4</td><td className="p-2 border border-gray-200 dark:border-gray-700">*</td><td className="p-2 border border-gray-200 dark:border-gray-700">Push *</td><td className="p-2 border border-gray-200 dark:border-gray-700">[*]</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">6</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[* (]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CB</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">8</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[* ( +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CBA</td></tr>
            ...
            <div className="mt-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <span className="font-medium">✅ Observation:</span> Parentheses force addition first, then multiplication. Prefix: <code>*+ABC</code>.
              </p>
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
                ⚠️ <span className="font-medium">Common Mistake:</span> Forgetting to swap parentheses in complex expressions can lead to incorrect grouping.
              </p>
            </div>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <section className="animate-fadeUp delay-500">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 dark:hover:shadow-amber-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">2</td><td className="p-2 border border-gray-200 dark:border-gray-700">SWAP</td><td className="p-2 border border-gray-200 dark:border-gray-700">No parentheses</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">3</td><td className="p-2 border border-gray-200 dark:border-gray-700">D</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[]</td><td className="p-2 border border-gray-200 dark:border-gray-700">D</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">5</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[*]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">7</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[+]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC*B</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">9</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[+ *]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC*BA</td></tr>
            ...
            <div className="mt-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
              ...
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
                ⚠️ <span className="font-medium">Common Mistake:</span> The order of operands in prefix is tricky – <code>*AB</code> and <code>*CD</code> must be in the correct order.
              </p>
            </div>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">7</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[- *]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DCB</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">8</td><td className="p-2 border border-gray-200 dark:border-gray-700">+</td><td className="p-2 border border-gray-200 dark:border-gray-700">Pop * (higher), pop - (equal? Actually - and + have equal precedence; but we do NOT pop equal for prefix! Wait, careful. In prefix, equal precedence is NOT popped. So when we see +, we check: top is - (equal precedence) – do not pop. So we push + on top.</td><td className="p-2 border border-gray-200 dark:border-gray-700">[- +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DCB*</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">9</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[- +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DCB*A</td></tr>
            ...
            <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <span className="font-medium">✅ Observation:</span> The algorithm produces <code>-+A*BCD</code> which corresponds to <code>(A + (B*C)) - D</code>.
              </p>
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
        ...
        <section className="animate-fadeUp delay-200">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 dark:hover:shadow-emerald-400/10">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">7</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[^ ^]</td><td className="p-2 border border-gray-200 dark:border-gray-700">CBA</td></tr>
            ...
            <div className="mt-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
              ...
              <p className="text-sm text-red-600 dark:text-red-400 mt-2">
                ⚠️ <span className="font-medium">Common Mistake:</span> 
                Treating <code>^</code> as left‑associative and producing <code>^ABC^</code> or <code>^^ABC?</code> Actually left‑assoc would be <code>{`^A^BC`}</code>? The correct is right‑assoc.
              </p>
            </div>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Final prefix: <strong className="text-indigo-600 dark:text-indigo-400">^^ABC</strong>
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">4</td><td className="p-2 border border-gray-200 dark:border-gray-700">D</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[(]</td><td className="p-2 border border-gray-200 dark:border-gray-700">D</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">6</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[( -]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">10</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[* (]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC-B</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">12</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[* ( +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">DC-BA</td></tr>
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-gray-600 dark:text-gray-400">
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">3</td><td className="p-2 border border-gray-200 dark:border-gray-700">E</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[]</td><td className="p-2 border border-gray-200 dark:border-gray-700">E</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">5</td><td className="p-2 border border-gray-200 dark:border-gray-700">D</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[/]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">7</td><td className="p-2 border border-gray-200 dark:border-gray-700">C</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[-]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/C</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">8</td><td className="p-2 border border-gray-200 dark:border-gray-700">+</td><td className="p-2 border border-gray-200 dark:border-gray-700">+ and - have equal precedence; do NOT pop. Push +</td><td className="p-2 border border-gray-200 dark:border-gray-700">[- +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/C</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">9</td><td className="p-2 border border-gray-200 dark:border-gray-700">B</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[- +]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/CB</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">10</td><td className="p-2 border border-gray-200 dark:border-gray-700">*</td><td className="p-2 border border-gray-200 dark:border-gray-700">* &gt; + and * &gt; -, so pop +? Wait, top is + (precedence 1), * is 2 – pop +. Then top is - (precedence 1), * &gt; -, pop -. Then push *.</td><td className="p-2 border border-gray-200 dark:border-gray-700">[*]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/CB+-</td></tr>
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">11</td><td className="p-2 border border-gray-200 dark:border-gray-700">A</td><td className="p-2 border border-gray-200 dark:border-gray-700">Operand → output</td><td className="p-2 border border-gray-200 dark:border-gray-700">[*]</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/CB+-A</td></tr>
                  ...
                  <tr><td className="p-2 border border-gray-200 dark:border-gray-700">13</td><td className="p-2 border border-gray-200 dark:border-gray-700">REVERSE</td><td className="p-2 border border-gray-200 dark:border-gray-700">ED/CB+-A* → *A+BC/DE-? Let's reverse: *A+BC/DE-? Actually reverse of ED/CB+-A* is *A+-BC/DE? We'll compute: ED/CB+-A* reversed is *A-+BC/DE? Let's do carefully: ED/CB+-A* -&gt; reverse -&gt; *A-+BC/DE? Wait, we need to check. The correct prefix is -*A+BC/DE. So output should be -*A+BC/DE. Let's trust the algorithm.</td><td className="p-2 border border-gray-200 dark:border-gray-700">—</td><td className="p-2 border border-gray-200 dark:border-gray-700">-*A+BC/DE</td></tr>
                </tbody>
              </table>
            </div>
            <div className="mt-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 dark:hover:shadow-amber-400/10">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
              <li>Always write down the reversed and swapped expressions to avoid mistakes.</li>
              <li>Remember: In prefix, equal precedence is <strong>not</strong> popped.</li>
              <li>Practice with the interactive tool from Topic15 to visualise stack changes.</li>
              <li>Verify your prefix output by converting back to infix mentally.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fadeUp delay-200">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 dark:hover:shadow-red-400/10">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
              ...
              <li>Mis‑ordering operands in prefix.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fadeUp delay-300">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/10 dark:hover:shadow-green-400/10">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
              <li>Trace the algorithm on paper before coding.</li>
              <li>Use helper functions for reversing and swapping.</li>
              <li>Add comments for each step in your code.</li>
              <li>Test with expressions containing right‑associative operators like <code>^</code>.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fadeUp delay-400">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                "I can trace the algorithm on examples.",
        ...
        <section className="animate-fadeUp delay-500">
          <div className="rounded-2xl bg-indigo-50 dark:bg-indigo-950/30 p-6 sm:p-8 border border-indigo-200 dark:border-indigo-800 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-400/10">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
              ...
              <li>How does swapping parentheses affect nesting?</li>
              <li>What happens if we don't reverse the final output?</li>
              <li>Try converting <code>A-B-C</code> to prefix and compare with <code>--ABC</code>.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fadeUp delay-100">
          <div className="rounded-2xl bg-gray-50 dark:bg-gray-900/60 p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="mt-4">
              <JavaFileLoader
                fileModule={javaCode}
                title="InfixToPrefixExamples.java"
                highlightLines={[]}
              />
            </div>
        ...
        <div className="animate-fadeUp delay-200">
          <Teacher
            note={
              "I find that these examples are the most effective way to teach the algorithm. I ask my students in Barrackpore to trace each step on paper before looking at the solution. The key is to internalise the 'reverse, swap, apply, reverse' pattern. The most common error is forgetting the final reverse – a simple but costly mistake."
            }
          />
        </div>
        ...
        <div className="animate-fadeUp delay-300">
          <FAQTemplate
            title="Infix to Prefix Examples – FAQs"
            questions={questions}
          />
        </div>
