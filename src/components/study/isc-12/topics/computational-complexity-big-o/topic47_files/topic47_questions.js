const questions = [
  {
    ...
    explanation: "Balanced partitions give two calls on half the input, plus O(n) work for partitioning.",
  ...
  },
  {
    ...
    shortAnswer: "O(log n) average, O(n) worst — due to recursion stack.",
    explanation: "The recursion depth is O(log n) when partitions are balanced, O(n) when unbalanced.",
    hint: "Recursion stack.",
    level: "intermediate",
    codeExample: "// O(log n) average, O(n) worst"
  },
  {
  ...
  {
    question: "What is the space complexity of quicksort in the best case?",
    shortAnswer: "O(log n) — recursion stack depth.",
  ...
  {
    question: "What is the recurrence for quicksort with random pivot?",
    shortAnswer: "T(n) = 2T(n/2) + O(n) on average — same as balanced case.",
    explanation: "Random pivot gives balanced partitions with high probability.",
    hint: "O(n log n).",
    level: "advanced",
    codeExample: "// T(n) = 2T(n/2) + n"
  },
  ...
  {
    question: "What is the recurrence for the number of comparisons in quicksort worst case?",
    shortAnswer: "Comp(n) = Comp(n-1) + n, Comp(1) = 0 → O(n²).",
    explanation: "Each level does O(n) comparisons, with n levels.",
    hint: "n + (n-1) + ... + 1.",
    level: "advanced",
    codeExample: "// Comp(n) = n + (n-1) + ... + 1"
  },
  {
    question: "What is the recurrence for the number of comparisons in quicksort average case?",
    shortAnswer: "Comp(n) = 2/n * Σ_{k=0}^{n-1} Comp(k) + n → O(n log n).",
    explanation: "This is the average-case recurrence for quicksort.",
    hint: "2/n sum.",
    level: "advanced",
    codeExample: "// O(n log n)"
  },
  {
    question: "What is the time complexity of quicksort with a constant-time pivot selection?",
    shortAnswer: "O(n²) worst-case, O(n log n) average.",
    explanation: "Even with constant-time pivot, the worst-case remains O(n²).",
    hint: "Same as standard.",
    level: "advanced",
    codeExample: "// O(n²) worst"
  },
  {
    question: "What is the time complexity of quicksort with a median-of-medians pivot?",
    shortAnswer: "O(n log n) worst-case.",
    explanation: "Median-of-medians gives a guaranteed good pivot, achieving O(n log n) worst-case.",
    hint: "Guaranteed O(n log n).",
    level: "advanced",
    codeExample: "// O(n log n) worst"
  },
  {
    question: "What is the space complexity of quicksort with median-of-medians?",
    shortAnswer: "O(log n) average, O(n) worst — same as standard quicksort.",
    explanation: "The recursion depth is still O(log n) on average, O(n) worst.",
    hint: "Same.",
    level: "advanced",
    codeExample: "// O(log n) average"
  },
  {
    question: "What is the time complexity of quicksort on a partially sorted array?",
    shortAnswer: "O(n log n) with good pivot, O(n²) with bad pivot.",
    explanation: "Partial sortedness can cause issues with naive pivot selection.",
    hint: "Depends on pivot.",
    level: "intermediate",
    codeExample: "// O(n log n) with random pivot"
  }
];
