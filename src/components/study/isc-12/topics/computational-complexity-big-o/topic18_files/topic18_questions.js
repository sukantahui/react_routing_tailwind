const questions = [
  {
    ...
    shortAnswer: "A visual representation of the recursive calls made by an algorithm.",
    explanation: "Each node represents a subproblem, and children represent recursive calls. Used to visualize and solve recurrence relations.",
    hint: "It's like a family tree for recursive calls.",
    level: "basic",
    codeExample: "// Tree with root T(n), children T(n/b)"
  },
  {
    question: "What does each node in a recursion tree represent?",
    shortAnswer: "A subproblem of size n/bᵏ with its work f(n/bᵏ).",
    explanation: "The node represents the work done at that subproblem, excluding the recursive calls.",
    hint: "Each node is a recursive call.",
    level: "basic",
    codeExample: "// Node: T(size) with work f(size)"
  },
  {
  ...
  {
    question: "What is the recursion tree for T(n) = 2T(n/2) + n log n?",
    shortAnswer: "Tree with 2 branches, height = log₂(n), work per level = n log(n/2ᵏ).",
    explanation: "Work per level decreases slightly, dominated by the root? Actually it's O(n log² n).",
    hint: "Each level does n log n work.",
    level: "advanced",
    codeExample: "// O(n log² n)"
  }
];
