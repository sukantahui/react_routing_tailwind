const questions = [
  {
    ...
    explanation: "Merge sort always divides and merges, giving O(n log n).",
    hint: "Divide and conquer with O(n) work per level.",
    level: "basic",
  ...
  },
  {
    ...
    shortAnswer: "O(n) — for the temporary array used during merging.",
    explanation: "The merge step requires an auxiliary array of size n.",
  ...
  },
  {
    ...
    shortAnswer: "O(n) for the array plus O(log n) for the recursion stack.",
