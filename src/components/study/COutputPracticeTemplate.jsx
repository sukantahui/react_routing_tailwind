...
import CCodeBlock from "../../common/CodeBlock"; // assume a generic or C-specific code block
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-black to-zinc-900 text-zinc-200 p-6">
      <div className="max-w-5xl mx-auto">
        {/* Header with C‑specific logo / title */}
        ...
        {/* Control Panel (identical to Java version) */}
        ...
        {started &&
          sessionQ.map((q, index) => (
            ...
            >
              ...
              {/* Use C‑specific code block */}
              <CCodeBlock code={q.code} />

              {/* Eye button to toggle answer */}
              <button
                onClick={() => toggle(q.id)}
