...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Solving the N+1 Query Problem with DataLoader &amp; Batching · Architecture &amp; Execution Pipeline</text>
