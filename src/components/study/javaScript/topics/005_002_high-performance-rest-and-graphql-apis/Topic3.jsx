...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">High-Speed RPC Communication with gRPC &amp; Protocol Buffers (protobuf) · Architecture &amp; Execution Pipeline</text>
