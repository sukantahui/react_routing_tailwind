...
// Topic: Building a Full-Featured Reactive UI Framework from Scratch (Mini React/Vue)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Building a Full-Featured Reactive UI Framework from Scratch (Mini React/Vue)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Industrial Capstone Projects, Testing & Interview Mastery",
