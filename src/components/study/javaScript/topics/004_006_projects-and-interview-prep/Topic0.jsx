...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Designing &amp; Planning Capstone JavaScript Projects (Architecture &amp; SPAs) · Architecture &amp; Execution Pipeline</text>
