...
export default function Topic9() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">JavaScript Security Hardening: XSS, CSRF, CSP &amp; Prototype Pollution Defenses · Architecture &amp; Execution Pipeline</text>
