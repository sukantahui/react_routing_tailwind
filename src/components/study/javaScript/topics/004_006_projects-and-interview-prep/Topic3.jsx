...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Writing Unit Tests for Pure JavaScript Functions from Scratch · Architecture &amp; Execution Pipeline</text>
