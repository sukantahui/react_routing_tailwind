...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Testing Architecture: Unit, Integration &amp; End-to-End Testing Concepts · Architecture &amp; Execution Pipeline</text>
