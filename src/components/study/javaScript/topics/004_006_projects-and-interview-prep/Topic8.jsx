...
export default function Topic8() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Building a Full-Featured Reactive UI Framework from Scratch (Mini React/Vue) · Architecture &amp; Execution Pipeline</text>
