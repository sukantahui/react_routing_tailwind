    ...
    return (
      <div className="space-y-6">
        <h2 className="text-xl font-semibold">
          Topic 16 – Looping arrays of objects using map, filter, reduce
        </h2>

        <EditableCodeBlock
          language="javascript"
          initialCode={`// Example 1: map – get list of student names
const students = [
...
console.log(names);`}
        ...
        <EditableCodeBlock
          language="javascript"
          initialCode={`// Example 2: filter – students scoring 90+
const students = [
...
console.log(toppers);`}
        ...
        <EditableCodeBlock
          language="javascript"
          initialCode={`// Example 3: reduce – total and average marks
const results = [
...
console.log("Average:", average);`}
        ...
        <EditableCodeBlock
          language="javascript"
          initialCode={`// Example 4: chain filter + map
const batches = [
