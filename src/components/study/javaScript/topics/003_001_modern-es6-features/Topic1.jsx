...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Template Literals, Multi-line Strings &amp; Tagged Templates · Architecture &amp; Execution Pipeline</text>
