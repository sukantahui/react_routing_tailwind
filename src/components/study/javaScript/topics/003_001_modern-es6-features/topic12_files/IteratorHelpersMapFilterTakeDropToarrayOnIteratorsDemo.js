...
// Topic: Iterator Helpers (map, filter, take, drop, toArray on Iterators)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Iterator Helpers (map, filter, take, drop, toArray on Iterators)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Modern JavaScript (ES6 through ES2026+ Essentials)",
