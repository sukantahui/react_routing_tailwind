...
// Topic: TC39 Stage 3/4 Proposals: Temporal API for Modern Date/Time
...
console.log("Demonstrating foundational mechanics for: TC39 Stage 3/4 Proposals: Temporal API for Modern Date/Time");
console.log("");
