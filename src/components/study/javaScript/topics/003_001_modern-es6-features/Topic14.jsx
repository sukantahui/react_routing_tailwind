...
import projectsData from "./topic14_files/js-es6-features-projects.json";

export default function PracticalProjectsPage() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    const modules = import.meta.glob("./topic14_files/answers/*.js", { query: "?raw", import: "default", eager: true });
    const fileMap = {};
