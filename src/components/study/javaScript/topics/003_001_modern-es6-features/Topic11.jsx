...
export default function Topic11() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">JavaScript Decorators (@decorator) &amp; Metadata Reflection · Architecture &amp; Execution Pipeline</text>
