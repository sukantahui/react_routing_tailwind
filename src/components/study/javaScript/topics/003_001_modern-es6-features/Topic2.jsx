...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Destructuring in JavaScript (Arrays, Objects &amp; Nested Aliasing) · Architecture &amp; Execution Pipeline</text>
