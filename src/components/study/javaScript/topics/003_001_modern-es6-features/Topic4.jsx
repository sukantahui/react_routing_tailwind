...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Enhanced Object Literals, Method Shorthands &amp; Computed Keys · Architecture &amp; Execution Pipeline</text>
