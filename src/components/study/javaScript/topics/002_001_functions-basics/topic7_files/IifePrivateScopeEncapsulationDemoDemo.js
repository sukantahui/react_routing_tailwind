/**
 * Topic 7 Demo: IIFE (Immediately Invoked Function Expressions) & Private Scope Encapsulation
 * Module: 002_001_functions-basics
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 7: IIFE (IMMEDIATELY INVOKED FUNCTION EXPRESSIONS) & PRIVATE SCOPE ENCAPSULATION");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior and syntax invariants for: IIFE (Immediately Invoked Function Expressions) & Private Scope Encapsulation");
...
console.log("4. Real-World Domain Application:");
{
  const enterpriseState = {
    service: "IifePrivateScopeEncapsulationDemo",
