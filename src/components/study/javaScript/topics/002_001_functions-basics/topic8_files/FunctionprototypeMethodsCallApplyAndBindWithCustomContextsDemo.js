...
// Topic: Function.prototype Methods: call(), apply(), and bind() with Custom Contexts
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Function.prototype Methods: call(), apply(), and bind() with Custom Contexts");
console.log("");
