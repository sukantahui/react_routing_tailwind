...
// Topic: IIFE (Immediately Invoked Function Expressions) & Closure Scopes
...
console.log("Demonstrating foundational mechanics for: IIFE (Immediately Invoked Function Expressions) & Closure Scopes");
console.log("");
