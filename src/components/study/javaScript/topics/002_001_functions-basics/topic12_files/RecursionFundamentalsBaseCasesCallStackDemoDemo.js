/**
 * Topic 12 Demo: Recursion Fundamentals, Base Cases & Call Stack Overflow Invariants
 * Module: 002_001_functions-basics
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 12: RECURSION FUNDAMENTALS, BASE CASES & CALL STACK OVERFLOW INVARIANTS");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior and syntax invariants for: Recursion Fundamentals, Base Cases & Call Stack Overflow Invariants");
...
console.log("4. Real-World Domain Application:");
{
  const enterpriseState = {
    service: "RecursionFundamentalsBaseCasesCallStackDemo",
...
{
  function findKeys(obj, prefix = "", result = []) {
