/**
 * Topic 0 Demo: Function Declarations vs Function Expressions: Hoisting & Syntax Invariants
 * Module: 002_001_functions-basics
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 0: FUNCTION DECLARATIONS VS FUNCTION EXPRESSIONS: HOISTING & SYNTAX INVARIANTS");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior and syntax invariants for: Function Declarations vs Function Expressions: Hoisting & Syntax Invariants");
...
console.log("4. Real-World Domain Application:");
{
  const enterpriseState = {
    service: "FunctionDeclarationsVsExpressionsHoistingDemo",
...
// typeof fact is "undefined" in outer scope
}
