...
import projectsData from "./topic16_files/js-functions-projects.json";

export default function PracticalProjectsPage() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    const modules = import.meta.glob("./topic16_files/answers/*.js", { query: "?raw", import: "default", eager: true });
    const fileMap = {};
