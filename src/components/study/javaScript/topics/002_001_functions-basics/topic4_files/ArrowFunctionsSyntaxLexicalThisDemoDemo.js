/**
 * Topic 4 Demo: Arrow Functions: Syntax, Lexical this Binding & Implicit Returns
 * Module: 002_001_functions-basics
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 4: ARROW FUNCTIONS: SYNTAX, LEXICAL THIS BINDING & IMPLICIT RETURNS");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior and syntax invariants for: Arrow Functions: Syntax, Lexical this Binding & Implicit Returns");
...
console.log("4. Real-World Domain Application:");
{
  const enterpriseState = {
    service: "ArrowFunctionsSyntaxLexicalThisDemo",
...
console.log(detached()); // 1 (no need for .bind())
}
