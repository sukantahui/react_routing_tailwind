...
import demoCode from "./topic0_files/FunctionDeclarationsVsExpressionsHoistingDemoDemo.js?raw";
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 002_001_functions-basics · Topic 0</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            {"Master the fundamental distinctions between function declarations and function expressions in JavaScript, including V8 hoisting mechanics, lexical binding, and anonymous vs named function expressions."}
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              {"Master the fundamental distinctions between function declarations and function expressions in JavaScript, including V8 hoisting mechanics, lexical binding, and anonymous vs named function expressions."} In modern software engineering, mastering this feature allows developers to write decoupled, resilient, and highly performant JavaScript applications across Node.js runtimes and client browsers.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                {"Swadeep tried to invoke a function expression stored in a `const` before its assignment line and was puzzled by the `ReferenceError: Cannot access 'calc' before initialization`."}
              </p>
              <p>
                {"Sukanta Hui demonstrated how function declarations are hoisted completely into the Variable Environment during the Creation Phase, while function expressions obey let/const Temporal Dead Zone (TDZ) rules."}
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            ...
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 800 240" className="w-full h-auto" role="img" aria-label={"Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}>
                <defs>
                ...
                <text x="400" y="30" fill="#f8fafc" fontSize="14" fontWeight="bold" textAnchor="middle">{"Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"} · Architecture &amp; State Transitions</text>
                ...
                <text x="140" y="135" fill="#fef3c7" fontSize="11" textAnchor="middle">{"Creation Phase: Lexical Environment"}</text>
                ...
                <text x="400" y="135" fill="#e0f2fe" fontSize="11" textAnchor="middle">{"Hoisting Registry (Top of Scope)"}</text>
                ...
                <text x="660" y="135" fill="#d1fae5" fontSize="11" textAnchor="middle">{"Execution Phase: Call Stack Evaluation"}</text>
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure: Step-by-step architectural execution and state transitions for {"Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
              The ECMAScript specification mandates precise abstract operations during the lifecycle of {"Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}. The table below outlines formal specification rules, engine runtime dynamics, and actionable developer invariants.
            </p>
              ...
              <table className="w-full text-left text-sm text-slate-300 border-collapse border border-slate-800">
                ...
                <tbody className="divide-y divide-slate-800 font-mono text-xs">
                  ...
                  <tr className="hover:bg-slate-800/30">
                    <td className="p-3 text-sky-400">{"Function Declaration"}</td>
                    <td className="p-3 text-slate-300 font-sans">{"Hoisted with definition body attached"}</td>
                    <td className="p-3 text-amber-300 font-sans">{"Stored in VariableEnvironment before code runs"}</td>
                    <td className="p-3 text-emerald-400 font-sans">{"Top-level module exports & general utility declarations"}</td>
                  </tr>
                  <tr className="hover:bg-slate-800/30">
                    <td className="p-3 text-sky-400">{"Function Expression"}</td>
                    <td className="p-3 text-slate-300 font-sans">{"Evaluated as assignment expression"}</td>
                    <td className="p-3 text-amber-300 font-sans">{"Variable hoisted uninitialized (TDZ) or as undefined (var)"}</td>
                    <td className="p-3 text-emerald-400 font-sans">{"Conditional function assignments & higher-order callbacks"}</td>
                  </tr>
                  <tr className="hover:bg-slate-800/30">
                    <td className="p-3 text-sky-400">{"Named Function Expr (NFE)"}</td>
                    <td className="p-3 text-slate-300 font-sans">{"Name identifier bound only inside function body"}</td>
                    <td className="p-3 text-amber-300 font-sans">{"Local scope immutable binding for recursion"}</td>
                    <td className="p-3 text-emerald-400 font-sans">{"Self-referencing recursion and stack trace debugging"}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mt-6 p-5 rounded-xl bg-slate-900/80 border border-rose-900/40 space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm text-slate-300 leading-relaxed">
                <li><strong className="text-rose-300">{"ReferenceError (TDZ):"}</strong> {"Calling a `const` or `let` function expression before its declaration line."}</li>
                <li><strong className="text-rose-300">{"TypeError (var invocation):"}</strong> {"Invoking a `var` function expression before initialization produces `TypeError: fn is not a function` because var holds `undefined`."}</li>
                <li><strong className="text-rose-300">{"Block Scope Hoisting Quirks:"}</strong> {"In non-strict mode, function declarations inside if blocks have browser-dependent hoisting behaviors; in strict mode they are block-scoped."}</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="FunctionDeclarationsVsExpressionsHoistingDemoDemo.js"
            />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-rose-950/20 border border-rose-800/40 rounded-2xl p-6 shadow-lg space-y-3">
              <div className="flex items-center gap-2 text-rose-400 font-bold">
                <span>❌</span>
                <span>Anti-Pattern: {"Invoking var/let Function Expressions Before Declaration"}</span>
              </div>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                {"Assuming function expressions are hoisted like declarations causes runtime crashes."}
              </p>
              <pre className="p-4 rounded-xl bg-slate-950 border border-rose-900/50 text-xs font-mono text-rose-300 overflow-x-auto">
{"// ❌ AVOID: Crashes at runtime\ncalculateTotal(); // TypeError: calculateTotal is not a function (if var) or ReferenceError (if const)\nconst calculateTotal = () => 100;"}
              </pre>
            </div>
            ...
            <div className="bg-emerald-950/20 border border-emerald-800/40 rounded-2xl p-6 shadow-lg space-y-3">
              <div className="flex items-center gap-2 text-emerald-400 font-bold">
                <span>✓</span>
                <span>Senior Pro Practice: {"Use Explicit Declaration Order & Named Function Expressions"}</span>
              </div>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                {"Always define function expressions before use or leverage declarations for hoisting."}
              </p>
...
{"// ✓ RECOMMENDED: Explicit and predictable\nconst calculateTotal = function calculateInvoiceTotal(base, taxRate = 0.18) {\n  return base + (base * taxRate);\n};\nconsole.log(calculateTotal(1000)); // 1180"}
              </pre>
            </div>
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  {"Named Function Expression (NFE) Scope Immutability & Stack Traces"}
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              {"When defining a Named Function Expression `const f = function helper() {}`, the name `helper` is bound as an immutable identifier available ONLY inside the function's own body, preventing external pollution while providing clean stack traces."}
            </p>

            <div className="rounded-xl border border-amber-900/50 bg-slate-950 p-4 font-mono text-xs text-amber-200 overflow-x-auto">
              <pre>{"const factorial = function fact(n) {\n  if (n <= 1) return 1;\n  // 'fact' is locally immutable inside its body\n  return n * fact(n - 1);\n};\nconsole.log(factorial(5)); // 120\n// typeof fact is \"undefined\" in outer scope"}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-indigo-950/20 border border-indigo-800/40 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed mb-4">
              {"What happens if you reassign the inner name of a Named Function Expression inside its own body (e.g. `fact = 100; return fact;`) in strict vs non-strict mode?"}
            </p>
            <div className="p-4 rounded-xl bg-slate-900 border border-indigo-900/50 text-xs sm:text-sm text-indigo-300 font-mono">
              💡 Hint: {"Named Function Expression identifiers are read-only bindings in the function's Declarative Environment Record."}
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Function Declarations vs Function Expressions: Hoisting & Syntax Invariants"}
            downloadFileName="002-001-topic0-note.txt"
          />
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <Teacher
            note={"In my 27+ years of mentoring software engineers at Coder & AccoTax in Barrackpore, I have consistently seen that mastering " + "Function Declarations vs Function Expressions: Hoisting & Syntax Invariants" + " separates code monkeys from genuine software engineers. " + "In modern JavaScript architecture, choosing between declarations and expressions isn't just about syntax—it dictates how the V8 engine builds the lexical environment and how stack traces appear in production monitoring."}
          />
        </section>
