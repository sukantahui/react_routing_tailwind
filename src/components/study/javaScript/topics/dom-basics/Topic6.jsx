...
import projectsData from "./topic6_files/js-dom-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic6_files/answers/*.js", { query: "?raw", import: "default", eager: true });
