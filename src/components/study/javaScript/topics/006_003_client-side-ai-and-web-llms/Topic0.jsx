...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Machine Learning in JavaScript: Tensors, Matrix Multiplication &amp; Math Kernels · Architecture &amp; Execution Pipeline</text>
