...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Transformers.js: Running Hugging Face Models Directly in the Browser · Architecture &amp; Execution Pipeline</text>
