...
// Topic: Machine Learning in JavaScript: Tensors, Matrix Multiplication & Math Kernels
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Machine Learning in JavaScript: Tensors, Matrix Multiplication & Math Kernels");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Client-Side AI, Neural Networks & Local Web LLMs",
