...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Structural Design Patterns: Adapter, Decorator &amp; Facade · Architecture &amp; Execution Pipeline</text>
