...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">State Management Fundamentals without External Libraries · Architecture &amp; Execution Pipeline</text>
