...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Structuring Scalable Frontend Applications &amp; Directory Topologies · Architecture &amp; Execution Pipeline</text>
