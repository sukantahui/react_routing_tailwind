...
// Topic: Model-View-Intent (MVI) & Unidirectional Data Flow (Redux/Flux pattern from scratch)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Model-View-Intent (MVI) & Unidirectional Data Flow (Redux/Flux pattern from scratch)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Design Patterns & Software Architecture in JavaScript",
