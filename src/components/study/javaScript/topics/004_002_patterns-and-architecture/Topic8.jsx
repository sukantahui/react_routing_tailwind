...
export default function Topic8() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Model-View-Intent (MVI) &amp; Unidirectional Data Flow (Redux/Flux pattern from scratch) · Architecture &amp; Execution Pipeline</text>
