...
// Topic: Explicit Type Conversion (Number, String, Boolean) vs Implicit Coercion Rules
...
console.log("Demonstrating foundational mechanics for: Explicit Type Conversion (Number, String, Boolean) vs Implicit Coercion Rules");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "JavaScript Syntax, Variables & Data Types",
