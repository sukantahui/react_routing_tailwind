...
import demoCode from "./topic4_files/LiteralsDataTypesInJavascriptDemo.js?raw";

/**
 * Topic4 – Literals & Data Types in JavaScript
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_002_javascript-syntax-and-basics · Topic 4</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Understand the 7 primitive data types, composite object types, and literal declaration syntaxes in modern ECMAScript.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">Literals & Types</strong> provides the rock-solid foundation necessary for advanced JavaScript and TypeScript development. In high-scale web applications, subtle syntax nuances, type coercions, and lexical scoping rules dictate how the V8 engine allocates memory and compiles bytecode.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an interactive lab session, student <strong>Debangshu</strong> encountered unexpected runtime behavior. Debangshu confused primitive value copy with object reference copying, assuming obj2 = obj1 cloned the object. Sukanta Hui traced memory addresses on the board showing Call Stack value copies vs Heap pointer references.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the step-by-step memory allocation on the whiteboard, showing how mastering <em>Literals & Types</em> guarantees deterministic code execution.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> 7 Primitives (Call Stack) vs Object Structures (Memory Heap)
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Literals & Data Types in JavaScript Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  7 Primitives (Call Stack) vs Object Structures (Memory Heap)
                </text>
                
                <g transform="translate(40, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">7 Primitive Types (Stack Memory / Value Copy)</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="68" fill="#e2e8f0" fontSize="10">• <strong class="text-sky-300">number</strong>: 42, 3.14159, NaN, Infinity</text>
                  <text x="35" y="86" fill="#e2e8f0" fontSize="10">• <strong class="text-sky-300">string</strong>: 'hello', "world", `template`</text>
                  <text x="35" y="104" fill="#e2e8f0" fontSize="10">• <strong class="text-sky-300">boolean</strong>: true, false | <strong class="text-sky-300">undefined</strong> | <strong class="text-sky-300">null</strong></text>
                  <text x="35" y="122" fill="#e2e8f0" fontSize="10">• <strong class="text-sky-300">symbol</strong>: Symbol('id') (Unique)</text>
                  <text x="35" y="140" fill="#e2e8f0" fontSize="10">• <strong class="text-sky-300">bigint</strong>: 9007199254740991n (Arbitrary)</text>
                </g>

                <g transform="translate(440, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#a855f7" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#c084fc" fontSize="13" fontWeight="bold" textAnchor="middle">Composite Object Types (Heap Memory / Pointer Reference)</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="68" fill="#e2e8f0" fontSize="10">• <strong class="text-purple-300">Object</strong>: &#123; name: "Swadeep", score: 98 &#125;</text>
                  <text x="35" y="90" fill="#e2e8f0" fontSize="10">• <strong class="text-purple-300">Array</strong>: [10, 20, 30] (Specialized Object)</text>
                  <text x="35" y="112" fill="#e2e8f0" fontSize="10">• <strong class="text-purple-300">Function</strong>: First-Class Callable Object</text>
                  <text x="35" y="134" fill="#e2e8f0" fontSize="10">• <strong class="text-purple-300">Map / Set / Date / RegExp / Error</strong></text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 4.1: Runtime execution pipeline, memory layout, and engine rules for Literals &amp; Types.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="LiteralsAndDataTypesDemo.js"
            />
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-gradient-to-br from-amber-950/30 via-slate-900 to-purple-950/20 border border-amber-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Modern JavaScript (ES2021) supports numeric separators (_) in number literals to improve readability without affecting numerical value.
            </p>
...
console.log(salary === 1500000); // true`}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Literals & Types"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Literals & Types"}
            downloadFileName="001_002_javascript-syntax-and-basics-topic4-note.txt"
          />
        </section>
