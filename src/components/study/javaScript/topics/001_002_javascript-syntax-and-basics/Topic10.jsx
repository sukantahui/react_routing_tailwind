...
import demoCode from "./topic10_files/ObjectisVsStrictAndLooseEqualityDemo.js?raw";

/**
 * Topic10 – Object.is() vs Strict (===) and Loose (==) Equality
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_002_javascript-syntax-and-basics · Topic 10</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Object.is() vs Strict (===) and Loose (==) Equality"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master ECMAScript SameValue algorithm, SameValueZero used by Map/Set, strict identity (===), and loose coercion (==).
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">Equality: Object.is vs === vs ==</strong> provides the rock-solid foundation necessary for advanced JavaScript and TypeScript development. In high-scale web applications, subtle syntax nuances, type coercions, and lexical scoping rules dictate how the V8 engine allocates memory and compiles bytecode.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an interactive lab session, student <strong>Swadeep</strong> encountered unexpected runtime behavior. Swadeep tried to check if a computed value was NaN using val === NaN. In JavaScript, NaN === NaN is false! Sukanta Hui explained why Object.is(val, NaN) and Number.isNaN(val) are the only reliable ways to detect NaN.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the step-by-step memory allocation on the whiteboard, showing how mastering <em>Equality: Object.is vs === vs ==</em> guarantees deterministic code execution.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Equality Algorithm Comparison: Object.is() vs === vs ==
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Object.is() vs Strict (===) and Loose (==) Equality Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Equality Algorithm Comparison: Object.is() vs === vs ==
                </text>
                
                <g transform="translate(40, 50)">
                  <rect width="760" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="380" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">JavaScript Equality Comparison Matrix</text>
                  
                  {/* Table Headers */}
                  <rect x="20" y="45" width="720" height="30" fill="#0f172a" rx="4" />
                  <text x="120" y="65" fill="#94a3b8" fontSize="11" fontWeight="bold" textAnchor="middle">Comparison Expression</text>
                  <text x="300" y="65" fill="#f59e0b" fontSize="11" fontWeight="bold" textAnchor="middle">Loose (==)</text>
                  <text x="480" y="65" fill="#10b981" fontSize="11" fontWeight="bold" textAnchor="middle">Strict (===)</text>
                  <text x="640" y="65" fill="#38bdf8" fontSize="11" fontWeight="bold" textAnchor="middle">Object.is() [SameValue]</text>

                  {/* Row 1: NaN */}
                  <text x="120" y="98" fill="#e2e8f0" fontSize="11" fontFamily="monospace" textAnchor="middle">NaN with NaN</text>
                  <text x="300" y="98" fill="#f87171" fontSize="11" textAnchor="middle">false</text>
                  <text x="480" y="98" fill="#f87171" fontSize="11" textAnchor="middle">false</text>
                  <text x="640" y="98" fill="#34d399" fontSize="11" fontWeight="bold" textAnchor="middle">true ✓</text>

                  {/* Row 2: -0 and +0 */}
                  <text x="120" y="125" fill="#e2e8f0" fontSize="11" fontFamily="monospace" textAnchor="middle">-0 with +0</text>
                  <text x="300" y="125" fill="#34d399" fontSize="11" textAnchor="middle">true</text>
                  <text x="480" y="125" fill="#34d399" fontSize="11" textAnchor="middle">true</text>
                  <text x="640" y="125" fill="#f87171" fontSize="11" fontWeight="bold" textAnchor="middle">false (Distinguishes sign!)</text>

                  {/* Row 3: '0' and false */}
                  <text x="120" y="152" fill="#e2e8f0" fontSize="11" fontFamily="monospace" textAnchor="middle">'0' with false</text>
                  <text x="300" y="152" fill="#f87171" fontSize="11" textAnchor="middle">true (Coerces)</text>
                  <text x="480" y="152" fill="#34d399" fontSize="11" textAnchor="middle">false ✓</text>
                  <text x="640" y="152" fill="#34d399" fontSize="11" textAnchor="middle">false ✓</text>

                  {/* Row 4: null and undefined */}
                  <text x="120" y="178" fill="#e2e8f0" fontSize="11" fontFamily="monospace" textAnchor="middle">null with undefined</text>
                  <text x="300" y="178" fill="#f59e0b" fontSize="11" textAnchor="middle">true</text>
                  <text x="480" y="178" fill="#34d399" fontSize="11" textAnchor="middle">false ✓</text>
                  <text x="640" y="178" fill="#34d399" fontSize="11" textAnchor="middle">false ✓</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 10.1: Runtime execution pipeline, memory layout, and engine rules for Equality: Object.is vs === vs ==.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="ObjectIsVsStrictLooseEqualityDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  React's use of Object.is() for State Re-renders
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              React uses Object.is() (via ObjectIs polyfill) inside useState and useMemo to determine if state has changed and if a component re-render is required.
            </p>
...
if (!Object.is(prevState, nextState)) {
  scheduleRender();
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Equality: Object.is vs === vs =="}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Equality: Object.is vs === vs =="}
            downloadFileName="001_002_javascript-syntax-and-basics-topic10-note.txt"
          />
        </section>
