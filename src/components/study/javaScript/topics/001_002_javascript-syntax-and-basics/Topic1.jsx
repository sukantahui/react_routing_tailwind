...
import demoCode from "./topic1_files/CommentsInJavascriptDemo.js?raw";

/**
 * Topic1 – Comments in JavaScript & JSDoc Standards
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_002_javascript-syntax-and-basics · Topic 1</span>
          </div>
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Comments in JavaScript & JSDoc Standards"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Understand single-line, multi-line, and enterprise JSDoc documentation standards processed by TypeScript and IDE language servers.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">Comments & JSDoc</strong> provides the rock-solid foundation necessary for advanced JavaScript and TypeScript development. In high-scale web applications, subtle syntax nuances, type coercions, and lexical scoping rules dictate how the V8 engine allocates memory and compiles bytecode.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an interactive lab session, student <strong>Tuhina</strong> encountered unexpected runtime behavior. Tuhina documented an API function with regular multi-line comments. When Swadeep called it, VS Code provided no autocomplete types or parameter hints. Sukanta Hui showed how standard JSDoc (@param, @returns) powers full TypeScript intellisense in vanilla JS.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the step-by-step memory allocation on the whiteboard, showing how mastering <em>Comments & JSDoc</em> guarantees deterministic code execution.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Lexer Comment Stripping & JSDoc AST Pipeline
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Comments in JavaScript & JSDoc Standards Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Lexer Comment Stripping & JSDoc AST Pipeline
                </text>
                
                <g transform="translate(40, 60)">
                  <rect width="210" height="100" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="105" y="26" fill="#38bdf8" fontSize="12" fontWeight="bold" textAnchor="middle">1. Source Code</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#7dd3fc" fontSize="10" textAnchor="middle">// Single &amp; /* Multi */</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">/** JSDoc Comments */</text>
                </g>
                ...
                <g transform="translate(325, 60)">
                  ...
                  <text x="105" y="26" fill="#fbbf24" fontSize="12" fontWeight="bold" textAnchor="middle">2. Lexical Scanner</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#fde68a" fontSize="10" textAnchor="middle">Strips Whitespace &amp; Notes</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Zero runtime byte footprint</text>
                </g>
                ...
                <g transform="translate(610, 60)">
                  ...
                  <text x="95" y="26" fill="#34d399" fontSize="12" fontWeight="bold" textAnchor="middle">3. Language Server (LSP)</text>
                  <rect x="15" y="40" width="160" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="95" y="58" fill="#a7f3d0" fontSize="10" textAnchor="middle">JSDoc Type Checking</text>
                  <text x="95" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Powers IDE Autocomplete</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 1.1: Runtime execution pipeline, memory layout, and engine rules for Comments &amp; JSDoc.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="CommentsInJavaScriptDemo.js"
            />
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-gradient-to-br from-amber-950/30 via-slate-900 to-purple-950/20 border border-amber-500/30 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              You can enable full static TypeScript type-checking inside vanilla JavaScript files without a compiler by adding // @ts-check at the very first line of your .js file.
            </p>
...
// add('1', 2); -&gt; VS Code flags red type error!`}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Comments & JSDoc"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Comments & JSDoc"}
            downloadFileName="001_002_javascript-syntax-and-basics-topic1-note.txt"
          />
        </section>
