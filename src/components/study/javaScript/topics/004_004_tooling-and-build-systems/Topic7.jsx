...
export default function Topic7() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Monorepos, pnpm Workspaces &amp; JavaScript Package Publishing (npm/jsr) · Architecture &amp; Execution Pipeline</text>
