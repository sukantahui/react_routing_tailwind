...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">package.json, Scripts &amp; Semantic Versioning (SemVer) Architecture · Architecture &amp; Execution Pipeline</text>
