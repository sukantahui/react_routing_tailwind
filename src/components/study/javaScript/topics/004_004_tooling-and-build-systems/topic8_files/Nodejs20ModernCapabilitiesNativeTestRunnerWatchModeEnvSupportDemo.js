...
// Topic: Node.js 20+ Modern Capabilities: Native Test Runner, Watch Mode & .env support
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Node.js 20+ Modern Capabilities: Native Test Runner, Watch Mode & .env support");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Modern JavaScript Tooling, Bundlers & Build Systems",
