...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Automating Developer Workflows with npm scripts &amp; Cross-Env · Architecture &amp; Execution Pipeline</text>
