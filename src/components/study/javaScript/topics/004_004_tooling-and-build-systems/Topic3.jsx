...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Modern Bundlers: How Vite, Webpack, Rollup &amp; ESBuild Work · Architecture &amp; Execution Pipeline</text>
