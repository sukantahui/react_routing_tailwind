...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">TypeScript Foundations: Type Annotations, Interfaces, Generics &amp; tsconfig · Architecture &amp; Execution Pipeline</text>
