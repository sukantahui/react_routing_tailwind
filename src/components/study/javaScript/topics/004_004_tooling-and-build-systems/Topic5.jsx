...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Code Quality Pipelines: ESLint, Prettier &amp; Git Pre-Commit Hooks · Architecture &amp; Execution Pipeline</text>
