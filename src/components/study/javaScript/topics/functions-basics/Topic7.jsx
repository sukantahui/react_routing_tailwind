...
import projectsData from "./topic7_files/js-function-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic7_files/answers/*.js", { as: "raw", eager: true });
