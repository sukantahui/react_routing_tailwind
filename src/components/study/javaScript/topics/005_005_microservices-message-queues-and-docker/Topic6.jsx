...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Distributed Tracing &amp; Observability with OpenTelemetry and Structured Logging · Architecture &amp; Execution Pipeline</text>
