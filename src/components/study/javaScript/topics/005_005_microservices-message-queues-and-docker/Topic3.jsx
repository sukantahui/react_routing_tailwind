...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Implementing Idempotent Consumers, Dead Letter Queues (DLQ) &amp; Retry Policies · Architecture &amp; Execution Pipeline</text>
