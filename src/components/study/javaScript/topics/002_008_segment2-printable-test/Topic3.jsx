...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Comprehensive Mid-Term Certification Examination · Architecture &amp; Execution Pipeline</text>
