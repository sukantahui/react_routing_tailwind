...
// Topic: Introduction to WebGPU: Adapters, Devices & Modern Graphics Pipelines
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Introduction to WebGPU: Adapters, Devices & Modern Graphics Pipelines");
console.log("");
