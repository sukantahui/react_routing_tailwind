...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">HTTP Basics: Request Methods (GET, POST, PUT, DELETE) &amp; Status Codes · Architecture &amp; Execution Pipeline</text>
