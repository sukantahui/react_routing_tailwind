...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Parsing &amp; Stringifying JSON: Advanced Replacers &amp; Revivers · Architecture &amp; Execution Pipeline</text>
