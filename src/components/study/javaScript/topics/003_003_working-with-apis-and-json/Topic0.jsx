...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">What is JSON? Syntax, Data Types &amp; Relational Serialization · Architecture &amp; Execution Pipeline</text>
