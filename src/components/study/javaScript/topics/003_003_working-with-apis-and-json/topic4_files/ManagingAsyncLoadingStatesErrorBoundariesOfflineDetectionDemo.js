...
// Topic: Managing Async Loading States, Error Boundaries & Offline Detection
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Managing Async Loading States, Error Boundaries & Offline Detection");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Working with REST APIs, JSON & HTTP Requests",
