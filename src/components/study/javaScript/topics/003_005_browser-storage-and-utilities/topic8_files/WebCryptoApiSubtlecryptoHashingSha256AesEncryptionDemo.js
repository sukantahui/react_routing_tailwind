...
// Topic: Web Crypto API: SubtleCrypto, Hashing (SHA-256) & AES Encryption
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Web Crypto API: SubtleCrypto, Hashing (SHA-256) & AES Encryption");
console.log("");
