...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">The Date Object: Timestamps, Calculations, Parsing &amp; UTC Timezones · Architecture &amp; Execution Pipeline</text>
