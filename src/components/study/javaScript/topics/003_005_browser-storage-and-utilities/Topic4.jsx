...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Browser Timers &amp; Animation: setTimeout, setInterval vs requestAnimationFrame · Architecture &amp; Execution Pipeline</text>
