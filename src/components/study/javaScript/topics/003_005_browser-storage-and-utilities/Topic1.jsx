...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Storing Complex Data &amp; Objects: Type-Safe JSON Storage Wrappers · Architecture &amp; Execution Pipeline</text>
