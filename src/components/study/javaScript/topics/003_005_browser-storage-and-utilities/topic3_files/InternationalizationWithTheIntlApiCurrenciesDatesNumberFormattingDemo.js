...
// Topic: Internationalization with the Intl API: Currencies, Dates & Number Formatting
...
console.log("Demonstrating foundational mechanics for: Internationalization with the Intl API: Currencies, Dates & Number Formatting");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Browser Storage, Date/Time & Essential Web APIs",
