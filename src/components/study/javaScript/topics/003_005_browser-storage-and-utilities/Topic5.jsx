...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">IndexedDB &amp; Modern IDB Key-Value Databases (idb / Dexie patterns) · Architecture &amp; Execution Pipeline</text>
