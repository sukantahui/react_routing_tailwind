...
// Topic: Creating, Appending & Removing Elements in the DOM
...
console.log("Demonstrating foundational mechanics for: Creating, Appending & Removing Elements in the DOM");
console.log("");
