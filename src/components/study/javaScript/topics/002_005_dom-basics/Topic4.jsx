...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Working with Attributes, Classes &amp; data-* Attributes · Architecture &amp; Execution Pipeline</text>
