...
// Topic: High Performance HTML Injections with insertAdjacentHTML() and insertAdjacentElement()
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: High Performance HTML Injections with insertAdjacentHTML() and insertAdjacentElement()");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "DOM (Document Object Model) Fundamentals",
