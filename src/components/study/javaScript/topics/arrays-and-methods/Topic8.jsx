...
import projectsData from "./topic8_files/js-array-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic8_files/answers/*.js", { as: "raw", eager: true });
