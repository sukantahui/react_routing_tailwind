...
// Topic: V8 Hidden Classes, Shapes, Transitions & Inline Caching (IC)
...
console.log("Demonstrating foundational mechanics for: V8 Hidden Classes, Shapes, Transitions & Inline Caching (IC)");
console.log("");
