...
// Topic: Small Integers (SMI) vs HeapNumbers & Pointer Tagging
...
console.log("Demonstrating foundational mechanics for: Small Integers (SMI) vs HeapNumbers & Pointer Tagging");
console.log("");
