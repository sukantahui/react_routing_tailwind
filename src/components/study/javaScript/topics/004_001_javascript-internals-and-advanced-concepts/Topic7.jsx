...
export default function Topic7() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Small Integers (SMI) vs HeapNumbers &amp; Pointer Tagging · Architecture &amp; Execution Pipeline</text>
