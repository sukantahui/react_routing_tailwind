...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Memory Management: Heap, Stack, Mark-and-Sweep &amp; Memory Leaks · Architecture &amp; Execution Pipeline</text>
