...
// Topic: Garbage Collection Internals: Orinoco, Scavenger (Young Gen) & Mark-Sweep (Old Gen)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Garbage Collection Internals: Orinoco, Scavenger (Young Gen) & Mark-Sweep (Old Gen)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "JavaScript Internals, V8 Engine Architecture & Execution Contexts",
