...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">The this Keyword in Depth: Default, Implicit, Explicit &amp; Arrow Binding · Architecture &amp; Execution Pipeline</text>
