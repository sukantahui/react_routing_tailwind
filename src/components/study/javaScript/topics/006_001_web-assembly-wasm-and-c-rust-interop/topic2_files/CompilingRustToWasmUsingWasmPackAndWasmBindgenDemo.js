...
// Topic: Compiling Rust to WASM using wasm-pack and wasm-bindgen
...
console.log("Demonstrating foundational mechanics for: Compiling Rust to WASM using wasm-pack and wasm-bindgen");
console.log("");
