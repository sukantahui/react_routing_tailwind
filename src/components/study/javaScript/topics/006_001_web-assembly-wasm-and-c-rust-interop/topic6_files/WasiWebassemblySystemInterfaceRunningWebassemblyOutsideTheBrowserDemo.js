...
// Topic: WASI (WebAssembly System Interface): Running WebAssembly Outside the Browser
...
console.log("Demonstrating foundational mechanics for: WASI (WebAssembly System Interface): Running WebAssembly Outside the Browser");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "WebAssembly (WASM): High-Performance C/Rust Browser Interop",
