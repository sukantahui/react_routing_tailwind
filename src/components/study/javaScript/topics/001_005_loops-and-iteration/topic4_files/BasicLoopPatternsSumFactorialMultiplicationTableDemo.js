...
// Topic: Basic Loop Patterns (Sum, Factorial, Multiplication Table)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Basic Loop Patterns (Sum, Factorial, Multiplication Table)");
console.log("");
