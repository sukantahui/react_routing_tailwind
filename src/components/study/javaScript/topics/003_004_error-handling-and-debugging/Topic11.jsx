...
import projectsData from "./topic11_files/js-error-handling-projects.json";

export default function PracticalProjectsPage() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    const modules = import.meta.glob("./topic11_files/answers/*.js", { query: "?raw", import: "default", eager: true });
    const fileMap = {};
