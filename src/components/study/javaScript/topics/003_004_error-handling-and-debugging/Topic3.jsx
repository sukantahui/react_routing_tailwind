...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Throwing Custom Errors &amp; Creating Custom Error Classes · Architecture &amp; Execution Pipeline</text>
