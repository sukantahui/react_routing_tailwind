...
// Topic: Error Causes (new Error('msg', { cause: err })) & Error Chaining
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Error Causes (new Error('msg', { cause: err })) & Error Chaining");
console.log("");
