...
// Topic: Console API Power Tools: console.table, group, time & trace
...
console.log("Demonstrating foundational mechanics for: Console API Power Tools: console.table, group, time & trace");
console.log("");
