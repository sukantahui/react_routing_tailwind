...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Mastering try...catch...finally Blocks &amp; Error Scope · Architecture &amp; Execution Pipeline</text>
