...
export default function Topic9() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Global Unhandled Rejection &amp; Uncaught Exception Listeners · Architecture &amp; Execution Pipeline</text>
