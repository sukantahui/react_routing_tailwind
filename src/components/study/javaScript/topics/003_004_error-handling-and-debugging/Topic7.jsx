...
export default function Topic7() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Defensive Programming Practices &amp; Production Error Monitoring · Architecture &amp; Execution Pipeline</text>
