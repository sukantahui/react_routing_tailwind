...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">The JavaScript Error Object Hierarchy: TypeError, ReferenceError &amp; SyntaxError · Architecture &amp; Execution Pipeline</text>
