...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Static Code Analysis: Linters, ESLint Rules &amp; Defensive Guards · Architecture &amp; Execution Pipeline</text>
