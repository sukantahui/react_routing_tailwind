...
// Topic: async / await Syntax & Error Handling with try / catch
...
console.log("Demonstrating foundational mechanics for: async / await Syntax & Error Handling with try / catch");
console.log("");
