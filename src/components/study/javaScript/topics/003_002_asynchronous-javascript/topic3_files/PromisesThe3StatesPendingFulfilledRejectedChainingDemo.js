...
// Topic: Promises: The 3 States (Pending, Fulfilled, Rejected) & Chaining
...
console.log("Demonstrating foundational mechanics for: Promises: The 3 States (Pending, Fulfilled, Rejected) & Chaining");
console.log("");
