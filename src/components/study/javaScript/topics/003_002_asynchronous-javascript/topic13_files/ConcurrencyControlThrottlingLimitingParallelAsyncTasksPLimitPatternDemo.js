...
// Topic: Concurrency Control: Throttling & Limiting Parallel Async Tasks (p-limit pattern)
...
console.log("Demonstrating foundational mechanics for: Concurrency Control: Throttling & Limiting Parallel Async Tasks (p-limit pattern)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Asynchronous JavaScript: Callbacks, Promises & Async/Await",
