...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Modern ORM Architecture: Type-Safe Queries with Drizzle &amp; Prisma · Architecture &amp; Execution Pipeline</text>
