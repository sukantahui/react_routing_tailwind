...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Database Migration Pipelines &amp; Automated Seed Workflows · Architecture &amp; Execution Pipeline</text>
