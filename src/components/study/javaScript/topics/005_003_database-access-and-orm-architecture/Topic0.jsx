...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Relational Database Integration: PostgreSQL Connection Pools &amp; Raw Queries · Architecture &amp; Execution Pipeline</text>
