...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Document Databases: MongoDB Aggregation Pipelines &amp; Change Streams · Architecture &amp; Execution Pipeline</text>
