...
import projectsData from "./topic0_files/js-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic0_files/answers/*.{js,html}", { query: "?raw", import: "default", eager: true, });
