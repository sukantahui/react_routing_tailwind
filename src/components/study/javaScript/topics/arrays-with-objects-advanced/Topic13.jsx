...
import JavaScriptProjectAnswerTemplate from "../../../JavaScriptProjectAnswerTemplate"; // adjust the import path as needed
import projectsData from "./topic13_files/js-array-object-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic13_files/answers/*.js", { query: "?raw", import: "default", eager: true });
