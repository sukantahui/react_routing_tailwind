...
import demoCode from "./topic4_files/RealWorldExamplesOfDecisionMakingDemo.js?raw";

/**
 * Topic4 – Real-World Examples of Decision Making in Enterprise Applications
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_004_control-flow-conditions · Topic 4</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Real-World Examples of Decision Making in Enterprise Applications"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Apply decision trees, role-based authorization matrices, and dynamic discounts in production applications.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">Real-World Decisions</strong> empowers developers to architect clear, bug-free, and high-performance control flow trees. In enterprise JavaScript applications, clean conditional logic determines how state transitions occur, how errors are guarded against, and how business rules execute.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an intensive lab test, student <strong>Swadeep</strong> encountered a subtle architectural issue. Swadeep built a tax calculation module with 15 nested if/else statements that broke when a new tax slab was added. Sukanta Hui refactored the logic into a clean table-driven Strategy Pattern.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact decision tree on the whiteboard, proving that understanding <em>Real-World Decisions</em> produces maintainable and robust production applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Enterprise Decision Matrix & Strategy Pattern Flow
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Real-World Examples of Decision Making in Enterprise Applications Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Enterprise Decision Matrix & Strategy Pattern Flow
                </text>
                
                <g transform="translate(40, 60)">
                  <rect width="210" height="100" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="105" y="26" fill="#38bdf8" fontSize="12" fontWeight="bold" textAnchor="middle">1. Request Context</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#7dd3fc" fontSize="10" textAnchor="middle">userRole, cartTotal, region</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Input parameter vector</text>
                </g>
                ...
                <g transform="translate(325, 60)">
                  ...
                  <text x="105" y="26" fill="#fbbf24" fontSize="12" fontWeight="bold" textAnchor="middle">2. Decision Strategy</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#fde68a" fontSize="10" textAnchor="middle">rulesTable[region].compute()</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">O(1) dictionary dispatch</text>
                </g>

                <path d="M 535 110 L 605 110" fill="none" stroke="#10b981" strokeWidth="2.5" />

                <g transform="translate(610, 60)">
                  <rect width="190" height="100" rx="10" fill="#1e293b" stroke="#10b981" strokeWidth="1.5" />
                  <text x="95" y="26" fill="#34d399" fontSize="12" fontWeight="bold" textAnchor="middle">3. Applied Decision</text>
                  <rect x="15" y="40" width="160" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="95" y="58" fill="#a7f3d0" fontSize="10" textAnchor="middle">Discount: 15%, Tax: 18%</text>
                  <text x="95" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Final executed business rule</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 4.1: Runtime decision branching, bytecode flow, and control architecture for Real-World Decisions.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="RealWorldDecisionMakingDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Object Lookup Tables Over Giant if/else Chains
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Replace 20 if/else branches with a plain JavaScript object mapping keys to handlers for O(1) instantaneous lookup.
            </p>
...
(actions[type] || actions.DEFAULT)();`}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Real-World Decisions"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Real-World Decisions"}
            downloadFileName="001_004_control-flow-conditions-topic4-note.txt"
          />
        </section>
