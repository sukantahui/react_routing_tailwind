...
// Topic: The switch(true) Range Evaluation & Pattern Matching Pattern
...
console.log("Demonstrating foundational mechanics for: The switch(true) Range Evaluation & Pattern Matching Pattern");
console.log("");
