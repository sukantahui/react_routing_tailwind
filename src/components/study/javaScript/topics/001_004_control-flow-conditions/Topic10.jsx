...
import demoCode from "./topic10_files/TheSwitchtrueRangeEvaluationPatternMatchingPatternDemo.js?raw";

/**
 * Topic10 – The switch(true) Range Evaluation & Pattern Matching Pattern
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_004_control-flow-conditions · Topic 10</span>
          </div>
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"The switch(true) Range Evaluation & Pattern Matching Pattern"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master the powerful switch(true) idiom for expressive range evaluations, complex multi-variable conditions, and clean fall-through pipelines.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">switch(true) Pattern</strong> empowers developers to architect clear, bug-free, and high-performance control flow trees. In enterprise JavaScript applications, clean conditional logic determines how state transitions occur, how errors are guarded against, and how business rules execute.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an intensive lab test, student <strong>Swadeep</strong> encountered a subtle architectural issue. Swadeep tried to test score ranges (score &gt;= 90, score &gt;= 75) using a standard switch(score) and each case matched nothing. Sukanta Hui demonstrated switch(true), where each case expression evaluates to boolean true.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact decision tree on the whiteboard, proving that understanding <em>switch(true) Pattern</em> produces maintainable and robust production applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> switch(true) Dynamic Expression Matching Architecture
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="The switch(true) Range Evaluation & Pattern Matching Pattern Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  switch(true) Dynamic Expression Matching Architecture
                </text>
                
                <g transform="translate(60, 50)">
                  <rect width="720" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="360" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">switch (true) · Dynamic Boolean Expression Evaluation</text>
                  
                  <g transform="translate(30, 45)">
                    <rect width="210" height="120" rx="6" fill="#0f172a" stroke="#10b981" />
                    <text x="105" y="24" fill="#34d399" fontSize="11" fontWeight="bold" textAnchor="middle">case score &gt;= 90:</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10" fontFamily="monospace">grade = "A+ (Distinction)";</text>
                    <text x="15" y="70" fill="#fbbf24" fontSize="10" fontFamily="monospace">break;</text>
                    <text x="15" y="95" fill="#a7f3d0" fontSize="9">Evaluates expression to true</text>
                  </g>

                  <g transform="translate(255, 45)">
                    <rect width="210" height="120" rx="6" fill="#0f172a" stroke="#f59e0b" />
                    <text x="105" y="24" fill="#fbbf24" fontSize="11" fontWeight="bold" textAnchor="middle">case score &gt;= 75:</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10" fontFamily="monospace">grade = "A (First Class)";</text>
                    <text x="15" y="70" fill="#fbbf24" fontSize="10" fontFamily="monospace">break;</text>
                    <text x="15" y="95" fill="#fde68a" fontSize="9">Tested in top-down sequence</text>
                  </g>

                  <g transform="translate(480, 45)">
                    <rect width="210" height="120" rx="6" fill="#0f172a" stroke="#f43f5e" />
                    <text x="105" y="24" fill="#f43f5e" fontSize="11" fontWeight="bold" textAnchor="middle">default:</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10" fontFamily="monospace">grade = "Needs Retake";</text>
                    <text x="15" y="70" fill="#94a3b8" fontSize="9" fontFamily="monospace">break;</text>
                    <text x="15" y="95" fill="#fda4af" fontSize="9">Executes if no range matches</text>
                  </g>
                </g>
            ...
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 10.1: Runtime decision branching, bytecode flow, and control architecture for switch(true) Pattern.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="SwitchTruePatternDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Multi-Variable Range Testing with switch(true)
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Unlike standard switch which only tests a single variable, switch(true) can evaluate expressions involving multiple completely different variables in each case statement.
            </p>
...
switch (true) {
  ...
  default: return 'Underage';
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "switch(true) Pattern"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "switch(true) Pattern"}
            downloadFileName="001_004_control-flow-conditions-topic10-note.txt"
          />
        </section>
