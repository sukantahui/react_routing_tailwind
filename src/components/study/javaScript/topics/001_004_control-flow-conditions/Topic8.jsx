...
import demoCode from "./topic8_files/CommonMistakesInConditionsAssignmentInsteadOfComparisonEtcDemo.js?raw";

/**
 * Topic8 – Common Mistakes in Conditions (Assignment vs Comparison & Coercion)
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_004_control-flow-conditions · Topic 8</span>
          </div>
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Common Mistakes in Conditions (Assignment vs Comparison & Coercion)"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Identify and eliminate dangerous bugs: single equals in conditions, NaN comparisons, empty string fallbacks, and semicolon after if.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">Condition Traps & Bugs</strong> empowers developers to architect clear, bug-free, and high-performance control flow trees. In enterprise JavaScript applications, clean conditional logic determines how state transitions occur, how errors are guarded against, and how business rules execute.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an intensive lab test, student <strong>Tuhina</strong> encountered a subtle architectural issue. Tuhina accidentally placed a semicolon after an if header: if (isApproved); &#123; grantAccess(); &#125;. Because of the semicolon, the if branch terminated immediately and grantAccess() ran unconditionally! Sukanta Hui explained empty statement grammar.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact decision tree on the whiteboard, proving that understanding <em>Condition Traps & Bugs</em> produces maintainable and robust production applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Dangerous Conditional Syntax Traps & Defensive Fixes
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Common Mistakes in Conditions (Assignment vs Comparison & Coercion) Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Dangerous Conditional Syntax Traps & Defensive Fixes
                </text>
                
                <g transform="translate(60, 50)">
                  <rect width="330" height="180" rx="10" fill="#1e293b" stroke="#f43f5e" strokeWidth="1.5" />
                  <text x="165" y="26" fill="#f43f5e" fontSize="12" fontWeight="bold" textAnchor="middle">❌ Dangerous Bug: Semicolon after if</text>
                  <rect x="15" y="42" width="300" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="25" y="65" fill="#fda4af" fontSize="11" fontFamily="monospace">if (isBlocked);</text>
                  <text x="25" y="85" fill="#fda4af" fontSize="11" fontFamily="monospace">  deleteUser();</text>
                  <path d="M 25 105 L 295 105" stroke="#f43f5e" strokeDasharray="3 3" />
                  <text x="25" y="125" fill="#f87171" fontSize="10">Semicolon ; creates an Empty Statement!</text>
                  <text x="25" y="145" fill="#fecdd3" fontSize="10" fontWeight="bold">deleteUser() runs for ALL users!</text>
                </g>

                <g transform="translate(440, 50)">
                  <rect width="340" height="180" rx="10" fill="#1e293b" stroke="#10b981" strokeWidth="1.5" />
                  <text x="170" y="26" fill="#34d399" fontSize="12" fontWeight="bold" textAnchor="middle">✓ Defensive Linter Rules</text>
                  <rect x="15" y="42" width="310" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="25" y="65" fill="#a7f3d0" fontSize="10" fontFamily="monospace">/* eslint no-empty: "error" */</text>
                  <text x="25" y="85" fill="#a7f3d0" fontSize="10" fontFamily="monospace">/* eslint eqeqeq: "error" */</text>
                  <text x="25" y="105" fill="#a7f3d0" fontSize="10" fontFamily="monospace">/* eslint no-cond-assign: "error" */</text>
                  <text x="25" y="135" fill="#34d399" fontSize="10" fontWeight="bold">Automated CI catches syntax traps before deployment</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 8.1: Runtime decision branching, bytecode flow, and control architecture for Condition Traps &amp; Bugs.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="CommonMistakesConditionsDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  ESLint no-cond-assign Rule
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Enable the ESLint rule 'no-cond-assign' in your .eslintrc to make accidental assignments inside if (x = y) a compile-time build failure.
            </p>
...
// In .eslintrc.json:
{
  "rules": {
    "no-cond-assign": ["error", "always"]
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Condition Traps & Bugs"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Condition Traps & Bugs"}
            downloadFileName="001_004_control-flow-conditions-topic8-note.txt"
          />
        </section>
