...
import demoCode from "./topic3_files/TheSwitchStatementDemo.js?raw";

/**
 * Topic3 – The switch Statement in JavaScript
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_004_control-flow-conditions · Topic 3</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master strict equality case matching, fall-through mechanics, default clauses, and block scoping within cases.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Mastering <strong className="text-amber-300">The switch Statement</strong> empowers developers to architect clear, bug-free, and high-performance control flow trees. In enterprise JavaScript applications, clean conditional logic determines how state transitions occur, how errors are guarded against, and how business rules execute.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During an intensive lab test, student <strong>Debangshu</strong> encountered a subtle architectural issue. Debangshu declared let message = 'ok' in case 1 and let message = 'error' in case 2, receiving a SyntaxError: Identifier 'message' has already been declared. Sukanta Hui explained that an entire switch block shares a single lexical scope unless individual cases are wrapped in &#123; ... &#125; braces.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact decision tree on the whiteboard, proving that understanding <em>The switch Statement</em> produces maintainable and robust production applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> switch Statement Jump Table & Fall-Through Architecture
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="The switch Statement in JavaScript Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  switch Statement Jump Table & Fall-Through Architecture
                </text>
                
                <g transform="translate(60, 50)">
                  <rect width="720" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="360" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">switch (expression) · Strict Equality (===) Jump Table</text>
                  
                  <g transform="translate(30, 45)">
                    <rect width="190" height="120" rx="6" fill="#0f172a" stroke="#10b981" />
                    <text x="95" y="24" fill="#34d399" fontSize="11" fontWeight="bold" textAnchor="middle">case 'ADMIN':</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10">grantAllAccess();</text>
                    <text x="15" y="70" fill="#fbbf24" fontSize="10" fontFamily="monospace">break; // Prevents fall</text>
                    <text x="15" y="95" fill="#a7f3d0" fontSize="9">Exits switch block</text>
                  </g>

                  <g transform="translate(255, 45)">
                    <rect width="210" height="120" rx="6" fill="#0f172a" stroke="#f59e0b" />
                    <text x="105" y="24" fill="#fbbf24" fontSize="11" fontWeight="bold" textAnchor="middle">case 'EDITOR': (Fall)</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10">case 'AUTHOR':</text>
                    <text x="15" y="70" fill="#e2e8f0" fontSize="10">allowPublishing();</text>
                    <text x="15" y="95" fill="#fde68a" fontSize="9">Shared multi-case grouping</text>
                  </g>

                  <g transform="translate(495, 45)">
                    <rect width="195" height="120" rx="6" fill="#0f172a" stroke="#f43f5e" />
                    <text x="97" y="24" fill="#f43f5e" fontSize="11" fontWeight="bold" textAnchor="middle">default:</text>
                    <text x="15" y="48" fill="#e2e8f0" fontSize="10">handleUnknown();</text>
                    <text x="15" y="70" fill="#94a3b8" fontSize="9">Catch-all fallback</text>
                    <text x="15" y="95" fill="#fda4af" fontSize="9">Matches when no case hits</text>
                  </g>
                </g>
            ...
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 3.1: Runtime decision branching, bytecode flow, and control architecture for The switch Statement.
            </p>
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Block Scoping Inside Case Clauses: case 'A': &#123; let x = 1; break; &#125;
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              To declare variables with let or const inside a switch case without variable name collisions with sibling cases, always wrap the case body in curly braces &#123; ... &#125;.
            </p>
...
switch (action) {
  ...
  case 'DELETE': {
    ...
    break;
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "The switch Statement"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "The switch Statement"}
            downloadFileName="001_004_control-flow-conditions-topic3-note.txt"
          />
        </section>
