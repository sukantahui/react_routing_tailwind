...
export default function Topic13() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Building a Production Toast Notification Dispatch Center · Architecture &amp; Execution Pipeline</text>
