...
export default function Topic12() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Architecture of Dynamic Card Grids with Filter &amp; Sort Controls · Architecture &amp; Execution Pipeline</text>
