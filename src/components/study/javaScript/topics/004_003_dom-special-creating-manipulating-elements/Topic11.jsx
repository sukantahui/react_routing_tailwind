...
export default function Topic11() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Architecture of a Dynamic List &amp; Todo Manager Component · Architecture &amp; Execution Pipeline</text>
