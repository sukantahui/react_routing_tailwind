...
// Topic: Web Components: Custom Elements (customElements.define) & Autonomous Elements
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Web Components: Custom Elements (customElements.define) & Autonomous Elements");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "DOM Special: Creating, Inserting & Manipulating Elements",
