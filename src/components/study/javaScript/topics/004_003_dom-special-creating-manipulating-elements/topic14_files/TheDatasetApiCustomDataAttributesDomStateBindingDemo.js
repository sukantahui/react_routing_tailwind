...
// Topic: The dataset API: Custom Data Attributes & DOM State Binding
...
console.log("Demonstrating foundational mechanics for: The dataset API: Custom Data Attributes & DOM State Binding");
console.log("");
