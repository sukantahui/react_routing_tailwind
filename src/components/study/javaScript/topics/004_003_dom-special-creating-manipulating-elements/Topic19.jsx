...
import projectsData from "./topic19_files/js-dom-elements-projects.json";

export default function PracticalProjectsPage() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    const modules = import.meta.glob("./topic19_files/answers/*.js", { query: "?raw", import: "default", eager: true });
    const fileMap = {};
