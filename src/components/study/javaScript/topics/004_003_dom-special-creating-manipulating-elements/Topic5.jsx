...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Component Factory Functions in Vanilla JavaScript · Architecture &amp; Execution Pipeline</text>
