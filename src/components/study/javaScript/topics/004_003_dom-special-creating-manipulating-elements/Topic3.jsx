...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Dynamic UI Card Generation &amp; Schema Mapping · Architecture &amp; Execution Pipeline</text>
