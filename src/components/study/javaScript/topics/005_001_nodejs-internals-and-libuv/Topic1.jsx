...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Working with Buffers, TypedArrays &amp; Low-Level Binary Data Streams · Architecture &amp; Execution Pipeline</text>
