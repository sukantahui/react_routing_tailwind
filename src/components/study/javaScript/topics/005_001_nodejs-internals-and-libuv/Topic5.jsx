...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Native Diagnostics, Profiling with Chrome DevTools &amp; Memory Leak Analysis · Architecture &amp; Execution Pipeline</text>
