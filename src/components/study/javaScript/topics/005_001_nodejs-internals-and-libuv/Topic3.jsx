...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Child Processes, Cluster Module &amp; Multi-Core CPU Scaling · Architecture &amp; Execution Pipeline</text>
