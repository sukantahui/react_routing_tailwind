...
// Topic: Array Searching Algorithms (findLast, findLastIndex, indexOf, includes)
...
console.log("Demonstrating foundational mechanics for: Array Searching Algorithms (findLast, findLastIndex, indexOf, includes)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Arrays & Essential Array Methods",
