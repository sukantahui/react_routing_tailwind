...
// Topic: Searching in Arrays — indexOf(), includes(), find(), findIndex()
...
console.log("Demonstrating foundational mechanics for: Searching in Arrays — indexOf(), includes(), find(), findIndex()");
console.log("");
