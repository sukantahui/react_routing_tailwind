/**
 * Topic 3 Demo: Powerful Slicing & Splicing — slice(), splice(), copyWithin(), fill()
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 3: POWERFUL SLICING & SPLICING — SLICE(), SPLICE(), COPYWITHIN(), FILL()");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: Powerful Slicing & Splicing — slice(), splice(), copyWithin(), fill()");
...
console.log(buffer); // [3, 4, 5, 4, 5, 6]
}
