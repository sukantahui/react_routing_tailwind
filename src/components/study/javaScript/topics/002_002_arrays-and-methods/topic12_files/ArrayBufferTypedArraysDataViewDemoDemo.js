/**
 * Topic 12 Demo: ArrayBuffer, TypedArrays (Uint8Array, Float64Array) & DataView Architecture
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 12: ARRAYBUFFER, TYPEDARRAYS (UINT8ARRAY, FLOAT64ARRAY) & DATAVIEW ARCHITECTURE");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: ArrayBuffer, TypedArrays (Uint8Array, Float64Array) & DataView Architecture");
