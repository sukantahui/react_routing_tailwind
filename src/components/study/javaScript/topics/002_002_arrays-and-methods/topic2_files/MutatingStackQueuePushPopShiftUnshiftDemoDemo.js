/**
 * Topic 2 Demo: Mutating Stack & Queue Methods — push(), pop(), shift(), unshift()
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 2: MUTATING STACK & QUEUE METHODS — PUSH(), POP(), SHIFT(), UNSHIFT()");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: Mutating Stack & Queue Methods — push(), pop(), shift(), unshift()");
...
{
  function batchPush(target, source, chunkSize = 10000) {
...
console.log("Big Array Length:", bigArr.length); // 150000
}
