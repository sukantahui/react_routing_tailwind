...
// Topic: Mutating Methods — push(), pop(), shift(), unshift(), splice()
...
console.log("Demonstrating foundational mechanics for: Mutating Methods — push(), pop(), shift(), unshift(), splice()");
console.log("");
