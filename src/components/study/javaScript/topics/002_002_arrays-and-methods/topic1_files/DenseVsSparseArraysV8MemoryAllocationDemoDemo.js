/**
 * Topic 1 Demo: Dense vs Sparse Arrays & Memory Allocation in the V8 Engine
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 1: DENSE VS SPARSE ARRAYS & MEMORY ALLOCATION IN THE V8 ENGINE");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: Dense vs Sparse Arrays & Memory Allocation in the V8 Engine");
...
console.log(Object.hasOwn(explicit, 1)); // true (Defined property)
}
