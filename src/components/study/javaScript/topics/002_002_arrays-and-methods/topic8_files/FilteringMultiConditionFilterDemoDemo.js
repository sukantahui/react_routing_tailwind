/**
 * Topic 8 Demo: Filtering & Multi-Condition Filtering with filter()
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 8: FILTERING & MULTI-CONDITION FILTERING WITH FILTER()");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: Filtering & Multi-Condition Filtering with filter()");
...
{
  const createFilter = (...predicates) => (item) => predicates.every(p => p(item));
...
console.log(users.filter(enterpriseFilter));
}
