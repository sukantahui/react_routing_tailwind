/**
 * Topic 4 Demo: Non-Mutating Array Combinations — concat(), join(), Spread Operator
 * Module: 002_002_arrays-and-methods
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 4: NON-MUTATING ARRAY COMBINATIONS — CONCAT(), JOIN(), SPREAD OPERATOR");
console.log("==================================================");
...
{
  console.log("Demonstrating fundamental behavior for: Non-Mutating Array Combinations — concat(), join(), Spread Operator");
...
console.log([1, 2].concat(col)); // [1, 2, "A", "B"]
}
