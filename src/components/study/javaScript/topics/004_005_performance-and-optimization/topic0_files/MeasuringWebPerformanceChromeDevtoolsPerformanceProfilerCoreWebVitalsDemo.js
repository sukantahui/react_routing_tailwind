...
// Topic: Measuring Web Performance: Chrome DevTools Performance Profiler & Core Web Vitals
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Measuring Web Performance: Chrome DevTools Performance Profiler & Core Web Vitals");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Performance Optimization, Memory Profiling & Best Practices",
