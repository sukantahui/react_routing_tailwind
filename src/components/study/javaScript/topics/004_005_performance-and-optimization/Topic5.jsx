...
export default function Topic5() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Memory Leak Detection &amp; Heap Snapshot Profiling · Architecture &amp; Execution Pipeline</text>
