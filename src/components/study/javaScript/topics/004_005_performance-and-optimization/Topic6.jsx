...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">SharedArrayBuffer &amp; Atomics for High-Performance Multi-Threading · Architecture &amp; Execution Pipeline</text>
