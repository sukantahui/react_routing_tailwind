...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Measuring Web Performance: Chrome DevTools Performance Profiler &amp; Core Web Vitals · Architecture &amp; Execution Pipeline</text>
