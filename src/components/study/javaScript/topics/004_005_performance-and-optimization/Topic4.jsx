...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Web Workers &amp; Multi-Threaded JavaScript Execution · Architecture &amp; Execution Pipeline</text>
