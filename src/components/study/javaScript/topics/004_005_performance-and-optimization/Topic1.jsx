...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Big-O Algorithmic Thinking in JavaScript: Time &amp; Space Complexity · Architecture &amp; Execution Pipeline</text>
