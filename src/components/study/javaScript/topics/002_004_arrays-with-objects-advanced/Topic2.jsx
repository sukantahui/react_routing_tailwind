...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Filtering Object Arrays with Multi-Criteria Predicates · Architecture &amp; Execution Pipeline</text>
