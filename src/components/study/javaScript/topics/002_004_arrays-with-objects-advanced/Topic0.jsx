...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">What is an Array of Objects? Relational &amp; Schema Architecture · Architecture &amp; Execution Pipeline</text>
