...
import projectsData from "./topic17_files/js-array-pipelines-projects.json";

export default function PracticalProjectsPage() {
  const [enhancedData, setEnhancedData] = useState(null);

  useEffect(() => {
    const modules = import.meta.glob("./topic17_files/answers/*.js", { query: "?raw", import: "default", eager: true });
    const fileMap = {};
