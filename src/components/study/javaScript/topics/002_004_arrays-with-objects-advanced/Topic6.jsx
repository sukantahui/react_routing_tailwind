...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Counting and Frequency Distributions across Object Arrays · Architecture &amp; Execution Pipeline</text>
