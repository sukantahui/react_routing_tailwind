...
export default function Topic9() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Complex Data Analysis: Ranking, Merit Lists &amp; Percentiles · Architecture &amp; Execution Pipeline</text>
