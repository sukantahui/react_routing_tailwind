...
import demoCode from "./topic15_files/ComplexMultiKeyIndexingInMemoryRelationalDataLookupDemo.js?raw";
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            ...
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Complex Multi-Key Indexing & In-Memory Relational Data Lookup Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="14" fontWeight="bold" textAnchor="middle">
                  Complex Multi-Key Indexing & In-Memory Relational Data Lookup · Data Transformation &amp; Memory Layout
                </text>
            ...
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 15.1: Architectural execution lifecycle, memory flow, and runtime mechanics for Complex Multi-Key Indexing &amp; In-Memory Relational Data Lookup.
            </p>
          </div>
        </section>
  ...
  return val.toUpperCase();
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            ...
            downloadFileName="002-004-topic15-note.txt"
          />
        </section>
