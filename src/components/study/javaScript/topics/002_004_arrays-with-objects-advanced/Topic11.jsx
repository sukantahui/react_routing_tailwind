...
export default function Topic11() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Deep Cloning &amp; Immutability in Object Collections · Architecture &amp; Execution Pipeline</text>
