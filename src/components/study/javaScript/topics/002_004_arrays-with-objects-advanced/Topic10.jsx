...
export default function Topic10() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Pagination &amp; Slicing Object Datasets for Modern UI Grids · Architecture &amp; Execution Pipeline</text>
