...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Searching Object Arrays with find(), findIndex() &amp; findLast() · Architecture &amp; Execution Pipeline</text>
