...
import demoCode from "./topic2_files/ComparisonOperatorsGtLtDemo.js?raw";

/**
 * Topic2 – Comparison Operators (==, ===, !=, !==, >, <, >=, <=)
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_003_operators-and-expressions · Topic 2</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Deep dive into strict vs loose relational and equality comparisons, lexicographical string ordering, and NaN comparison invariants.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During a lab session, student <strong>Abhronila</strong> encountered a subtle logical glitch. Abhronila compared two strings '10' &lt; '9' and expected false, but got true! Sukanta Hui explained that when both operands are strings, JavaScript performs lexicographical (character code) comparison where '1' (code 49) is less than '9' (code 57).
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact step-by-step operand evaluation on the whiteboard, explaining why mastering <em>Comparison Operators</em> eliminates ambiguity and prevents production regressions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Relational Comparison & Lexicographical vs Numerical Branching
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Comparison Operators (==, ===, !=, !==, >, <, >=, <=) Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Relational Comparison & Lexicographical vs Numerical Branching
                </text>
                
                <g transform="translate(40, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">Numerical vs Lexicographical Rules</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="70" fill="#e2e8f0" fontSize="11" fontFamily="monospace">10 &lt; 9 === false (Numeric compare)</text>
                  <text x="35" y="92" fill="#f87171" fontSize="11" fontFamily="monospace">"10" &lt; "9" === true (Lexicographical!)</text>
                  <text x="35" y="114" fill="#a7f3d0" fontSize="10">Rule: If BOTH operands are strings, compare UTF-16 code points</text>
                  <text x="35" y="136" fill="#fbbf24" fontSize="10">Rule: If EITHER operand is number, coerce both to numbers</text>
                </g>

                <g transform="translate(440, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#10b981" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#34d399" fontSize="13" fontWeight="bold" textAnchor="middle">Strict Equality (===) vs Loose (==)</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="70" fill="#a7f3d0" fontSize="11" fontFamily="monospace">5 === "5" // FALSE (Type mismatch)</text>
                  <text x="35" y="92" fill="#f87171" fontSize="11" fontFamily="monospace">5 == "5"  // TRUE (Coerces "5" to 5)</text>
                  <text x="35" y="114" fill="#fda4af" fontSize="10">null &gt;= 0 is TRUE, but null == 0 is FALSE</text>
                  <text x="35" y="136" fill="#34d399" fontSize="10" fontWeight="bold">Senior Standard: ALWAYS use === and !==</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 2.1: Runtime execution lifecycle, memory flow, and operator evaluation rules for Comparison Operators.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="ComparisonOperatorsDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  The null &gt;= 0 vs null == 0 Bizarre Invariant
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              In JavaScript, null &gt; 0 is false and null == 0 is false, but null &gt;= 0 is TRUE! This occurs because relational operators (&lt;, &gt;=) coerce null to number (0), whereas equality (==) does NOT coerce null to number.
            </p>
...
console.log(null &gt;= 0); // true!`}</pre>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Comparison Operators"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Comparison Operators"}
            downloadFileName="001_003_operators-and-expressions-topic2-note.txt"
          />
        </section>
