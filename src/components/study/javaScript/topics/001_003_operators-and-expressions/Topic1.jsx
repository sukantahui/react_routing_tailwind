...
import demoCode from "./topic1_files/AssignmentCompoundAssignmentOperatorsDemo.js?raw";

/**
 * Topic1 – Assignment & Compound Assignment Operators in JavaScript
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_003_operators-and-expressions · Topic 1</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Assignment & Compound Assignment Operators in JavaScript"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master direct assignment (=), arithmetic compound operators (+=, -=, *=, /=, %=, **=), and operator evaluation order.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During a lab session, student <strong>Tuhina</strong> encountered a subtle logical glitch. Tuhina wrote total =+ 10 instead of total += 10. The statement assigned positive 10 to total instead of adding 10! Mentor Sukanta Hui explained the difference between compound assignment (+=) and assignment with unary plus (= +).
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact step-by-step operand evaluation on the whiteboard, explaining why mastering <em>Assignment Operators</em> eliminates ambiguity and prevents production regressions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Compound Assignment Arithmetic & Memory Mutation Cycle
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Assignment & Compound Assignment Operators in JavaScript Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Compound Assignment Arithmetic & Memory Mutation Cycle
                </text>
                
                <g transform="translate(40, 60)">
                  <rect width="210" height="100" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="105" y="26" fill="#38bdf8" fontSize="12" fontWeight="bold" textAnchor="middle">1. Left-Hand Target</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#7dd3fc" fontSize="11" textAnchor="middle">balance (Reference)</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Current Value: 500</text>
                </g>
                ...
                <g transform="translate(325, 60)">
                  ...
                  <text x="105" y="26" fill="#fbbf24" fontSize="12" fontWeight="bold" textAnchor="middle">2. Compound Evaluation</text>
                  <rect x="15" y="40" width="180" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="105" y="58" fill="#fde68a" fontSize="11" textAnchor="middle">balance += 150</text>
                  <text x="105" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Expands: balance = balance + 150</text>
                </g>
                ...
                <g transform="translate(610, 60)">
                  ...
                  <text x="95" y="26" fill="#34d399" fontSize="12" fontWeight="bold" textAnchor="middle">3. Memory Update</text>
                  <rect x="15" y="40" width="160" height="45" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="95" y="58" fill="#a7f3d0" fontSize="11" textAnchor="middle">balance = 650</text>
                  <text x="95" y="74" fill="#94a3b8" fontSize="9" textAnchor="middle">Single memory re-write</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 1.1: Runtime execution lifecycle, memory flow, and operator evaluation rules for Assignment Operators.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="AssignmentOperatorsDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Chained Assignments: a = b = c = 10
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Because assignment expressions return the assigned value and are right-associative, chaining multiple variables sets all of them simultaneously in reverse order.
            </p>
...
let x, y, z;
x = y = z = 42;
console.log(x, y, z); // 42 42 42`}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Assignment Operators"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Assignment Operators"}
            downloadFileName="001_003_operators-and-expressions-topic1-note.txt"
          />
        </section>
