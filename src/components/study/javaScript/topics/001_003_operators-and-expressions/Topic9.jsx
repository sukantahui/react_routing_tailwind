...
import demoCode from "./topic9_files/UnaryRelationalCommaOperatorsInDeleteVoidTypeofInstanceofDemo.js?raw";

/**
 * Topic9 – Unary, Relational & Comma Operators (in, delete, void, typeof, instanceof)
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_003_operators-and-expressions · Topic 9</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Unary, Relational & Comma Operators (in, delete, void, typeof, instanceof)"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master property testing with 'in', prototype inspection with 'instanceof', safe property removal with 'delete', and the 'void 0' undefined constant.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During a lab session, student <strong>Debangshu</strong> encountered a subtle logical glitch. Debangshu used delete arr[2] on an array expecting the array length to shrink from 3 to 2. Sukanta Hui showed that delete leaves an empty sparse hole in the array and does not change array.length.
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact step-by-step operand evaluation on the whiteboard, explaining why mastering <em>Unary & Relational Operators</em> eliminates ambiguity and prevents production regressions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> Relational 'in', 'instanceof' & Memory 'delete' Lifecycle
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Unary, Relational & Comma Operators (in, delete, void, typeof, instanceof) Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  Relational 'in', 'instanceof' & Memory 'delete' Lifecycle
                </text>
                
                <g transform="translate(40, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">'in' vs 'instanceof' Operators</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="68" fill="#7dd3fc" fontSize="11" fontFamily="monospace">"name" in user // Checks key &amp; prototype</text>
                  <text x="35" y="90" fill="#a7f3d0" fontSize="11" fontFamily="monospace">arr instanceof Array // Walks prototype chain</text>
                  <text x="35" y="112" fill="#e2e8f0" fontSize="10">void 0 === undefined (Reliable pure undefined)</text>
                  <text x="35" y="134" fill="#34d399" fontSize="10">typeof fn === "function"</text>
                </g>

                <g transform="translate(440, 50)">
                  <rect width="360" height="190" rx="10" fill="#1e293b" stroke="#f43f5e" strokeWidth="1.5" />
                  <text x="180" y="26" fill="#f43f5e" fontSize="13" fontWeight="bold" textAnchor="middle">The 'delete' Operator &amp; Hidden Classes</text>
                  <rect x="20" y="45" width="320" height="120" rx="6" fill="#0f172a" stroke="#334155" />
                  <text x="35" y="68" fill="#fda4af" fontSize="11" fontFamily="monospace">delete user.age // Removes property from object</text>
                  <text x="35" y="90" fill="#f87171" fontSize="10">⚠️ In V8: delete de-optimizes Object Hidden Class</text>
                  <text x="35" y="112" fill="#fda4af" fontSize="10">⚠️ On Arrays: delete arr[0] creates a sparse hole!</text>
                  <text x="35" y="134" fill="#34d399" fontSize="10" fontWeight="bold">Senior Tip: Set to null or use Map for dynamic keys</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 9.1: Runtime execution lifecycle, memory flow, and operator evaluation rules for Unary &amp; Relational Operators.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="UnaryRelationalCommaOperatorsDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Why Senior Libraries Use 'void 0' instead of 'undefined'
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              In older ECMAScript standards, 'undefined' was a writable global variable that could be overwritten (undefined = true). Using void 0 is guaranteed by the spec to always evaluate to pure undefined.
            </p>

            <div className="rounded-xl border border-amber-900/50 bg-slate-950 p-4 font-mono text-xs text-amber-200 overflow-x-auto">
              <pre>{`// 💎 SENIOR SECRET:
console.log(void 0 === undefined); // true (Safe canonical undefined)`}</pre>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Unary & Relational Operators"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Unary & Relational Operators"}
            downloadFileName="001_003_operators-and-expressions-topic9-note.txt"
          />
        </section>
