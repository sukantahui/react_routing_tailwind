...
import demoCode from "./topic5_files/OperatorPrecedenceParenthesesDemo.js?raw";

/**
 * Topic5 – Operator Precedence & Parentheses in JavaScript
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 001_003_operators-and-expressions · Topic 5</span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-sky-300 tracking-tight leading-tight">
            {"Operator Precedence & Parentheses in JavaScript"}
          </h1>

          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Master the 20-level ECMAScript operator precedence hierarchy, associativity rules, and defensive grouping with parentheses.
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                During a lab session, student <strong>Tuhina</strong> encountered a subtle logical glitch. Tuhina evaluated 5 + 2 * 10 &gt; 20 && 3 + 4 === 7 and struggled to predict the execution order. Mentor Sukanta Hui mapped out the operator precedence levels: * (14), + (13), &gt; (11), === (10), && (6).
              </p>
              <p>
                Mentor <strong>Sukanta Hui</strong> demonstrated the exact step-by-step operand evaluation on the whiteboard, explaining why mastering <em>Operator Precedence</em> eliminates ambiguity and prevents production regressions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            <h2 className="text-lg sm:text-xl font-bold text-sky-400 mb-4 flex items-center gap-2">
              <span>📊</span> ECMAScript Operator Precedence Hierarchy (Highest to Lowest)
            </h2>
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 840 280" className="w-full h-auto" role="img" aria-label="Operator Precedence & Parentheses in JavaScript Architecture">
                ...
                <text x="420" y="28" fill="#f8fafc" fontSize="15" fontWeight="bold" textAnchor="middle">
                  ECMAScript Operator Precedence Hierarchy (Highest to Lowest)
                </text>
                
                <g transform="translate(60, 50)">
                  <rect width="720" height="190" rx="10" fill="#1e293b" stroke="#38bdf8" strokeWidth="1.5" />
                  <text x="360" y="26" fill="#38bdf8" fontSize="13" fontWeight="bold" textAnchor="middle">Operator Precedence Order (20 Tiers)</text>
                  
                  <rect x="20" y="42" width="680" height="26" rx="4" fill="#0f172a" />
                  <text x="30" y="59" fill="#34d399" fontSize="11" fontWeight="bold">Tier 19-20 (Highest):</text>
                  <text x="200" y="59" fill="#e2e8f0" fontSize="11">Grouping ( ... ), Member Access obj.prop, Function Call fn()</text>

                  <rect x="20" y="72" width="680" height="26" rx="4" fill="#0f172a" />
                  <text x="30" y="89" fill="#38bdf8" fontSize="11" fontWeight="bold">Tier 14-16 (Arithmetic):</text>
                  <text x="200" y="89" fill="#e2e8f0" fontSize="11">Exponentiation **, Multiplicative * / %, Additive + -</text>

                  <rect x="20" y="102" width="680" height="26" rx="4" fill="#0f172a" />
                  <text x="30" y="119" fill="#fbbf24" fontSize="11" fontWeight="bold">Tier 9-11 (Relational &amp; Equality):</text>
                  <text x="200" y="119" fill="#e2e8f0" fontSize="11">&lt;, &lt;=, &gt;, &gt;=, in, instanceof, Strict ===, !==, Loose ==</text>

                  <rect x="20" y="132" width="680" height="26" rx="4" fill="#0f172a" />
                  <text x="30" y="149" fill="#a855f7" fontSize="11" fontWeight="bold">Tier 4-6 (Logical &amp; Nullish):</text>
                  <text x="200" y="149" fill="#e2e8f0" fontSize="11">Logical AND &amp;&amp;, Logical OR ||, Nullish Coalescing ??</text>

                  <rect x="20" y="162" width="680" height="26" rx="4" fill="#0f172a" />
                  <text x="30" y="179" fill="#f43f5e" fontSize="11" fontWeight="bold">Tier 1-3 (Lowest):</text>
                  <text x="200" y="179" fill="#fda4af" fontSize="11">Conditional a ? b : c, Assignments =, +=, &amp;&amp;=, Comma ,</text>
                </g>
    
              </svg>
            </div>
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure 5.1: Runtime execution lifecycle, memory flow, and operator evaluation rules for Operator Precedence.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="OperatorPrecedenceDemo.js"
            />
          </div>
        </section>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  Defensive Parentheses Standard in Enterprise Codebases
                </h3>
              </div>
            </div>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-6">
              Never rely on subtle precedence rules when combining arithmetic, logical, and ternary operators. Always use grouping parentheses ( ... ) to make intent crystal clear to both compilers and future engineers.
            </p>
...
const ok = (a && b) || (c && d);`}</pre>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Operator Precedence"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Operator Precedence"}
            downloadFileName="001_003_operators-and-expressions-topic5-note.txt"
          />
        </section>
