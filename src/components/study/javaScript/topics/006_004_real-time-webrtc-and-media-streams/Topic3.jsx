...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Zero-Latency Peer-to-Peer Data Channels (RTCDataChannel) for Gaming &amp; File Transfer · Architecture &amp; Execution Pipeline</text>
