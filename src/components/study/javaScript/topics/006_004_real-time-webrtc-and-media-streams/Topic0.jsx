...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Real-Time Web Architecture: Signaling Servers vs Peer-to-Peer Topologies · Architecture &amp; Execution Pipeline</text>
