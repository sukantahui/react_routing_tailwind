...
// Topic: Zero-Latency Peer-to-Peer Data Channels (RTCDataChannel) for Gaming & File Transfer
...
console.log("Demonstrating foundational mechanics for: Zero-Latency Peer-to-Peer Data Channels (RTCDataChannel) for Gaming & File Transfer");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Real-Time Communications: WebRTC, AudioWorklet & Media Streams",
