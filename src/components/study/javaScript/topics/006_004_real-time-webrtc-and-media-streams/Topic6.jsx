...
export default function Topic6() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Enterprise Mesh vs SFU (Selective Forwarding Unit) Video Conference Architecture · Architecture &amp; Execution Pipeline</text>
