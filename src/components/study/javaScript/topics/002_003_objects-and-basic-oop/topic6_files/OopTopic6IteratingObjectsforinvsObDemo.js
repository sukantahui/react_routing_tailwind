/**
 * Topic 6 Demo: Iterating Objects: for...in vs Object.keys(), values(), entries(), fromEntries()
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 6: ITERATING OBJECTS: FOR...IN VS OBJECT.KEYS(), VALUES(), ENTRIES(), FROMENTRIES()");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Iterating Objects: for...in vs Object.keys(), values(), entries(), fromEntries()");
