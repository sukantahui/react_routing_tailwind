/**
 * Topic 11 Demo: Property Getters and Setters (Accessors) for Data Validation & Encapsulation
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 11: PROPERTY GETTERS AND SETTERS (ACCESSORS) FOR DATA VALIDATION & ENCAPSULATION");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Property Getters and Setters (Accessors) for Data Validation & Encapsulation");
