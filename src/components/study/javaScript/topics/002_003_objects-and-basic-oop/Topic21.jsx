...
import demoCode from "./topic21_files/OopTopic21ObjectOrientedDesignPrincDemo.js?raw";
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 md:p-12 font-sans selection:bg-amber-500/30 selection:text-amber-200">
        ...
        <header ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/70 border border-amber-700/60 text-amber-300 text-xs font-semibold uppercase tracking-wider shadow-lg">
            <span>⚡</span>
            <span>Module 002_003_objects-and-basic-oop · Topic 21</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
            {"Comprehensive master guide to Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism in JavaScript, exploring V8 heap allocation, prototypal mechanics, and enterprise software engineering patterns."}
          </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg hover:border-slate-700 transition-all">
            ...
            <div className="p-5 rounded-xl bg-slate-900/90 border border-amber-900/40 text-sm text-slate-300 leading-relaxed space-y-2">
              ...
              <p>
                {"During the Barrackpore lab session, students encountered runtime exceptions when working with Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism due to subtle object reference or context binding nuances."}
              </p>
              <p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl">
            ...
            <div className="w-full overflow-x-auto">
              <svg viewBox="0 0 800 240" className="w-full h-auto" role="img" aria-label={"Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}>
                <defs>
                ...
                <text x="400" y="30" fill="#f8fafc" fontSize="14" fontWeight="bold" textAnchor="middle">{"Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"} · Architecture &amp; Pipeline</text>
            ...
            <p className="text-xs text-slate-400 mt-3 text-center">
              Figure: Step-by-step architectural execution for {"Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}.
            </p>
          </div>
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-6">
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
              The ECMAScript specification mandates precise abstract operations during the lifecycle of {"Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}. The table below outlines formal specification rules, engine runtime dynamics, and actionable developer invariants.
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 overflow-hidden shadow-2xl bg-slate-900">
            <JavaScriptEditableCodeBlock
              ...
              title="OopTopic21ObjectOrientedDesignPrincDemo.js"
            />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-rose-950/20 border border-rose-800/40 rounded-2xl p-6 shadow-lg space-y-3">
              <div className="flex items-center gap-2 text-rose-400 font-bold">
                <span>❌</span>
                <span>Anti-Pattern: {"Improper Usage of Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}</span>
              </div>
...
{"// ❌ AVOID: Direct mutation or unsafe property access\nconst obj = { a: 1 };\nconst copy = obj; // Shared pointer!\ncopy.a = 99; // Mutates obj.a!"}
            ...
            <div className="bg-emerald-950/20 border border-emerald-800/40 rounded-2xl p-6 shadow-lg space-y-3">
              <div className="flex items-center gap-2 text-emerald-400 font-bold">
                <span>✓</span>
                <span>Senior Pro Practice: {"Senior Pro Best Practice for Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}</span>
              </div>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
...
{"// ✓ RECOMMENDED: Defensive & Predictable\nconst obj = { a: 1 };\nconst clone = { ...obj };\nclone.a = 99;\nconsole.log(obj.a); // 1 (Safe)"}
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">
                  {"Senior Pro Gem for Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}
                </h3>
              </div>
            </div>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <div className="bg-indigo-950/20 border border-indigo-800/40 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed mb-4">
              {"In the context of Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism, how does the JavaScript engine optimize property lookups when objects share the exact same instantiation order?"}
            </p>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <FAQTemplate
            title={"Frequently Asked Questions · " + "Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <PlainTextPrint
            content={noteText}
            title={"JavaScript Master Note · " + "Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism"}
            downloadFileName="002-003-topic21-note.txt"
          />
        </section>
        ...
        <section ref={addRef} className="reveal-section max-w-5xl mx-auto mb-12">
          <Teacher
            note={"In my 27+ years of mentoring software engineers at Coder & AccoTax in Barrackpore, I have consistently seen that mastering " + "Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism" + " separates code monkeys from genuine software engineers. " + "Mastering Object-Oriented Design Principles: Encapsulation, Abstraction, Inheritance & Polymorphism is what gives you full control over JavaScript's flexible, prototype-driven object model."}
          />
        </section>
