/**
 * Topic 12 Demo: Constructor Functions & the new Keyword Execution Lifecycle
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 12: CONSTRUCTOR FUNCTIONS & THE NEW KEYWORD EXECUTION LIFECYCLE");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Constructor Functions & the new Keyword Execution Lifecycle");
