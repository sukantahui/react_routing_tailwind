/**
 * Topic 15 Demo: ES6 Classes: Syntax, Constructors, Instance Methods & Class Expressions
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 15: ES6 CLASSES: SYNTAX, CONSTRUCTORS, INSTANCE METHODS & CLASS EXPRESSIONS");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: ES6 Classes: Syntax, Constructors, Instance Methods & Class Expressions");
