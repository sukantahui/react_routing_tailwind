/**
 * Topic 4 Demo: Deeply Nested Objects, Optional Chaining (?.) & Nullish Coalescing (??)
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 4: DEEPLY NESTED OBJECTS, OPTIONAL CHAINING (?.) & NULLISH COALESCING (??)");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Deeply Nested Objects, Optional Chaining (?.) & Nullish Coalescing (??)");
