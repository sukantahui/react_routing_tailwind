/**
 * Topic 7 Demo: Shallow Copying (Object.assign, Spread) vs Deep Copying (structuredClone)
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 7: SHALLOW COPYING (OBJECT.ASSIGN, SPREAD) VS DEEP COPYING (STRUCTUREDCLONE)");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Shallow Copying (Object.assign, Spread) vs Deep Copying (structuredClone)");
