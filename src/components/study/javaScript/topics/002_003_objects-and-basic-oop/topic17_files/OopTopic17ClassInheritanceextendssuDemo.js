/**
 * Topic 17 Demo: Class Inheritance: extends, super(), & Subclass Constructor Rules
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 17: CLASS INHERITANCE: EXTENDS, SUPER(), & SUBCLASS CONSTRUCTOR RULES");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Class Inheritance: extends, super(), & Subclass Constructor Rules");
...
console.log("");
console.log("✓ All 5 Topic 17 practical examples executed successfully.");
