/**
 * Topic 2 Demo: Adding, Modifying, Deleting Properties & The delete Operator Mechanics
 * Module: 002_003_objects-and-basic-oop
 * Educator: Sukanta Hui | Coder & AccoTax
 */

console.log("==================================================");
console.log("TOPIC 2: ADDING, MODIFYING, DELETING PROPERTIES & THE DELETE OPERATOR MECHANICS");
console.log("==================================================");
...
{
  console.log("Executing foundational pattern for: Adding, Modifying, Deleting Properties & The delete Operator Mechanics");
