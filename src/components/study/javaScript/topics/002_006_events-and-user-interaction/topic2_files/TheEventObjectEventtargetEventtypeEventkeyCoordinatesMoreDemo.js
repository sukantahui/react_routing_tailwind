...
// Topic: The Event Object — event.target, event.type, event.key, coordinates & more
...
console.log("Demonstrating foundational mechanics for: The Event Object — event.target, event.type, event.key, coordinates & more");
console.log("");
