...
// Topic: JavaScript Events & User Interaction – 30 Practical Projects (Question & Answer Lab)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: JavaScript Events & User Interaction – 30 Practical Projects (Question & Answer Lab)");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Events, Event Listeners & User Interaction",
