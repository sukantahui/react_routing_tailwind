...
export default function Topic9() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">AbortController &amp; AbortSignal for Multi-Listener Teardown · Architecture &amp; Execution Pipeline</text>
