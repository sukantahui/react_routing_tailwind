...
export default function Topic7() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Building a Custom Virtual Keyboard (Advanced) · Architecture &amp; Execution Pipeline</text>
