...
export default function Topic0() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Projects and Practical Interactive Web App Development · Architecture &amp; Execution Pipeline</text>
