...
// Topic: Role-Based Access Control (RBAC) & Attribute-Based Access Control (ABAC)
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Role-Based Access Control (RBAC) & Attribute-Based Access Control (ABAC)");
console.log("");
