...
export default function Topic3() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Modern Passwordless Auth: WebAuthn, FIDO2 &amp; Biometric Passkeys · Architecture &amp; Execution Pipeline</text>
