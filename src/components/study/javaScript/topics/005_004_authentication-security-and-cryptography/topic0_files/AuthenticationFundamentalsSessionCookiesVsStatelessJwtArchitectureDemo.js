...
// Topic: Authentication Fundamentals: Session Cookies vs Stateless JWT Architecture
// Classroom Lab: Barrackpore Lab
// Mentors: Sukanta Hui | Students: Swadeep, Tuhina
// ============================================================================

console.log("=== [1] FUNDAMENTAL CONCEPT & INITIALIZATION ===");
console.log("Demonstrating foundational mechanics for: Authentication Fundamentals: Session Cookies vs Stateless JWT Architecture");
console.log("");

// Example 1: Basic declaration and setup
const courseConfig = {
  subject: "JavaScript Master Pro",
  module: "Enterprise Security, Cryptography, OAuth2 & Zero-Trust Architecture",
