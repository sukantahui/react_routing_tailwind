...
export default function Topic2() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">OAuth 2.0 &amp; OpenID Connect: Authorization Code Flow with PKCE · Architecture &amp; Execution Pipeline</text>
