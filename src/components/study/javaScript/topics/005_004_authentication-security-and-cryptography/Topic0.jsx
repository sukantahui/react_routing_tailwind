...
export default function Topic0() {
  ...
  <defs>
    <linearGradient id="memGrad_0" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stopColor="#f59e0b" stopOpacity="0.8" />
      <stop offset="100%" stopColor="#b45309" stopOpacity="0.2" />
    </linearGradient>
    <linearGradient id="heapGrad_0" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Authentication Fundamentals: Session Cookies vs Stateless JWT Architecture · Architecture &amp; Execution Pipeline</text>
  ...
  <g transform="translate(460, 65)">
    <rect width="280" height="145" rx="12" fill="url(#heapGrad_0)" stroke="#a855f7" strokeWidth="1.5" />
