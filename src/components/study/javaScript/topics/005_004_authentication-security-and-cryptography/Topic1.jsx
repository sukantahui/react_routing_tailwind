...
export default function Topic1() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Cryptographic Password Hashing: Argon2id, Scrypt &amp; Bcrypt Benchmarks · Architecture &amp; Execution Pipeline</text>
