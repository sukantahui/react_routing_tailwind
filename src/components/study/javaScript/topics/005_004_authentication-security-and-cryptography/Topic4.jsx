...
export default function Topic4() {
  ...
  <text x="400" y="34" fill="#f8fafc" fontSize="16" fontWeight="bold" textAnchor="middle">Role-Based Access Control (RBAC) &amp; Attribute-Based Access Control (ABAC) · Architecture &amp; Execution Pipeline</text>
