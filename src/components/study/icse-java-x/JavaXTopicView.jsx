// src/components/study/JavaXTopicView.jsx
...
// ===================================================================
export default function JavaXTopicView() {
...
function TopicViewInner({ moduleSlug, topicIndex }) {
  ...
  useEffect(() => {
    const handler = (e) => {
      if (e.key === "ArrowRight" && hasNext)
        navigate(`/${roadmapData.folder}/topic/${moduleSlug}/${index + 1}`);
  ...
  }, [index, hasNext, hasPrev, moduleSlug, navigate]);
