        ...
        <div className="space-y-6">
          {activeSection === 'theory' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              {/* How It Works */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">⚙️ How Selection Sort Works</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300">Organizing a deck of cards:</p>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🎯 Prize Distribution</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Teacher Sukanta Hui selects the highest scorer first, then next highest - selection sort in action!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📋 To-Do List Prioritization</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Finding the most important task first, then next important - selecting priorities!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🏃 Race Ranking</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Selecting fastest runner first (gold), then second fastest (silver) - selection sort!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📊 Exam Grading</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Finding top score in Barrackpore school, then second highest - selection sort naturally!</p>
                  </div>
                </div>
              </div>
              ...
              {/* Properties */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">✨ Properties of Selection Sort</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Equal elements may change relative order</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                  ...
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Always O(n²) even if array sorted</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
