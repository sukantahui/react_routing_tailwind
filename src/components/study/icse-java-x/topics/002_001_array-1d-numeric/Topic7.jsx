 ...
 * - Using manual for-loop display utility
 * - Formatted output
 *
 * Animations:
...
const Topic7 = () => {
  return (
          ...
          >
            ...
            <div className="space-y-3 text-slate-300">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li><strong>manual for-loop display</strong> – quick, one‑line representation.</li>
          ...
          >
            ...
            <div className="bg-slate-800/40 border border-slate-800 rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md">
              ...
              >
                ...
                {/* ManualLoopArrayUtility.toString box */}
                <rect x="410" y="20" width="150" height="70" fill="#2d3748" rx="8" />
                <text x="430" y="50" fill="#fbbf24" fontSize="14" fontWeight="bold">manual for-loop display</text>
    ...
    System.out.print(value + " ");
                ...
                <div>
                  <dt className="font-semibold text-indigo-600 dark:text-indigo-400">
                    manual for-loop display
                  </dt>
                  <dd>
                    <code className="text-sm bg-slate-950 border border-slate-800 text-amber-300 px-2 py-1 rounded">
                      System.out.println(manual for-loop display);
                    </code>
                  </dd>
                </div>
                <div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-800/40 border border-slate-800 p-4 rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <p className="text-sm text-slate-400 dark:text-gray-300">
                  Using <code className="text-xs">manual for-loop display</code> requires <code className="text-xs"></code>.
                </p>
              </div>
              <div className="bg-slate-800/40 border border-slate-800 p-4 rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <h3 className="font-semibold text-red-600 dark:text-red-400">
              ...
              <div className="bg-slate-800/40 border border-slate-800 p-4 rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <h3 className="font-semibold text-red-600 dark:text-red-400">
                  Using <code className="text-xs">manual for-loop display</code> on multi‑dimensional arrays
                </h3>
                <p className="text-sm text-slate-400 dark:text-gray-300">
                  For 2D arrays, use <code className="text-xs">ManualLoopArrayUtility.deepToString()</code> to see nested contents.
                </p>
              </div>
            </div>
          </section>
          ...
          >
            ...
            <div className="bg-slate-800/40 border border-slate-800 p-5 rounded-lg space-y-3 shadow-sm transition-all duration-300 hover:shadow-md">
              <ul className="list-disc pl-5 space-y-2 text-slate-300">
                <li>
                  <strong>Use <code className="text-xs">manual for-loop display</code> for quick debugging</strong> – it’s concise and readable.
                </li>
                <li>
                  <strong>When formatting matters</strong> (e.g., for user output), use a loop to control spacing, commas, or alignment.
                </li>
                <li>
                  <strong>For multi‑dimensional arrays</strong>, nest loops or use <code className="text-xs">ManualLoopArrayUtility.deepToString()</code>.
                </li>
                <li>
          ...
          >
            <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <ul className="space-y-2 text-blue-700 dark:text-blue-200">
                ...
                <li>
                  • If you have an array of objects, what does <code className="text-xs">manual for-loop display</code> display?
                </li>
              </ul>
            </div>
          </section>
          ...
          >
            <div className="bg-amber-50 dark:bg-amber-900/20 p-5 rounded-lg border border-amber-200 dark:border-amber-800 transition-all duration-300 hover:shadow-lg hover:scale-[1.01]">
              ...
              <div className="space-y-3 text-amber-700 dark:text-amber-200">
                ...
                <p>
                  “Displaying arrays is your window into the program’s state. I’ve seen students in Ichapur spend hours hunting bugs when a simple <code className="text-xs">System.out.println(manual for-loop display)</code> would have revealed the issue instantly. Learn all three methods: loops for control, enhanced for simplicity, and <code className="text-xs">manual for-loop display</code> for speed. And remember – never print the reference directly unless you enjoy debugging hex codes!”
                </p>
                <p className="text-sm">
            ...
            <div className="bg-slate-800/40 border border-slate-800 p-5 rounded-lg shadow-sm">
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-slate-300">
                <li className="flex items-start gap-2">
                  <span className="text-green-600 dark:text-green-400">✔</span> Don’t print array variable directly (use loop or <code className="text-xs">manual for-loop display</code>)
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 dark:text-green-400">✔</span> <code className="text-xs">manual for-loop display</code> requires <code className="text-xs"></code>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 dark:text-green-400">✔</span> For 2D arrays, use <code className="text-xs">ManualLoopArrayUtility.deepToString()</code>
                </li>
                <li className="flex items-start gap-2">
