...
const Topic11 = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center animate-[fadeInUp_0.6s_ease-out]">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-pink-600 to-rose-600 dark:from-pink-400 dark:to-rose-400 bg-clip-text text-transparent mb-4">
        ...
        <div className="space-y-6">
          {activeSection === 'theory' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">🔄 Ascending vs Descending</h2>
    ...
    arr[j+1] = temp;
              ...
              {/* How It Works */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">⚙️ How Descending Bubble Sort Works</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300">Heavy vs Light balls:</p>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🏆 Leaderboard Ranking</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">High scores displayed highest first - top scorers (Angshuman: 98, Riddhiman: 95, Swadeep: 92) bubble to front!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📅 Recent Posts Feed</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Newest content first - dates sorted descending order (today → yesterday → last week).</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">💰 Price Sorting (High to Low)</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">E-commerce sites showing most expensive items first - customers see premium products initially.</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">⭐ Rating Sorting</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">5-star reviews appear first, then 4-star, etc. - best rated products bubble to top in Barrackpore shopping app!</p>
                  </div>
                </div>
              </div>
