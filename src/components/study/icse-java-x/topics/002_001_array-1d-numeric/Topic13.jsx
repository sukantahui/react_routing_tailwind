...
const Topic13 = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center animate-[fadeInUp_0.6s_ease-out]">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-rose-600 to-pink-600 dark:from-rose-400 dark:to-pink-400 bg-clip-text text-transparent mb-4">
        ...
        <div className="space-y-6">
          {activeSection === 'theory' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">🔄 Ascending vs Descending Selection Sort</h2>
    ...
    swap(arr[i], arr[maxIndex]);
              ...
              {/* How It Works */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">⚙️ How Descending Selection Sort Works</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300">Award ceremony:</p>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🏅 Olympic Medal Ranking</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Select gold medalist first (highest score), then silver, then bronze - descending selection sort!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📱 Top Downloads Chart</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">App store showing most downloaded apps first - selecting maximum download counts!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">💰 Wealthiest People List</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Forbes richest list - selecting highest net worth first, then next highest!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📊 Class Rank List</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Teacher Sukanta Hui ranking students: Nandini (96%) first, then Angshuman (92%), then Tuhina (91%) - descending selection!</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <p className="text-xs text-slate-400">Swaps</p>
              ...
              {/* Properties */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">✨ Properties of Descending Selection Sort</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-red-600">✗ Unstable Sort</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Equal elements may change relative order (same as ascending)</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-blue-600">✓ In-place Algorithm</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">No extra memory needed (O(1) space)</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-yellow-600">✓ Non-adaptive</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Always O(n²) even if array sorted descending</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-green-600">✓ Minimal Swaps</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Only n swaps total - great for expensive swap operations!</p>
                  </div>
                </div>
              </div>
          ...
          {activeSection === 'visual' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">👁️ Visual Walkthrough - Descending Order</h2>
