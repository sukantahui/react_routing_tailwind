...
const AlgorithmComparisonSVG = () => (
  <svg viewBox="0 0 700 250" className="w-full h-auto max-w-3xl mx-auto my-4">
    ...
    <text x="190" y="75" textAnchor="middle" fill="#7f1d1d" fontSize="11">manual Bubble / Selection Sort</text>
...
const qaData = [
  ...
  },
  {
    ...
    answer: "Yes: ManualLoopArrayUtility.stream(arr).boxed().sorted(Comparator.reverseOrder()).distinct().skip(1).findFirst()"
  },
  {
