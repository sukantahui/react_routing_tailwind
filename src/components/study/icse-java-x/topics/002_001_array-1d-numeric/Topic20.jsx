...
import demoCode from "./topic20_files/ArrayInsertDemo.java?raw";
...
const InstructionalSVG = () => (
  <svg viewBox="0 0 500 150" className="w-full h-auto max-w-xl mx-auto my-4" aria-label="Inserting an Element at a Position Diagram">
    <rect x="20" y="20" width="460" height="110" rx="10" fill="#0f172a" stroke="#38bdf8" strokeWidth="2" />
    <text x="250" y="55" textAnchor="middle" fill="#38bdf8" fontSize="16" fontWeight="bold">ICSE Algorithm: Inserting an Element at a Position</text>
    ...
    <div className="dark bg-slate-900 text-slate-200 min-h-screen py-8 px-4 md:px-6 lg:px-8 space-y-12">
      ...
      <header className="space-y-4 border-b border-slate-800 pb-6 animate-fade-in">
        ...
        <p className="text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl">
          Inserting a new element into a specific index by right-shifting existing items
        </p>
      </header>
      ...
      <section className="space-y-5 bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-slate-800 shadow-lg hover:border-slate-700 transition-all duration-300">
        ...
        <div className="space-y-4 text-slate-300 leading-relaxed">
          <p>
            Understanding <strong>Inserting an Element at a Position</strong> is a core algorithm requirement in the ICSE Class X Computer Applications syllabus.
          </p>
          <div className="p-4 bg-slate-950/60 rounded-xl border-l-4 border-sky-500 text-slate-300">
            ...
            <p className="text-sm">In Naihati computer hub, Swadeep inserts a new student's score at index 2 without overwriting existing marks.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-5">
        <FAQTemplate
          title="Inserting an Element at a Position FAQs"
          questions={questions}
        />
      </section>
      ...
      <section className="space-y-5">
        <PlainTextPrint
          content={noteText}
          title="Module 002_001 Topic 20: Inserting an Element at a Position"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Printable Note"
          downloadFileName="002_001_topic20_note.txt"
        />
      </section>
