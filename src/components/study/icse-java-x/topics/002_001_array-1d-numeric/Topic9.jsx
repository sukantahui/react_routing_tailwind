            ...
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-slate-300">
                  ...
                  <li>• <strong>Built-in method:</strong> Java provides <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">manual Binary Search loop</code></li>
            ...
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <ul className="space-y-2 text-slate-400 dark:text-gray-300 list-disc list-inside">
                  ...
                  <li>Consider using built-in <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">manual Binary Search loop</code> for production code</li>
...
const qaData = [
  ...
  {
    question: "What does manual Binary Search loop return when element not found?",
