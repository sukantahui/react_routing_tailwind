          ...
          >
            ...
            <div className="transition-all duration-300 hover:scale-[1.01]">
              <JavaFileLoader
                ...
                title="DefaultValuesNumericManualLoopArrayUtility.java"
                highlightLines={[]}
              />
            </div>
          ...
          >
            ...
            <div className="bg-slate-800/40 border border-slate-800 p-5 rounded-lg space-y-3 shadow-sm transition-all duration-300 hover:shadow-md">
              <ul className="list-disc pl-5 space-y-2 text-slate-300">
                ...
                <li>
                  <strong>Use <code className="text-xs">ManualLoopArrayUtility.fill()</code></strong> to set all elements to a specific non‑default value after creation.
                </li>
                <li>
