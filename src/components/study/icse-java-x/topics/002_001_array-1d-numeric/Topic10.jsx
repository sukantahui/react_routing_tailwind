    ...
    <div className="min-h-screen bg-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center animate-[fadeInUp_0.6s_ease-out]">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent mb-4">
        ...
        <div className="space-y-6">
          {activeSection === 'theory' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              {/* How It Works */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">⚙️ How Bubble Sort Works</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300">Bubbles in a soda:</p>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🎈 Balloon Sorting Game</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Teacher Sukanta Hui has students line up by height - tallest students "bubble" to the end through adjacent swaps!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📚 Library Book Arranging</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Librarian in Barrackpore arranging books by call number - each pass moves largest number to correct shelf.</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">🏃‍♂️ Race Results</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Sorting race times - slowest times bubble to bottom, fastest rise to top!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300">
                    <h3 className="font-semibold text-slate-200 mb-2">📊 Exam Score Sorting</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Angshuman's 95 bubbles up, while lower scores sink down - perfect for small class sizes!</p>
                  </div>
                </div>
              </div>
              ...
              {/* Properties */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">✨ Properties of Bubble Sort</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Equal elements maintain their relative order</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-blue-600">✓ In-place Algorithm</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">No extra memory needed</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-yellow-600">✓ Adaptive</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Performance improves on partially sorted arrays</p>
                  </div>
                  <div className="p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-purple-600">✓ Online</span>
                    <p className="text-sm text-slate-400 dark:text-gray-300 mt-1">Can sort as elements arrive</p>
                  </div>
                </div>
              </div>
