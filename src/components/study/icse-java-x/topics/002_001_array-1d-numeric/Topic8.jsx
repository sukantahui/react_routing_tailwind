        ...
        <div className="space-y-6">
          {activeSection === 'theory' && (
            <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
              ...
              {/* How It Works */}
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                <h2 className="text-2xl font-semibold text-white mb-4">⚙️ How Linear Search Works</h2>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg">
                    <h3 className="font-semibold text-slate-200 mb-2">📚 Library Book Search</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">A librarian checking each shelf sequentially until finding "Harry Potter" - books aren't sorted by title!</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg">
                    <h3 className="font-semibold text-slate-200 mb-2">🎒 Lost Student ID</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Teacher Sukanta Hui checking each student in Barrackpore school roll call until finding Abhronila's ID card.</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg">
                    <h3 className="font-semibold text-slate-200 mb-2">🚇 Train Platform Search</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Checking platform numbers sequentially at Shyamnagar station to find train to Naihati.</p>
                  </div>
                  <div className="bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg">
                    <h3 className="font-semibold text-slate-200 mb-2">📱 Contact List</h3>
                    <p className="text-sm text-slate-400 dark:text-gray-300">Scrolling through unsorted phone contacts to find "Riddhiman" - one by one until found.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-slate-300 dark:text-gray-200">Best Case:</span>
                    <span className="text-green-600 dark:text-green-400 font-mono">O(1)</span>
                    <span className="text-sm text-slate-400">Element found at first position (index 0)</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-slate-300 dark:text-gray-200">Average Case:</span>
                    <span className="text-yellow-600 dark:text-yellow-400 font-mono">O(n)</span>
                    <span className="text-sm text-slate-400">Element found in middle of array</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-slate-300 dark:text-gray-200">Worst Case:</span>
                    <span className="text-red-600 dark:text-red-400 font-mono">O(n)</span>
                    <span className="text-sm text-slate-400">Element at last position or not present</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-slate-950/60 dark:bg-gray-700/50 rounded-lg">
                    <span className="font-semibold text-slate-300 dark:text-gray-200">Space Complexity:</span>
                    <span className="text-blue-600 dark:text-blue-400 font-mono">O(1)</span>
                    <span className="text-sm text-slate-400">No extra space needed (iterative)</span>
                  </div>
                </div>
              </div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-slate-950/60 dark:bg-gray-700/50">
                      <tr>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Step</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Index</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Element</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Target</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Match?</th>
                        <th className="px-4 py-2 text-left text-sm font-semibold text-slate-300 dark:text-gray-200">Action</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {[
                        ...
                        <tr key={i} className={row.match === '✓ Yes' ? 'bg-green-50 dark:bg-green-900/20' : ''}>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">{row.step}</td>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">{row.idx}</td>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">{row.elem}</td>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">67</td>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">{row.match}</td>
                          <td className="px-4 py-2 text-sm text-slate-400 dark:text-gray-300">{row.action}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-slate-200">Off-by-one errors</p>
                      <p className="text-sm text-slate-400 dark:text-gray-300">Loop condition <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">i &lt;= arr.length</code> causes ArrayIndexOutOfBoundsException</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <span className="text-red-600 dark:text-red-400 text-xl">❌</span>
                    <div>
                      <p className="font-semibold text-slate-200">Forgetting to return -1</p>
                      <p className="text-sm text-slate-400 dark:text-gray-300">Method with no return when element not found causes compilation error</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <span className="text-red-600 dark:text-red-400 text-xl">❌</span>
                    <div>
                      <p className="font-semibold text-slate-200">Comparing objects with ==</p>
                      <p className="text-sm text-slate-400 dark:text-gray-300">Use <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">.equals()</code> for String/Object comparison</p>
                    </div>
                  </div>
                </div>
              </div>
