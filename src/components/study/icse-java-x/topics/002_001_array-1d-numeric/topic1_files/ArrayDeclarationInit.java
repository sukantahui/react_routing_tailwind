...
public class ArrayDeclarationInit {
    public static void main(String[] args) {
        ...
        System.out.println("arr1: " + java.util.displayArray(arr));
        System.out.println("arr2: " + java.util.displayArray(arr));
        System.out.println("arr3: " + java.util.displayArray(arr));
    }

    // Helper method that accepts an array
    public static void printArray(int[] array) {
        System.out.println("Anonymous array: " + java.util.displayArray(arr));
    }
}