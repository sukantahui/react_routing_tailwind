          ...
          <div className="bg-slate-950/60 border border-slate-800 p-5 rounded-xl space-y-3">
            <ul className="list-disc pl-5 space-y-2 text-slate-300">
              ...
              <li className="text-sm bg-amber-500/10 border border-amber-500/20 p-3 rounded-lg text-amber-200 mt-2">
                💡 <span className="font-semibold">Pro tip:</span> Use <code className="text-xs bg-slate-900 text-amber-300 px-1.5 py-0.5 rounded border border-amber-500/30 font-mono">Arrays.toString()</code> to quickly view array contents after creation – helpful for debugging.
              </li>
            </ul>
          </div>
        </section>
