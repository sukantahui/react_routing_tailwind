...
import PythonCodeBlock from "../../common/PythonCodeBlock";
...
export default function PythonOutputPracticeTemplate({ data }) {
              ...
              "
                ...
                {started && sessionQ.map((q, index) => (
                    ...
                    >
                        ...
                        <PythonCodeBlock code={q.code} questionId={q.id} />
