      ...
      <div className={themeClasses}>
        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <header className={clsx(sectionAnimation, "mb-12 text-center")}>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">
              ...
              <div className={`p-6 ${getSecurityBg(securityScore)} rounded-lg border-l-4 ${securityScore >= 90 ? 'border-green-500' : securityScore >= 70 ? 'border-yellow-500' : 'border-red-500'}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-center">
                    <div className={`text-xl sm:text-2xl md:text-3xl font-bold ${getSecurityColor(securityScore)}`} style={{animation: 'pulseSecurity 2s infinite'}}>
                      {securityScore}%
                    </div>
