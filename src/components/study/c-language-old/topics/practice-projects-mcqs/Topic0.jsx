...
import projectsData from "./topic0_files/basic-segment-projects.json";             // your generated JSON file
...
export default function CProjectPage() {
  ...
  useEffect(() => {
    ...
    const modules = import.meta.glob("./topic0_files/answers/*.c", { query: "?raw", import: "default", eager: true });
