...
1. Computational mechanisms and algorithmic step-by-step logic for Need for splitting criteria.
...
class Topic0LabEngine:
    """
    Simulation engine for Need for splitting criteria in Entropy and Information Gain.
    """
...
def run_laboratory():
    ...
    print("NEED FOR SPLITTING CRITERIA")
