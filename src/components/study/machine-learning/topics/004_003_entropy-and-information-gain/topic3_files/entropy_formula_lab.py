...
1. Computational mechanisms and algorithmic step-by-step logic for Entropy formula.
...
class Topic3LabEngine:
    """
    Simulation engine for Entropy formula in Entropy and Information Gain.
    """
