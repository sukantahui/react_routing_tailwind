...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Entropy of a binary dataset.
...
class Topic8LabEngine:
    """
    Simulation engine for Worked Example 1: Entropy of a binary dataset in Entropy and Information Gain.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: ENTROPY OF A BINARY DATASET")
