"""
=============================================================================
TOPIC 6: CALCULATING WEIGHTED ENTROPY
...
1. Computational mechanisms and algorithmic step-by-step logic for Calculating weighted entropy.
...
class Topic6LabEngine:
    """
    Simulation engine for Calculating weighted entropy in Entropy and Information Gain.
    """
...
def run_laboratory():
    ...
    print("CALCULATING WEIGHTED ENTROPY")
