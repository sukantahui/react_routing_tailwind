...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Selecting the root node.
...
class Topic10LabEngine:
    """
    Simulation engine for Worked Example 3: Selecting the root node in Entropy and Information Gain.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: SELECTING THE ROOT NODE")
