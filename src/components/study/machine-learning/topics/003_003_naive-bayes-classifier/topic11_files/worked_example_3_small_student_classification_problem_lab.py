...
Module: Naive Bayes Classifier (Slug: 003_003_naive-bayes-classifier)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Small student classification problem.
...
class Topic11LabEngine:
    """
    Simulation engine for Worked Example 3: Small student classification problem in Naive Bayes Classifier.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: SMALL STUDENT CLASSIFICATION PROBLEM")
    print("Module: Naive Bayes Classifier")
    print("=" * 80)
