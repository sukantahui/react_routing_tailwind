...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Simple categorical Naive Bayes.
...
class Topic9LabEngine:
    """
    Simulation engine for Worked Example 1: Simple categorical Naive Bayes in Naive Bayes Classifier.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: SIMPLE CATEGORICAL NAIVE BAYES")
