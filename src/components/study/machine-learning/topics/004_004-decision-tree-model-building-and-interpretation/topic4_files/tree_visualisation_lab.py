...
1. Computational mechanisms and algorithmic step-by-step logic for Tree visualisation.
...
class Topic4LabEngine:
    """
    Simulation engine for Tree visualisation in Decision Tree Model Building and Interpretation.
    """
