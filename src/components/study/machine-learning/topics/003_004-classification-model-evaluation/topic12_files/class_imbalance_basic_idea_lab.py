...
1. Computational mechanisms and algorithmic step-by-step logic for Class imbalance (basic idea).
...
class Topic12LabEngine:
    """
    Simulation engine for Class imbalance (basic idea) in Classification Model Evaluation.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Class imbalance (basic idea)",
...
def run_laboratory():
    ...
    print("CLASS IMBALANCE (BASIC IDEA)")
