...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Constructing a confusion matrix.
...
class Topic14LabEngine:
    """
    Simulation engine for Worked Example 1: Constructing a confusion matrix in Classification Model Evaluation.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: Constructing a confusion matrix",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: CONSTRUCTING A CONFUSION MATRIX")
