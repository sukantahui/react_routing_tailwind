...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 5: Calculating F1-score.
...
class Topic18LabEngine:
    """
    Simulation engine for Worked Example 5: Calculating F1-score in Classification Model Evaluation.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 5: Calculating F1-score",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 5: CALCULATING F1-SCORE")
