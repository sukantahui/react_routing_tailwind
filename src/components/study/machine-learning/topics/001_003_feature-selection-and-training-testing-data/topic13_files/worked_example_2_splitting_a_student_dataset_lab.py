...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 2: Splitting a student dataset.
...
class Topic13LabEngine:
    """
    Simulation engine for Worked Example 2: Splitting a student dataset in Feature Selection and Training & Testing Data.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 2: Splitting a student dataset",
...
def run_laboratory():
    print("=" * 80)
    print("CODER & ACCOTAX - MACHINE LEARNING LAB (TOPIC 13)")
    print("WORKED EXAMPLE 2: SPLITTING A STUDENT DATASET")
    print("Module: Feature Selection and Training & Testing Data")
    print("=" * 80)
    
    lab = Topic13LabEngine()
