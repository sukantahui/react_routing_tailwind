...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Cleaning a student dataset.
...
class Topic21LabEngine:
    """
    Simulation engine for Worked Example 1: Cleaning a student dataset in Data Types and Preprocessing.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: Cleaning a student dataset",
...
def run_laboratory():
    print("=" * 80)
    print("CODER & ACCOTAX - MACHINE LEARNING LAB (TOPIC 21)")
    print("WORKED EXAMPLE 1: CLEANING A STUDENT DATASET")
    print("Module: Data Types and Preprocessing")
    print("=" * 80)
    
    lab = Topic21LabEngine()
