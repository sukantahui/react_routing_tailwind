...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 4: Scaling age and income features.
...
class Topic24LabEngine:
    """
    Simulation engine for Worked Example 4: Scaling age and income features in Data Types and Preprocessing.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 4: Scaling age and income features",
...
def run_laboratory():
    print("=" * 80)
    print("CODER & ACCOTAX - MACHINE LEARNING LAB (TOPIC 24)")
    print("WORKED EXAMPLE 4: SCALING AGE AND INCOME FEATURES")
    print("Module: Data Types and Preprocessing")
    print("=" * 80)
    
    lab = Topic24LabEngine()
