...
1. Core computational mechanisms of Practice Problems.
...
class Topic19SimulationEngine:
    """
    Dedicated simulation engine for Practice Problems.
    """
...
def run_lab():
    ...
    engine = Topic19SimulationEngine()
