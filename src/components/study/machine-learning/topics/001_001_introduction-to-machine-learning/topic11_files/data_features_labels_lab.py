...
1. Core computational mechanisms of Data, Features, Labels and Target Variables.
...
class Topic11SimulationEngine:
    """
    Dedicated simulation engine for Data, Features, Labels and Target Variables.
    """
...
def run_lab():
    ...
    engine = Topic11SimulationEngine()
