...
1. Core computational mechanisms of Training, Validation and Testing Data.
...
class Topic12SimulationEngine:
    """
    Dedicated simulation engine for Training, Validation and Testing Data.
    """
...
def run_lab():
    ...
    engine = Topic12SimulationEngine()
