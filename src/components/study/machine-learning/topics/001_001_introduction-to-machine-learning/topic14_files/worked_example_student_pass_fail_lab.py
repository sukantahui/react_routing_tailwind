...
1. Core computational mechanisms of Worked Example 1: Student Pass/Fail Prediction.
...
class Topic14SimulationEngine:
    """
    Dedicated simulation engine for Worked Example 1: Student Pass/Fail Prediction.
    """
...
def run_lab():
    ...
    engine = Topic14SimulationEngine()
