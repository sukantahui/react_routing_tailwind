...
1. Core computational mechanisms of Worked Example 5: Customer Segmentation.
...
class Topic18SimulationEngine:
    """
    Dedicated simulation engine for Worked Example 5: Customer Segmentation.
    """
...
def run_lab():
    ...
    engine = Topic18SimulationEngine()
