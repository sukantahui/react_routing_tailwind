...
1. Core computational mechanisms of Worked Example 3: Customer Churn Prediction.
...
class Topic16SimulationEngine:
    """
    Dedicated simulation engine for Worked Example 3: Customer Churn Prediction.
    """
...
def run_lab():
    ...
    engine = Topic16SimulationEngine()
