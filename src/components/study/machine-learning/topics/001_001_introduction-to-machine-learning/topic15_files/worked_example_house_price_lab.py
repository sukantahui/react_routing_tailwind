...
1. Core computational mechanisms of Worked Example 2: House Price Prediction.
...
class Topic15SimulationEngine:
    """
    Dedicated simulation engine for Worked Example 2: House Price Prediction.
    """
...
def run_lab():
    ...
    engine = Topic15SimulationEngine()
