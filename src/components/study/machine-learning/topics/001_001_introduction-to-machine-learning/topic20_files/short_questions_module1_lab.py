...
1. Core computational mechanisms of Short Questions.
...
class Topic20SimulationEngine:
    """
    Dedicated simulation engine for Short Questions.
    """
...
def run_lab():
    ...
    engine = Topic20SimulationEngine()
