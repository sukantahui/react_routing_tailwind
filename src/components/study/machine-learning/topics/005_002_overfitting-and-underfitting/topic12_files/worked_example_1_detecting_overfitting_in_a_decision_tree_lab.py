...
Module: Overfitting and Underfitting (Slug: 005_002_overfitting-and-underfitting)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Detecting overfitting in a decision tree.
...
class Topic12LabEngine:
    """
    Simulation engine for Worked Example 1: Detecting overfitting in a decision tree in Overfitting and Underfitting.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: DETECTING OVERFITTING IN A DECISION TREE")
    print("Module: Overfitting and Underfitting")
    print("=" * 80)
