...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Sales forecasting example.
...
class Topic12LabEngine:
    """
    Simulation engine for Worked Example 3: Sales forecasting example in Regression Applications and Practice.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: SALES FORECASTING EXAMPLE")
