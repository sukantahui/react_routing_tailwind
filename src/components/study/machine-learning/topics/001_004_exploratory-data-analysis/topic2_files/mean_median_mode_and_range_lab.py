"""
=============================================================================
TOPIC 2: MEAN, MEDIAN, MODE AND RANGE
...
1. Computational mechanisms and algorithmic step-by-step logic for Mean, median, mode and range.
...
class Topic2LabEngine:
    """
    Simulation engine for Mean, median, mode and range in Exploratory Data Analysis.
    """
...
def run_laboratory():
    ...
    print("MEAN, MEDIAN, MODE AND RANGE")
