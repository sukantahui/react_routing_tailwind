...
Module: Exploratory Data Analysis (Slug: 001_004_exploratory-data-analysis)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Detecting an outlier using a box plot.
...
class Topic16LabEngine:
    """
    Simulation engine for Worked Example 3: Detecting an outlier using a box plot in Exploratory Data Analysis.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 3: Detecting an outlier using a box plot",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: DETECTING AN OUTLIER USING A BOX PLOT")
    print("Module: Exploratory Data Analysis")
    print("=" * 80)
