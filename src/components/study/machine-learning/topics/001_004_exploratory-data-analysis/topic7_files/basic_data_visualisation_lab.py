...
1. Computational mechanisms and algorithmic step-by-step logic for Basic data visualisation.
...
class Topic7LabEngine:
    """
    Simulation engine for Basic data visualisation in Exploratory Data Analysis.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Basic data visualisation",
...
def run_laboratory():
    ...
    print("BASIC DATA VISUALISATION")
