"""
===============================================================================
CODER & ACCOTAX ML LAB: Constructing a Dendrogram by Hand
File: dendrogram_construction_lab.py
Module: 006_002 Hierarchical Clustering • Topic 12
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Constructing a Dendrogram by Hand")
