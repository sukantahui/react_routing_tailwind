"""
===============================================================================
CODER & ACCOTAX ML LAB: The Dendrogram Architecture & Tree Representation
File: dendrogram_architecture_lab.py
Module: 006_002 Hierarchical Clustering • Topic 8
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: The Dendrogram Architecture & Tree Representation")
