...
import labCode from "./topic3_files/pairwise_distances_lab.py?raw";
    ...
    <div className="space-y-8 text-slate-200 leading-relaxed max-w-6xl mx-auto pt-6 pb-12">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="px-3.5 py-1 text-xs font-bold tracking-wider uppercase bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 rounded-full">
              BCAC701B • Advanced ML • Module 006_002 • Topic 3
            </span>
            <span className="px-3 py-1 text-xs font-semibold bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 rounded-full">
              Dissimilarity Foundations
            </span>
          </div>

          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight">
            Pairwise Distance Metrics for Hierarchical Systems
          </h1>

          <p className="text-base sm:text-lg text-slate-300 max-w-4xl leading-relaxed">
            Understand how initial N x N dissimilarity matrices are constructed using Euclidean, Manhattan, Cosine, and Mahalanobis distance functions to ground hierarchical clustering.
          </p>
      ...
      <section id="theory" className="scroll-mt-6 bg-gradient-to-br from-indigo-950/40 via-slate-900 to-slate-900 border-2 border-indigo-500/30 rounded-3xl p-6 md:p-8 shadow-2xl space-y-6">
        <div className="flex items-center gap-3 border-b border-indigo-500/20 pb-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-indigo-200 tracking-tight">
              Teacher's Corner: The City Road Distance vs Flight Path Analogy
            </h2>
        ...
        <div className="space-y-5 text-slate-300 text-sm md:text-base leading-relaxed">
          <p>
            Welcome students! Today we master <strong>Observation Distance Metrics</strong>. Let's step into our Barrackpore ML Lab and see how hierarchical structures organize data points into meaningful nested families without requiring a fixed pre-set cluster count!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-indigo-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Barrackpore Warehousing Freight Cost Matrix</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Sukanta Hui computed road distance matrices between 20 warehouses using Manhattan metric to plan truck routes.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-amber-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Kolkata Financial Fraud Feature Matrix</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Debangshu built Mahalanobis distance matrices across correlated banking transaction features.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-emerald-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Jadavpur Text Mining Document Similarity</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Susmita created Cosine distance matrices across 5,000 research paper vector embeddings.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-rose-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Shyamnagar Retail Customer Distance Matrix</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Tuhina constructed scaled Euclidean distance matrices across customer purchasing history vectors.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
            <div className="bg-slate-950 p-4 rounded-xl border border-indigo-800/50 space-y-1.5">
              <div className="text-xs font-bold text-indigo-400 uppercase tracking-wider">❓ WHAT is Observation Distance Metrics?</div>
              <p className="text-xs text-slate-300 leading-relaxed">
      ...
      <section id="diagram" className="scroll-mt-6 space-y-4">
        <h2 className="text-xl font-bold text-sky-300 flex items-center gap-2">
          <span>⚙️</span> Semantic Visual Diagram: Observation-to-Observation Proximity Matrix Construction
        </h2>
        <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 overflow-x-auto shadow-inner">
          <svg viewBox="0 0 920 300" className="w-full min-w-[750px] font-sans">
            <text x="460" y="25" textAnchor="middle" fill="#38bdf8" className="font-bold text-sm">
              Observation-to-Observation Proximity Matrix Construction
            </text>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Mathematical Formulations &amp; Symmetric N x N Distance Matrix Formulations
            </h2>
      ...
      <section id="caseStudies" className="scroll-mt-6 bg-slate-900/90 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-indigo-400 uppercase">Case 1 • Barrackpore Warehousing Freight Cost Matrix</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase">Case 2 • Kolkata Financial Fraud Feature Matrix</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-purple-400 uppercase">Case 3 • Jadavpur Text Mining Document Similarity</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-rose-400 uppercase">Case 4 • Shyamnagar Retail Customer Distance Matrix</span>
      ...
      <section className="space-y-4 bg-amber-950/20 border border-amber-900/40 p-6 rounded-2xl">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          Why must all continuous features be standardized (z-score scaling) before computing distance matrices for hierarchical clustering?
        </p>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Interactive standalone lab script for Observation Distance Metrics
            </p>
          </div>
        </div>
        ...
        <PythonFileLoader
          fileModule={labCode}
          title="pairwise_distances_lab.py"
      ...
      <section className="space-y-4">
        <FAQTemplate
          title="Pairwise Distance Metrics for Hierarchical Systems — Frequently Asked Questions"
          questions={questions}
        />
      </section>
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Pairwise Distance Metrics for Hierarchical Systems"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Topic 3 Note"
          downloadFileName="module_006_002_topic3_note.txt"
        />
      </section>
      ...
      <section>
        <Teacher
          note="Observation Distance Metrics provides an intuitive, deterministic multi-scale view of data structure. Master linkage criteria and dendrogram interpretation, and you can unlock deep nested insights across any dataset! — Sukanta Hui"
        />
      </section>
    </div>
  );
