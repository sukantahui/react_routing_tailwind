"""
===============================================================================
CODER & ACCOTAX ML LAB: Pairwise Distance Metrics for Hierarchical Systems
File: pairwise_distances_lab.py
Module: 006_002 Hierarchical Clustering • Topic 3
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Pairwise Distance Metrics for Hierarchical Systems")
