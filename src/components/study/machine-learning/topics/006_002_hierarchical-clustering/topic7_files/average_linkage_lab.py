"""
===============================================================================
CODER & ACCOTAX ML LAB: Average Linkage (UPGMA & Ward's Variance Criterion)
File: average_linkage_lab.py
Module: 006_002 Hierarchical Clustering • Topic 7
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Average Linkage (UPGMA & Ward's Variance Criterion)")
