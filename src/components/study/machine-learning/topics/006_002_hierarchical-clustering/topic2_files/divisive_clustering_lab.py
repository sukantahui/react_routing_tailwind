"""
===============================================================================
CODER & ACCOTAX ML LAB: Divisive (Top-Down) Hierarchical Clustering
File: divisive_clustering_lab.py
Module: 006_002 Hierarchical Clustering • Topic 2
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Divisive (Top-Down) Hierarchical Clustering")
