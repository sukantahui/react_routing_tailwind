"""
===============================================================================
CODER & ACCOTAX ML LAB: Single Linkage (Minimum Distance / Nearest-Neighbor)
File: single_linkage_lab.py
Module: 006_002 Hierarchical Clustering • Topic 5
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Single Linkage (Minimum Distance / Nearest-Neighbor)")
