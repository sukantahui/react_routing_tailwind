"""
===============================================================================
CODER & ACCOTAX ML LAB: Complete Linkage (Maximum Distance / Farthest-Neighbor)
File: complete_linkage_lab.py
Module: 006_002 Hierarchical Clustering • Topic 6
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Complete Linkage (Maximum Distance / Farthest-Neighbor)")
