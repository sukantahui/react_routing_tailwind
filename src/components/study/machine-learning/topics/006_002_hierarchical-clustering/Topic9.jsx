...
import labCode from "./topic9_files/dendrogram_interpretation_lab.py?raw";
    ...
    <div className="space-y-8 text-slate-200 leading-relaxed max-w-6xl mx-auto pt-6 pb-12">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="px-3.5 py-1 text-xs font-bold tracking-wider uppercase bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 rounded-full">
              BCAC701B • Advanced ML • Module 006_002 • Topic 9
            </span>
            <span className="px-3 py-1 text-xs font-semibold bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 rounded-full">
              Tree Validation & CPCC
            </span>
          </div>

          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight">
            Interpreting Dendrograms & Cophenetic Correlation
          </h1>

          <p className="text-base sm:text-lg text-slate-300 max-w-4xl leading-relaxed">
            Learn how to interpret dendrogram branch structures and evaluate tree quality using the Cophenetic Correlation Coefficient (CPCC) between original distances and cophenetic tree distances.
          </p>
      ...
      <section id="theory" className="scroll-mt-6 bg-gradient-to-br from-indigo-950/40 via-slate-900 to-slate-900 border-2 border-indigo-500/30 rounded-3xl p-6 md:p-8 shadow-2xl space-y-6">
        <div className="flex items-center gap-3 border-b border-indigo-500/20 pb-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-indigo-200 tracking-tight">
              Teacher's Corner: The Map Distortion & Topographic Contour Analogy
            </h2>
        ...
        <div className="space-y-5 text-slate-300 text-sm md:text-base leading-relaxed">
          <p>
            Welcome students! Today we master <strong>Dendrogram Interpretation & CPCC</strong>. Let's step into our Barrackpore ML Lab and see how hierarchical structures organize data points into meaningful nested families without requiring a fixed pre-set cluster count!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-indigo-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Barrackpore Financial Credit Scoring Tree Validation</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Debangshu evaluated the CPCC of a credit scoring dendrogram (CPCC = 0.89) to verify tree fidelity.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-amber-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Kolkata Traffic Congestion Cluster Tree</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Susmita verified traffic bottleneck dendrograms across peak commuter hours using cophenetic correlation.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-emerald-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Jadavpur Genomic Sequence Tree Fidelity</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Mahima calculated CPCC across DNA sequence distance matrices and biological tree representations.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-rose-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Shyamnagar Retail Basket Hierarchy Check</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Tuhina validated market basket clustering dendrograms prior to retail store layout changes.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
            <div className="bg-slate-950 p-4 rounded-xl border border-indigo-800/50 space-y-1.5">
              <div className="text-xs font-bold text-indigo-400 uppercase tracking-wider">❓ WHAT is Dendrogram Interpretation & CPCC?</div>
              <p className="text-xs text-slate-300 leading-relaxed">
      ...
      <section id="diagram" className="scroll-mt-6 space-y-4">
        <h2 className="text-xl font-bold text-sky-300 flex items-center gap-2">
          <span>⚙️</span> Semantic Visual Diagram: Original Distance Matrix vs Cophenetic Distance Matrix Comparison
        </h2>
        <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 overflow-x-auto shadow-inner">
          <svg viewBox="0 0 920 300" className="w-full min-w-[750px] font-sans">
            <text x="460" y="25" textAnchor="middle" fill="#38bdf8" className="font-bold text-sm">
              Original Distance Matrix vs Cophenetic Distance Matrix Comparison
            </text>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Mathematical Formulations &amp; Cophenetic Correlation Coefficient (CPCC) Formula
            </h2>
      ...
      <section id="caseStudies" className="scroll-mt-6 bg-slate-900/90 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-indigo-400 uppercase">Case 1 • Barrackpore Financial Credit Scoring Tree Validation</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase">Case 2 • Kolkata Traffic Congestion Cluster Tree</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-purple-400 uppercase">Case 3 • Jadavpur Genomic Sequence Tree Fidelity</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-rose-400 uppercase">Case 4 • Shyamnagar Retail Basket Hierarchy Check</span>
      ...
      <section className="space-y-4 bg-amber-950/20 border border-amber-900/40 p-6 rounded-2xl">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          What does a Cophenetic Correlation Coefficient (CPCC) close to 1.0 indicate about the quality of a dendrogram?
        </p>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Interactive standalone lab script for Dendrogram Interpretation & CPCC
            </p>
          </div>
        </div>
        ...
        <PythonFileLoader
          fileModule={labCode}
          title="dendrogram_interpretation_lab.py"
      ...
      <section className="space-y-4">
        <FAQTemplate
          title="Interpreting Dendrograms & Cophenetic Correlation — Frequently Asked Questions"
          questions={questions}
        />
      </section>
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Interpreting Dendrograms & Cophenetic Correlation"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Topic 9 Note"
          downloadFileName="module_006_002_topic9_note.txt"
        />
      </section>
      ...
      <section>
        <Teacher
          note="Dendrogram Interpretation & CPCC provides an intuitive, deterministic multi-scale view of data structure. Master linkage criteria and dendrogram interpretation, and you can unlock deep nested insights across any dataset! — Sukanta Hui"
        />
      </section>
    </div>
  );
