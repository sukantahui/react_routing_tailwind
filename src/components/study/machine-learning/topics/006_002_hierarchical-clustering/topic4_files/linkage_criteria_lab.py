"""
===============================================================================
CODER & ACCOTAX ML LAB: Cluster Linkage Criteria & Inter-Cluster Dissimilarity
File: linkage_criteria_lab.py
Module: 006_002 Hierarchical Clustering • Topic 4
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Cluster Linkage Criteria & Inter-Cluster Dissimilarity")
