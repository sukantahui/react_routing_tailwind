...
import labCode from "./topic14_files/short_questions_lab.py?raw";
    ...
    <div className="space-y-8 text-slate-200 leading-relaxed max-w-6xl mx-auto pt-6 pb-12">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="px-3.5 py-1 text-xs font-bold tracking-wider uppercase bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 rounded-full">
              BCAC701B • Advanced ML • Module 006_002 • Topic 14
            </span>
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight">
            Hierarchical Clustering Conceptual & Technical Review
          </h1>

          <p className="text-base sm:text-lg text-slate-300 max-w-4xl leading-relaxed">
            Review key concepts, high-frequency university exam short questions, viva voce questions, and a complete formula cheat-sheet for Hierarchical Clustering.
          </p>
      ...
      <section id="theory" className="scroll-mt-6 bg-gradient-to-br from-indigo-950/40 via-slate-900 to-slate-900 border-2 border-indigo-500/30 rounded-3xl p-6 md:p-8 shadow-2xl space-y-6">
        <div className="flex items-center gap-3 border-b border-indigo-500/20 pb-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-indigo-200 tracking-tight">
              Teacher's Corner: The Final Revision & Viva Voce Preparation
            </h2>
        ...
        <div className="space-y-5 text-slate-300 text-sm md:text-base leading-relaxed">
          <p>
            Welcome students! Today we master <strong>Hierarchical Clustering Review & FAQs</strong>. Let's step into our Barrackpore ML Lab and see how hierarchical structures organize data points into meaningful nested families without requiring a fixed pre-set cluster count!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-indigo-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Barrackpore University Examination Quick Review</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Sukanta Hui summarized top 15 short-answer questions for BCA Semester VII exams.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-amber-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Kolkata Tech Job Viva Voce Preparation</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Sachin reviewed core hierarchical clustering definitions for senior ML engineer technical interviews.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-emerald-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Jadavpur Academic Seminar Summary</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Mahima compiled a concise memory cheat-sheet covering agglomerative vs divisive trade-offs.
              </p>
            </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-rose-800/60 space-y-2">
              ...
              <h3 className="font-bold text-white text-sm">Naihati ML Workshop Cheat-Sheet Distribution</h3>
              <p className="text-xs text-slate-300 leading-relaxed">
                Susmita published a 1-page quick revision sheet for hierarchical clustering linkage algorithms.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
            <div className="bg-slate-950 p-4 rounded-xl border border-indigo-800/50 space-y-1.5">
              <div className="text-xs font-bold text-indigo-400 uppercase tracking-wider">❓ WHAT is Hierarchical Clustering Review & FAQs?</div>
              <p className="text-xs text-slate-300 leading-relaxed">
      ...
      <section id="diagram" className="scroll-mt-6 space-y-4">
        <h2 className="text-xl font-bold text-sky-300 flex items-center gap-2">
          <span>⚙️</span> Semantic Visual Diagram: Hierarchical Clustering Master Concept & Formula Cheat-Sheet
        </h2>
        <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 overflow-x-auto shadow-inner">
          <svg viewBox="0 0 920 300" className="w-full min-w-[750px] font-sans">
            <text x="460" y="25" textAnchor="middle" fill="#38bdf8" className="font-bold text-sm">
              Hierarchical Clustering Master Concept & Formula Cheat-Sheet
            </text>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Mathematical Formulations &amp; Master Formula Summary & High-Frequency Exam Q&A
            </h2>
      ...
      <section id="caseStudies" className="scroll-mt-6 bg-slate-900/90 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-indigo-400 uppercase">Case 1 • Barrackpore University Examination Quick Review</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase">Case 2 • Kolkata Tech Job Viva Voce Preparation</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-purple-400 uppercase">Case 3 • Jadavpur Academic Seminar Summary</span>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            <span className="text-xs font-mono font-bold text-rose-400 uppercase">Case 4 • Naihati ML Workshop Cheat-Sheet Distribution</span>
      ...
      <section className="space-y-4 bg-amber-950/20 border border-amber-900/40 p-6 rounded-2xl">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          What are the primary computational time and memory complexities of standard Agglomerative Hierarchical Clustering O(N^3) and O(N^2)?
        </p>
      </section>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Interactive standalone lab script for Hierarchical Clustering Review & FAQs
            </p>
          </div>
        </div>
      ...
      <section className="space-y-4">
        <FAQTemplate
          title="Hierarchical Clustering Conceptual & Technical Review — Frequently Asked Questions"
          questions={questions}
        />
      </section>
      ...
      <section className="space-y-4">
        <PlainTextPrint
          content={noteText}
          title="Hierarchical Clustering Conceptual & Technical Review"
          stampEnabled={true}
          showDownload={true}
          downloadButtonText="Download Topic 14 Note"
          downloadFileName="module_006_002_topic14_note.txt"
        />
      </section>
      ...
      <section>
        <Teacher
          note="Hierarchical Clustering Review & FAQs provides an intuitive, deterministic multi-scale view of data structure. Master linkage criteria and dendrogram interpretation, and you can unlock deep nested insights across any dataset! — Sukanta Hui"
        />
      </section>
    </div>
  );
