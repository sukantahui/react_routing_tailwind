"""
===============================================================================
CODER & ACCOTAX ML LAB: Agglomerative (Bottom-Up) Hierarchical Clustering
File: agglomerative_clustering_lab.py
Module: 006_002 Hierarchical Clustering • Topic 1
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Agglomerative (Bottom-Up) Hierarchical Clustering")
