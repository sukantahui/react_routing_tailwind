"""
===============================================================================
CODER & ACCOTAX ML LAB: Selecting Optimal K via Horizontal Dendrogram Cuts
File: dendrogram_cutting_lab.py
Module: 006_002 Hierarchical Clustering • Topic 10
...
def run_hierarchical_demo():
    print("=" * 70)
    print("  CODER & ACCOTAX ML LAB: Selecting Optimal K via Horizontal Dendrogram Cuts")
