...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Selecting the best model using cross-validation.
...
class Topic11LabEngine:
    """
    Simulation engine for Worked Example 3: Selecting the best model using cross-validation in Model Comparison and Selection.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: SELECTING THE BEST MODEL USING CROSS-VALIDATION")
