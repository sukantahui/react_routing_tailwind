...
1. Computational mechanisms and algorithmic step-by-step logic for Choosing suitable evaluation metrics.
...
class Topic3LabEngine:
    """
    Simulation engine for Choosing suitable evaluation metrics in Model Comparison and Selection.
    """
...
def run_laboratory():
    ...
    print("CHOOSING SUITABLE EVALUATION METRICS")
