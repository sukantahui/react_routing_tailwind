"""
=============================================================================
TOPIC 1: INSTANCE-BASED LEARNING
...
1. Computational mechanisms and algorithmic step-by-step logic for Instance-based learning.
...
class Topic1LabEngine:
    """
    Simulation engine for Instance-based learning in K-Nearest Neighbours (KNN).
    """
