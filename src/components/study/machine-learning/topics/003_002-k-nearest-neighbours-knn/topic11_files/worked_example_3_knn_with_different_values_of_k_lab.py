...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: KNN with different values of K.
...
class Topic11LabEngine:
    """
    Simulation engine for Worked Example 3: KNN with different values of K in K-Nearest Neighbours (KNN).
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 3: KNN with different values of K",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: KNN WITH DIFFERENT VALUES OF K")
