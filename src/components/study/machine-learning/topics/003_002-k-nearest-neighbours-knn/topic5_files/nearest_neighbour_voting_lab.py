"""
=============================================================================
TOPIC 5: NEAREST-NEIGHBOUR VOTING
...
1. Computational mechanisms and algorithmic step-by-step logic for Nearest-neighbour voting.
...
class Topic5LabEngine:
    """
    Simulation engine for Nearest-neighbour voting in K-Nearest Neighbours (KNN).
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Nearest-neighbour voting",
...
def run_laboratory():
    ...
    print("NEAREST-NEIGHBOUR VOTING")
