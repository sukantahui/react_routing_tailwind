...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Fruit classification.
...
class Topic9LabEngine:
    """
    Simulation engine for Worked Example 1: Fruit classification in K-Nearest Neighbours (KNN).
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: Fruit classification",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: FRUIT CLASSIFICATION")
