...
1. Computational mechanisms and algorithmic step-by-step logic for Euclidean distance.
...
class Topic3LabEngine:
    """
    Simulation engine for Euclidean distance in K-Nearest Neighbours (KNN).
    """
