...
Module: Decision Tree Concept and Structure (Slug: 004_002_decision-tree-concept-and-structure)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Simple product classification tree.
...
class Topic15LabEngine:
    """
    Simulation engine for Worked Example 3: Simple product classification tree in Decision Tree Concept and Structure.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 3: Simple product classification tree",
            "module": "Decision Tree Concept and Structure",
...
def run_laboratory():
    print("=" * 80)
    print("CODER & ACCOTAX - MACHINE LEARNING LAB (TOPIC 15)")
    print("WORKED EXAMPLE 3: SIMPLE PRODUCT CLASSIFICATION TREE")
    print("Module: Decision Tree Concept and Structure")
    print("=" * 80)
    
    lab = Topic15LabEngine()
