...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 2: Loan approval decision tree.
...
class Topic14LabEngine:
    """
    Simulation engine for Worked Example 2: Loan approval decision tree in Decision Tree Concept and Structure.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 2: Loan approval decision tree",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 2: LOAN APPROVAL DECISION TREE")
