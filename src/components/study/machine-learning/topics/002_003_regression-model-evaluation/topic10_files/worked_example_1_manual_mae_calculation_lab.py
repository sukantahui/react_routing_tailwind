...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Manual MAE calculation.
...
class Topic10LabEngine:
    """
    Simulation engine for Worked Example 1: Manual MAE calculation in Regression Model Evaluation.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: MANUAL MAE CALCULATION")
