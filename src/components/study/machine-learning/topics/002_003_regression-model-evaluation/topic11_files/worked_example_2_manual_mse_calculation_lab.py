...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 2: Manual MSE calculation.
...
class Topic11LabEngine:
    """
    Simulation engine for Worked Example 2: Manual MSE calculation in Regression Model Evaluation.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 2: MANUAL MSE CALCULATION")
