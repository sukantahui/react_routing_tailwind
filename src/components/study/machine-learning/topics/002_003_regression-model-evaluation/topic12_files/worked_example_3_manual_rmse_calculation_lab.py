...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Manual RMSE calculation.
...
class Topic12LabEngine:
    """
    Simulation engine for Worked Example 3: Manual RMSE calculation in Regression Model Evaluation.
    """
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: MANUAL RMSE CALCULATION")
