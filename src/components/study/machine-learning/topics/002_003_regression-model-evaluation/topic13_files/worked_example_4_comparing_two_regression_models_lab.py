...
Module: Regression Model Evaluation (Slug: 002_003_regression-model-evaluation)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 4: Comparing two regression models.
...
class Topic13LabEngine:
    """
    Simulation engine for Worked Example 4: Comparing two regression models in Regression Model Evaluation.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "module": "Regression Model Evaluation",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 4: COMPARING TWO REGRESSION MODELS")
    print("Module: Regression Model Evaluation")
    print("=" * 80)
