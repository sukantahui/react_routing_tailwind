...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 2: Student grouping.
...
class Topic14LabEngine:
    """
    Simulation engine for Worked Example 2: Student grouping in K-Means Clustering.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 2: Student grouping",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 2: STUDENT GROUPING")
