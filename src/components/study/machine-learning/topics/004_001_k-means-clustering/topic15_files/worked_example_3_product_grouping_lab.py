...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Product grouping.
...
class Topic15LabEngine:
    """
    Simulation engine for Worked Example 3: Product grouping in K-Means Clustering.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 3: Product grouping",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: PRODUCT GROUPING")
