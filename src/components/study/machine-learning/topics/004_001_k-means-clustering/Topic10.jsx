...
import labCode from "./topic10_files/within_cluster_variation_lab.py?raw";
    ...
    <div className="space-y-8 text-slate-200 leading-relaxed max-w-6xl mx-auto pb-12">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="px-3.5 py-1 text-xs font-bold tracking-wider uppercase bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 rounded-full">
              BCAC701B • K-Means Clustering • Topic 10
            </span>
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-4xl">
            Explore Within-cluster variation within the comprehensive framework of K-Means Clustering. Understand mathematical principles, algorithmic formulations, loss optimization, and industrial case studies across West Bengal.
          </p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Theoretical Foundation: Within-cluster variation
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              In K-Means Clustering, within-cluster variation establishes mathematical mapping functions between high-dimensional feature vectors and target prediction spaces, adjusting weights iteratively via empirical loss minimization.
            </p>
      ...
      <section className="bg-slate-900/90 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Interactive Within-cluster variation Simulation Studio
            </h2>
            <p className="text-xs sm:text-sm text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Mamata and Mahima implemented within-cluster variation models analyzing assignment submission rhythms, attendance rates, and weekly quiz scores to provide proactive academic mentoring.
            </p>
          </div>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Debangshu deployed within-cluster variation pipelines in corporate payment gateways to evaluate real-time transaction risks and predict market valuation in ₹ Lakhs.
            </p>
          </div>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Susmita applied within-cluster variation algorithms on 40,000 retail transaction histories to personalize promotional discount allocations.
            </p>
          </div>
          ...
          <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Abhronila engineered within-cluster variation classifiers to evaluate high-resolution diagnostic imaging, maximizing diagnostic sensitivity.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900/90 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Key engineering guidelines for Within-cluster variation
            </p>
          </div>
        </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Interactive standalone lab script for Within-cluster variation
            </p>
          </div>
        </div>
        ...
        <PythonFileLoader
          fileModule={labCode}
          title="within_cluster_variation_lab.py"
      ...
      <section className="space-y-4">
        <FAQTemplate
          title="Within-cluster variation — Frequently Asked Questions"
          questions={questions}
        />
      </section>
