...
Module: K-Means Clustering (Slug: 004_001_k-means-clustering)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Customer segmentation.
...
class Topic13LabEngine:
    """
    Simulation engine for Worked Example 1: Customer segmentation in K-Means Clustering.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: Customer segmentation",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: CUSTOMER SEGMENTATION")
    print("Module: K-Means Clustering")
    print("=" * 80)
