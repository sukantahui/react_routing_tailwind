...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: House price using area and bedrooms.
...
class Topic9LabEngine:
    """
    Simulation engine for Worked Example 1: House price using area and bedrooms in Multiple Linear Regression.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: House price using area and bedrooms",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: HOUSE PRICE USING AREA AND BEDROOMS")
