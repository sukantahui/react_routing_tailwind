...
Module: Simple Linear Regression (Slug: 002_001_simple-linear-regression)
...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 3: Sales prediction from advertising expenditure.
...
class Topic14LabEngine:
    """
    Simulation engine for Worked Example 3: Sales prediction from advertising expenditure in Simple Linear Regression.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 3: Sales prediction from advertising expenditure",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 3: SALES PREDICTION FROM ADVERTISING EXPENDITURE")
    print("Module: Simple Linear Regression")
    print("=" * 80)
