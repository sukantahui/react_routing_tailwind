...
1. Computational mechanisms and algorithmic step-by-step logic for Worked Example 1: Salary prediction from experience.
...
class Topic12LabEngine:
    """
    Simulation engine for Worked Example 1: Salary prediction from experience in Simple Linear Regression.
    """
    ...
    def simulate(self) -> Dict[str, Any]:
        ...
        return {
            "topic": "Worked Example 1: Salary prediction from experience",
...
def run_laboratory():
    ...
    print("WORKED EXAMPLE 1: SALARY PREDICTION FROM EXPERIENCE")
