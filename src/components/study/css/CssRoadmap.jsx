// src/components/study/ExcelRoadmap.jsx
...
import roadmapData from "./css-roadmap.json";
...
export default class CssRoadmap extends Component {
  // ==========================================================
  // Dynamic Segment Colors
  // ==========================================================
 
  colorThemes = [
  { glow: "shadow-[0_0_10px_rgba(30,58,138,0.25)]", bg: "bg-blue-950/40", title: "text-sky-300" },
  { glow: "shadow-[0_0_14px_rgba(29,78,216,0.25)]", bg: "bg-green-900/35", title: "text-sky-300" },
  { glow: "shadow-[0_0_18px_rgba(37,99,235,0.25)]", bg: "bg-blue-900/30", title: "text-sky-300" },
  { glow: "shadow-[0_0_22px_rgba(59,130,246,0.25)]", bg: "bg-blue-800/30", title: "text-sky-300" },
  { glow: "shadow-[0_0_26px_rgba(96,165,250,0.25)]", bg: "bg-blue-800/25", title: "text-sky-300" },
  { glow: "shadow-[0_0_30px_rgba(14,165,233,0.25)]", bg: "bg-sky-900/25",  title: "text-sky-300" },
  { glow: "shadow-[0_0_34px_rgba(56,189,248,0.25)]", bg: "bg-sky-800/20",  title: "text-sky-300" },
];
  ...
  renderSegment(segment, index) {
    ...
    return (
      <section key={segment.segmentId} 
         className={`relative border border-slate-800 rounded-3xl p-5 sm:p-6 md:p-10 mb-14 backdrop-blur-xl 
            ${theme.glow} ${theme.bg}`}
        style={{
          background: `linear-gradient(135deg, ${theme.from}, ${theme.to})`,
        }}
      >
        <div className="relative border border-slate-800 bg-slate-900/80 rounded-3xl p-5 sm:p-6 md:p-10 shadow-[0_0_35px_rgba(0,0,0,0.4)] backdrop-blur-xl">
        {/* Segment Header */}
