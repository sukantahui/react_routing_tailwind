// src/components/study/CssModuleView.jsx
...
export default function CssModuleView() {
                        ...
                        <div className="mt-4 flex justify-between items-center">
                            <Link
                                ...
                                className="
                                            ...
                                            hover:border-sky-500 hover:bg-sky-600/20 
                                            transition
                                            "
                            >
                                <ArrowLeft size={16} />
                            ...
                            <div className="text-xs text-slate-400">
                                Segment: <span className="text-sky-400">{segmentData?.title}</span>
                            </div>
                        </div>
