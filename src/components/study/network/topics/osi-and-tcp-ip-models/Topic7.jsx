...
/**
 * Topic7: Transport Layer – end-to-end delivery, TCP vs UDP, reliability, flow control
 * 
 * Purpose: Explain the transport layer's role in end-to-end communication,
 *          segmentation, multiplexing, and the key protocols TCP and UDP.
 * 
 * Return: JSX.Element - Full educational component with theory, examples, and interactions.
 * 
 * When & Why: Builds on network layer to show how reliable (or fast) delivery is
 *              provided to applications, using ports for demultiplexing.
 */
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <section className="text-center space-y-4 opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards]">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              Layer 4: End-to-end delivery, TCP vs UDP, reliability, flow control — the backbone of application communication
            </p>
          </section>
          ...
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl hover:scale-[1.01] opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[100ms]">
            <h2 className="text-2xl font-semibold flex items-center gap-2 border-l-4 border-blue-500 pl-4 mb-4">
              📦 Real-World Analogy: Courier vs. Express Mail
            </h2>
            <p>
              Imagine <strong>Susmita</strong> in <strong>Naihati</strong> sends a package to <strong>Debangshu</strong> in <strong>Ichapur</strong>.
            </p>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              <li><span className="font-bold">TCP (Reliable Courier):</span> Tracks the package, confirms delivery, retries if lost, delivers in order. Used for important documents.</li>
              <li><span className="font-bold">UDP (Express Mail):</span> Just drops the package, no tracking, no confirmation. Faster, but could be lost. Used for time-sensitive items where occasional loss is acceptable.</li>
            </ul>
            <p>
              The transport layer provides these services to applications, using <span className="font-bold">port numbers</span> like delivery addresses to ensure data reaches the right app.
            </p>
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg text-sm">
              💡 <span className="font-medium">Think about:</span> Why would a video call use UDP while a file download uses TCP? Speed vs. reliability tradeoff.
            </div>
          </section>

          {/* Core Concepts: Segmentation, Ports, Multiplexing */}
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[200ms]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-xl transition-transform duration-300 hover:scale-105 hover:shadow-md">
                ...
                <p className="text-sm">Breaks data from application layer into smaller segments (each with sequence number) for efficient transmission and reassembly.</p>
              </div>
              <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-xl transition-transform duration-300 hover:scale-105 hover:shadow-md">
              ...
              <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-xl transition-transform duration-300 hover:scale-105 hover:shadow-md">
                ...
                <p className="text-sm">Allows multiple applications to use the network simultaneously; the transport layer demultiplexes incoming data to the correct app using ports.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[300ms]">
            <h2 className="text-2xl font-semibold flex items-center gap-2 border-l-4 border-purple-500 pl-4 mb-4">
              ⚖️ TCP vs UDP: The Two Main Protocols
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg">
                <h3 className="font-bold text-lg text-blue-600 dark:text-blue-400">TCP (Transmission Control Protocol)</h3>
                <ul className="list-disc list-inside text-sm mt-2">
                  <li>Connection-oriented (3-way handshake)</li>
                  <li>Reliable: acknowledges, retransmits lost packets</li>
                  <li>Flow control (sliding window)</li>
                  <li>Congestion control</li>
                  <li>Ordered delivery</li>
                  <li>Heavier overhead (20-60 byte header)</li>
                  <li>Examples: HTTP, HTTPS, FTP, SMTP, SSH</li>
                </ul>
              </div>
              <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg">
                <h3 className="font-bold text-lg text-green-600 dark:text-green-400">UDP (User Datagram Protocol)</h3>
                <ul className="list-disc list-inside text-sm mt-2">
                  <li>Connectionless (just sends)</li>
                  <li>Unreliable: no acknowledgments, no retransmission</li>
                  <li>No flow/congestion control</li>
                  <li>No ordering guarantee</li>
                  <li>Lightweight (8-byte header)</li>
                  <li>Examples: DNS, DHCP, VoIP, streaming, gaming</li>
                </ul>
              </div>
            </div>
            <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
              💡 <span className="font-bold">Key insight:</span> TCP sacrifices speed for reliability; UDP sacrifices reliability for speed. Choose based on application needs.
            </div>
          </section>

          {/* Reliability & Flow Control (TCP details) */}
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[400ms]">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-bold">📨 Acknowledgments (ACKs)</h3>
                <p>Receiver sends ACK for received segments. Sender retransmits if ACK not received within timeout.</p>
              </div>
              <div>
                <h3 className="font-bold">🚦 Flow Control</h3>
                <p>Uses sliding window: receiver advertises its available buffer space (window size). Sender adjusts rate to avoid overwhelming receiver.</p>
              </div>
              <div>
                <h3 className="font-bold">🚧 Congestion Control</h3>
                <p>TCP dynamically adjusts sending rate to avoid network congestion (algorithms like Reno, Cubic).</p>
              </div>
              <div>
                <h3 className="font-bold">🔢 Sequence Numbers</h3>
                <p>Each segment is numbered; receiver reorders out-of-order segments and detects missing data.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[500ms]">
            <h2 className="text-2xl font-semibold flex items-center gap-2 border-l-4 border-teal-500 pl-4 mb-4">
              🔌 Port Numbers: The "Doors" to Applications
            </h2>
            <p>
              Ports are 16-bit numbers (0–65535). Divided into:
            </p>
            <ul className="list-disc list-inside ml-4 mt-2">
              <li><span className="font-bold">Well-known ports (0–1023):</span> Reserved for system services (e.g., HTTP:80, HTTPS:443, FTP:21, SSH:22).</li>
              <li><span className="font-bold">Registered ports (1024–49151):</span> Used by applications (e.g., MySQL:3306, Minecraft:25565).</li>
          ...
          {/* SVG Illustration: TCP Handshake & Data Transfer */}
          ...
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[700ms]">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><span className="font-bold">Use `netstat` or `ss`</span> to see active TCP connections and listening ports on your system.</li>
              <li><span className="font-bold">Wireshark is your friend:</span> capture a TCP stream and follow it to see sequence numbers, retransmissions, and window updates.</li>
          ...
          <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-xl opacity-0 translate-y-4 animate-[fadeSlideUp_0.6s_ease-out_forwards] animation-delay-[1000ms]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="flex items-center gap-2"><span className="text-green-500 text-xl">✓</span> Transport layer = end-to-end delivery</div>
              <div className="flex items-center gap-2"><span className="text-green-500 text-xl">✓</span> Segmentation, port addressing, multiplexing</div>
              <div className="flex items-center gap-2"><span className="text-green-500 text-xl">✓</span> TCP: reliable, ordered, connection-oriented</div>
