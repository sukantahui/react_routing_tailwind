// src/components/study/NetworkScriptRoadmap.jsx
...
export default class NetworkRoadmap extends Component {
  // ==========================================================
  ...
  isCompleted(moduleId) {
    return (
      localStorage.getItem(`network-module-completed::${moduleId}`) === "true"
    );
  }

  toggleCompleted(moduleId) {
    const key = `network-module-completed::${moduleId}`;
