...
import CCodeBlock from "../../common/CodeBlock"; // adjust the import path as needed
...
export default function COutputPracticeTemplateWithFiles({ data }) {
        ...
        {started &&
          sessionQ.map((q, index) => (
            ...
            >
              ...
              {/* Code block – the code is already in q.code (merged from raw import) */}
