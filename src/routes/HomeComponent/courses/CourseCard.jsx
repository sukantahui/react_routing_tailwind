      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 mt-4">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-full text-xs font-medium bg-purple-600/25 hover:bg-purple-600 text-purple-300 hover:text-white border border-purple-500/40 transition-all flex items-center justify-center gap-1 cursor-pointer"
            title="Generate Student Course QR and Share on WhatsApp"
          >
