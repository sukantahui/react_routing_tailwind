...
// About.jsx (Optimized)
// -----------------------------------------------
// - Dynamic year calculation from 1998
// - Improved Counter with cleanup & requestAnimationFrame
// - Memoized scroll function & static stats array
// - Accessibility: aria-live for counters
// ===============================================
...
// -----------------------------------------------------------------
// Counter Component (optimized with RAF & cleanup)
// -----------------------------------------------------------------
...
// -----------------------------------------------------------------
// Static stats array (memoized outside component)
// -----------------------------------------------------------------
const STATS = [
  { icon: "🎓", label: "Years of Excellence", value: null }, // value will be dynamic
...
const About = () => {
  ...
  // Dynamic years calculation (founded 1998)
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center md:text-left">
        ...
        >
          ...
          <p className="text-justify mb-5 leading-relaxed text-gray-300">
            With over{" "}
            <strong className="text-amber-400">{yearsOfExcellence} years of experience</strong>{" "}
            and{" "}
          ...
          {STATS.map((stat, idx) => (
            ...
            >
              ...
              {stat.isISO ? (
                ...
                <Counter
                  target={stat.label === "Years of Excellence" ? yearsOfExcellence : stat.value}
                  suffix={stat.label === "Years of Excellence" ? "+" : "+"}
                />
              )}
